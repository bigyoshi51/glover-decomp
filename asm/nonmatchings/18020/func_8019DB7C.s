...
glabel func_8019DB7C
    ...
    /* 9DB84 8019DB84 461A2080 */   add.s     $f2, $f4, $f26
    /* 9DB88 8019DB88 461C103C */  c.lt.s     $f2, $f28
  .L8019DB8C:
    /* 9DB8C 8019DB8C 00000000 */  nop
    /* 9DB90 8019DB90 45020002 */  bc1fl      .L8019DB9C
    /* 9DB94 8019DB94 46022080 */   add.s     $f2, $f4, $f2
    /* 9DB98 8019DB98 461C2080 */  add.s      $f2, $f4, $f28
  .L8019DB9C:
    ...
    /* 9DBB4 8019DBB4 E6020040 */   swc1      $f2, 0x40($s0)
    ...
    /* 9DBC8 8019DBC8 C4600034 */  lwc1       $f0, 0x34($v1)
    /* 9DBCC 8019DBCC 080672FA */  j          .L8019CBE8
    /* 9DBD0 8019DBD0 E440000C */   swc1      $f0, 0xC($v0)
  .L8019DBD4:
  ...
  .L8019DBE8:
    ...
    /* 9DC04 8019DC04 C4400034 */  lwc1       $f0, 0x34($v0)
    /* 9DC08 8019DC08 E480000C */  swc1       $f0, 0xC($a0)
  .L8019DC0C:
  ...
  .L8019DCAC:
    ...
    /* 9DCC0 8019DCC0 C6240058 */  lwc1       $f4, 0x58($s1)
    /* 9DCC4 8019DCC4 3C018011 */  lui        $at, %hi(D_8010A990)
    /* 9DCC8 8019DCC8 C427A990 */  lwc1       $f7, %lo(D_8010A990)($at)
    /* 9DCCC 8019DCCC C426A994 */  lwc1       $f6, %lo(D_8010A990 + 0x4)($at)
    /* 9DCD0 8019DCD0 46002121 */  cvt.d.s    $f4, $f4
    /* 9DCD4 8019DCD4 46262102 */  mul.d      $f4, $f4, $f6
    /* 9DCD8 8019DCD8 C622005C */  lwc1       $f2, 0x5C($s1)
    /* 9DCDC 8019DCDC 460010A1 */  cvt.d.s    $f2, $f2
    /* 9DCE0 8019DCE0 46261082 */  mul.d      $f2, $f2, $f6
