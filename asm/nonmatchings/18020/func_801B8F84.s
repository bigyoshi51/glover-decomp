...
glabel func_801B8F84
  ...
  .L801B9048:
    ...
    /* B9070 801B9070 C7BD0070 */  lwc1       $fs4f, 0x70($sp)
    /* B9074 801B9074 C7BC0074 */  lwc1       $fs4, 0x74($sp)
    /* B9078 801B9078 C7BB0068 */  lwc1       $fs3f, 0x68($sp)
    /* B907C 801B907C C7BA006C */  lwc1       $fs3, 0x6C($sp)
    /* B9080 801B9080 C7B90060 */  lwc1       $fs2f, 0x60($sp)
    /* B9084 801B9084 C7B80064 */  lwc1       $fs2, 0x64($sp)
    /* B9088 801B9088 C7B70058 */  lwc1       $fs1f, 0x58($sp)
    /* B908C 801B908C C7B6005C */  lwc1       $fs1, 0x5C($sp)
    /* B9090 801B9090 C7B50050 */  lwc1       $fs0f, 0x50($sp)
    /* B9094 801B9094 C7B40054 */  lwc1       $fs0, 0x54($sp)
    ...
    /* B90E0 801B90E0 C426BE14 */  lwc1       $ft1, %lo(D_8010BE14)($at)
    /* B90E4 801B90E4 3C018011 */  lui        $at, %hi(D_8010BE18)
    /* B90E8 801B90E8 C428BE18 */  lwc1       $ft2, %lo(D_8010BE18)($at)
    ...
    /* B90F8 801B90F8 C422BE1C */  lwc1       $fv1, %lo(D_8010BE1C)($at)
    /* B90FC 801B90FC 3C018011 */  lui        $at, %hi(D_8010BE20)
    /* B9100 801B9100 C424BE20 */  lwc1       $ft0, %lo(D_8010BE20)($at)
    /* B9104 801B9104 24020001 */  addiu      $v0, $zero, 0x1
    /* B9108 801B9108 44800000 */  mtc1       $zero, $fv0
    ...
    /* B9120 801B9120 E420A838 */  swc1       $fv0, %lo(D_802AA838)($at)
    /* B9124 801B9124 E4600000 */  swc1       $fv0, 0x0($v1)
    /* B9128 801B9128 E6060000 */  swc1       $ft1, 0x0($s0)
    /* B912C 801B912C 3C01802B */  lui        $at, %hi(D_802AA730)
    /* B9130 801B9130 E428A730 */  swc1       $ft2, %lo(D_802AA730)($at)
    /* B9134 801B9134 3C01802B */  lui        $at, %hi(D_802AA8AC)
    /* B9138 801B9138 E422A8AC */  swc1       $fv1, %lo(D_802AA8AC)($at)
