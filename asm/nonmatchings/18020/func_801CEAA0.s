...
glabel func_801CEAA0
    /* CEAA0 801CEAA0 46180083 */  div.s      $fv1, $fv0, $fs2
    /* CEAA4 801CEAA4 46140003 */  div.s      $fv0, $fv0, $fs0
    /* CEAA8 801CEAA8 3C013F00 */  lui        $at, (0x3F000000 >> 16)
    /* CEAAC 801CEAAC 44812000 */  mtc1       $at, $ft0
    /* CEAB0 801CEAB0 00000000 */  nop
    /* CEAB4 801CEAB4 46041080 */  add.s      $fv1, $fv1, $ft0
    /* CEAB8 801CEAB8 46040000 */  add.s      $fv0, $fv0, $ft0
    /* CEABC 801CEABC 4600110D */  trunc.w.s  $ft0, $fv1
    /* CEAC0 801CEAC0 440F2000 */  mfc1       $t7, $ft0
    /* CEAC4 801CEAC4 4600008D */  trunc.w.s  $fv1, $fv0
    /* CEAC8 801CEAC8 440A1000 */  mfc1       $t2, $fv1
  ...
  .L801CEB0C:
    ...
    /* CEB10 801CEB10 44940000 */  mtc1       $s4, $fv0
    /* CEB14 801CEB14 00000000 */  nop
    /* CEB18 801CEB18 46800020 */  cvt.s.w    $fv0, $fv0
    /* CEB1C 801CEB1C 4600A002 */  mul.s      $fv0, $fs0, $fv0
    /* CEB20 801CEB20 86220002 */  lh         $v0, 0x2($s1)
    /* CEB24 801CEB24 44823000 */  mtc1       $v0, $ft1
    /* CEB28 801CEB28 00000000 */  nop
    /* CEB2C 801CEB2C 468031A0 */  cvt.s.w    $ft1, $ft1
    /* CEB30 801CEB30 46003100 */  add.s      $ft0, $ft1, $fv0
    /* CEB34 801CEB34 3C013F7F */  lui        $at, (0x3F7FFF58 >> 16)
    /* CEB38 801CEB38 3421FF58 */  ori        $at, $at, (0x3F7FFF58 & 0xFFFF)
    /* CEB3C 801CEB3C 44814000 */  mtc1       $at, $ft2
    /* CEB40 801CEB40 00000000 */  nop
    /* CEB44 801CEB44 46082000 */  add.s      $fv0, $ft0, $ft2
    /* CEB48 801CEB48 4600008D */  trunc.w.s  $fv1, $fv0
    /* CEB4C 801CEB4C 44161000 */  mfc1       $s6, $fv1
    /* CEB50 801CEB50 00000000 */  nop
    /* CEB54 801CEB54 44960000 */  mtc1       $s6, $fv0
    /* CEB58 801CEB58 00000000 */  nop
    /* CEB5C 801CEB5C 46800020 */  cvt.s.w    $fv0, $fv0
    /* CEB60 801CEB60 46040001 */  sub.s      $fv0, $fv0, $ft0
    /* CEB64 801CEB64 448A1000 */  mtc1       $t2, $fv1
    /* CEB68 801CEB68 00000000 */  nop
    /* CEB6C 801CEB6C 468010A0 */  cvt.s.w    $fv1, $fv1
    /* CEB70 801CEB70 46001082 */  mul.s      $fv1, $fv1, $fv0
    /* CEB74 801CEB74 96230014 */  lhu        $v1, 0x14($s1)
    /* CEB78 801CEB78 4600100D */  trunc.w.s  $fv0, $fv1
    /* CEB7C 801CEB7C 44120000 */  mfc1       $s2, $fv0
  ...
  .L801CEBB0:
    ...
    /* CEBB4 801CEBB4 448B0000 */  mtc1       $t3, $fv0
    /* CEBB8 801CEBB8 00000000 */  nop
    /* CEBBC 801CEBBC 46800020 */  cvt.s.w    $fv0, $fv0
    /* CEBC0 801CEBC0 46140002 */  mul.s      $fv0, $fv0, $fs0
    /* CEBC4 801CEBC4 46003000 */  add.s      $fv0, $ft1, $fv0
    /* CEBC8 801CEBC8 46080000 */  add.s      $fv0, $fv0, $ft2
    /* CEBCC 801CEBCC 4600008D */  trunc.w.s  $fv1, $fv0
    /* CEBD0 801CEBD0 44101000 */  mfc1       $s0, $fv1
  ...
  .L801CEBF0:
    ...
    /* CEC08 801CEC08 4481B000 */  mtc1       $at, $fs1
  ...
  alabel D_801CEC38
    /* CEC38 801CEC38 44940000 */  mtc1       $s4, $fv0
    /* CEC3C 801CEC3C 00000000 */  nop
    /* CEC40 801CEC40 46800020 */  cvt.s.w    $fv0, $fv0
    /* CEC44 801CEC44 46140002 */  mul.s      $fv0, $fv0, $fs0
    /* CEC48 801CEC48 86220002 */  lh         $v0, 0x2($s1)
    /* CEC4C 801CEC4C 44823000 */  mtc1       $v0, $ft1
    /* CEC50 801CEC50 00000000 */  nop
    /* CEC54 801CEC54 468031A0 */  cvt.s.w    $ft1, $ft1
    /* CEC58 801CEC58 46003100 */  add.s      $ft0, $ft1, $fv0
    /* CEC5C 801CEC5C 46162000 */  add.s      $fv0, $ft0, $fs1
    /* CEC60 801CEC60 4600008D */  trunc.w.s  $fv1, $fv0
    /* CEC64 801CEC64 44161000 */  mfc1       $s6, $fv1
    /* CEC68 801CEC68 00000000 */  nop
    /* CEC6C 801CEC6C 44960000 */  mtc1       $s6, $fv0
    /* CEC70 801CEC70 00000000 */  nop
    /* CEC74 801CEC74 46800020 */  cvt.s.w    $fv0, $fv0
    /* CEC78 801CEC78 46040001 */  sub.s      $fv0, $fv0, $ft0
    /* CEC7C 801CEC7C 448A1000 */  mtc1       $t2, $fv1
    /* CEC80 801CEC80 00000000 */  nop
    /* CEC84 801CEC84 468010A0 */  cvt.s.w    $fv1, $fv1
    /* CEC88 801CEC88 46001082 */  mul.s      $fv1, $fv1, $fv0
  .L801CEC8C:
    ...
    /* CECA0 801CECA0 4600100D */  trunc.w.s  $fv0, $fv1
    /* CECA4 801CECA4 44120000 */  mfc1       $s2, $fv0
  ...
  .L801CECD8:
    /* CECD8 801CECD8 448B0000 */  mtc1       $t3, $fv0
    /* CECDC 801CECDC 00000000 */  nop
    /* CECE0 801CECE0 46800020 */  cvt.s.w    $fv0, $fv0
    /* CECE4 801CECE4 46140002 */  mul.s      $fv0, $fv0, $fs0
    /* CECE8 801CECE8 46003000 */  add.s      $fv0, $ft1, $fv0
    /* CECEC 801CECEC 46160000 */  add.s      $fv0, $fv0, $fs1
    /* CECF0 801CECF0 02CEB021 */  addu       $s6, $s6, $t6
    /* CECF4 801CECF4 4600008D */  trunc.w.s  $fv1, $fv0
    /* CECF8 801CECF8 44101000 */  mfc1       $s0, $fv1
  ...
  .L801CED3C:
    /* CED3C 801CED3C 44932000 */  mtc1       $s3, $ft0
    /* CED40 801CED40 00000000 */  nop
    /* CED44 801CED44 46802120 */  cvt.s.w    $ft0, $ft0
    /* CED48 801CED48 46182102 */  mul.s      $ft0, $ft0, $fs2
    /* CED4C 801CED4C 86220000 */  lh         $v0, 0x0($s1)
    /* CED50 801CED50 44823000 */  mtc1       $v0, $ft1
    /* CED54 801CED54 00000000 */  nop
    /* CED58 801CED58 468031A0 */  cvt.s.w    $ft1, $ft1
    /* CED5C 801CED5C 46043100 */  add.s      $ft0, $ft1, $ft0
    /* CED60 801CED60 46162000 */  add.s      $fv0, $ft0, $fs1
    /* CED64 801CED64 4600008D */  trunc.w.s  $fv1, $fv0
    /* CED68 801CED68 44071000 */  mfc1       $a3, $fv1
    /* CED6C 801CED6C 00000000 */  nop
    /* CED70 801CED70 44871000 */  mtc1       $a3, $fv1
    /* CED74 801CED74 00000000 */  nop
    /* CED78 801CED78 468010A0 */  cvt.s.w    $fv1, $fv1
    /* CED7C 801CED7C 46041081 */  sub.s      $fv1, $fv1, $ft0
    /* CED80 801CED80 448F0000 */  mtc1       $t7, $fv0
    /* CED84 801CED84 00000000 */  nop
    /* CED88 801CED88 46800020 */  cvt.s.w    $fv0, $fv0
    /* CED8C 801CED8C 46020002 */  mul.s      $fv0, $fv0, $fv1
    /* CED90 801CED90 96240014 */  lhu        $a0, 0x14($s1)
    /* CED94 801CED94 4600008D */  trunc.w.s  $fv1, $fv0
    /* CED98 801CED98 44081000 */  mfc1       $t0, $fv1
