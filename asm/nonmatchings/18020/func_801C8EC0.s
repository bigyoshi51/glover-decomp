...
glabel func_801C8EC0
  ...
  .L801C8ED8:
    ...
    /* C8EF0 801C8EF0 D422C440 */  ldc1       $fv1, %lo(D_8010C440)($at)
    /* C8EF4 801C8EF4 00021403 */  sra        $v0, $v0, 16
    /* C8EF8 801C8EF8 44820000 */  mtc1       $v0, $fv0
    /* C8EFC 801C8EFC 00000000 */  nop
    /* C8F00 801C8F00 46800021 */  cvt.d.w    $fv0, $fv0
    /* C8F04 801C8F04 46220103 */  div.d      $ft0, $fv0, $fv1
    /* C8F08 801C8F08 24050009 */  addiu      $a1, $zero, 0x9
    /* C8F0C 801C8F0C 24860012 */  addiu      $a2, $a0, 0x12
    /* C8F10 801C8F10 A4870018 */  sh         $a3, 0x18($a0)
    /* C8F14 801C8F14 46201206 */  mov.d      $ft2, $fv1
    /* C8F18 801C8F18 46202186 */  mov.d      $ft1, $ft0
  .L801C8F1C:
    /* C8F1C 801C8F1C 00000000 */  nop
    /* C8F20 801C8F20 46262102 */  mul.d      $ft0, $ft0, $ft1
    /* C8F24 801C8F24 00000000 */  nop
    /* C8F28 801C8F28 46282002 */  mul.d      $fv0, $ft0, $ft2
    /* C8F2C 801C8F2C 24A50001 */  addiu      $a1, $a1, 0x1
    /* C8F30 801C8F30 4620008D */  trunc.w.d  $fv1, $fv0
    /* C8F34 801C8F34 44021000 */  mfc1       $v0, $fv1
    ...
    /* C8F94 801C8F94 F7B40040 */  sdc1       $fs0, 0x40($sp)
