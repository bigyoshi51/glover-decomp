...
glabel func_801C0C70
    ...
    /* C0CBC 801C0CBC 44835000 */   mtc1      $v1, $ft3
    /* C0CC0 801C0CC0 00611825 */  or         $v1, $v1, $at
    /* C0CC4 801C0CC4 44835000 */  mtc1       $v1, $ft3
  .L801C0CC8:
    /* C0CC8 801C0CC8 C4840030 */  lwc1       $ft0, 0x30($a0)
    /* C0CCC 801C0CCC C486008C */  lwc1       $ft1, 0x8C($a0)
    /* C0CD0 801C0CD0 46805420 */  cvt.s.w    $ft4, $ft3
