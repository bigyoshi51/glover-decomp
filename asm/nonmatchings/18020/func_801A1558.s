...
glabel func_801A1558
    ...
    /* A155C 801A155C E7A40020 */   swc1      $f4, 0x20($sp)
    /* A1560 801A1560 0C07100C */  jal        func_801C4030
    /* A1564 801A1564 00000000 */   nop
    /* A1568 801A1568 46000586 */  mov.s      $f22, $f0
  .L801A156C:
    ...
    /* A159C 801A159C 4480A000 */  mtc1       $zero, $f20
    /* A15A0 801A15A0 24040002 */  addiu      $a0, $zero, 0x2
    /* A15A4 801A15A4 E45400E0 */  swc1       $f20, 0xE0($v0)
    /* A15A8 801A15A8 E61400DC */  swc1       $f20, 0xDC($s0)
    /* A15AC 801A15AC 0C05F6E8 */  jal        func_8017DBA0
    /* A15B0 801A15B0 E63400D8 */   swc1      $f20, 0xD8($s1)
    ...
    /* A15D0 801A15D0 E45400E0 */  swc1       $f20, 0xE0($v0)
    /* A15D4 801A15D4 E61400DC */  swc1       $f20, 0xDC($s0)
    /* A15D8 801A15D8 0C05F6E8 */  jal        func_8017DBA0
    /* A15DC 801A15DC E63400D8 */   swc1      $f20, 0xD8($s1)
    ...
    /* A15FC 801A15FC E45400E0 */  swc1       $f20, 0xE0($v0)
    /* A1600 801A1600 E61400DC */  swc1       $f20, 0xDC($s0)
    /* A1604 801A1604 E63400D8 */  swc1       $f20, 0xD8($s1)
    /* A1608 801A1608 E6540060 */  swc1       $f20, 0x60($s2)
    /* A160C 801A160C E654005C */  swc1       $f20, 0x5C($s2)
    /* A1610 801A1610 0C05255A */  jal        func_80149568
    /* A1614 801A1614 E6540058 */   swc1      $f20, 0x58($s2)
    /* A1618 801A1618 3C018011 */  lui        $at, %hi(D_8010AC40)
    /* A161C 801A161C C420AC40 */  lwc1       $f0, %lo(D_8010AC40)($at)
    /* A1620 801A1620 4600B03C */  c.lt.s     $f22, $f0
  ...
  .L801A1640:
    ...
    /* A16A4 801A16A4 C42CF95C */  lwc1       $f12, %lo(D_8028F95C)($at)
    /* A16A8 801A16A8 3C018011 */  lui        $at, %hi(D_8010AC40 + 0x4)
    /* A16AC 801A16AC C421AC44 */  lwc1       $f1, %lo(D_8010AC40 + 0x4)($at)
    /* A16B0 801A16B0 C420AC48 */  lwc1       $f0, %lo(D_8010AC48)($at)
    /* A16B4 801A16B4 46006321 */  cvt.d.s    $f12, $f12
    /* A16B8 801A16B8 46206300 */  add.d      $f12, $f12, $f0
    /* A16BC 801A16BC 0C0525B2 */  jal        func_801496C8
    /* A16C0 801A16C0 46206320 */   cvt.s.d   $f12, $f12
    ...
    /* A16E0 801A16E0 E4200360 */  swc1       $f0, %lo(D_80290360)($at)
  ...
  .L801A16F8:
    /* A16F8 801A16F8 44060000 */  mfc1       $a2, $f0
  ...
  .L801A170C:
    ...
    /* A1710 801A1710 C420AC4C */  lwc1       $f0, %lo(D_8010AC4C)($at)
    /* A1714 801A1714 4600B03C */  c.lt.s     $f22, $f0
    ...
    /* A1768 801A1768 4480A000 */  mtc1       $zero, $f20
    /* A176C 801A176C 24040002 */  addiu      $a0, $zero, 0x2
    /* A1770 801A1770 E45400E0 */  swc1       $f20, 0xE0($v0)
    /* A1774 801A1774 E61400DC */  swc1       $f20, 0xDC($s0)
    /* A1778 801A1778 0C05F6E8 */  jal        func_8017DBA0
    /* A177C 801A177C E63400D8 */   swc1      $f20, 0xD8($s1)
    ...
    /* A179C 801A179C E45400E0 */  swc1       $f20, 0xE0($v0)
    /* A17A0 801A17A0 E61400DC */  swc1       $f20, 0xDC($s0)
    /* A17A4 801A17A4 0C05F6E8 */  jal        func_8017DBA0
    /* A17A8 801A17A8 E63400D8 */   swc1      $f20, 0xD8($s1)
    ...
    /* A17C8 801A17C8 E45400E0 */  swc1       $f20, 0xE0($v0)
    /* A17CC 801A17CC E61400DC */  swc1       $f20, 0xDC($s0)
    /* A17D0 801A17D0 E63400D8 */  swc1       $f20, 0xD8($s1)
    /* A17D4 801A17D4 E6540060 */  swc1       $f20, 0x60($s2)
    /* A17D8 801A17D8 E654005C */  swc1       $f20, 0x5C($s2)
    /* A17DC 801A17DC 0C05CF3A */  jal        func_80173CE8
    /* A17E0 801A17E0 E6540058 */   swc1      $f20, 0x58($s2)
  ...
  .L801A17F0:
    /* A17F0 801A17F0 C64200BC */  lwc1       $f2, 0xBC($s2)
    /* A17F4 801A17F4 3C018011 */  lui        $at, %hi(D_8010AC50)
    /* A17F8 801A17F8 C421AC50 */  lwc1       $f1, %lo(D_8010AC50)($at)
    /* A17FC 801A17FC C420AC54 */  lwc1       $f0, %lo(D_8010AC50 + 0x4)($at)
    /* A1800 801A1800 460010A1 */  cvt.d.s    $f2, $f2
    /* A1804 801A1804 46201082 */  mul.d      $f2, $f2, $f0
    /* A1808 801A1808 3C01801F */  lui        $at, %hi(D_801EFFB0)
    /* A180C 801A180C C420FFB0 */  lwc1       $f0, %lo(D_801EFFB0)($at)
    /* A1810 801A1810 46000021 */  cvt.d.s    $f0, $f0
    /* A1814 801A1814 46201083 */  div.d      $f2, $f2, $f0
    /* A1818 801A1818 3C018011 */  lui        $at, %hi(D_8010AC58)
    /* A181C 801A181C C421AC58 */  lwc1       $f1, %lo(D_8010AC58)($at)
    /* A1820 801A1820 C420AC5C */  lwc1       $f0, %lo(D_8010AC58 + 0x4)($at)
    /* A1824 801A1824 4620103C */  c.lt.d     $f2, $f0
    /* A1828 801A1828 00000000 */  nop
    /* A182C 801A182C 45010003 */  bc1t       .L801A183C
    /* A1830 801A1830 24030046 */   addiu     $v1, $zero, 0x46
    /* A1834 801A1834 4620100D */  trunc.w.d  $f0, $f2
    /* A1838 801A1838 44030000 */  mfc1       $v1, $f0
  .L801A183C:
    ...
    /* A1848 801A1848 C6000000 */  lwc1       $f0, 0x0($s0)
    /* A184C 801A184C C64200BC */  lwc1       $f2, 0xBC($s2)
    /* A1850 801A1850 46020001 */  sub.s      $f0, $f0, $f2
    /* A1854 801A1854 3C018011 */  lui        $at, %hi(D_8010AC60)
    /* A1858 801A1858 C423AC60 */  lwc1       $f3, %lo(D_8010AC60)($at)
    /* A185C 801A185C C422AC64 */  lwc1       $f2, %lo(D_8010AC60 + 0x4)($at)
    /* A1860 801A1860 46000021 */  cvt.d.s    $f0, $f0
    /* A1864 801A1864 46220002 */  mul.d      $f0, $f0, $f2
    /* A1868 801A1868 3C018011 */  lui        $at, %hi(D_8010AC68)
    /* A186C 801A186C C423AC68 */  lwc1       $f3, %lo(D_8010AC68)($at)
    /* A1870 801A1870 C422AC6C */  lwc1       $f2, %lo(D_8010AC68 + 0x4)($at)
    /* A1874 801A1874 46220000 */  add.d      $f0, $f0, $f2
    /* A1878 801A1878 24040001 */  addiu      $a0, $zero, 0x1
    /* A187C 801A187C 4620008D */  trunc.w.d  $f2, $f0
    /* A1880 801A1880 44021000 */  mfc1       $v0, $f2
    /* A1884 801A1884 0C05F6E8 */  jal        func_8017DBA0
    /* A1888 801A1888 A64202D8 */   sh        $v0, 0x2D8($s2)
    /* A188C 801A188C 8E4300D8 */  lw         $v1, 0xD8($s2)
    /* A1890 801A1890 C6420034 */  lwc1       $f2, 0x34($s2)
    /* A1894 801A1894 C460007C */  lwc1       $f0, 0x7C($v1)
    /* A1898 801A1898 46020001 */  sub.s      $f0, $f0, $f2
    /* A189C 801A189C E7A00018 */  swc1       $f0, 0x18($sp)
    /* A18A0 801A18A0 8E4300D8 */  lw         $v1, 0xD8($s2)
    /* A18A4 801A18A4 C6420038 */  lwc1       $f2, 0x38($s2)
    /* A18A8 801A18A8 C4600080 */  lwc1       $f0, 0x80($v1)
    /* A18AC 801A18AC 46020001 */  sub.s      $f0, $f0, $f2
    /* A18B0 801A18B0 E7A0001C */  swc1       $f0, 0x1C($sp)
    /* A18B4 801A18B4 8E4300D8 */  lw         $v1, 0xD8($s2)
    /* A18B8 801A18B8 C642003C */  lwc1       $f2, 0x3C($s2)
    /* A18BC 801A18BC C4600084 */  lwc1       $f0, 0x84($v1)
    /* A18C0 801A18C0 46020001 */  sub.s      $f0, $f0, $f2
    /* A18C4 801A18C4 E7A00020 */  swc1       $f0, 0x20($sp)
    /* A18C8 801A18C8 C640007C */  lwc1       $f0, 0x7C($s2)
    /* A18CC 801A18CC 00409821 */  addu       $s3, $v0, $zero
    /* A18D0 801A18D0 46000007 */  neg.s      $f0, $f0
    /* A18D4 801A18D4 27A40018 */  addiu      $a0, $sp, 0x18
    /* A18D8 801A18D8 44060000 */  mfc1       $a2, $f0
    /* A18DC 801A18DC 0C05242B */  jal        func_801490AC
    /* A18E0 801A18E0 00802821 */   addu      $a1, $a0, $zero
    /* A18E4 801A18E4 C64200BC */  lwc1       $f2, 0xBC($s2)
    /* A18E8 801A18E8 3C018011 */  lui        $at, %hi(D_8010AC70)
    /* A18EC 801A18EC C420AC70 */  lwc1       $f0, %lo(D_8010AC70)($at)
    /* A18F0 801A18F0 46001082 */  mul.s      $f2, $f2, $f0
    /* A18F4 801A18F4 C6040000 */  lwc1       $f4, 0x0($s0)
    /* A18F8 801A18F8 46041083 */  div.s      $f2, $f2, $f4
    /* A18FC 801A18FC C7A00018 */  lwc1       $f0, 0x18($sp)
    /* A1900 801A1900 46020000 */  add.s      $f0, $f0, $f2
    /* A1904 801A1904 E7A00018 */  swc1       $f0, 0x18($sp)
    /* A1908 801A1908 C64200BC */  lwc1       $f2, 0xBC($s2)
    /* A190C 801A190C 3C018011 */  lui        $at, %hi(D_8010AC74)
    /* A1910 801A1910 C420AC74 */  lwc1       $f0, %lo(D_8010AC74)($at)
    /* A1914 801A1914 46001082 */  mul.s      $f2, $f2, $f0
    /* A1918 801A1918 46041083 */  div.s      $f2, $f2, $f4
    /* A191C 801A191C C7A00020 */  lwc1       $f0, 0x20($sp)
    /* A1920 801A1920 46020000 */  add.s      $f0, $f0, $f2
    /* A1924 801A1924 E7A00020 */  swc1       $f0, 0x20($sp)
    ...
    /* A1938 801A1938 C6400034 */  lwc1       $f0, 0x34($s2)
    /* A193C 801A193C C7A20018 */  lwc1       $f2, 0x18($sp)
    /* A1940 801A1940 46020000 */  add.s      $f0, $f0, $f2
    /* A1944 801A1944 E66000B4 */  swc1       $f0, 0xB4($s3)
    /* A1948 801A1948 C6400038 */  lwc1       $f0, 0x38($s2)
    /* A194C 801A194C C7A2001C */  lwc1       $f2, 0x1C($sp)
    /* A1950 801A1950 46020000 */  add.s      $f0, $f0, $f2
    /* A1954 801A1954 E66000B8 */  swc1       $f0, 0xB8($s3)
    /* A1958 801A1958 C640003C */  lwc1       $f0, 0x3C($s2)
    /* A195C 801A195C C7A20020 */  lwc1       $f2, 0x20($sp)
    /* A1960 801A1960 46020000 */  add.s      $f0, $f0, $f2
    /* A1964 801A1964 8E62002C */  lw         $v0, 0x2C($s3)
    /* A1968 801A1968 E66000BC */  swc1       $f0, 0xBC($s3)
    ...
    /* A1984 801A1984 C66600B4 */  lwc1       $f6, 0xB4($s3)
    /* A1988 801A1988 C66000C0 */  lwc1       $f0, 0xC0($s3)
    /* A198C 801A198C C66400B8 */  lwc1       $f4, 0xB8($s3)
    /* A1990 801A1990 46003181 */  sub.s      $f6, $f6, $f0
    /* A1994 801A1994 C66200C4 */  lwc1       $f2, 0xC4($s3)
    /* A1998 801A1998 C66000BC */  lwc1       $f0, 0xBC($s3)
    /* A199C 801A199C 46022101 */  sub.s      $f4, $f4, $f2
    /* A19A0 801A19A0 C66200C8 */  lwc1       $f2, 0xC8($s3)
    /* A19A4 801A19A4 3C028020 */  lui        $v0, %hi(D_802004E0)
    /* A19A8 801A19A8 8C4204E0 */  lw         $v0, %lo(D_802004E0)($v0)
    /* A19AC 801A19AC 46020001 */  sub.s      $f0, $f0, $f2
    /* A19B0 801A19B0 2842000B */  slti       $v0, $v0, 0xB
    /* A19B4 801A19B4 E66600D8 */  swc1       $f6, 0xD8($s3)
    /* A19B8 801A19B8 E66400DC */  swc1       $f4, 0xDC($s3)
    /* A19BC 801A19BC 14400038 */  bnez       $v0, .L801A1AA0
    /* A19C0 801A19C0 E66000E0 */   swc1      $f0, 0xE0($s3)
    /* A19C4 801A19C4 8E4200DC */  lw         $v0, 0xDC($s2)
    /* A19C8 801A19C8 C440000C */  lwc1       $f0, 0xC($v0)
    /* A19CC 801A19CC 44802000 */  mtc1       $zero, $f4
    /* A19D0 801A19D0 46040032 */  c.eq.s     $f0, $f4
    /* A19D4 801A19D4 00000000 */  nop
    /* A19D8 801A19D8 45010031 */  bc1t       .L801A1AA0
    /* A19DC 801A19DC 00000000 */   nop
    /* A19E0 801A19E0 C66000B8 */  lwc1       $f0, 0xB8($s3)
    /* A19E4 801A19E4 C662000C */  lwc1       $f2, 0xC($s3)
    /* A19E8 801A19E8 46020001 */  sub.s      $f0, $f0, $f2
    /* A19EC 801A19EC 4604003E */  c.le.s     $f0, $f4
    /* A19F0 801A19F0 00000000 */  nop
    /* A19F4 801A19F4 45000018 */  bc1f       .L801A1A58
    /* A19F8 801A19F8 00000000 */   nop
    /* A19FC 801A19FC C66000C4 */  lwc1       $f0, 0xC4($s3)
    /* A1A00 801A1A00 46020001 */  sub.s      $f0, $f0, $f2
    /* A1A04 801A1A04 4600203C */  c.lt.s     $f4, $f0
  ...
  .L801A1A58:
    /* A1A58 801A1A58 C66000B8 */  lwc1       $f0, 0xB8($s3)
    /* A1A5C 801A1A5C C662000C */  lwc1       $f2, 0xC($s3)
    /* A1A60 801A1A60 46020001 */  sub.s      $f0, $f0, $f2
    /* A1A64 801A1A64 44802000 */  mtc1       $zero, $f4
    /* A1A68 801A1A68 4600203E */  c.le.s     $f4, $f0
    /* A1A6C 801A1A6C 00000000 */  nop
    /* A1A70 801A1A70 4500000B */  bc1f       .L801A1AA0
    /* A1A74 801A1A74 00000000 */   nop
    /* A1A78 801A1A78 C66000C4 */  lwc1       $f0, 0xC4($s3)
    /* A1A7C 801A1A7C 46020001 */  sub.s      $f0, $f0, $f2
    /* A1A80 801A1A80 4604003C */  c.lt.s     $f0, $f4
  ...
  .L801A1AA0:
    ...
    /* A1AC4 801A1AC4 C6420034 */  lwc1       $f2, 0x34($s2)
    /* A1AC8 801A1AC8 C46000A0 */  lwc1       $f0, 0xA0($v1)
    /* A1ACC 801A1ACC 46020001 */  sub.s      $f0, $f0, $f2
    /* A1AD0 801A1AD0 E7A00018 */  swc1       $f0, 0x18($sp)
    /* A1AD4 801A1AD4 8E4300D8 */  lw         $v1, 0xD8($s2)
    /* A1AD8 801A1AD8 C6420038 */  lwc1       $f2, 0x38($s2)
    /* A1ADC 801A1ADC C46000A4 */  lwc1       $f0, 0xA4($v1)
    /* A1AE0 801A1AE0 46020001 */  sub.s      $f0, $f0, $f2
    /* A1AE4 801A1AE4 E7A0001C */  swc1       $f0, 0x1C($sp)
    /* A1AE8 801A1AE8 8E4300D8 */  lw         $v1, 0xD8($s2)
    /* A1AEC 801A1AEC C642003C */  lwc1       $f2, 0x3C($s2)
    /* A1AF0 801A1AF0 C46000A8 */  lwc1       $f0, 0xA8($v1)
    /* A1AF4 801A1AF4 46020001 */  sub.s      $f0, $f0, $f2
    /* A1AF8 801A1AF8 E7A00020 */  swc1       $f0, 0x20($sp)
    /* A1AFC 801A1AFC C640007C */  lwc1       $f0, 0x7C($s2)
    /* A1B00 801A1B00 00409821 */  addu       $s3, $v0, $zero
    /* A1B04 801A1B04 46000007 */  neg.s      $f0, $f0
    /* A1B08 801A1B08 27A40018 */  addiu      $a0, $sp, 0x18
    /* A1B0C 801A1B0C 44060000 */  mfc1       $a2, $f0
    /* A1B10 801A1B10 0C05242B */  jal        func_801490AC
    /* A1B14 801A1B14 00802821 */   addu      $a1, $a0, $zero
    /* A1B18 801A1B18 C64200BC */  lwc1       $f2, 0xBC($s2)
    /* A1B1C 801A1B1C 3C018011 */  lui        $at, %hi(D_8010AC78)
    /* A1B20 801A1B20 C420AC78 */  lwc1       $f0, %lo(D_8010AC78)($at)
    /* A1B24 801A1B24 46001082 */  mul.s      $f2, $f2, $f0
    /* A1B28 801A1B28 3C01801F */  lui        $at, %hi(D_801EFFB0)
    /* A1B2C 801A1B2C C424FFB0 */  lwc1       $f4, %lo(D_801EFFB0)($at)
    /* A1B30 801A1B30 46041083 */  div.s      $f2, $f2, $f4
    /* A1B34 801A1B34 C7A00018 */  lwc1       $f0, 0x18($sp)
    /* A1B38 801A1B38 46020001 */  sub.s      $f0, $f0, $f2
    /* A1B3C 801A1B3C E7A00018 */  swc1       $f0, 0x18($sp)
    /* A1B40 801A1B40 C64200BC */  lwc1       $f2, 0xBC($s2)
    /* A1B44 801A1B44 3C018011 */  lui        $at, %hi(D_8010AC7C)
    /* A1B48 801A1B48 C420AC7C */  lwc1       $f0, %lo(D_8010AC7C)($at)
    /* A1B4C 801A1B4C 46001082 */  mul.s      $f2, $f2, $f0
    /* A1B50 801A1B50 46041083 */  div.s      $f2, $f2, $f4
    /* A1B54 801A1B54 C7A00020 */  lwc1       $f0, 0x20($sp)
    /* A1B58 801A1B58 46020001 */  sub.s      $f0, $f0, $f2
    /* A1B5C 801A1B5C E7A00020 */  swc1       $f0, 0x20($sp)
    ...
    /* A1B70 801A1B70 C6400034 */  lwc1       $f0, 0x34($s2)
    /* A1B74 801A1B74 C7A20018 */  lwc1       $f2, 0x18($sp)
    /* A1B78 801A1B78 46020000 */  add.s      $f0, $f0, $f2
    /* A1B7C 801A1B7C E66000B4 */  swc1       $f0, 0xB4($s3)
    /* A1B80 801A1B80 C6400038 */  lwc1       $f0, 0x38($s2)
    /* A1B84 801A1B84 C7A2001C */  lwc1       $f2, 0x1C($sp)
    /* A1B88 801A1B88 46020000 */  add.s      $f0, $f0, $f2
    /* A1B8C 801A1B8C E66000B8 */  swc1       $f0, 0xB8($s3)
    /* A1B90 801A1B90 C640003C */  lwc1       $f0, 0x3C($s2)
    /* A1B94 801A1B94 C7A20020 */  lwc1       $f2, 0x20($sp)
    /* A1B98 801A1B98 46020000 */  add.s      $f0, $f0, $f2
    /* A1B9C 801A1B9C 8E62002C */  lw         $v0, 0x2C($s3)
    /* A1BA0 801A1BA0 E66000BC */  swc1       $f0, 0xBC($s3)
    ...
    /* A1BBC 801A1BBC C66600B4 */  lwc1       $f6, 0xB4($s3)
    /* A1BC0 801A1BC0 C66000C0 */  lwc1       $f0, 0xC0($s3)
    /* A1BC4 801A1BC4 C66400B8 */  lwc1       $f4, 0xB8($s3)
    /* A1BC8 801A1BC8 46003181 */  sub.s      $f6, $f6, $f0
    /* A1BCC 801A1BCC C66200C4 */  lwc1       $f2, 0xC4($s3)
    /* A1BD0 801A1BD0 C66000BC */  lwc1       $f0, 0xBC($s3)
    /* A1BD4 801A1BD4 46022101 */  sub.s      $f4, $f4, $f2
    /* A1BD8 801A1BD8 C66200C8 */  lwc1       $f2, 0xC8($s3)
    /* A1BDC 801A1BDC 3C028020 */  lui        $v0, %hi(D_802004E0)
    /* A1BE0 801A1BE0 8C4204E0 */  lw         $v0, %lo(D_802004E0)($v0)
    /* A1BE4 801A1BE4 46020001 */  sub.s      $f0, $f0, $f2
    /* A1BE8 801A1BE8 2842000B */  slti       $v0, $v0, 0xB
    /* A1BEC 801A1BEC E66600D8 */  swc1       $f6, 0xD8($s3)
    /* A1BF0 801A1BF0 E66400DC */  swc1       $f4, 0xDC($s3)
    /* A1BF4 801A1BF4 14400038 */  bnez       $v0, .L801A1CD8
    /* A1BF8 801A1BF8 E66000E0 */   swc1      $f0, 0xE0($s3)
    /* A1BFC 801A1BFC 8E4200DC */  lw         $v0, 0xDC($s2)
    /* A1C00 801A1C00 C440000C */  lwc1       $f0, 0xC($v0)
    /* A1C04 801A1C04 44802000 */  mtc1       $zero, $f4
    /* A1C08 801A1C08 46040032 */  c.eq.s     $f0, $f4
    /* A1C0C 801A1C0C 00000000 */  nop
    /* A1C10 801A1C10 45010031 */  bc1t       .L801A1CD8
    /* A1C14 801A1C14 00000000 */   nop
    /* A1C18 801A1C18 C66000B8 */  lwc1       $f0, 0xB8($s3)
    /* A1C1C 801A1C1C C662000C */  lwc1       $f2, 0xC($s3)
    /* A1C20 801A1C20 46020001 */  sub.s      $f0, $f0, $f2
    /* A1C24 801A1C24 4604003E */  c.le.s     $f0, $f4
    /* A1C28 801A1C28 00000000 */  nop
    /* A1C2C 801A1C2C 45000018 */  bc1f       .L801A1C90
    /* A1C30 801A1C30 00000000 */   nop
    /* A1C34 801A1C34 C66000C4 */  lwc1       $f0, 0xC4($s3)
    /* A1C38 801A1C38 46020001 */  sub.s      $f0, $f0, $f2
    /* A1C3C 801A1C3C 4600203C */  c.lt.s     $f4, $f0
  ...
  .L801A1C90:
    /* A1C90 801A1C90 C66000B8 */  lwc1       $f0, 0xB8($s3)
    /* A1C94 801A1C94 C662000C */  lwc1       $f2, 0xC($s3)
    /* A1C98 801A1C98 46020001 */  sub.s      $f0, $f0, $f2
    /* A1C9C 801A1C9C 44802000 */  mtc1       $zero, $f4
    /* A1CA0 801A1CA0 4600203E */  c.le.s     $f4, $f0
    /* A1CA4 801A1CA4 00000000 */  nop
    /* A1CA8 801A1CA8 4500000B */  bc1f       .L801A1CD8
    /* A1CAC 801A1CAC 00000000 */   nop
    /* A1CB0 801A1CB0 C66000C4 */  lwc1       $f0, 0xC4($s3)
    /* A1CB4 801A1CB4 46020001 */  sub.s      $f0, $f0, $f2
    /* A1CB8 801A1CB8 4604003C */  c.lt.s     $f0, $f4
  ...
  .L801A1CD8:
    ...
    /* A1D08 801A1D08 C422AC80 */  lwc1       $f2, %lo(D_8010AC80)($at)
    /* A1D0C 801A1D0C C4400048 */  lwc1       $f0, 0x48($v0)
    /* A1D10 801A1D10 46020003 */  div.s      $f0, $f0, $f2
    /* A1D14 801A1D14 8E4200D8 */  lw         $v0, 0xD8($s2)
    /* A1D18 801A1D18 E4400074 */  swc1       $f0, 0x74($v0)
    /* A1D1C 801A1D1C E4400070 */  swc1       $f0, 0x70($v0)
    ...
    /* A1D2C 801A1D2C C420AC84 */  lwc1       $f0, %lo(D_8010AC84)($at)
  ...
  .L801A1D48:
    ...
    /* A1D4C 801A1D4C E6400270 */  swc1       $f0, 0x270($s2)
    /* A1D50 801A1D50 AE40026C */  sw         $zero, 0x26C($s2)
  .L801A1D54:
    /* A1D54 801A1D54 8E4200D8 */  lw         $v0, 0xD8($s2)
    /* A1D58 801A1D58 8E4300D0 */  lw         $v1, 0xD0($s2)
    /* A1D5C 801A1D5C C4400070 */  lwc1       $f0, 0x70($v0)
    /* A1D60 801A1D60 C4620048 */  lwc1       $f2, 0x48($v1)
    /* A1D64 801A1D64 46020003 */  div.s      $f0, $f0, $f2
    /* A1D68 801A1D68 3C03801F */  lui        $v1, %hi(D_801EFFB0)
    /* A1D6C 801A1D6C 2463FFB0 */  addiu      $v1, $v1, %lo(D_801EFFB0)
    /* A1D70 801A1D70 C4620000 */  lwc1       $f2, 0x0($v1)
    /* A1D74 801A1D74 46020002 */  mul.s      $f0, $f0, $f2
    /* A1D78 801A1D78 8E4200D8 */  lw         $v0, 0xD8($s2)
    /* A1D7C 801A1D7C E64000BC */  swc1       $f0, 0xBC($s2)
    /* A1D80 801A1D80 E64000C4 */  swc1       $f0, 0xC4($s2)
    /* A1D84 801A1D84 E64000C0 */  swc1       $f0, 0xC0($s2)
    /* A1D88 801A1D88 C4400070 */  lwc1       $f0, 0x70($v0)
    /* A1D8C 801A1D8C 3C018011 */  lui        $at, %hi(D_8010AC88)
    /* A1D90 801A1D90 C423AC88 */  lwc1       $f3, %lo(D_8010AC88)($at)
    /* A1D94 801A1D94 C422AC8C */  lwc1       $f2, %lo(D_8010AC88 + 0x4)($at)
    /* A1D98 801A1D98 46000021 */  cvt.d.s    $f0, $f0
    /* A1D9C 801A1D9C 46220002 */  mul.d      $f0, $f0, $f2
    /* A1DA0 801A1DA0 8E4200CC */  lw         $v0, 0xCC($s2)
    /* A1DA4 801A1DA4 46200020 */  cvt.s.d    $f0, $f0
    /* A1DA8 801A1DA8 E4400008 */  swc1       $f0, 0x8($v0)
    /* A1DAC 801A1DAC C64200BC */  lwc1       $f2, 0xBC($s2)
    /* A1DB0 801A1DB0 3C018011 */  lui        $at, %hi(D_8010AC90)
    /* A1DB4 801A1DB4 C425AC90 */  lwc1       $f5, %lo(D_8010AC90)($at)
    /* A1DB8 801A1DB8 C424AC94 */  lwc1       $f4, %lo(D_8010AC90 + 0x4)($at)
    /* A1DBC 801A1DBC 460010A1 */  cvt.d.s    $f2, $f2
    /* A1DC0 801A1DC0 46241082 */  mul.d      $f2, $f2, $f4
    /* A1DC4 801A1DC4 C4600000 */  lwc1       $f0, 0x0($v1)
    /* A1DC8 801A1DC8 46000021 */  cvt.d.s    $f0, $f0
    /* A1DCC 801A1DCC 46201083 */  div.d      $f2, $f2, $f0
    /* A1DD0 801A1DD0 8E4200D0 */  lw         $v0, 0xD0($s2)
    /* A1DD4 801A1DD4 462010A0 */  cvt.s.d    $f2, $f2
    /* A1DD8 801A1DD8 E4420004 */  swc1       $f2, 0x4($v0)
    /* A1DDC 801A1DDC C64200BC */  lwc1       $f2, 0xBC($s2)
    /* A1DE0 801A1DE0 460010A1 */  cvt.d.s    $f2, $f2
    /* A1DE4 801A1DE4 46241082 */  mul.d      $f2, $f2, $f4
    /* A1DE8 801A1DE8 C4600000 */  lwc1       $f0, 0x0($v1)
    /* A1DEC 801A1DEC 46000021 */  cvt.d.s    $f0, $f0
    /* A1DF0 801A1DF0 46201083 */  div.d      $f2, $f2, $f0
    /* A1DF4 801A1DF4 8E4200D0 */  lw         $v0, 0xD0($s2)
    /* A1DF8 801A1DF8 3C018011 */  lui        $at, %hi(D_8010AC98)
    /* A1DFC 801A1DFC C420AC98 */  lwc1       $f0, %lo(D_8010AC98)($at)
    /* A1E00 801A1E00 462010A0 */  cvt.s.d    $f2, $f2
    /* A1E04 801A1E04 E442000C */  swc1       $f2, 0xC($v0)
    /* A1E08 801A1E08 C64200BC */  lwc1       $f2, 0xBC($s2)
    /* A1E0C 801A1E0C 46001082 */  mul.s      $f2, $f2, $f0
    /* A1E10 801A1E10 C4600000 */  lwc1       $f0, 0x0($v1)
    /* A1E14 801A1E14 46001083 */  div.s      $f2, $f2, $f0
    /* A1E18 801A1E18 8E4200D4 */  lw         $v0, 0xD4($s2)
    /* A1E1C 801A1E1C AE40005C */  sw         $zero, 0x5C($s2)
    /* A1E20 801A1E20 E6420038 */  swc1       $f2, 0x38($s2)
    ...
    /* A1E48 801A1E48 C44000DC */  lwc1       $f0, 0xDC($v0)
    /* A1E4C 801A1E4C 44801000 */  mtc1       $zero, $f2
    /* A1E50 801A1E50 4602003C */  c.lt.s     $f0, $f2
    ...
    /* A1E64 801A1E64 46001506 */  mov.s      $f20, $f2
  ...
  .L801A1E74:
    ...
    /* A1E90 801A1E90 C4400004 */  lwc1       $f0, 0x4($v0)
    /* A1E94 801A1E94 4614003C */  c.lt.s     $f0, $f20
  ...
  .L801A1EBC:
    ...
    /* A1EE0 801A1EE0 E4340338 */  swc1       $f20, %lo(D_80290338)($at)
    /* A1EE4 801A1EE4 3C018029 */  lui        $at, %hi(D_80290334)
    /* A1EE8 801A1EE8 E4340334 */  swc1       $f20, %lo(D_80290334)($at)
    /* A1EEC 801A1EEC 3C018029 */  lui        $at, %hi(D_80290330)
    /* A1EF0 801A1EF0 E4340330 */  swc1       $f20, %lo(D_80290330)($at)
  ...
  .L801A1F04:
    ...
    /* A1F1C 801A1F1C C4800000 */  lwc1       $f0, 0x0($a0)
    /* A1F20 801A1F20 3C018011 */  lui        $at, %hi(D_8010AC9C)
    /* A1F24 801A1F24 C424AC9C */  lwc1       $f4, %lo(D_8010AC9C)($at)
    /* A1F28 801A1F28 4604003C */  c.lt.s     $f0, $f4
    /* A1F2C 801A1F2C 00000000 */  nop
    /* A1F30 801A1F30 45000002 */  bc1f       .L801A1F3C
    /* A1F34 801A1F34 46000086 */   mov.s     $f2, $f0
    /* A1F38 801A1F38 46002086 */  mov.s      $f2, $f4
  .L801A1F3C:
    /* A1F3C 801A1F3C 8C82FFF0 */  lw         $v0, -0x10($a0)
    /* A1F40 801A1F40 44800000 */  mtc1       $zero, $f0
    /* A1F44 801A1F44 2403FFEE */  addiu      $v1, $zero, -0x12
    /* A1F48 801A1F48 E4820000 */  swc1       $f2, 0x0($a0)
    /* A1F4C 801A1F4C E4800028 */  swc1       $f0, 0x28($a0)
    /* A1F50 801A1F50 E4800024 */  swc1       $f0, 0x24($a0)
    /* A1F54 801A1F54 E4800020 */  swc1       $f0, 0x20($a0)
  ...
  .L801A1F60:
    ...
    /* A1F80 801A1F80 C44000DC */  lwc1       $f0, 0xDC($v0)
    /* A1F84 801A1F84 44801000 */  mtc1       $zero, $f2
    /* A1F88 801A1F88 4602003C */  c.lt.s     $f0, $f2
    /* A1F8C 801A1F8C 00000000 */  nop
    /* A1F90 801A1F90 45000013 */  bc1f       .L801A1FE0
    /* A1F94 801A1F94 00008021 */   addu      $s0, $zero, $zero
    /* A1F98 801A1F98 46001506 */  mov.s      $f20, $f2
  .L801A1F9C:
    ...
    /* A1FB8 801A1FB8 C4400004 */  lwc1       $f0, 0x4($v0)
    /* A1FBC 801A1FBC 4614003C */  c.lt.s     $f0, $f20
  ...
  .L801A1FE4:
    ...
    /* A1FF8 801A1FF8 C422ACA0 */  lwc1       $f2, %lo(D_8010ACA0)($at)
    /* A1FFC 801A1FFC 4600103C */  c.lt.s     $f2, $f0
  ...
  .L801A2044:
    ...
    /* A2058 801A2058 C6420034 */  lwc1       $f2, 0x34($s2)
    /* A205C 801A205C C46000A0 */  lwc1       $f0, 0xA0($v1)
    /* A2060 801A2060 46020001 */  sub.s      $f0, $f0, $f2
    /* A2064 801A2064 E7A00018 */  swc1       $f0, 0x18($sp)
    /* A2068 801A2068 8E4300D8 */  lw         $v1, 0xD8($s2)
    /* A206C 801A206C C6420038 */  lwc1       $f2, 0x38($s2)
    /* A2070 801A2070 C46000A4 */  lwc1       $f0, 0xA4($v1)
    /* A2074 801A2074 46020001 */  sub.s      $f0, $f0, $f2
    /* A2078 801A2078 E7A0001C */  swc1       $f0, 0x1C($sp)
    /* A207C 801A207C 8E4300D8 */  lw         $v1, 0xD8($s2)
    /* A2080 801A2080 C642003C */  lwc1       $f2, 0x3C($s2)
    /* A2084 801A2084 C46000A8 */  lwc1       $f0, 0xA8($v1)
    /* A2088 801A2088 46020001 */  sub.s      $f0, $f0, $f2
    /* A208C 801A208C E7A00020 */  swc1       $f0, 0x20($sp)
    /* A2090 801A2090 C640007C */  lwc1       $f0, 0x7C($s2)
    /* A2094 801A2094 00409821 */  addu       $s3, $v0, $zero
    /* A2098 801A2098 46000007 */  neg.s      $f0, $f0
    /* A209C 801A209C 27A40018 */  addiu      $a0, $sp, 0x18
    /* A20A0 801A20A0 44060000 */  mfc1       $a2, $f0
    /* A20A4 801A20A4 0C05242B */  jal        func_801490AC
    /* A20A8 801A20A8 00802821 */   addu      $a1, $a0, $zero
    /* A20AC 801A20AC A66000A6 */  sh         $zero, 0xA6($s3)
    /* A20B0 801A20B0 C7A40018 */  lwc1       $f4, 0x18($sp)
    /* A20B4 801A20B4 3C018011 */  lui        $at, %hi(D_8010ACA4)
    /* A20B8 801A20B8 C420ACA4 */  lwc1       $f0, %lo(D_8010ACA4)($at)
    /* A20BC 801A20BC C7A2001C */  lwc1       $f2, 0x1C($sp)
    /* A20C0 801A20C0 46002101 */  sub.s      $f4, $f4, $f0
    /* A20C4 801A20C4 3C018011 */  lui        $at, %hi(D_8010ACA8)
    /* A20C8 801A20C8 C420ACA8 */  lwc1       $f0, %lo(D_8010ACA8)($at)
    /* A20CC 801A20CC 46001081 */  sub.s      $f2, $f2, $f0
    /* A20D0 801A20D0 E7A40018 */  swc1       $f4, 0x18($sp)
    /* A20D4 801A20D4 E7A2001C */  swc1       $f2, 0x1C($sp)
    ...
    /* A20E8 801A20E8 C6400034 */  lwc1       $f0, 0x34($s2)
    /* A20EC 801A20EC C7A20018 */  lwc1       $f2, 0x18($sp)
    /* A20F0 801A20F0 46020000 */  add.s      $f0, $f0, $f2
    /* A20F4 801A20F4 E66000B4 */  swc1       $f0, 0xB4($s3)
    /* A20F8 801A20F8 C6400038 */  lwc1       $f0, 0x38($s2)
    /* A20FC 801A20FC C7A2001C */  lwc1       $f2, 0x1C($sp)
    /* A2100 801A2100 46020000 */  add.s      $f0, $f0, $f2
    /* A2104 801A2104 E66000B8 */  swc1       $f0, 0xB8($s3)
    /* A2108 801A2108 C640003C */  lwc1       $f0, 0x3C($s2)
    /* A210C 801A210C C7A20020 */  lwc1       $f2, 0x20($sp)
    /* A2110 801A2110 46020000 */  add.s      $f0, $f0, $f2
    /* A2114 801A2114 E66000BC */  swc1       $f0, 0xBC($s3)
    ...
    /* A2140 801A2140 C423ACAC */  lwc1       $f3, %lo(D_8010ACA8 + 0x4)($at)
    /* A2144 801A2144 C422ACB0 */  lwc1       $f2, %lo(D_8010ACB0)($at)
    /* A2148 801A2148 00431023 */  subu       $v0, $v0, $v1
    /* A214C 801A214C 44820000 */  mtc1       $v0, $f0
    /* A2150 801A2150 46800020 */  cvt.s.w    $f0, $f0
    /* A2154 801A2154 46000021 */  cvt.d.s    $f0, $f0
    /* A2158 801A2158 46220003 */  div.d      $f0, $f0, $f2
    /* A215C 801A215C 3C018011 */  lui        $at, %hi(D_8010ACB4)
    /* A2160 801A2160 C424ACB4 */  lwc1       $f4, %lo(D_8010ACB4)($at)
    /* A2164 801A2164 3C018011 */  lui        $at, %hi(D_8010ACB8)
    /* A2168 801A2168 C422ACB8 */  lwc1       $f2, %lo(D_8010ACB8)($at)
    /* A216C 801A216C AFA0001C */  sw         $zero, 0x1C($sp)
    /* A2170 801A2170 E7A40020 */  swc1       $f4, 0x20($sp)
    /* A2174 801A2174 E7A20018 */  swc1       $f2, 0x18($sp)
    /* A2178 801A2178 8E4300DC */  lw         $v1, 0xDC($s2)
    /* A217C 801A217C 8C620048 */  lw         $v0, 0x48($v1)
    /* A2180 801A2180 C44200B8 */  lwc1       $f2, 0xB8($v0)
    /* A2184 801A2184 46200120 */  cvt.s.d    $f4, $f0
    /* A2188 801A2188 46041082 */  mul.s      $f2, $f2, $f4
    /* A218C 801A218C C7A6001C */  lwc1       $f6, 0x1C($sp)
  .L801A2190:
    /* A2190 801A2190 4606103C */  c.lt.s     $f2, $f6
    /* A2194 801A2194 00000000 */  nop
    /* A2198 801A2198 45030001 */  bc1tl      .L801A21A0
    /* A219C 801A219C 46003086 */   mov.s     $f2, $f6
  .L801A21A0:
    /* A21A0 801A21A0 E462000C */  swc1       $f2, 0xC($v1)
    /* A21A4 801A21A4 8E4200D0 */  lw         $v0, 0xD0($s2)
    /* A21A8 801A21A8 C4400004 */  lwc1       $f0, 0x4($v0)
    /* A21AC 801A21AC 46040002 */  mul.s      $f0, $f0, $f4
    /* A21B0 801A21B0 E4400004 */  swc1       $f0, 0x4($v0)
