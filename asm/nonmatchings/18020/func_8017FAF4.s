...
glabel func_8017FAF4
  ...
  .L8017FB18:
    ...
    /* 7FB2C 8017FB2C C42088CC */  lwc1       $f0, %lo(D_801088CC)($at)
    ...
    /* 7FB50 8017FB50 E7A00020 */  swc1       $f0, 0x20($sp)
  ...
  .L8017FB8C:
    ...
    /* 7FB90 8017FB90 C43488D0 */  lwc1       $f20, %lo(D_801088D0)($at)
  .L8017FB94:
  ...
  .L8017FBBC:
    ...
    /* 7FBC0 8017FBC0 C43488D4 */  lwc1       $f20, %lo(D_801088D4)($at)
    /* 7FBC4 8017FBC4 0805FAF5 */  j          .L8017EBD4
    /* 7FBC8 8017FBC8 00000000 */   nop
  .L8017FBCC:
    /* 7FBCC 8017FBCC 3C018011 */  lui        $at, %hi(D_801088D8)
    /* 7FBD0 8017FBD0 C43488D8 */  lwc1       $f20, %lo(D_801088D8)($at)
    /* 7FBD4 8017FBD4 3C018011 */  lui        $at, %hi(D_801088DC)
    /* 7FBD8 8017FBD8 C42088DC */  lwc1       $f0, %lo(D_801088DC)($at)
    /* 7FBDC 8017FBDC 4614003E */  c.le.s     $f0, $f20
  ...
  .L8017FC04:
    ...
    /* 7FC20 8017FC20 4406A000 */  mfc1       $a2, $f20
  ...
  .L8017FC78:
    ...
    /* 7FC7C 8017FC7C C42088E0 */  lwc1       $f0, %lo(D_801088E0)($at)
    ...
    /* 7FCA0 8017FCA0 E420FB3C */  swc1       $f0, %lo(D_8028FB3C)($at)
  .L8017FCA4:
    ...
    /* 7FCB0 8017FCB0 C422D680 */  lwc1       $f2, %lo(D_801ED680)($at)
    /* 7FCB4 8017FCB4 3C018011 */  lui        $at, %hi(D_801088E4)
    /* 7FCB8 8017FCB8 C42088E4 */  lwc1       $f0, %lo(D_801088E4)($at)
    /* 7FCBC 8017FCBC 46001082 */  mul.s      $f2, $f2, $f0
    /* 7FCC0 8017FCC0 3C018011 */  lui        $at, %hi(D_801088E8)
    /* 7FCC4 8017FCC4 C42488E8 */  lwc1       $f4, %lo(D_801088E8)($at)
    /* 7FCC8 8017FCC8 3C018011 */  lui        $at, %hi(D_801088EC)
    /* 7FCCC 8017FCCC C42688EC */  lwc1       $f6, %lo(D_801088EC)($at)
    /* 7FCD0 8017FCD0 44800000 */  mtc1       $zero, $f0
    /* 7FCD4 8017FCD4 46041080 */  add.s      $f2, $f2, $f4
    /* 7FCD8 8017FCD8 3C018029 */  lui        $at, %hi(D_80290370)
    /* 7FCDC 8017FCDC E4260370 */  swc1       $f6, %lo(D_80290370)($at)
    /* 7FCE0 8017FCE0 3C018029 */  lui        $at, %hi(D_80290364)
    /* 7FCE4 8017FCE4 E4200364 */  swc1       $f0, %lo(D_80290364)($at)
    /* 7FCE8 8017FCE8 3C018029 */  lui        $at, %hi(D_80290358)
    /* 7FCEC 8017FCEC E4200358 */  swc1       $f0, %lo(D_80290358)($at)
    /* 7FCF0 8017FCF0 3C018029 */  lui        $at, %hi(D_80290334)
    /* 7FCF4 8017FCF4 E4220334 */  swc1       $f2, %lo(D_80290334)($at)
  .L8017FCF8:
  ...
  .L8017FD08:
    ...
    /* 7FD24 8017FD24 C426EC40 */  lwc1       $f6, %lo(D_801EEC40)($at)
    /* 7FD28 8017FD28 3C018011 */  lui        $at, %hi(D_801088F0)
    /* 7FD2C 8017FD2C C42188F0 */  lwc1       $f1, %lo(D_801088F0)($at)
    /* 7FD30 8017FD30 C42088F4 */  lwc1       $f0, %lo(D_801088F0 + 0x4)($at)
    /* 7FD34 8017FD34 460031A1 */  cvt.d.s    $f6, $f6
    /* 7FD38 8017FD38 46203183 */  div.d      $f6, $f6, $f0
    /* 7FD3C 8017FD3C 3C028029 */  lui        $v0, %hi(D_80290394)
    /* 7FD40 8017FD40 24420394 */  addiu      $v0, $v0, %lo(D_80290394)
    /* 7FD44 8017FD44 46200020 */  cvt.s.d    $f0, $f0
    /* 7FD48 8017FD48 E7A00028 */  swc1       $f0, 0x28($sp)
    /* 7FD4C 8017FD4C E7A00024 */  swc1       $f0, 0x24($sp)
  .L8017FD50:
    /* 7FD50 8017FD50 E7A00020 */  swc1       $f0, 0x20($sp)
    ...
    /* 7FD6C 8017FD6C C4440000 */  lwc1       $f4, 0x0($v0)
    /* 7FD70 8017FD70 46002121 */  cvt.d.s    $f4, $f4
  .L8017FD74:
    /* 7FD74 8017FD74 46262102 */  mul.d      $f4, $f4, $f6
    /* 7FD78 8017FD78 3C018029 */  lui        $at, %hi(D_80290398)
    /* 7FD7C 8017FD7C C4220398 */  lwc1       $f2, %lo(D_80290398)($at)
    /* 7FD80 8017FD80 460010A1 */  cvt.d.s    $f2, $f2
    /* 7FD84 8017FD84 46261082 */  mul.d      $f2, $f2, $f6
    /* 7FD88 8017FD88 3C018029 */  lui        $at, %hi(D_8029039C)
  alabel D_8017FD8C
    /* 7FD8C 8017FD8C C420039C */  lwc1       $f0, %lo(D_8029039C)($at)
    /* 7FD90 8017FD90 46000021 */  cvt.d.s    $f0, $f0
    /* 7FD94 8017FD94 46260002 */  mul.d      $f0, $f0, $f6
    /* 7FD98 8017FD98 3C018011 */  lui        $at, %hi(D_801088F8)
    /* 7FD9C 8017FD9C C43488F8 */  lwc1       $f20, %lo(D_801088F8)($at)
    /* 7FDA0 8017FDA0 3C03801F */  lui        $v1, %hi(D_801EFCF8)
  .L8017FDA4:
    /* 7FDA4 8017FDA4 8C63FCF8 */  lw         $v1, %lo(D_801EFCF8)($v1)
    /* 7FDA8 8017FDA8 46202120 */  cvt.s.d    $f4, $f4
    /* 7FDAC 8017FDAC 462010A0 */  cvt.s.d    $f2, $f2
    /* 7FDB0 8017FDB0 46200020 */  cvt.s.d    $f0, $f0
  .L8017FDB4:
    /* 7FDB4 8017FDB4 E4440000 */  swc1       $f4, 0x0($v0)
    /* 7FDB8 8017FDB8 3C018029 */  lui        $at, %hi(D_80290398)
    /* 7FDBC 8017FDBC E4220398 */  swc1       $f2, %lo(D_80290398)($at)
    /* 7FDC0 8017FDC0 3C018029 */  lui        $at, %hi(D_8029039C)
    /* 7FDC4 8017FDC4 E420039C */  swc1       $f0, %lo(D_8029039C)($at)
    ...
    /* 7FE18 8017FE18 C422D680 */  lwc1       $f2, %lo(D_801ED680)($at)
    /* 7FE1C 8017FE1C 3C018011 */  lui        $at, %hi(D_801088FC)
    /* 7FE20 8017FE20 C42088FC */  lwc1       $f0, %lo(D_801088FC)($at)
    /* 7FE24 8017FE24 46001082 */  mul.s      $f2, $f2, $f0
    /* 7FE28 8017FE28 2404005D */  addiu      $a0, $zero, 0x5D
    /* 7FE2C 8017FE2C 3C018011 */  lui        $at, %hi(D_80108900)
    /* 7FE30 8017FE30 C4208900 */  lwc1       $f0, %lo(D_80108900)($at)
    /* 7FE34 8017FE34 02002821 */  addu       $a1, $s0, $zero
    /* 7FE38 8017FE38 3C018011 */  lui        $at, %hi(D_80108904)
    /* 7FE3C 8017FE3C C4248904 */  lwc1       $f4, %lo(D_80108904)($at)
    /* 7FE40 8017FE40 46001080 */  add.s      $f2, $f2, $f0
    /* 7FE44 8017FE44 24060064 */  addiu      $a2, $zero, 0x64
    /* 7FE48 8017FE48 3C01802A */  lui        $at, %hi(D_8029FA30)
    /* 7FE4C 8017FE4C E424FA30 */  swc1       $f4, %lo(D_8029FA30)($at)
    /* 7FE50 8017FE50 3C01802A */  lui        $at, %hi(D_8029F9D4)
    /* 7FE54 8017FE54 E422F9D4 */  swc1       $f2, %lo(D_8029F9D4)($at)
    ...
    /* 7FE74 8017FE74 C4208908 */  lwc1       $f0, %lo(D_80108908)($at)
    ...
    /* 7FE8C 8017FE8C E420FB3C */  swc1       $f0, %lo(D_8028FB3C)($at)
  .L8017FE90:
    ...
    /* 7FEA4 8017FEA4 C420EC40 */  lwc1       $f0, %lo(D_801EEC40)($at)
    /* 7FEA8 8017FEA8 4600A002 */  mul.s      $f0, $f20, $f0
    /* 7FEAC 8017FEAC 3C018011 */  lui        $at, %hi(D_80108908 + 0x4)
    /* 7FEB0 8017FEB0 C423890C */  lwc1       $f3, %lo(D_80108908 + 0x4)($at)
    /* 7FEB4 8017FEB4 C4228910 */  lwc1       $f2, %lo(D_80108910)($at)
    /* 7FEB8 8017FEB8 46000021 */  cvt.d.s    $f0, $f0
    /* 7FEBC 8017FEBC 46220003 */  div.d      $f0, $f0, $f2
    /* 7FEC0 8017FEC0 3C02802A */  lui        $v0, %hi(D_8029FA50)
    /* 7FEC4 8017FEC4 8C42FA50 */  lw         $v0, %lo(D_8029FA50)($v0)
    /* 7FEC8 8017FEC8 46200020 */  cvt.s.d    $f0, $f0
    /* 7FECC 8017FECC E4400074 */  swc1       $f0, 0x74($v0)
    /* 7FED0 8017FED0 0805FC22 */  j          .L8017F088
    /* 7FED4 8017FED4 E4400070 */   swc1      $f0, 0x70($v0)
  .L8017FED8:
    ...
    /* 7FEEC 8017FEEC C4248914 */  lwc1       $f4, %lo(D_80108914)($at)
    ...
    /* 7FF0C 8017FF0C C422F9B0 */  lwc1       $f2, %lo(D_8029F9B0)($at)
    /* 7FF10 8017FF10 46041080 */  add.s      $f2, $f2, $f4
    /* 7FF14 8017FF14 C4600000 */  lwc1       $f0, 0x0($v1)
    /* 7FF18 8017FF18 46040000 */  add.s      $f0, $f0, $f4
    /* 7FF1C 8017FF1C 3C01802A */  lui        $at, %hi(D_8029F9B0)
    /* 7FF20 8017FF20 E422F9B0 */  swc1       $f2, %lo(D_8029F9B0)($at)
    /* 7FF24 8017FF24 E4600000 */  swc1       $f0, 0x0($v1)
