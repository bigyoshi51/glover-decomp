...
glabel func_801B13CC
    ...
    /* B13F4 801B13F4 C4200308 */  lwc1       $f0, %lo(D_80290308)($at)
    /* B13F8 801B13F8 3C018011 */  lui        $at, %hi(D_8010B7BC)
    /* B13FC 801B13FC C422B7BC */  lwc1       $f2, %lo(D_8010B7BC)($at)
    /* B1400 801B1400 0806C107 */  j          .L801B041C
    /* B1404 801B1404 46020000 */   add.s     $f0, $f0, $f2
  .L801B1408:
    /* B1408 801B1408 3C01802A */  lui        $at, %hi(D_8029F9A8)
    /* B140C 801B140C C420F9A8 */  lwc1       $f0, %lo(D_8029F9A8)($at)
    /* B1410 801B1410 3C018011 */  lui        $at, %hi(D_8010B7C0)
    /* B1414 801B1414 C422B7C0 */  lwc1       $f2, %lo(D_8010B7C0)($at)
    /* B1418 801B1418 46020000 */  add.s      $f0, $f0, $f2
    /* B141C 801B141C E7A00018 */  swc1       $f0, 0x18($sp)
    /* B1420 801B1420 3C068020 */  lui        $a2, %hi(D_802004E0)
    /* B1424 801B1424 8CC604E0 */  lw         $a2, %lo(D_802004E0)($a2)
    /* B1428 801B1428 4480A000 */  mtc1       $zero, $f20
    /* B142C 801B142C 3C01801F */  lui        $at, %hi(D_801F1AE4)
    /* B1430 801B1430 C42C1AE4 */  lwc1       $f12, %lo(D_801F1AE4)($at)
    /* B1434 801B1434 46806320 */  cvt.s.w    $f12, $f12
    /* B1438 801B1438 0C0525C9 */  jal        func_80149724
    /* B143C 801B143C 4600A386 */   mov.s     $f14, $f20
    /* B1440 801B1440 3C018011 */  lui        $at, %hi(D_8010B7C4)
    /* B1444 801B1444 C422B7C4 */  lwc1       $f2, %lo(D_8010B7C4)($at)
    /* B1448 801B1448 46020002 */  mul.s      $f0, $f0, $f2
    /* B144C 801B144C 3C01802A */  lui        $at, %hi(D_8029F504)
    /* B1450 801B1450 C422F504 */  lwc1       $f2, %lo(D_8029F504)($at)
    /* B1454 801B1454 46001087 */  neg.s      $f2, $f2
    /* B1458 801B1458 27A40018 */  addiu      $a0, $sp, 0x18
    /* B145C 801B145C 44061000 */  mfc1       $a2, $f2
    /* B1460 801B1460 00802821 */  addu       $a1, $a0, $zero
    /* B1464 801B1464 E7B40020 */  swc1       $f20, 0x20($sp)
    /* B1468 801B1468 0C05242B */  jal        func_801490AC
    /* B146C 801B146C E7A0001C */   swc1      $f0, 0x1C($sp)
    ...
    /* B148C 801B148C C420F9A8 */  lwc1       $f0, %lo(D_8029F9A8)($at)
    /* B1490 801B1490 3C018011 */  lui        $at, %hi(D_8010B7C8)
    /* B1494 801B1494 C423B7C8 */  lwc1       $f3, %lo(D_8010B7C8)($at)
