...
glabel func_801B3BB8
    ...
    /* B3BBC 801B3BBC 4614A082 */  mul.s      $fv1, $fs0, $fs0
    ...
    /* B3BE4 801B3BE4 C4420004 */  lwc1       $fv1, 0x4($v0)
    /* B3BE8 801B3BE8 461A103E */  c.le.s     $fv1, $fs3
    /* B3BEC 801B3BEC 00000000 */  nop
    /* B3BF0 801B3BF0 45000011 */  bc1f       .L801B3C38
    /* B3BF4 801B3BF4 00000000 */   nop
    /* B3BF8 801B3BF8 C6660058 */  lwc1       $ft1, 0x58($s3)
    /* B3BFC 801B3BFC C4400000 */  lwc1       $fv0, 0x0($v0)
    /* B3C00 801B3C00 46003182 */  mul.s      $ft1, $ft1, $fv0
    /* B3C04 801B3C04 C664005C */  lwc1       $ft0, 0x5C($s3)
    /* B3C08 801B3C08 46022102 */  mul.s      $ft0, $ft0, $fv1
    /* B3C0C 801B3C0C C6600060 */  lwc1       $fv0, 0x60($s3)
    /* B3C10 801B3C10 C4420008 */  lwc1       $fv1, 0x8($v0)
    /* B3C14 801B3C14 46020002 */  mul.s      $fv0, $fv0, $fv1
    /* B3C18 801B3C18 46043180 */  add.s      $ft1, $ft1, $ft0
    /* B3C1C 801B3C1C 46003080 */  add.s      $fv1, $ft1, $fv0
    /* B3C20 801B3C20 4602D03E */  c.le.s     $fs3, $fv1
  ...
  .L801B3C5C:
    ...
    /* B3C60 801B3C60 44800000 */  mtc1       $zero, $fv0
    /* B3C64 801B3C64 4600A032 */  c.eq.s     $fs0, $fv0
  ...
  .L801B3C78:
    /* B3C78 801B3C78 4600C032 */  c.eq.s     $fs2, $fv0
  ...
  .L801B3C8C:
    ...
    /* B3C94 801B3C94 E7B40010 */   swc1      $fs0, 0x10($sp)
