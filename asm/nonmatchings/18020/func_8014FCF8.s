nonmatching func_8014FCF8, 0x18C
...
glabel func_8014FCF8
    ...
    /* 4FD10 8014FD10 C7B70028 */  lwc1       $fs1f, 0x28($sp)
    /* 4FD14 8014FD14 C7B6002C */  lwc1       $fs1, 0x2C($sp)
    /* 4FD18 8014FD18 C7B50020 */  lwc1       $fs0f, 0x20($sp)
  .L8014FD1C:
    /* 4FD1C 8014FD1C C7B40024 */  lwc1       $fs0, 0x24($sp)
  ...
  .L8014FD80:
    ...
    /* 4FDB0 8014FDB0 E7B70048 */  swc1       $fs1f, 0x48($sp)
    /* 4FDB4 8014FDB4 E7B6004C */  swc1       $fs1, 0x4C($sp)
    /* 4FDB8 8014FDB8 E7B50040 */  swc1       $fs0f, 0x40($sp)
    /* 4FDBC 8014FDBC E7B40044 */  swc1       $fs0, 0x44($sp)
  ...
  .L8014FDE4:
    ...
    /* 4FDF4 8014FDF4 C42065B4 */  lwc1       $fv0, %lo(D_801065B4)($at)
    ...
    /* 4FE08 8014FE08 E7A00010 */   swc1      $fv0, 0x10($sp)
    /* 4FE0C 8014FE0C C7A20010 */  lwc1       $fv1, 0x10($sp)
    /* 4FE10 8014FE10 3C018029 */  lui        $at, %hi(D_8028F938)
  .L8014FE14:
    /* 4FE14 8014FE14 C420F938 */  lwc1       $fv0, %lo(D_8028F938)($at)
    /* 4FE18 8014FE18 46001082 */  mul.s      $fv1, $fv1, $fv0
    /* 4FE1C 8014FE1C 3C018029 */  lui        $at, %hi(D_8028F940)
    /* 4FE20 8014FE20 C424F940 */  lwc1       $ft0, %lo(D_8028F940)($at)
    /* 4FE24 8014FE24 C7A00018 */  lwc1       $fv0, 0x18($sp)
    /* 4FE28 8014FE28 46040002 */  mul.s      $fv0, $fv0, $ft0
  .L8014FE2C:
    /* 4FE2C 8014FE2C 86220084 */  lh         $v0, 0x84($s1)
    /* 4FE30 8014FE30 46001080 */  add.s      $fv1, $fv1, $fv0
    /* 4FE34 8014FE34 44820000 */  mtc1       $v0, $fv0
    /* 4FE38 8014FE38 46800020 */  cvt.s.w    $fv0, $fv0
    /* 4FE3C 8014FE3C 46001082 */  mul.s      $fv1, $fv1, $fv0
    /* 4FE40 8014FE40 00000000 */  nop
    /* 4FE44 8014FE44 46001082 */  mul.s      $fv1, $fv1, $fv0
    /* 4FE48 8014FE48 3C01801F */  lui        $at, %hi(D_801ED65C)
    /* 4FE4C 8014FE4C C420D65C */  lwc1       $fv0, %lo(D_801ED65C)($at)
    /* 4FE50 8014FE50 46001083 */  div.s      $fv1, $fv1, $fv0
    /* 4FE54 8014FE54 C620000C */  lwc1       $fv0, 0xC($s1)
    /* 4FE58 8014FE58 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* 4FE5C 8014FE5C E620000C */  swc1       $fv0, 0xC($s1)
    /* 4FE60 8014FE60 3C018029 */  lui        $at, %hi(D_8028FB88)
    /* 4FE64 8014FE64 C42CFB88 */  lwc1       $fa0, %lo(D_8028FB88)($at)
    /* 4FE68 8014FE68 C60E0000 */  lwc1       $fa1, 0x0($s0)
    /* 4FE6C 8014FE6C 0C052533 */  jal        func_801494CC
  .L8014FE70:
    /* 4FE70 8014FE70 00000000 */   nop
    /* 4FE74 8014FE74 86220084 */  lh         $v0, 0x84($s1)
    /* 4FE78 8014FE78 44821000 */  mtc1       $v0, $fv1
    /* 4FE7C 8014FE7C 468010A0 */  cvt.s.w    $fv1, $fv1
    /* 4FE80 8014FE80 46020002 */  mul.s      $fv0, $fv0, $fv1
