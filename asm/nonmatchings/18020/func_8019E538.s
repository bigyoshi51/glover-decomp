...
glabel func_8019E538
  ...
  .L8019E570:
    ...
    /* 9E578 8019E578 C7B50030 */  lwc1       $f21, 0x30($sp)
  .L8019E57C:
    /* 9E57C 8019E57C C7B40034 */  lwc1       $f20, 0x34($sp)
    ...
    /* 9E5AC 8019E5AC E7B50048 */  swc1       $f21, 0x48($sp)
    /* 9E5B0 8019E5B0 E7B4004C */  swc1       $f20, 0x4C($sp)
  ...
  .L8019E5E0:
    ...
    /* 9E604 8019E604 C6000058 */  lwc1       $f0, 0x58($s0)
    /* 9E608 8019E608 3C018011 */  lui        $at, %hi(D_8010A9E8 + 0x4)
    /* 9E60C 8019E60C C425A9EC */  lwc1       $f5, %lo(D_8010A9E8 + 0x4)($at)
    /* 9E610 8019E610 C424A9F0 */  lwc1       $f4, %lo(D_8010A9F0)($at)
    /* 9E614 8019E614 46000021 */  cvt.d.s    $f0, $f0
    /* 9E618 8019E618 46240002 */  mul.d      $f0, $f0, $f4
    /* 9E61C 8019E61C C6020060 */  lwc1       $f2, 0x60($s0)
    /* 9E620 8019E620 460010A1 */  cvt.d.s    $f2, $f2
    /* 9E624 8019E624 46241082 */  mul.d      $f2, $f2, $f4
    /* 9E628 8019E628 46200020 */  cvt.s.d    $f0, $f0
    /* 9E62C 8019E62C 462010A0 */  cvt.s.d    $f2, $f2
    /* 9E630 8019E630 E6000058 */  swc1       $f0, 0x58($s0)
    /* 9E634 8019E634 0806759D */  j          .L8019D674
    /* 9E638 8019E638 E6020060 */   swc1      $f2, 0x60($s0)
  .L8019E63C:
  ...
  .L8019E678:
    ...
    /* 9E6B0 8019E6B0 C4420000 */  lwc1       $f2, 0x0($v0)
    /* 9E6B4 8019E6B4 3C018011 */  lui        $at, %hi(D_8010A9F0 + 0x4)
    /* 9E6B8 8019E6B8 C425A9F4 */  lwc1       $f5, %lo(D_8010A9F0 + 0x4)($at)
    /* 9E6BC 8019E6BC C424A9F8 */  lwc1       $f4, %lo(D_8010A9F8)($at)
    /* 9E6C0 8019E6C0 460010A1 */  cvt.d.s    $f2, $f2
    /* 9E6C4 8019E6C4 46241082 */  mul.d      $f2, $f2, $f4
    /* 9E6C8 8019E6C8 3C01802A */  lui        $at, %hi(D_8029F9D8)
    /* 9E6CC 8019E6CC C420F9D8 */  lwc1       $f0, %lo(D_8029F9D8)($at)
    /* 9E6D0 8019E6D0 46000021 */  cvt.d.s    $f0, $f0
    /* 9E6D4 8019E6D4 46240002 */  mul.d      $f0, $f0, $f4
    /* 9E6D8 8019E6D8 462010A0 */  cvt.s.d    $f2, $f2
    /* 9E6DC 8019E6DC 46200020 */  cvt.s.d    $f0, $f0
    /* 9E6E0 8019E6E0 E4420000 */  swc1       $f2, 0x0($v0)
    /* 9E6E4 8019E6E4 3C01802A */  lui        $at, %hi(D_8029F9D8)
    /* 9E6E8 8019E6E8 E420F9D8 */  swc1       $f0, %lo(D_8029F9D8)($at)
  .L8019E6EC:
  ...
  .L8019E6F0:
    ...
    /* 9E714 8019E714 C6020030 */  lwc1       $f2, 0x30($s0)
    /* 9E718 8019E718 C4400070 */  lwc1       $f0, 0x70($v0)
    /* 9E71C 8019E71C 46020000 */  add.s      $f0, $f0, $f2
  .L8019E720:
    /* 9E720 8019E720 C7A2001C */  lwc1       $f2, 0x1C($sp)
    /* 9E724 8019E724 46001080 */  add.s      $f2, $f2, $f0
    /* 9E728 8019E728 C7A00018 */  lwc1       $f0, 0x18($sp)
    /* 9E72C 8019E72C E7A2001C */  swc1       $f2, 0x1C($sp)
    /* 9E730 8019E730 C6040034 */  lwc1       $f4, 0x34($s0)
    /* 9E734 8019E734 46040001 */  sub.s      $f0, $f0, $f4
    /* 9E738 8019E738 E7A00028 */  swc1       $f0, 0x28($sp)
    /* 9E73C 8019E73C C6040038 */  lwc1       $f4, 0x38($s0)
    /* 9E740 8019E740 46000002 */  mul.s      $f0, $f0, $f0
    /* 9E744 8019E744 46041081 */  sub.s      $f2, $f2, $f4
    /* 9E748 8019E748 C7A40020 */  lwc1       $f4, 0x20($sp)
    /* 9E74C 8019E74C E7A2002C */  swc1       $f2, 0x2C($sp)
    /* 9E750 8019E750 C606003C */  lwc1       $f6, 0x3C($s0)
    /* 9E754 8019E754 46021082 */  mul.s      $f2, $f2, $f2
    /* 9E758 8019E758 46062101 */  sub.s      $f4, $f4, $f6
    /* 9E75C 8019E75C 46042182 */  mul.s      $f6, $f4, $f4
    /* 9E760 8019E760 46020000 */  add.s      $f0, $f0, $f2
    /* 9E764 8019E764 46060300 */  add.s      $f12, $f0, $f6
    /* 9E768 8019E768 46006004 */  sqrt.s     $f0, $f12
    /* 9E76C 8019E76C 46000032 */  c.eq.s     $f0, $f0
    /* 9E770 8019E770 00008821 */  addu       $s1, $zero, $zero
    /* 9E774 8019E774 45010003 */  bc1t       .L8019E784
    /* 9E778 8019E778 E7A40030 */   swc1      $f4, 0x30($sp)
    /* 9E77C 8019E77C 0C07100C */  jal        func_801C4030
    /* 9E780 8019E780 00000000 */   nop
  .L8019E784:
    /* 9E784 8019E784 3C018011 */  lui        $at, %hi(D_8010A9FC)
    /* 9E788 8019E788 C434A9FC */  lwc1       $f20, %lo(D_8010A9FC)($at)
    /* 9E78C 8019E78C 4614003E */  c.le.s     $f0, $f20
    /* 9E790 8019E790 00000000 */  nop
    /* 9E794 8019E794 45030021 */  bc1tl      .L8019E81C
    /* 9E798 8019E798 24110001 */   addiu     $s1, $zero, 0x1
    /* 9E79C 8019E79C 4600A003 */  div.s      $f0, $f20, $f0
    /* 9E7A0 8019E7A0 26040034 */  addiu      $a0, $s0, 0x34
    /* 9E7A4 8019E7A4 44060000 */  mfc1       $a2, $f0
    /* 9E7A8 8019E7A8 0C052343 */  jal        func_80148D0C
    /* 9E7AC 8019E7AC 27A50028 */   addiu     $a1, $sp, 0x28
    /* 9E7B0 8019E7B0 C7A20018 */  lwc1       $f2, 0x18($sp)
    /* 9E7B4 8019E7B4 C6000034 */  lwc1       $f0, 0x34($s0)
    /* 9E7B8 8019E7B8 46001081 */  sub.s      $f2, $f2, $f0
    /* 9E7BC 8019E7BC C7A0001C */  lwc1       $f0, 0x1C($sp)
    /* 9E7C0 8019E7C0 E7A20028 */  swc1       $f2, 0x28($sp)
    /* 9E7C4 8019E7C4 C6040038 */  lwc1       $f4, 0x38($s0)
    /* 9E7C8 8019E7C8 46021082 */  mul.s      $f2, $f2, $f2
    /* 9E7CC 8019E7CC 46040001 */  sub.s      $f0, $f0, $f4
    /* 9E7D0 8019E7D0 C7A40020 */  lwc1       $f4, 0x20($sp)
    /* 9E7D4 8019E7D4 E7A0002C */  swc1       $f0, 0x2C($sp)
    /* 9E7D8 8019E7D8 C606003C */  lwc1       $f6, 0x3C($s0)
    /* 9E7DC 8019E7DC 46000002 */  mul.s      $f0, $f0, $f0
    /* 9E7E0 8019E7E0 46062101 */  sub.s      $f4, $f4, $f6
    /* 9E7E4 8019E7E4 46042182 */  mul.s      $f6, $f4, $f4
