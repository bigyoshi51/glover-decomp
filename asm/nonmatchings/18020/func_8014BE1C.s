...
glabel func_8014BE1C
  ...
  .L8014BE24:
    ...
    /* 4BE54 8014BE54 C4206478 */  lwc1       $f0, %lo(D_80106478)($at)
    /* 4BE58 8014BE58 3C018020 */  lui        $at, %hi(D_802004E0)
    /* 4BE5C 8014BE5C C42E04E0 */  lwc1       $f14, %lo(D_802004E0)($at)
    /* 4BE60 8014BE60 468073A0 */  cvt.s.w    $f14, $f14
    /* 4BE64 8014BE64 46007383 */  div.s      $f14, $f14, $f0
    /* 4BE68 8014BE68 3C018010 */  lui        $at, %hi(D_8010647C)
    /* 4BE6C 8014BE6C C42C647C */  lwc1       $f12, %lo(D_8010647C)($at)
    ...
    /* 4BE7C 8014BE7C C4226480 */  lwc1       $f2, %lo(D_80106480)($at)
    /* 4BE80 8014BE80 46020000 */  add.s      $f0, $f0, $f2
    /* 4BE84 8014BE84 3C018010 */  lui        $at, %hi(D_80106484)
    /* 4BE88 8014BE88 C4226484 */  lwc1       $f2, %lo(D_80106484)($at)
    /* 4BE8C 8014BE8C 46020002 */  mul.s      $f0, $f0, $f2
    /* 4BE90 8014BE90 3C018010 */  lui        $at, %hi(D_80106488)
    /* 4BE94 8014BE94 C4226488 */  lwc1       $f2, %lo(D_80106488)($at)
    /* 4BE98 8014BE98 46020080 */  add.s      $f2, $f0, $f2
    /* 4BE9C 8014BE9C 3C018010 */  lui        $at, %hi(D_8010648C)
    /* 4BEA0 8014BEA0 C420648C */  lwc1       $f0, %lo(D_8010648C)($at)
    /* 4BEA4 8014BEA4 4602003E */  c.le.s     $f0, $f2
    ...
    /* 4BEB4 8014BEB4 46001001 */   sub.s     $f0, $f2, $f0
    /* 4BEB8 8014BEB8 4600100D */  trunc.w.s  $f0, $f2
    /* 4BEBC 8014BEBC 44030000 */  mfc1       $v1, $f0
    /* 4BEC0 8014BEC0 08052BB7 */  j          .L8014AEDC
    /* 4BEC4 8014BEC4 A083005B */   sb        $v1, 0x5B($a0)
  .L8014BEC8:
    /* 4BEC8 8014BEC8 4600008D */  trunc.w.s  $f2, $f0
    /* 4BECC 8014BECC 44031000 */  mfc1       $v1, $f2
  ...
  .L8014BEDC:
    ...
    /* 4BEF8 8014BEF8 C4206490 */  lwc1       $f0, %lo(D_80106490)($at)
    /* 4BEFC 8014BEFC 24420005 */  addiu      $v0, $v0, 0x5
    /* 4BF00 8014BF00 44827000 */  mtc1       $v0, $f14
    /* 4BF04 8014BF04 468073A0 */  cvt.s.w    $f14, $f14
    /* 4BF08 8014BF08 46007383 */  div.s      $f14, $f14, $f0
    /* 4BF0C 8014BF0C 3C018010 */  lui        $at, %hi(D_80106494)
    /* 4BF10 8014BF10 C42C6494 */  lwc1       $f12, %lo(D_80106494)($at)
    ...
    /* 4BF20 8014BF20 C4226498 */  lwc1       $f2, %lo(D_80106498)($at)
    /* 4BF24 8014BF24 46020000 */  add.s      $f0, $f0, $f2
    /* 4BF28 8014BF28 3C018010 */  lui        $at, %hi(D_8010649C)
    /* 4BF2C 8014BF2C C422649C */  lwc1       $f2, %lo(D_8010649C)($at)
    /* 4BF30 8014BF30 46020002 */  mul.s      $f0, $f0, $f2
    /* 4BF34 8014BF34 3C018010 */  lui        $at, %hi(D_801064A0)
    /* 4BF38 8014BF38 C42264A0 */  lwc1       $f2, %lo(D_801064A0)($at)
    /* 4BF3C 8014BF3C 46020080 */  add.s      $f2, $f0, $f2
    /* 4BF40 8014BF40 3C018010 */  lui        $at, %hi(D_801064A4)
    /* 4BF44 8014BF44 C42064A4 */  lwc1       $f0, %lo(D_801064A4)($at)
    /* 4BF48 8014BF48 4602003E */  c.le.s     $f0, $f2
    ...
    /* 4BF58 8014BF58 46001001 */   sub.s     $f0, $f2, $f0
    /* 4BF5C 8014BF5C 4600100D */  trunc.w.s  $f0, $f2
    /* 4BF60 8014BF60 44030000 */  mfc1       $v1, $f0
    /* 4BF64 8014BF64 08052BE0 */  j          .L8014AF80
    /* 4BF68 8014BF68 A083005B */   sb        $v1, 0x5B($a0)
  .L8014BF6C:
    /* 4BF6C 8014BF6C 4600008D */  trunc.w.s  $f2, $f0
    /* 4BF70 8014BF70 44031000 */  mfc1       $v1, $f2
  ...
  .L8014BF80:
    ...
    /* 4BF9C 8014BF9C C42064A8 */  lwc1       $f0, %lo(D_801064A8)($at)
    /* 4BFA0 8014BFA0 2442000A */  addiu      $v0, $v0, 0xA
    /* 4BFA4 8014BFA4 44827000 */  mtc1       $v0, $f14
    /* 4BFA8 8014BFA8 468073A0 */  cvt.s.w    $f14, $f14
    /* 4BFAC 8014BFAC 46007383 */  div.s      $f14, $f14, $f0
    /* 4BFB0 8014BFB0 3C018010 */  lui        $at, %hi(D_801064AC)
    /* 4BFB4 8014BFB4 C42C64AC */  lwc1       $f12, %lo(D_801064AC)($at)
    ...
    /* 4BFC4 8014BFC4 C42264B0 */  lwc1       $f2, %lo(D_801064B0)($at)
  .L8014BFC8:
    /* 4BFC8 8014BFC8 46020000 */  add.s      $f0, $f0, $f2
    /* 4BFCC 8014BFCC 3C018010 */  lui        $at, %hi(D_801064B4)
    /* 4BFD0 8014BFD0 C42264B4 */  lwc1       $f2, %lo(D_801064B4)($at)
    /* 4BFD4 8014BFD4 46020002 */  mul.s      $f0, $f0, $f2
    /* 4BFD8 8014BFD8 3C018010 */  lui        $at, %hi(D_801064B8)
    /* 4BFDC 8014BFDC C42264B8 */  lwc1       $f2, %lo(D_801064B8)($at)
    /* 4BFE0 8014BFE0 46020080 */  add.s      $f2, $f0, $f2
    /* 4BFE4 8014BFE4 3C018010 */  lui        $at, %hi(D_801064BC)
  .L8014BFE8:
    /* 4BFE8 8014BFE8 C42064BC */  lwc1       $f0, %lo(D_801064BC)($at)
    /* 4BFEC 8014BFEC 4602003E */  c.le.s     $f0, $f2
    ...
    /* 4BFFC 8014BFFC 46001001 */   sub.s     $f0, $f2, $f0
    /* 4C000 8014C000 4600100D */  trunc.w.s  $f0, $f2
    /* 4C004 8014C004 44030000 */  mfc1       $v1, $f0
    /* 4C008 8014C008 08052C09 */  j          .L8014B024
    /* 4C00C 8014C00C A083005B */   sb        $v1, 0x5B($a0)
  .L8014C010:
    /* 4C010 8014C010 4600008D */  trunc.w.s  $f2, $f0
    /* 4C014 8014C014 44031000 */  mfc1       $v1, $f2
