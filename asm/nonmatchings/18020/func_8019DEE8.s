...
glabel func_8019DEE8
  ...
  .L8019DFE0:
    ...
    /* 9DFE4 8019DFE4 C420A9A8 */  lwc1       $f0, %lo(D_8010A9A8)($at)
    /* 9DFE8 8019DFE8 C442004C */  lwc1       $f2, 0x4C($v0)
    /* 9DFEC 8019DFEC 4600103E */  c.le.s     $f2, $f0
  .L8019DFF0:
  ...
  .L8019DFF8:
    ...
    /* 9E018 8019E018 C7A20018 */  lwc1       $f2, 0x18($sp)
    /* 9E01C 8019E01C 3C018011 */  lui        $at, %hi(D_8010A9AC)
    /* 9E020 8019E020 C424A9AC */  lwc1       $f4, %lo(D_8010A9AC)($at)
    /* 9E024 8019E024 46041082 */  mul.s      $f2, $f2, $f4
    /* 9E028 8019E028 C7A00020 */  lwc1       $f0, 0x20($sp)
    /* 9E02C 8019E02C 46040002 */  mul.s      $f0, $f0, $f4
    /* 9E030 8019E030 27A40018 */  addiu      $a0, $sp, 0x18
    /* 9E034 8019E034 02002821 */  addu       $a1, $s0, $zero
    /* 9E038 8019E038 E7A20018 */  swc1       $f2, 0x18($sp)
    /* 9E03C 8019E03C 0C0524CB */  jal        func_8014932C
    /* 9E040 8019E040 E7A00020 */   swc1      $f0, 0x20($sp)
    /* 9E044 8019E044 3C01802A */  lui        $at, %hi(D_8029F9B0)
    /* 9E048 8019E048 C424F9B0 */  lwc1       $f4, %lo(D_8029F9B0)($at)
    /* 9E04C 8019E04C 3C018011 */  lui        $at, %hi(D_8010A9B0)
    /* 9E050 8019E050 C420A9B0 */  lwc1       $f0, %lo(D_8010A9B0)($at)
    /* 9E054 8019E054 46002100 */  add.s      $f4, $f4, $f0
    /* 9E058 8019E058 C7A00018 */  lwc1       $f0, 0x18($sp)
    /* 9E05C 8019E05C E7A4001C */  swc1       $f4, 0x1C($sp)
    /* 9E060 8019E060 C6220034 */  lwc1       $f2, 0x34($s1)
    /* 9E064 8019E064 46001081 */  sub.s      $f2, $f2, $f0
    /* 9E068 8019E068 E7A20028 */  swc1       $f2, 0x28($sp)
    /* 9E06C 8019E06C C6200038 */  lwc1       $f0, 0x38($s1)
    /* 9E070 8019E070 46021082 */  mul.s      $f2, $f2, $f2
    /* 9E074 8019E074 46040001 */  sub.s      $f0, $f0, $f4
    /* 9E078 8019E078 C7A60020 */  lwc1       $f6, 0x20($sp)
    /* 9E07C 8019E07C E7A0002C */  swc1       $f0, 0x2C($sp)
    /* 9E080 8019E080 C624003C */  lwc1       $f4, 0x3C($s1)
    /* 9E084 8019E084 46000002 */  mul.s      $f0, $f0, $f0
    /* 9E088 8019E088 46062101 */  sub.s      $f4, $f4, $f6
    /* 9E08C 8019E08C 46042182 */  mul.s      $f6, $f4, $f4
    /* 9E090 8019E090 46001080 */  add.s      $f2, $f2, $f0
    /* 9E094 8019E094 46061300 */  add.s      $f12, $f2, $f6
    /* 9E098 8019E098 46006004 */  sqrt.s     $f0, $f12
    /* 9E09C 8019E09C 46000032 */  c.eq.s     $f0, $f0
    /* 9E0A0 8019E0A0 00000000 */  nop
    /* 9E0A4 8019E0A4 45010003 */  bc1t       .L8019E0B4
    /* 9E0A8 8019E0A8 E7A40030 */   swc1      $f4, 0x30($sp)
    /* 9E0AC 8019E0AC 0C07100C */  jal        func_801C4030
    /* 9E0B0 8019E0B0 00000000 */   nop
  .L8019E0B4:
    /* 9E0B4 8019E0B4 3C01801F */  lui        $at, %hi(D_801F01C0)
    /* 9E0B8 8019E0B8 C42401C0 */  lwc1       $f4, %lo(D_801F01C0)($at)
    /* 9E0BC 8019E0BC 46000506 */  mov.s      $f20, $f0
    /* 9E0C0 8019E0C0 4614203C */  c.lt.s     $f4, $f20
    /* 9E0C4 8019E0C4 00000000 */  nop
    /* 9E0C8 8019E0C8 45000017 */  bc1f       .L8019E128
    /* 9E0CC 8019E0CC 00000000 */   nop
    /* 9E0D0 8019E0D0 46142103 */  div.s      $f4, $f4, $f20
    /* 9E0D4 8019E0D4 C7A60028 */  lwc1       $f6, 0x28($sp)
    /* 9E0D8 8019E0D8 46043182 */  mul.s      $f6, $f6, $f4
    /* 9E0DC 8019E0DC C7A2002C */  lwc1       $f2, 0x2C($sp)
    /* 9E0E0 8019E0E0 46041082 */  mul.s      $f2, $f2, $f4
    /* 9E0E4 8019E0E4 C7A00030 */  lwc1       $f0, 0x30($sp)
    /* 9E0E8 8019E0E8 46040002 */  mul.s      $f0, $f0, $f4
    /* 9E0EC 8019E0EC E7A60028 */  swc1       $f6, 0x28($sp)
    /* 9E0F0 8019E0F0 E7A2002C */  swc1       $f2, 0x2C($sp)
    /* 9E0F4 8019E0F4 E7A00030 */  swc1       $f0, 0x30($sp)
    /* 9E0F8 8019E0F8 C6200034 */  lwc1       $f0, 0x34($s1)
    /* 9E0FC 8019E0FC 46060001 */  sub.s      $f0, $f0, $f6
    /* 9E100 8019E100 E6200034 */  swc1       $f0, 0x34($s1)
    /* 9E104 8019E104 C6200038 */  lwc1       $f0, 0x38($s1)
    /* 9E108 8019E108 C7A2002C */  lwc1       $f2, 0x2C($sp)
    /* 9E10C 8019E10C 46020001 */  sub.s      $f0, $f0, $f2
    /* 9E110 8019E110 E6200038 */  swc1       $f0, 0x38($s1)
    /* 9E114 8019E114 C620003C */  lwc1       $f0, 0x3C($s1)
    /* 9E118 8019E118 C7A20030 */  lwc1       $f2, 0x30($sp)
    /* 9E11C 8019E11C 46020001 */  sub.s      $f0, $f0, $f2
    /* 9E120 8019E120 08067450 */  j          .L8019D140
    /* 9E124 8019E124 E620003C */   swc1      $f0, 0x3C($s1)
  .L8019E128:
    ...
    /* 9E144 8019E144 C42CF9AC */  lwc1       $f12, %lo(D_8029F9AC)($at)
    /* 9E148 8019E148 C6200034 */  lwc1       $f0, 0x34($s1)
    /* 9E14C 8019E14C 46006301 */  sub.s      $f12, $f12, $f0
    /* 9E150 8019E150 3C01802A */  lui        $at, %hi(D_8029F9B0)
    /* 9E154 8019E154 C420F9B0 */  lwc1       $f0, %lo(D_8029F9B0)($at)
    /* 9E158 8019E158 E7AC0018 */  swc1       $f12, 0x18($sp)
    /* 9E15C 8019E15C C6220038 */  lwc1       $f2, 0x38($s1)
    /* 9E160 8019E160 46020001 */  sub.s      $f0, $f0, $f2
    /* 9E164 8019E164 3C01802A */  lui        $at, %hi(D_8029F9B4)
    /* 9E168 8019E168 C42EF9B4 */  lwc1       $f14, %lo(D_8029F9B4)($at)
    /* 9E16C 8019E16C E7A0001C */  swc1       $f0, 0x1C($sp)
    /* 9E170 8019E170 C620003C */  lwc1       $f0, 0x3C($s1)
    /* 9E174 8019E174 46007381 */  sub.s      $f14, $f14, $f0
    /* 9E178 8019E178 0C051D18 */  jal        func_80147460
    /* 9E17C 8019E17C E7AE0020 */   swc1      $f14, 0x20($sp)
    /* 9E180 8019E180 0C0525B2 */  jal        func_801496C8
    /* 9E184 8019E184 46000306 */   mov.s     $f12, $f0
    /* 9E188 8019E188 0806748F */  j          .L8019D23C
    /* 9E18C 8019E18C E6200088 */   swc1      $f0, 0x88($s1)
  .L8019E190:
  ...
  .L8019E1C0:
    ...
    /* 9E1C4 8019E1C4 C42C030C */  lwc1       $f12, %lo(D_8029030C)($at)
    /* 9E1C8 8019E1C8 C6200034 */  lwc1       $f0, 0x34($s1)
    /* 9E1CC 8019E1CC 46006301 */  sub.s      $f12, $f12, $f0
    /* 9E1D0 8019E1D0 3C018029 */  lui        $at, %hi(D_80290310)
    /* 9E1D4 8019E1D4 C4200310 */  lwc1       $f0, %lo(D_80290310)($at)
    /* 9E1D8 8019E1D8 E7AC0018 */  swc1       $f12, 0x18($sp)
    /* 9E1DC 8019E1DC C6220038 */  lwc1       $f2, 0x38($s1)
    /* 9E1E0 8019E1E0 46020001 */  sub.s      $f0, $f0, $f2
    /* 9E1E4 8019E1E4 3C018029 */  lui        $at, %hi(D_80290314)
    /* 9E1E8 8019E1E8 C42E0314 */  lwc1       $f14, %lo(D_80290314)($at)
    /* 9E1EC 8019E1EC E7A0001C */  swc1       $f0, 0x1C($sp)
    /* 9E1F0 8019E1F0 C620003C */  lwc1       $f0, 0x3C($s1)
    /* 9E1F4 8019E1F4 46007381 */  sub.s      $f14, $f14, $f0
    /* 9E1F8 8019E1F8 0C051D18 */  jal        func_80147460
    /* 9E1FC 8019E1FC E7AE0020 */   swc1      $f14, 0x20($sp)
    /* 9E200 8019E200 0C0525B2 */  jal        func_801496C8
    /* 9E204 8019E204 46000306 */   mov.s     $f12, $f0
    ...
    /* 9E214 8019E214 E6200088 */   swc1      $f0, 0x88($s1)
