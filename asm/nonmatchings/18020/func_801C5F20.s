nonmatching func_801C5F20, 0xE0

glabel func_801C5F20
    /* C5F20 801C5F20 44927000 */  mtc1       $s2, $f14
    /* C5F24 801C5F24 00000000 */  nop
    /* C5F28 801C5F28 46007082 */  mul.s      $f2, $f14, $f0
    /* C5F2C 801C5F2C 3C0142FE */  lui        $at, (0x42FE0000 >> 16)
    /* C5F30 801C5F30 44810000 */  mtc1       $at, $f0
    /* C5F34 801C5F34 00000000 */  nop
    /* C5F38 801C5F38 4600103C */  c.lt.s     $f2, $f0
    ...
    /* C5F4C 801C5F4C 4600100D */  trunc.w.s  $f0, $f2
    /* C5F50 801C5F50 44020000 */  mfc1       $v0, $f0
  .L801C5F54:
    /* C5F54 801C5F54 3C014300 */  lui        $at, (0x43000000 >> 16)
    /* C5F58 801C5F58 44810000 */  mtc1       $at, $f0
    /* C5F5C 801C5F5C 44938000 */  mtc1       $s3, $f16
    /* C5F60 801C5F60 00000000 */  nop
    /* C5F64 801C5F64 46008082 */  mul.s      $f2, $f16, $f0
    /* C5F68 801C5F68 3C0142FE */  lui        $at, (0x42FE0000 >> 16)
    /* C5F6C 801C5F6C 44810000 */  mtc1       $at, $f0
    /* C5F70 801C5F70 00000000 */  nop
    /* C5F74 801C5F74 4600103C */  c.lt.s     $f2, $f0
    ...
    /* C5F88 801C5F88 4600100D */  trunc.w.s  $f0, $f2
    /* C5F8C 801C5F8C 44020000 */  mfc1       $v0, $f0
  ...
  .L801C5F98:
    ...
    /* C5FA0 801C5FA0 44810000 */  mtc1       $at, $f0
    /* C5FA4 801C5FA4 44947000 */  mtc1       $s4, $f14
    /* C5FA8 801C5FA8 00000000 */  nop
    /* C5FAC 801C5FAC 46007082 */  mul.s      $f2, $f14, $f0
    /* C5FB0 801C5FB0 3C0142FE */  lui        $at, (0x42FE0000 >> 16)
    /* C5FB4 801C5FB4 44810000 */  mtc1       $at, $f0
    /* C5FB8 801C5FB8 00000000 */  nop
    /* C5FBC 801C5FBC 4600103C */  c.lt.s     $f2, $f0
    ...
    /* C5FD0 801C5FD0 4600100D */  trunc.w.s  $f0, $f2
    /* C5FD4 801C5FD4 44020000 */  mfc1       $v0, $f0
  ...
  .L801C5FE0:
    ...
    /* C5FE8 801C5FE8 44810000 */  mtc1       $at, $f0
    /* C5FEC 801C5FEC 00000000 */  nop
    /* C5FF0 801C5FF0 4600F082 */  mul.s      $f2, $f30, $f0
    /* C5FF4 801C5FF4 3C0142FE */  lui        $at, (0x42FE0000 >> 16)
    /* C5FF8 801C5FF8 44810000 */  mtc1       $at, $f0
