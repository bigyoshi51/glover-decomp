...
glabel func_801B182C
    /* B182C 801B182C E7A2001C */  swc1       $fv1, 0x1C($sp)
    /* B1830 801B1830 0C05255A */  jal        func_80149568
    /* B1834 801B1834 E7A00020 */   swc1      $fv0, 0x20($sp)
    /* B1838 801B1838 C7A40018 */  lwc1       $ft0, 0x18($sp)
    /* B183C 801B183C 3C018011 */  lui        $at, %hi(D_8010B800)
    /* B1840 801B1840 C427B800 */  lwc1       $ft1f, %lo(D_8010B800)($at)
    /* B1844 801B1844 C426B804 */  lwc1       $ft1, %lo(D_8010B800 + 0x4)($at)
    /* B1848 801B1848 46002121 */  cvt.d.s    $ft0, $ft0
    /* B184C 801B184C 46262102 */  mul.d      $ft0, $ft0, $ft1
    /* B1850 801B1850 C7A2001C */  lwc1       $fv1, 0x1C($sp)
    /* B1854 801B1854 460010A1 */  cvt.d.s    $fv1, $fv1
    /* B1858 801B1858 46261082 */  mul.d      $fv1, $fv1, $ft1
    /* B185C 801B185C C7A00020 */  lwc1       $fv0, 0x20($sp)
    /* B1860 801B1860 46000021 */  cvt.d.s    $fv0, $fv0
    /* B1864 801B1864 46260002 */  mul.d      $fv0, $fv0, $ft1
    /* B1868 801B1868 C60E0030 */  lwc1       $fa1, 0x30($s0)
    /* B186C 801B186C 46202120 */  cvt.s.d    $ft0, $ft0
    /* B1870 801B1870 46047380 */  add.s      $fa1, $fa1, $ft0
    /* B1874 801B1874 3C01802A */  lui        $at, %hi(D_8029F9D4)
    /* B1878 801B1878 C42CF9D4 */  lwc1       $fa0, %lo(D_8029F9D4)($at)
    /* B187C 801B187C 460E7202 */  mul.s      $ft2, $fa1, $fa1
    /* B1880 801B1880 462010A0 */  cvt.s.d    $fv1, $fv1
    /* B1884 801B1884 46026300 */  add.s      $fa0, $fa0, $fv1
    /* B1888 801B1888 3C01802A */  lui        $at, %hi(D_8029F9D8)
    /* B188C 801B188C C42AF9D8 */  lwc1       $ft3, %lo(D_8029F9D8)($at)
    /* B1890 801B1890 460C6402 */  mul.s      $ft4, $fa0, $fa0
    /* B1894 801B1894 46200020 */  cvt.s.d    $fv0, $fv0
    /* B1898 801B1898 46005280 */  add.s      $ft3, $ft3, $fv0
    /* B189C 801B189C 460A5182 */  mul.s      $ft1, $ft3, $ft3
    /* B18A0 801B18A0 46104200 */  add.s      $ft2, $ft2, $ft4
    /* B18A4 801B18A4 46064200 */  add.s      $ft2, $ft2, $ft1
    /* B18A8 801B18A8 46004184 */  sqrt.s     $ft1, $ft2
    /* B18AC 801B18AC E7A40018 */  swc1       $ft0, 0x18($sp)
    /* B18B0 801B18B0 E7A2001C */  swc1       $fv1, 0x1C($sp)
    /* B18B4 801B18B4 E7A00020 */  swc1       $fv0, 0x20($sp)
    /* B18B8 801B18B8 E60E0030 */  swc1       $fa1, 0x30($s0)
    /* B18BC 801B18BC 46063032 */  c.eq.s     $ft1, $ft1
    /* B18C0 801B18C0 3C01802A */  lui        $at, %hi(D_8029F9D4)
    /* B18C4 801B18C4 E42CF9D4 */  swc1       $fa0, %lo(D_8029F9D4)($at)
    /* B18C8 801B18C8 3C01802A */  lui        $at, %hi(D_8029F9D8)
    /* B18CC 801B18CC E42AF9D8 */  swc1       $ft3, %lo(D_8029F9D8)($at)
    /* B18D0 801B18D0 45010004 */  bc1t       .L801B18E4
    /* B18D4 801B18D4 26110030 */   addiu     $s1, $s0, 0x30
    /* B18D8 801B18D8 0C07100C */  jal        func_801C4030
    /* B18DC 801B18DC 46004306 */   mov.s     $fa0, $ft2
    /* B18E0 801B18E0 46000186 */  mov.s      $ft1, $fv0
  .L801B18E4:
    /* B18E4 801B18E4 3C018011 */  lui        $at, %hi(D_8010B808)
    /* B18E8 801B18E8 C428B808 */  lwc1       $ft2, %lo(D_8010B808)($at)
    /* B18EC 801B18EC 4606403C */  c.lt.s     $ft2, $ft1
    /* B18F0 801B18F0 00000000 */  nop
    /* B18F4 801B18F4 45000038 */  bc1f       .L801B19D8
    /* B18F8 801B18F8 02201021 */   addu      $v0, $s1, $zero
    /* B18FC 801B18FC 46064003 */  div.s      $fv0, $ft2, $ft1
    /* B1900 801B1900 3C018011 */  lui        $at, %hi(D_8010B808 + 0x4)
    /* B1904 801B1904 C425B80C */  lwc1       $ft0f, %lo(D_8010B808 + 0x4)($at)
    /* B1908 801B1908 C424B810 */  lwc1       $ft0, %lo(D_8010B810)($at)
    /* B190C 801B190C C6020030 */  lwc1       $fv1, 0x30($s0)
    /* B1910 801B1910 46000021 */  cvt.d.s    $fv0, $fv0
    /* B1914 801B1914 4624003C */  c.lt.d     $fv0, $ft0
    /* B1918 801B1918 00000000 */  nop
    /* B191C 801B191C 45000004 */  bc1f       .L801B1930
    /* B1920 801B1920 460010A1 */   cvt.d.s   $fv1, $fv1
    /* B1924 801B1924 46241082 */  mul.d      $fv1, $fv1, $ft0
    /* B1928 801B1928 0806C24E */  j          .L801B0938
    /* B192C 801B192C 00000000 */   nop
  .L801B1930:
    /* B1930 801B1930 00000000 */  nop
    /* B1934 801B1934 46201082 */  mul.d      $fv1, $fv1, $fv0
    /* B1938 801B1938 46064003 */  div.s      $fv0, $ft2, $ft1
    /* B193C 801B193C 3C018011 */  lui        $at, %hi(D_8010B810 + 0x4)
    /* B1940 801B1940 C425B814 */  lwc1       $ft0f, %lo(D_8010B810 + 0x4)($at)
    /* B1944 801B1944 C424B818 */  lwc1       $ft0, %lo(D_8010B818)($at)
    /* B1948 801B1948 462010A0 */  cvt.s.d    $fv1, $fv1
    /* B194C 801B194C E4420000 */  swc1       $fv1, 0x0($v0)
    /* B1950 801B1950 3C01802A */  lui        $at, %hi(D_8029F9D4)
    /* B1954 801B1954 C422F9D4 */  lwc1       $fv1, %lo(D_8029F9D4)($at)
    /* B1958 801B1958 46000021 */  cvt.d.s    $fv0, $fv0
    /* B195C 801B195C 4624003C */  c.lt.d     $fv0, $ft0
    ...
    /* B196C 801B196C 460010A1 */   cvt.d.s   $fv1, $fv1
    /* B1970 801B1970 46241082 */  mul.d      $fv1, $fv1, $ft0
    /* B1974 801B1974 0806C261 */  j          .L801B0984
    /* B1978 801B1978 00000000 */   nop
  .L801B197C:
    /* B197C 801B197C 00000000 */  nop
    /* B1980 801B1980 46201082 */  mul.d      $fv1, $fv1, $fv0
    /* B1984 801B1984 46064003 */  div.s      $fv0, $ft2, $ft1
    /* B1988 801B1988 3C018011 */  lui        $at, %hi(D_8010B818 + 0x4)
    /* B198C 801B198C C427B81C */  lwc1       $ft1f, %lo(D_8010B818 + 0x4)($at)
    /* B1990 801B1990 C426B820 */  lwc1       $ft1, %lo(D_8010B820)($at)
    /* B1994 801B1994 462010A0 */  cvt.s.d    $fv1, $fv1
    /* B1998 801B1998 E4420004 */  swc1       $fv1, 0x4($v0)
    /* B199C 801B199C 3C01802A */  lui        $at, %hi(D_8029F9D8)
    /* B19A0 801B19A0 C422F9D8 */  lwc1       $fv1, %lo(D_8029F9D8)($at)
    /* B19A4 801B19A4 46000121 */  cvt.d.s    $ft0, $fv0
    /* B19A8 801B19A8 4626203C */  c.lt.d     $ft0, $ft1
    ...
    /* B19B8 801B19B8 46001021 */   cvt.d.s   $fv0, $fv1
    /* B19BC 801B19BC 46260002 */  mul.d      $fv0, $fv0, $ft1
    /* B19C0 801B19C0 0806C274 */  j          .L801B09D0
    /* B19C4 801B19C4 00000000 */   nop
  .L801B19C8:
    /* B19C8 801B19C8 00000000 */  nop
    /* B19CC 801B19CC 46240002 */  mul.d      $fv0, $fv0, $ft0
    /* B19D0 801B19D0 46200020 */  cvt.s.d    $fv0, $fv0
    /* B19D4 801B19D4 E4400008 */  swc1       $fv0, 0x8($v0)
  .L801B19D8:
    /* B19D8 801B19D8 3C01802A */  lui        $at, %hi(D_8029F9D0)
    /* B19DC 801B19DC C424F9D0 */  lwc1       $ft0, %lo(D_8029F9D0)($at)
    /* B19E0 801B19E0 46042102 */  mul.s      $ft0, $ft0, $ft0
    /* B19E4 801B19E4 3C01802A */  lui        $at, %hi(D_8029F9D4)
    /* B19E8 801B19E8 C422F9D4 */  lwc1       $fv1, %lo(D_8029F9D4)($at)
    /* B19EC 801B19EC 46021082 */  mul.s      $fv1, $fv1, $fv1
    /* B19F0 801B19F0 3C01802A */  lui        $at, %hi(D_8029F9D8)
    /* B19F4 801B19F4 C420F9D8 */  lwc1       $fv0, %lo(D_8029F9D8)($at)
    /* B19F8 801B19F8 46000002 */  mul.s      $fv0, $fv0, $fv0
    /* B19FC 801B19FC 46022100 */  add.s      $ft0, $ft0, $fv1
    /* B1A00 801B1A00 46002300 */  add.s      $fa0, $ft0, $fv0
    /* B1A04 801B1A04 46006004 */  sqrt.s     $fv0, $fa0
    /* B1A08 801B1A08 46000032 */  c.eq.s     $fv0, $fv0
  ...
  .L801B1A20:
    ...
    /* B1A24 801B1A24 E420F9EC */  swc1       $fv0, %lo(D_8029F9EC)($at)
  ...
  .L801B1AB0:
    ...
    /* B1AFC 801B1AFC C4820030 */  lwc1       $fv1, 0x30($a0)
    /* B1B00 801B1B00 44800000 */  mtc1       $zero, $fv0
    /* B1B04 801B1B04 46001032 */  c.eq.s     $fv1, $fv0
