nonmatching func_8019E248, 0x2EC

glabel func_8019E248
    /* 9E248 8019E248 8FB30044 */  lw         $s3, 0x44($sp)
    /* 9E24C 8019E24C 8FB20040 */  lw         $s2, 0x40($sp)
    /* 9E250 8019E250 8FB1003C */  lw         $s1, 0x3C($sp)
    /* 9E254 8019E254 8FB00038 */  lw         $s0, 0x38($sp)
    /* 9E258 8019E258 C7BF0080 */  lwc1       $fs5f, 0x80($sp)
    /* 9E25C 8019E25C C7BE0084 */  lwc1       $fs5, 0x84($sp)
    /* 9E260 8019E260 C7BD0078 */  lwc1       $fs4f, 0x78($sp)
    /* 9E264 8019E264 C7BC007C */  lwc1       $fs4, 0x7C($sp)
    /* 9E268 8019E268 C7BB0070 */  lwc1       $fs3f, 0x70($sp)
    /* 9E26C 8019E26C C7BA0074 */  lwc1       $fs3, 0x74($sp)
    /* 9E270 8019E270 C7B90068 */  lwc1       $fs2f, 0x68($sp)
    /* 9E274 8019E274 C7B8006C */  lwc1       $fs2, 0x6C($sp)
    /* 9E278 8019E278 C7B70060 */  lwc1       $fs1f, 0x60($sp)
    /* 9E27C 8019E27C C7B60064 */  lwc1       $fs1, 0x64($sp)
    /* 9E280 8019E280 C7B50058 */  lwc1       $fs0f, 0x58($sp)
    /* 9E284 8019E284 C7B4005C */  lwc1       $fs0, 0x5C($sp)
    /* 9E288 8019E288 27BD0088 */  addiu      $sp, $sp, 0x88
    /* 9E28C 8019E28C 03E00008 */  jr         $ra
    /* 9E290 8019E290 00000000 */   nop
    ...
    /* 9E2A4 8019E2A4 E7B50030 */  swc1       $fs0f, 0x30($sp)
    /* 9E2A8 8019E2A8 E7B40034 */  swc1       $fs0, 0x34($sp)
  ...
  .L8019E2D8:
    ...
    /* 9E2F0 8019E2F0 C42CA9B4 */  lwc1       $fa0, %lo(D_8010A9B4)($at)
  ...
  .L8019E310:
    ...
    /* 9E314 8019E314 C42CA9B8 */  lwc1       $fa0, %lo(D_8010A9B8)($at)
  ...
  .L8019E334:
    ...
    /* 9E338 8019E338 C42CA9BC */  lwc1       $fa0, %lo(D_8010A9BC)($at)
    ...
    /* 9E350 8019E350 C42CA9C0 */  lwc1       $fa0, %lo(D_8010A9C0)($at)
  ...
  .L8019E370:
    ...
    /* 9E374 8019E374 C42CA9C4 */  lwc1       $fa0, %lo(D_8010A9C4)($at)
    ...
    /* 9E38C 8019E38C C42CA9C8 */  lwc1       $fa0, %lo(D_8010A9C8)($at)
  ...
  .L8019E3AC:
    ...
    /* 9E3B0 8019E3B0 C42CA9CC */  lwc1       $fa0, %lo(D_8010A9CC)($at)
  ...
  .L8019E3D0:
    ...
    /* 9E3D4 8019E3D4 C42CA9D0 */  lwc1       $fa0, %lo(D_8010A9D0)($at)
  ...
  .L8019E41C:
    ...
    /* 9E440 8019E440 C482004C */  lwc1       $fv1, 0x4C($a0)
    /* 9E444 8019E444 3C018011 */  lui        $at, %hi(D_8010A9D4)
    /* 9E448 8019E448 C420A9D4 */  lwc1       $fv0, %lo(D_8010A9D4)($at)
    /* 9E44C 8019E44C 4602003C */  c.lt.s     $fv0, $fv1
    ...
    /* 9E464 8019E464 C6000034 */  lwc1       $fv0, 0x34($s0)
    /* 9E468 8019E468 44821000 */  mtc1       $v0, $fv1
    /* 9E46C 8019E46C 468010A0 */  cvt.s.w    $fv1, $fv1
    /* 9E470 8019E470 46020000 */  add.s      $fv0, $fv0, $fv1
  .L8019E474:
    /* 9E474 8019E474 3C018011 */  lui        $at, %hi(D_8010A9D8)
    /* 9E478 8019E478 C434A9D8 */  lwc1       $fs0, %lo(D_8010A9D8)($at)
    /* 9E47C 8019E47C 46140001 */  sub.s      $fv0, $fv0, $fs0
    /* 9E480 8019E480 E7A00018 */  swc1       $fv0, 0x18($sp)
    /* 9E484 8019E484 C6000038 */  lwc1       $fv0, 0x38($s0)
    /* 9E488 8019E488 C6020030 */  lwc1       $fv1, 0x30($s0)
    /* 9E48C 8019E48C 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* 9E490 8019E490 3C018011 */  lui        $at, %hi(D_8010A9DC)
    /* 9E494 8019E494 C422A9DC */  lwc1       $fv1, %lo(D_8010A9DC)($at)
    /* 9E498 8019E498 46020000 */  add.s      $fv0, $fv0, $fv1
    /* 9E49C 8019E49C 24040005 */  addiu      $a0, $zero, 0x5
    /* 9E4A0 8019E4A0 0C051C00 */  jal        func_80147000
    /* 9E4A4 8019E4A4 E7A0001C */   swc1      $fv0, 0x1C($sp)
    /* 9E4A8 8019E4A8 C602003C */  lwc1       $fv1, 0x3C($s0)
    /* 9E4AC 8019E4AC 44820000 */  mtc1       $v0, $fv0
    /* 9E4B0 8019E4B0 46800020 */  cvt.s.w    $fv0, $fv0
    /* 9E4B4 8019E4B4 46001080 */  add.s      $fv1, $fv1, $fv0
    /* 9E4B8 8019E4B8 00002021 */  addu       $a0, $zero, $zero
    /* 9E4BC 8019E4BC 46141081 */  sub.s      $fv1, $fv1, $fs0
    ...
    /* 9E4D0 8019E4D0 E7A20020 */  swc1       $fv1, 0x20($sp)
  ...
  .L8019E4DC:
    ...
    /* 9E4E0 8019E4E0 C420A9E0 */  lwc1       $fv0, %lo(D_8010A9E0)($at)
    /* 9E4E4 8019E4E4 0806753E */  j          .L8019D4F8
    /* 9E4E8 8019E4E8 E6000070 */   swc1      $fv0, 0x70($s0)
  .L8019E4EC:
    /* 9E4EC 8019E4EC 8E0200D0 */  lw         $v0, 0xD0($s0)
    /* 9E4F0 8019E4F0 C4400018 */  lwc1       $fv0, 0x18($v0)
    /* 9E4F4 8019E4F4 E6000070 */  swc1       $fv0, 0x70($s0)
    ...
    /* 9E50C 8019E50C C482004C */  lwc1       $fv1, 0x4C($a0)
    /* 9E510 8019E510 3C018011 */  lui        $at, %hi(D_8010A9E4)
    /* 9E514 8019E514 C420A9E4 */  lwc1       $fv0, %lo(D_8010A9E4)($at)
    /* 9E518 8019E518 4602003C */  c.lt.s     $fv0, $fv1
    ...
    /* 9E52C 8019E52C C420A9E8 */  lwc1       $fv0, %lo(D_8010A9E8)($at)
    /* 9E530 8019E530 4600103C */  c.lt.s     $fv1, $fv0
endlabel func_8019E248
