...
glabel func_801A8794
    /* A8794 801A8794 C424B148 */  lwc1       $f4, -0x4EB8($at)
    /* A8798 801A8798 46001021 */  cvt.d.s    $f0, $f2
    /* A879C 801A879C 4624003C */  c.lt.d     $f0, $f4
    ...
    /* A87B0 801A87B0 C422B14C */  lwc1       $f2, %lo(D_8010B14C)($at)
  .L801A87B4:
    /* A87B4 801A87B4 8E02000C */  lw         $v0, 0xC($s0)
    /* A87B8 801A87B8 C440013C */  lwc1       $f0, 0x13C($v0)
    /* A87BC 801A87BC 46020002 */  mul.s      $f0, $f0, $f2
    /* A87C0 801A87C0 E6000038 */  swc1       $f0, 0x38($s0)
