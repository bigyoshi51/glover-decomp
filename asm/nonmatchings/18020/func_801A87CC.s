nonmatching func_801A87CC, 0x664

glabel func_801A87CC
    /* A87CC 801A87CC 27BD0020 */  addiu      $sp, $sp, 0x20
    /* A87D0 801A87D0 03E00008 */  jr         $ra
    /* A87D4 801A87D4 00000000 */   nop
    ...
    /* A87FC 801A87FC E7B70150 */  swc1       $fs1f, 0x150($sp)
    /* A8800 801A8800 E7B60154 */  swc1       $fs1, 0x154($sp)
    /* A8804 801A8804 4486B000 */  mtc1       $a2, $fs1
    /* A8808 801A8808 24030001 */  addiu      $v1, $zero, 0x1
    /* A880C 801A880C E7B90158 */  swc1       $fs2f, 0x158($sp)
    /* A8810 801A8810 E7B8015C */  swc1       $fs2, 0x15C($sp)
    /* A8814 801A8814 4487C000 */  mtc1       $a3, $fs2
    /* A8818 801A8818 44800000 */  mtc1       $zero, $fv0
    /* A881C 801A881C AFBF0144 */  sw         $ra, 0x144($sp)
    /* A8820 801A8820 4600C03E */  c.le.s     $fs2, $fv0
    /* A8824 801A8824 AFB20138 */  sw         $s2, 0x138($sp)
    /* A8828 801A8828 E7B50148 */  swc1       $fs0f, 0x148($sp)
    /* A882C 801A882C E7B4014C */  swc1       $fs0, 0x14C($sp)
  ...
  .L801A883C:
    ...
    /* A8848 801A8848 4618B503 */  div.s      $fs0, $fs1, $fs2
    /* A884C 801A884C 4600A004 */  sqrt.s     $fv0, $fs0
    /* A8850 801A8850 46000032 */  c.eq.s     $fv0, $fv0
    /* A8854 801A8854 00000000 */  nop
    /* A8858 801A8858 4600B002 */  mul.s      $fv0, $fs1, $fv0
    /* A885C 801A885C 45030004 */  bc1tl      .L801A8870
    /* A8860 801A8860 00000000 */   nop
    /* A8864 801A8864 0C07100C */  jal        func_801C4030
    /* A8868 801A8868 4600A306 */   mov.s     $fa0, $fs0
    /* A886C 801A886C 4600B002 */  mul.s      $fv0, $fs1, $fv0
  .L801A8870:
    /* A8870 801A8870 4616003C */  c.lt.s     $fv0, $fs1
    /* A8874 801A8874 00000000 */  nop
    /* A8878 801A8878 4500000F */  bc1f       .L801A88B8
    /* A887C 801A887C 00000000 */   nop
    /* A8880 801A8880 4600A004 */  sqrt.s     $fv0, $fs0
    /* A8884 801A8884 46000032 */  c.eq.s     $fv0, $fv0
    /* A8888 801A8888 00000000 */  nop
    /* A888C 801A888C 4600B002 */  mul.s      $fv0, $fs1, $fv0
    /* A8890 801A8890 45030004 */  bc1tl      .L801A88A4
    /* A8894 801A8894 00000000 */   nop
    /* A8898 801A8898 0C07100C */  jal        func_801C4030
    /* A889C 801A889C 4600A306 */   mov.s     $fa0, $fs0
    /* A88A0 801A88A0 4600B002 */  mul.s      $fv0, $fs1, $fv0
  .L801A88A4:
    /* A88A4 801A88A4 3C018011 */  lui        $at, %hi(D_8010B150)
    /* A88A8 801A88A8 C422B150 */  lwc1       $fv1, %lo(D_8010B150)($at)
    /* A88AC 801A88AC 46020002 */  mul.s      $fv0, $fv0, $fv1
    /* A88B0 801A88B0 08069E31 */  j          .L801A78C4
    /* A88B4 801A88B4 00000000 */   nop
  .L801A88B8:
    /* A88B8 801A88B8 3C018011 */  lui        $at, %hi(D_8010B154)
    /* A88BC 801A88BC C420B154 */  lwc1       $fv0, %lo(D_8010B154)($at)
    /* A88C0 801A88C0 4600B002 */  mul.s      $fv0, $fs1, $fv0
    /* A88C4 801A88C4 46160000 */  add.s      $fv0, $fv0, $fs1
  .L801A88C8:
    /* A88C8 801A88C8 3C018011 */  lui        $at, %hi(D_8010B158)
    /* A88CC 801A88CC C422B158 */  lwc1       $fv1, %lo(D_8010B158)($at)
    ...
    /* A8900 801A8900 46020503 */   div.s     $fs0, $fv0, $fv1
  ...
  .L801A891C:
    ...
    /* A893C 801A893C C423B15C */  lwc1       $fv1f, %lo(D_8010B158 + 0x4)($at)
    /* A8940 801A8940 C422B160 */  lwc1       $fv1, %lo(D_8010B160)($at)
    /* A8944 801A8944 4600C021 */  cvt.d.s    $fv0, $fs2
    /* A8948 801A8948 46201081 */  sub.d      $fv1, $fv1, $fv0
    /* A894C 801A894C 27A40120 */  addiu      $a0, $sp, 0x120
    /* A8950 801A8950 8FA60178 */  lw         $a2, 0x178($sp)
    /* A8954 801A8954 462010A0 */  cvt.s.d    $fv1, $fv1
    /* A8958 801A8958 44071000 */  mfc1       $a3, $fv1
  ...
  .L801A896C:
    ...
    /* A8984 801A8984 4405A000 */  mfc1       $a1, $fs0
  ...
  .L801A8A88:
    ...
    /* A8AA0 801A8AA0 C7B90158 */  lwc1       $fs2f, 0x158($sp)
    /* A8AA4 801A8AA4 C7B8015C */  lwc1       $fs2, 0x15C($sp)
    /* A8AA8 801A8AA8 C7B70150 */  lwc1       $fs1f, 0x150($sp)
    /* A8AAC 801A8AAC C7B60154 */  lwc1       $fs1, 0x154($sp)
    /* A8AB0 801A8AB0 C7B50148 */  lwc1       $fs0f, 0x148($sp)
    /* A8AB4 801A8AB4 C7B4014C */  lwc1       $fs0, 0x14C($sp)
