...
glabel func_801A29F0
    ...
    /* A29F4 801A29F4 C42401E8 */  lwc1       $ft0, %lo(D_801F01E8)($at)
    /* A29F8 801A29F8 8E2200DC */  lw         $v0, 0xDC($s1)
    /* A29FC 801A29FC 3C018011 */  lui        $at, %hi(D_8010AD10)
    /* A2A00 801A2A00 C420AD10 */  lwc1       $fv0, %lo(D_8010AD10)($at)
    /* A2A04 801A2A04 E622005C */  swc1       $fv1, 0x5C($s1)
    /* A2A08 801A2A08 E6240060 */  swc1       $ft0, 0x60($s1)
    /* A2A0C 801A2A0C E440004C */  swc1       $fv0, 0x4C($v0)
    /* A2A10 801A2A10 3C018011 */  lui        $at, %hi(D_8010AD14)
    /* A2A14 801A2A14 C420AD14 */  lwc1       $fv0, %lo(D_8010AD14)($at)
    /* A2A18 801A2A18 8E220028 */  lw         $v0, 0x28($s1)
    /* A2A1C 801A2A1C 8E2300D8 */  lw         $v1, 0xD8($s1)
    /* A2A20 801A2A20 3C018011 */  lui        $at, %hi(D_8010AD18)
    /* A2A24 801A2A24 C422AD18 */  lwc1       $fv1, %lo(D_8010AD18)($at)
    /* A2A28 801A2A28 34420001 */  ori        $v0, $v0, 0x1
    /* A2A2C 801A2A2C E6200270 */  swc1       $fv0, 0x270($s1)
    /* A2A30 801A2A30 AE220028 */  sw         $v0, 0x28($s1)
    /* A2A34 801A2A34 C4600170 */  lwc1       $fv0, 0x170($v1)
    /* A2A38 801A2A38 46020002 */  mul.s      $fv0, $fv0, $fv1
    /* A2A3C 801A2A3C 8E2200D0 */  lw         $v0, 0xD0($s1)
    /* A2A40 801A2A40 C4420048 */  lwc1       $fv1, 0x48($v0)
    /* A2A44 801A2A44 46020003 */  div.s      $fv0, $fv0, $fv1
    /* A2A48 801A2A48 E4600074 */  swc1       $fv0, 0x74($v1)
  .L801A2A4C:
    /* A2A4C 801A2A4C C620005C */  lwc1       $fv0, 0x5C($s1)
    /* A2A50 801A2A50 4480A000 */  mtc1       $zero, $fs0
    /* A2A54 801A2A54 4614003C */  c.lt.s     $fv0, $fs0
  ...
  .L801A2A70:
    ...
    /* A2A74 801A2A74 C42CAD1C */  lwc1       $fa0, %lo(D_8010AD1C)($at)
  ...
  .L801A2ACC:
    ...
    /* A2AF8 801A2AF8 C4600088 */  lwc1       $fv0, 0x88($v1)
    /* A2AFC 801A2AFC 24060001 */  addiu      $a2, $zero, 0x1
    /* A2B00 801A2B00 24070001 */  addiu      $a3, $zero, 0x1
    /* A2B04 801A2B04 E440000C */  swc1       $fv0, 0xC($v0)
    /* A2B08 801A2B08 0C04CE66 */  jal        func_80133998
    /* A2B0C 801A2B0C E7B40010 */   swc1      $fs0, 0x10($sp)
    /* A2B10 801A2B10 08068864 */  j          .L801A2190
    /* A2B14 801A2B14 E6340270 */   swc1      $fs0, 0x270($s1)
  .L801A2B18:
    /* A2B18 801A2B18 3C01801F */  lui        $at, %hi(D_801F01D8)
    /* A2B1C 801A2B1C C42001D8 */  lwc1       $fv0, %lo(D_801F01D8)($at)
    /* A2B20 801A2B20 46001103 */  div.s      $ft0, $fv1, $fv0
    /* A2B24 801A2B24 3C01801F */  lui        $at, %hi(D_801F01D4)
    /* A2B28 801A2B28 C42001D4 */  lwc1       $fv0, %lo(D_801F01D4)($at)
    /* A2B2C 801A2B2C 4600203C */  c.lt.s     $ft0, $fv0
    /* A2B30 801A2B30 00000000 */  nop
    /* A2B34 801A2B34 45000002 */  bc1f       .L801A2B40
    /* A2B38 801A2B38 46000506 */   mov.s     $fs0, $fv0
    /* A2B3C 801A2B3C 46002506 */  mov.s      $fs0, $ft0
  .L801A2B40:
    /* A2B40 801A2B40 3C018011 */  lui        $at, %hi(D_8010AD20)
    /* A2B44 801A2B44 C420AD20 */  lwc1       $fv0, %lo(D_8010AD20)($at)
    /* A2B48 801A2B48 46001001 */  sub.s      $fv0, $fv1, $fv0
    /* A2B4C 801A2B4C 8E2200DC */  lw         $v0, 0xDC($s1)
    /* A2B50 801A2B50 E6200270 */  swc1       $fv0, 0x270($s1)
    /* A2B54 801A2B54 C440004C */  lwc1       $fv0, 0x4C($v0)
    /* A2B58 801A2B58 46140000 */  add.s      $fv0, $fv0, $fs0
    /* A2B5C 801A2B5C E440004C */  swc1       $fv0, 0x4C($v0)
    /* A2B60 801A2B60 8E2200DC */  lw         $v0, 0xDC($s1)
    /* A2B64 801A2B64 3C018011 */  lui        $at, %hi(D_8010AD24)
    /* A2B68 801A2B68 C420AD24 */  lwc1       $fv0, %lo(D_8010AD24)($at)
    /* A2B6C 801A2B6C C442004C */  lwc1       $fv1, 0x4C($v0)
    /* A2B70 801A2B70 4602003C */  c.lt.s     $fv0, $fv1
    ...
    /* A2B98 801A2B98 C422AD28 */  lwc1       $fv1, %lo(D_8010AD28)($at)
    /* A2B9C 801A2B9C C440004C */  lwc1       $fv0, 0x4C($v0)
    /* A2BA0 801A2BA0 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A2BA4 801A2BA4 08068864 */  j          .L801A2190
    /* A2BA8 801A2BA8 E440004C */   swc1      $fv0, 0x4C($v0)
  .L801A2BAC:
  ...
  .L801A2BC0:
    ...
    /* A2BD0 801A2BD0 C422AD2C */  lwc1       $fv1, %lo(D_8010AD2C)($at)
    /* A2BD4 801A2BD4 C4600170 */  lwc1       $fv0, 0x170($v1)
    /* A2BD8 801A2BD8 46020002 */  mul.s      $fv0, $fv0, $fv1
    /* A2BDC 801A2BDC 8E2200D0 */  lw         $v0, 0xD0($s1)
    /* A2BE0 801A2BE0 C4420048 */  lwc1       $fv1, 0x48($v0)
    /* A2BE4 801A2BE4 46020003 */  div.s      $fv0, $fv0, $fv1
    /* A2BE8 801A2BE8 08068864 */  j          .L801A2190
    /* A2BEC 801A2BEC E4600074 */   swc1      $fv0, 0x74($v1)
  .L801A2BF0:
    ...
    /* A2C24 801A2C24 C7AC0018 */  lwc1       $fa0, 0x18($sp)
    /* A2C28 801A2C28 C7AE0020 */  lwc1       $fa1, 0x20($sp)
    /* A2C2C 801A2C2C 0C051D18 */  jal        func_80147460
    /* A2C30 801A2C30 00000000 */   nop
    /* A2C34 801A2C34 0C0525B2 */  jal        func_801496C8
    /* A2C38 801A2C38 46000306 */   mov.s     $fa0, $fv0
    /* A2C3C 801A2C3C C62C007C */  lwc1       $fa0, 0x7C($s1)
    /* A2C40 801A2C40 46000506 */  mov.s      $fs0, $fv0
    /* A2C44 801A2C44 0C052513 */  jal        func_8014944C
    /* A2C48 801A2C48 4600A386 */   mov.s     $fa1, $fs0
    /* A2C4C 801A2C4C 3C018011 */  lui        $at, %hi(D_8010AD30)
    /* A2C50 801A2C50 C423AD30 */  lwc1       $fv1f, %lo(D_8010AD30)($at)
    /* A2C54 801A2C54 C422AD34 */  lwc1       $fv1, %lo(D_8010AD30 + 0x4)($at)
    /* A2C58 801A2C58 46000021 */  cvt.d.s    $fv0, $fv0
    /* A2C5C 801A2C5C 4622003C */  c.lt.d     $fv0, $fv1
    ...
    /* A2C88 801A2C88 E6340088 */   swc1      $fs0, 0x88($s1)
    /* A2C8C 801A2C8C 0C05255A */  jal        func_80149568
    /* A2C90 801A2C90 02002021 */   addu      $a0, $s0, $zero
    /* A2C94 801A2C94 8E2200D0 */  lw         $v0, 0xD0($s1)
    /* A2C98 801A2C98 C4440004 */  lwc1       $ft0, 0x4($v0)
    /* A2C9C 801A2C9C 3C018011 */  lui        $at, %hi(D_8010AD38)
    /* A2CA0 801A2CA0 C427AD38 */  lwc1       $ft1f, %lo(D_8010AD38)($at)
    /* A2CA4 801A2CA4 C426AD3C */  lwc1       $ft1, %lo(D_8010AD38 + 0x4)($at)
    /* A2CA8 801A2CA8 46002121 */  cvt.d.s    $ft0, $ft0
    /* A2CAC 801A2CAC 46262102 */  mul.d      $ft0, $ft0, $ft1
    /* A2CB0 801A2CB0 C6220074 */  lwc1       $fv1, 0x74($s1)
    /* A2CB4 801A2CB4 C6200058 */  lwc1       $fv0, 0x58($s1)
    /* A2CB8 801A2CB8 460010A1 */  cvt.d.s    $fv1, $fv1
    /* A2CBC 801A2CBC 46241080 */  add.d      $fv1, $fv1, $ft0
    /* A2CC0 801A2CC0 46000021 */  cvt.d.s    $fv0, $fv0
    /* A2CC4 801A2CC4 46220002 */  mul.d      $fv0, $fv0, $fv1
    /* A2CC8 801A2CC8 8E2200D0 */  lw         $v0, 0xD0($s1)
    /* A2CCC 801A2CCC 46200020 */  cvt.s.d    $fv0, $fv0
    /* A2CD0 801A2CD0 E6200058 */  swc1       $fv0, 0x58($s1)
    /* A2CD4 801A2CD4 C4440004 */  lwc1       $ft0, 0x4($v0)
    /* A2CD8 801A2CD8 46002121 */  cvt.d.s    $ft0, $ft0
    /* A2CDC 801A2CDC 46262102 */  mul.d      $ft0, $ft0, $ft1
    /* A2CE0 801A2CE0 C6220074 */  lwc1       $fv1, 0x74($s1)
    /* A2CE4 801A2CE4 460010A1 */  cvt.d.s    $fv1, $fv1
    /* A2CE8 801A2CE8 C620005C */  lwc1       $fv0, 0x5C($s1)
    /* A2CEC 801A2CEC 46241080 */  add.d      $fv1, $fv1, $ft0
    /* A2CF0 801A2CF0 46000021 */  cvt.d.s    $fv0, $fv0
    /* A2CF4 801A2CF4 46220002 */  mul.d      $fv0, $fv0, $fv1
    /* A2CF8 801A2CF8 8E2200D0 */  lw         $v0, 0xD0($s1)
    /* A2CFC 801A2CFC 46200020 */  cvt.s.d    $fv0, $fv0
    /* A2D00 801A2D00 E620005C */  swc1       $fv0, 0x5C($s1)
    /* A2D04 801A2D04 C4440004 */  lwc1       $ft0, 0x4($v0)
    /* A2D08 801A2D08 46002121 */  cvt.d.s    $ft0, $ft0
    /* A2D0C 801A2D0C 46262102 */  mul.d      $ft0, $ft0, $ft1
    /* A2D10 801A2D10 C6220074 */  lwc1       $fv1, 0x74($s1)
    /* A2D14 801A2D14 460010A1 */  cvt.d.s    $fv1, $fv1
    /* A2D18 801A2D18 C6200060 */  lwc1       $fv0, 0x60($s1)
    /* A2D1C 801A2D1C 46241080 */  add.d      $fv1, $fv1, $ft0
    /* A2D20 801A2D20 46000021 */  cvt.d.s    $fv0, $fv0
    /* A2D24 801A2D24 46220002 */  mul.d      $fv0, $fv0, $fv1
    /* A2D28 801A2D28 46200020 */  cvt.s.d    $fv0, $fv0
    /* A2D2C 801A2D2C 08068752 */  j          .L801A1D48
    /* A2D30 801A2D30 E6200060 */   swc1      $fv0, 0x60($s1)
  .L801A2D34:
    ...
    /* A2D50 801A2D50 C424AD40 */  lwc1       $ft0, %lo(D_8010AD40)($at)
    /* A2D54 801A2D54 C442004C */  lwc1       $fv1, 0x4C($v0)
    /* A2D58 801A2D58 4602203E */  c.le.s     $ft0, $fv1
    /* A2D5C 801A2D5C 00000000 */  nop
    /* A2D60 801A2D60 4500010B */  bc1f       .L801A3190
    /* A2D64 801A2D64 00000000 */   nop
    /* A2D68 801A2D68 C440000C */  lwc1       $fv0, 0xC($v0)
    /* A2D6C 801A2D6C 46040000 */  add.s      $fv0, $fv0, $ft0
    /* A2D70 801A2D70 4600103C */  c.lt.s     $fv1, $fv0
  ...
  .L801A2E48:
    ...
    /* A2E4C 801A2E4C C420AD44 */  lwc1       $fv0, %lo(D_8010AD44)($at)
    /* A2E50 801A2E50 C4420048 */  lwc1       $fv1, 0x48($v0)
    /* A2E54 801A2E54 46001083 */  div.s      $fv1, $fv1, $fv0
    /* A2E58 801A2E58 8E2200D8 */  lw         $v0, 0xD8($s1)
    /* A2E5C 801A2E5C C4400170 */  lwc1       $fv0, 0x170($v0)
    /* A2E60 801A2E60 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A2E64 801A2E64 E4400170 */  swc1       $fv0, 0x170($v0)
  ...
  .L801A2E94:
    ...
    /* A2EC8 801A2EC8 C420AD48 */  lwc1       $fv0, %lo(D_8010AD48)($at)
    /* A2ECC 801A2ECC 3C018011 */  lui        $at, %hi(D_8010AD4C)
    /* A2ED0 801A2ED0 C422AD4C */  lwc1       $fv1, %lo(D_8010AD4C)($at)
    ...
    /* A2EE0 801A2EE0 C424FBCC */  lwc1       $ft0, %lo(D_8028FBCC)($at)
    ...
    /* A2EF4 801A2EF4 E4200334 */  swc1       $fv0, %lo(D_80290334)($at)
    /* A2EF8 801A2EF8 3C018029 */  lui        $at, %hi(D_80290338)
    /* A2EFC 801A2EFC E4220338 */  swc1       $fv1, %lo(D_80290338)($at)
    ...
    /* A2F0C 801A2F0C E4240348 */  swc1       $ft0, %lo(D_80290348)($at)
  ...
  .L801A2F20:
    ...
    /* A2F44 801A2F44 C6240260 */  lwc1       $ft0, 0x260($s1)
    /* A2F48 801A2F48 C6200034 */  lwc1       $fv0, 0x34($s1)
    /* A2F4C 801A2F4C 46002101 */  sub.s      $ft0, $ft0, $fv0
    /* A2F50 801A2F50 AE200088 */  sw         $zero, 0x88($s1)
    /* A2F54 801A2F54 E7A40018 */  swc1       $ft0, 0x18($sp)
    /* A2F58 801A2F58 C6200264 */  lwc1       $fv0, 0x264($s1)
    /* A2F5C 801A2F5C C6220038 */  lwc1       $fv1, 0x38($s1)
    /* A2F60 801A2F60 46042102 */  mul.s      $ft0, $ft0, $ft0
    /* A2F64 801A2F64 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A2F68 801A2F68 E7A0001C */  swc1       $fv0, 0x1C($sp)
    /* A2F6C 801A2F6C C6220268 */  lwc1       $fv1, 0x268($s1)
    /* A2F70 801A2F70 C626003C */  lwc1       $ft1, 0x3C($s1)
    /* A2F74 801A2F74 46000002 */  mul.s      $fv0, $fv0, $fv0
    /* A2F78 801A2F78 46061081 */  sub.s      $fv1, $fv1, $ft1
    /* A2F7C 801A2F7C 46021182 */  mul.s      $ft1, $fv1, $fv1
    /* A2F80 801A2F80 46002100 */  add.s      $ft0, $ft0, $fv0
    /* A2F84 801A2F84 46062300 */  add.s      $fa0, $ft0, $ft1
    /* A2F88 801A2F88 46006384 */  sqrt.s     $fa1, $fa0
    /* A2F8C 801A2F8C 460E7032 */  c.eq.s     $fa1, $fa1
    /* A2F90 801A2F90 00000000 */  nop
    /* A2F94 801A2F94 45010004 */  bc1t       .L801A2FA8
    /* A2F98 801A2F98 E7A20020 */   swc1      $fv1, 0x20($sp)
    /* A2F9C 801A2F9C 0C07100C */  jal        func_801C4030
    /* A2FA0 801A2FA0 00000000 */   nop
    /* A2FA4 801A2FA4 46000386 */  mov.s      $fa1, $fv0
  .L801A2FA8:
    /* A2FA8 801A2FA8 3C01801F */  lui        $at, %hi(D_801EFFC8)
    /* A2FAC 801A2FAC C420FFC8 */  lwc1       $fv0, %lo(D_801EFFC8)($at)
    /* A2FB0 801A2FB0 C62200BC */  lwc1       $fv1, 0xBC($s1)
    /* A2FB4 801A2FB4 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A2FB8 801A2FB8 3C018011 */  lui        $at, %hi(D_8010AD50)
    /* A2FBC 801A2FBC C422AD50 */  lwc1       $fv1, %lo(D_8010AD50)($at)
    /* A2FC0 801A2FC0 46020002 */  mul.s      $fv0, $fv0, $fv1
    /* A2FC4 801A2FC4 3C018011 */  lui        $at, %hi(D_8010AD54)
    /* A2FC8 801A2FC8 C422AD54 */  lwc1       $fv1, %lo(D_8010AD54)($at)
    /* A2FCC 801A2FCC 46020000 */  add.s      $fv0, $fv0, $fv1
    /* A2FD0 801A2FD0 46007506 */  mov.s      $fs0, $fa1
    /* A2FD4 801A2FD4 4600A03E */  c.le.s     $fs0, $fv0
    /* A2FD8 801A2FD8 3C01801F */  lui        $at, %hi(D_801F01D0)
    /* A2FDC 801A2FDC E42001D0 */  swc1       $fv0, %lo(D_801F01D0)($at)
    /* A2FE0 801A2FE0 45020011 */  bc1fl      .L801A3028
    /* A2FE4 801A2FE4 46140003 */   div.s     $fv0, $fv0, $fs0
    /* A2FE8 801A2FE8 44800000 */  mtc1       $zero, $fv0
    /* A2FEC 801A2FEC E6200060 */  swc1       $fv0, 0x60($s1)
    /* A2FF0 801A2FF0 E620005C */  swc1       $fv0, 0x5C($s1)
    /* A2FF4 801A2FF4 E6200058 */  swc1       $fv0, 0x58($s1)
  ...
  .L801A3028:
    ...
    /* A302C 801A302C 44060000 */  mfc1       $a2, $fv0
    /* A3030 801A3030 44800000 */  mtc1       $zero, $fv0
    /* A3034 801A3034 27A50018 */  addiu      $a1, $sp, 0x18
    /* A3038 801A3038 E6200060 */  swc1       $fv0, 0x60($s1)
    /* A303C 801A303C E620005C */  swc1       $fv0, 0x5C($s1)
  .L801A3040:
    /* A3040 801A3040 0C052343 */  jal        func_80148D0C
    /* A3044 801A3044 E6200058 */   swc1      $fv0, 0x58($s1)
  ...
  .L801A3050:
    ...
    /* A305C 801A305C C42CAD58 */  lwc1       $fa0, %lo(D_8010AD58)($at)
  ...
  .L801A30B0:
    ...
    /* A30B4 801A30B4 C420AD5C */  lwc1       $fv0, %lo(D_8010AD5C)($at)
    /* A30B8 801A30B8 3C018011 */  lui        $at, %hi(D_8010AD60)
    /* A30BC 801A30BC C422AD60 */  lwc1       $fv1, %lo(D_8010AD60)($at)
    /* A30C0 801A30C0 AFA00018 */  sw         $zero, 0x18($sp)
    /* A30C4 801A30C4 E7A00020 */  swc1       $fv0, 0x20($sp)
    /* A30C8 801A30C8 C6200268 */  lwc1       $fv0, 0x268($s1)
    /* A30CC 801A30CC 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A30D0 801A30D0 3C018029 */  lui        $at, %hi(D_80290314)
    /* A30D4 801A30D4 C4220314 */  lwc1       $fv1, %lo(D_80290314)($at)
    /* A30D8 801A30D8 4600103C */  c.lt.s     $fv1, $fv0
    ...
    /* A30F8 801A30F8 C622003C */  lwc1       $fv1, 0x3C($s1)
    /* A30FC 801A30FC 3C018011 */  lui        $at, %hi(D_8010AD64)
    /* A3100 801A3100 C420AD64 */  lwc1       $fv0, %lo(D_8010AD64)($at)
    /* A3104 801A3104 4602003C */  c.lt.s     $fv0, $fv1
    ...
    /* A312C 801A312C C422AD68 */  lwc1       $fv1, %lo(D_8010AD68)($at)
    /* A3130 801A3130 4600103C */  c.lt.s     $fv1, $fv0
  ...
  .L801A3190:
    ...
    /* A31A4 801A31A4 C7B50048 */  lwc1       $fs0f, 0x48($sp)
    /* A31A8 801A31A8 C7B4004C */  lwc1       $fs0, 0x4C($sp)
  ...
  .L801A331C:
    ...
    /* A3344 801A3344 C480000C */  lwc1       $fv0, 0xC($a0)
    /* A3348 801A3348 3C018011 */  lui        $at, %hi(D_8010AD6C)
    /* A334C 801A334C C422AD6C */  lwc1       $fv1, %lo(D_8010AD6C)($at)
    /* A3350 801A3350 46020000 */  add.s      $fv0, $fv0, $fv1
    /* A3354 801A3354 C482004C */  lwc1       $fv1, 0x4C($a0)
    /* A3358 801A3358 4600103E */  c.le.s     $fv1, $fv0
  ...
  .L801A3418:
    ...
    /* A3420 801A3420 C420AD70 */  lwc1       $fv0, %lo(D_8010AD70)($at)
    /* A3424 801A3424 E4400098 */  swc1       $fv0, 0x98($v0)
    ...
    /* A3450 801A3450 C42201EC */  lwc1       $fv1, %lo(D_801F01EC)($at)
    /* A3454 801A3454 C600025C */  lwc1       $fv0, 0x25C($s0)
    /* A3458 801A3458 46800020 */  cvt.s.w    $fv0, $fv0
    /* A345C 801A345C 4600103E */  c.le.s     $fv1, $fv0
  ...
  .L801A3624:
    ...
    /* A3630 801A3630 C420AD74 */  lwc1       $fv0, %lo(D_8010AD74)($at)
    /* A3634 801A3634 02002021 */  addu       $a0, $s0, $zero
    /* A3638 801A3638 3C01802A */  lui        $at, %hi(D_8029F9D4)
    /* A363C 801A363C E420F9D4 */  swc1       $fv0, %lo(D_8029F9D4)($at)
  ...
  .L801A3650:
    ...
    /* A36B0 801A36B0 C420AD78 */  lwc1       $fv0, %lo(D_8010AD78)($at)
    /* A36B4 801A36B4 E6000270 */  swc1       $fv0, 0x270($s0)
  .L801A36B8:
  ...
  .L801A3718:
    ...
    /* A3720 801A3720 C4A2004C */  lwc1       $fv1, 0x4C($a1)
    /* A3724 801A3724 3C018011 */  lui        $at, %hi(D_8010AD7C)
    /* A3728 801A3728 C420AD7C */  lwc1       $fv0, %lo(D_8010AD7C)($at)
    /* A372C 801A372C 4602003C */  c.lt.s     $fv0, $fv1
  ...
  .L801A3774:
    ...
    /* A378C 801A378C C420AD80 */  lwc1       $fv0, %lo(D_8010AD80)($at)
    /* A3790 801A3790 AFA00018 */  sw         $zero, 0x18($sp)
    /* A3794 801A3794 E7A00020 */  swc1       $fv0, 0x20($sp)
    ...
    /* A37B0 801A37B0 C6000038 */  lwc1       $fv0, 0x38($s0)
    /* A37B4 801A37B4 3C018011 */  lui        $at, %hi(D_8010AD84)
    /* A37B8 801A37B8 C422AD84 */  lwc1       $fv1, %lo(D_8010AD84)($at)
    /* A37BC 801A37BC 46020000 */  add.s      $fv0, $fv0, $fv1
    /* A37C0 801A37C0 27A40018 */  addiu      $a0, $sp, 0x18
    /* A37C4 801A37C4 0C065C6A */  jal        func_801971A8
    /* A37C8 801A37C8 E7A0001C */   swc1      $fv0, 0x1C($sp)
    /* A37CC 801A37CC C6020270 */  lwc1       $fv1, 0x270($s0)
    /* A37D0 801A37D0 44802000 */  mtc1       $zero, $ft0
    /* A37D4 801A37D4 46041032 */  c.eq.s     $fv1, $ft0
    ...
    /* A37E8 801A37E8 C420AD88 */  lwc1       $fv0, %lo(D_8010AD88)($at)
    /* A37EC 801A37EC 46001001 */  sub.s      $fv0, $fv1, $fv0
    /* A37F0 801A37F0 46040032 */  c.eq.s     $fv0, $ft0
    /* A37F4 801A37F4 00000000 */  nop
    /* A37F8 801A37F8 45000003 */  bc1f       .L801A3808
    /* A37FC 801A37FC E6000270 */   swc1      $fv0, 0x270($s0)
  ...
  .L801A3884:
    ...
    /* A3888 801A3888 C420AD8C */  lwc1       $fv0, %lo(D_8010AD8C)($at)
    /* A388C 801A388C E6000270 */  swc1       $fv0, 0x270($s0)
  .L801A3890:
  ...
  .L801A3914:
    ...
    /* A3948 801A3948 C462004C */  lwc1       $fv1, 0x4C($v1)
    /* A394C 801A394C 4602603E */  c.le.s     $fa0, $fv1
    /* A3950 801A3950 00000000 */  nop
    /* A3954 801A3954 45000007 */  bc1f       .L801A3974
    /* A3958 801A3958 00001021 */   addu      $v0, $zero, $zero
    /* A395C 801A395C C460000C */  lwc1       $fv0, 0xC($v1)
    /* A3960 801A3960 46006000 */  add.s      $fv0, $fa0, $fv0
    /* A3964 801A3964 4600103C */  c.lt.s     $fv1, $fv0
  ...
  .L801A3A0C:
    ...
    /* A3A14 801A3A14 E7B70078 */  swc1       $fs1f, 0x78($sp)
    /* A3A18 801A3A18 E7B6007C */  swc1       $fs1, 0x7C($sp)
    /* A3A1C 801A3A1C E7B50070 */  swc1       $fs0f, 0x70($sp)
    /* A3A20 801A3A20 E7B40074 */  swc1       $fs0, 0x74($sp)
  ...
  .L801A3AA8:
    ...
    /* A3AC4 801A3AC4 C420AD9C */  lwc1       $fv0, %lo(D_8010AD9C)($at)
    ...
    /* A3AD8 801A3AD8 44060000 */  mfc1       $a2, $fv0
    ...
    /* A3AFC 801A3AFC 44800000 */  mtc1       $zero, $fv0
    ...
    /* A3B0C 801A3B0C E420FFD4 */  swc1       $fv0, %lo(D_8028FFD4)($at)
    /* A3B10 801A3B10 3C018029 */  lui        $at, %hi(D_8028FFD0)
    /* A3B14 801A3B14 E420FFD0 */  swc1       $fv0, %lo(D_8028FFD0)($at)
    /* A3B18 801A3B18 0C05E178 */  jal        func_801785E0
    /* A3B1C 801A3B1C E6000034 */   swc1      $fv0, 0x34($s0)
    /* A3B20 801A3B20 3C018011 */  lui        $at, %hi(D_8010ADA0)
    /* A3B24 801A3B24 C420ADA0 */  lwc1       $fv0, %lo(D_8010ADA0)($at)
    /* A3B28 801A3B28 3C018011 */  lui        $at, %hi(D_8010ADA4)
    /* A3B2C 801A3B2C C422ADA4 */  lwc1       $fv1, %lo(D_8010ADA4)($at)
    /* A3B30 801A3B30 3C01801F */  lui        $at, %hi(D_801ED680)
    /* A3B34 801A3B34 C424D680 */  lwc1       $ft0, %lo(D_801ED680)($at)
    ...
    /* A3B44 801A3B44 E4200054 */  swc1       $fv0, %lo(D_80290054)($at)
    /* A3B48 801A3B48 3C018029 */  lui        $at, %hi(D_80290058)
    /* A3B4C 801A3B4C E4220058 */  swc1       $fv1, %lo(D_80290058)($at)
    /* A3B50 801A3B50 3C018029 */  lui        $at, %hi(D_8029005C)
    /* A3B54 801A3B54 E420005C */  swc1       $fv0, %lo(D_8029005C)($at)
    /* A3B58 801A3B58 3C018029 */  lui        $at, %hi(D_802900E4)
    /* A3B5C 801A3B5C E42400E4 */  swc1       $ft0, %lo(D_802900E4)($at)
  ...
  .L801A3B68:
    ...
    /* A3B7C 801A3B7C C420ADA8 */  lwc1       $fv0, %lo(D_8010ADA8)($at)
    ...
    /* A3B94 801A3B94 E6600084 */  swc1       $fv0, 0x84($s3)
    /* A3B98 801A3B98 E6600078 */  swc1       $fv0, 0x78($s3)
  ...
  .L801A3BC8:
    ...
    /* A3BE0 801A3BE0 C424ADAC */  lwc1       $ft0, %lo(D_8010ADAC)($at)
    /* A3BE4 801A3BE4 AFA00028 */  sw         $zero, 0x28($sp)
    /* A3BE8 801A3BE8 C7A20028 */  lwc1       $fv1, 0x28($sp)
    /* A3BEC 801A3BEC AFA00030 */  sw         $zero, 0x30($sp)
    /* A3BF0 801A3BF0 E7A4002C */  swc1       $ft0, 0x2C($sp)
    /* A3BF4 801A3BF4 C6600058 */  lwc1       $fv0, 0x58($s3)
    /* A3BF8 801A3BF8 46020000 */  add.s      $fv0, $fv0, $fv1
    /* A3BFC 801A3BFC E7A00028 */  swc1       $fv0, 0x28($sp)
    /* A3C00 801A3C00 C660005C */  lwc1       $fv0, 0x5C($s3)
    /* A3C04 801A3C04 46040000 */  add.s      $fv0, $fv0, $ft0
    /* A3C08 801A3C08 E7A0002C */  swc1       $fv0, 0x2C($sp)
    /* A3C0C 801A3C0C C6600060 */  lwc1       $fv0, 0x60($s3)
    /* A3C10 801A3C10 46020000 */  add.s      $fv0, $fv0, $fv1
    /* A3C14 801A3C14 02602021 */  addu       $a0, $s3, $zero
    /* A3C18 801A3C18 27A50028 */  addiu      $a1, $sp, 0x28
    /* A3C1C 801A3C1C 0C0697B7 */  jal        func_801A5EDC
    /* A3C20 801A3C20 E7A00030 */   swc1      $fv0, 0x30($sp)
    ...
    /* A3C4C 801A3C4C C420ADB0 */  lwc1       $fv0, %lo(D_8010ADB0)($at)
    ...
    /* A3C5C 801A3C5C E7A00010 */   swc1      $fv0, 0x10($sp)
  .L801A3C60:
  ...
  .L801A3D10:
    ...
    /* A3D40 801A3D40 C66C0078 */  lwc1       $fa0, 0x78($s3)
    /* A3D44 801A3D44 3C01801F */  lui        $at, %hi(D_801F0204)
    /* A3D48 801A3D48 C4200204 */  lwc1       $fv0, %lo(D_801F0204)($at)
    /* A3D4C 801A3D4C 46006301 */  sub.s      $fa0, $fa0, $fv0
    /* A3D50 801A3D50 3C018011 */  lui        $at, %hi(D_8010ADB0 + 0x4)
    /* A3D54 801A3D54 C435ADB4 */  lwc1       $fs0f, %lo(D_8010ADB0 + 0x4)($at)
    /* A3D58 801A3D58 C434ADB8 */  lwc1       $fs0, %lo(D_8010ADB8)($at)
    /* A3D5C 801A3D5C 46006321 */  cvt.d.s    $fa0, $fa0
    /* A3D60 801A3D60 46346301 */  sub.d      $fa0, $fa0, $fs0
    /* A3D64 801A3D64 0C0525B2 */  jal        func_801496C8
    /* A3D68 801A3D68 46206320 */   cvt.s.d   $fa0, $fa0
    /* A3D6C 801A3D6C C676007C */  lwc1       $fs1, 0x7C($s3)
    /* A3D70 801A3D70 8E630028 */  lw         $v1, 0x28($s3)
    /* A3D74 801A3D74 3C018011 */  lui        $at, %hi(D_8010ADBC)
    /* A3D78 801A3D78 C424ADBC */  lwc1       $ft0, %lo(D_8010ADBC)($at)
    /* A3D7C 801A3D7C 02602021 */  addu       $a0, $s3, $zero
    /* A3D80 801A3D80 44801000 */  mtc1       $zero, $fv1
    /* A3D84 801A3D84 2402BFFF */  addiu      $v0, $zero, -0x4001
    /* A3D88 801A3D88 E6600078 */  swc1       $fv0, 0x78($s3)
    /* A3D8C 801A3D8C E6620060 */  swc1       $fv1, 0x60($s3)
    /* A3D90 801A3D90 E662005C */  swc1       $fv1, 0x5C($s3)
    /* A3D94 801A3D94 E6620058 */  swc1       $fv1, 0x58($s3)
    /* A3D98 801A3D98 E662007C */  swc1       $fv1, 0x7C($s3)
    /* A3D9C 801A3D9C E6620088 */  swc1       $fv1, 0x88($s3)
    /* A3DA0 801A3DA0 44052000 */  mfc1       $a1, $ft0
    ...
    /* A3DB4 801A3DB4 C66C0078 */  lwc1       $fa0, 0x78($s3)
    /* A3DB8 801A3DB8 8E620028 */  lw         $v0, 0x28($s3)
    /* A3DBC 801A3DBC 46006321 */  cvt.d.s    $fa0, $fa0
    /* A3DC0 801A3DC0 46346300 */  add.d      $fa0, $fa0, $fs0
    /* A3DC4 801A3DC4 34424000 */  ori        $v0, $v0, 0x4000
    /* A3DC8 801A3DC8 AE620028 */  sw         $v0, 0x28($s3)
    /* A3DCC 801A3DCC 0C0525B2 */  jal        func_801496C8
    /* A3DD0 801A3DD0 46206320 */   cvt.s.d   $fa0, $fa0
    /* A3DD4 801A3DD4 3C01801F */  lui        $at, %hi(D_801F0204)
    /* A3DD8 801A3DD8 C42C0204 */  lwc1       $fa0, %lo(D_801F0204)($at)
    /* A3DDC 801A3DDC 460C6300 */  add.s      $fa0, $fa0, $fa0
    /* A3DE0 801A3DE0 460CB300 */  add.s      $fa0, $fs1, $fa0
    /* A3DE4 801A3DE4 0C0525B2 */  jal        func_801496C8
    /* A3DE8 801A3DE8 E6600078 */   swc1      $fv0, 0x78($s3)
    /* A3DEC 801A3DEC 2664009C */  addiu      $a0, $s3, 0x9C
    /* A3DF0 801A3DF0 26650078 */  addiu      $a1, $s3, 0x78
    /* A3DF4 801A3DF4 E660007C */  swc1       $fv0, 0x7C($s3)
    /* A3DF8 801A3DF8 0C0570D4 */  jal        func_8015C350
    /* A3DFC 801A3DFC E6600088 */   swc1      $fv0, 0x88($s3)
  ...
  .L801A3E50:
    ...
    /* A3E70 801A3E70 C6620038 */  lwc1       $fv1, 0x38($s3)
    /* A3E74 801A3E74 3C018011 */  lui        $at, %hi(D_8010ADC0)
    /* A3E78 801A3E78 C420ADC0 */  lwc1       $fv0, %lo(D_8010ADC0)($at)
    /* A3E7C 801A3E7C 4602003C */  c.lt.s     $fv0, $fv1
  ...
  .L801A3F60:
    ...
    /* A3F70 801A3F70 C4620000 */  lwc1       $fv1, 0x0($v1)
    /* A3F74 801A3F74 2442FFF6 */  addiu      $v0, $v0, -0xA
    /* A3F78 801A3F78 44820000 */  mtc1       $v0, $fv0
    /* A3F7C 801A3F7C 46800020 */  cvt.s.w    $fv0, $fv0
    /* A3F80 801A3F80 46001080 */  add.s      $fv1, $fv1, $fv0
    /* A3F84 801A3F84 24040015 */  addiu      $a0, $zero, 0x15
    /* A3F88 801A3F88 0C051C00 */  jal        func_80147000
    /* A3F8C 801A3F8C E4620000 */   swc1      $fv1, 0x0($v1)
    /* A3F90 801A3F90 3C01802A */  lui        $at, %hi(D_80299720)
    /* A3F94 801A3F94 C4229720 */  lwc1       $fv1, %lo(D_80299720)($at)
    /* A3F98 801A3F98 2442FFF6 */  addiu      $v0, $v0, -0xA
    /* A3F9C 801A3F9C 44820000 */  mtc1       $v0, $fv0
    /* A3FA0 801A3FA0 46800020 */  cvt.s.w    $fv0, $fv0
    /* A3FA4 801A3FA4 46001080 */  add.s      $fv1, $fv1, $fv0
    /* A3FA8 801A3FA8 3C01802A */  lui        $at, %hi(D_80299720)
    /* A3FAC 801A3FAC E4229720 */  swc1       $fv1, %lo(D_80299720)($at)
    ...
    /* A3FBC 801A3FBC C4209724 */  lwc1       $fv0, %lo(D_80299724)($at)
    /* A3FC0 801A3FC0 2442FFF6 */  addiu      $v0, $v0, -0xA
    /* A3FC4 801A3FC4 44821000 */  mtc1       $v0, $fv1
    /* A3FC8 801A3FC8 468010A0 */  cvt.s.w    $fv1, $fv1
    /* A3FCC 801A3FCC 46020000 */  add.s      $fv0, $fv0, $fv1
    /* A3FD0 801A3FD0 3C01802A */  lui        $at, %hi(D_80299724)
    /* A3FD4 801A3FD4 E4209724 */  swc1       $fv0, %lo(D_80299724)($at)
  .L801A3FD8:
  ...
  .L801A4040:
    ...
    /* A4060 801A4060 C6620038 */  lwc1       $fv1, 0x38($s3)
    /* A4064 801A4064 3C018011 */  lui        $at, %hi(D_8010ADC4)
    /* A4068 801A4068 C420ADC4 */  lwc1       $fv0, %lo(D_8010ADC4)($at)
    /* A406C 801A406C 4602003C */  c.lt.s     $fv0, $fv1
  ...
  .L801A4094:
    /* A4094 801A4094 C6620038 */  lwc1       $fv1, 0x38($s3)
  .L801A4098:
    /* A4098 801A4098 3C018011 */  lui        $at, %hi(D_8010ADC8)
    /* A409C 801A409C C420ADC8 */  lwc1       $fv0, %lo(D_8010ADC8)($at)
    /* A40A0 801A40A0 4602003C */  c.lt.s     $fv0, $fv1
  ...
  .L801A40C0:
    ...
    /* A40E4 801A40E4 C4600000 */  lwc1       $fv0, 0x0($v1)
    /* A40E8 801A40E8 C4420000 */  lwc1       $fv1, 0x0($v0)
    /* A40EC 801A40EC 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A40F0 801A40F0 E7A00028 */  swc1       $fv0, 0x28($sp)
