...
glabel func_8015C4C8
    ...
    /* 5C4F0 8015C4F0 C7BD01F8 */  lwc1       $fs4f, 0x1F8($sp)
    /* 5C4F4 8015C4F4 C7BC01FC */  lwc1       $fs4, 0x1FC($sp)
    /* 5C4F8 8015C4F8 C7BB01F0 */  lwc1       $fs3f, 0x1F0($sp)
    /* 5C4FC 8015C4FC C7BA01F4 */  lwc1       $fs3, 0x1F4($sp)
    /* 5C500 8015C500 C7B901E8 */  lwc1       $fs2f, 0x1E8($sp)
    /* 5C504 8015C504 C7B801EC */  lwc1       $fs2, 0x1EC($sp)
    /* 5C508 8015C508 C7B701E0 */  lwc1       $fs1f, 0x1E0($sp)
    /* 5C50C 8015C50C C7B601E4 */  lwc1       $fs1, 0x1E4($sp)
    /* 5C510 8015C510 C7B501D8 */  lwc1       $fs0f, 0x1D8($sp)
    /* 5C514 8015C514 C7B401DC */  lwc1       $fs0, 0x1DC($sp)
    ...
    /* 5C528 8015C528 E7B50060 */  swc1       $fs0f, 0x60($sp)
    /* 5C52C 8015C52C E7B40064 */  swc1       $fs0, 0x64($sp)
    /* 5C530 8015C530 3C018010 */  lui        $at, %hi(D_80107160)
    /* 5C534 8015C534 C4347160 */  lwc1       $fs0, %lo(D_80107160)($at)
    ...
    /* 5C560 8015C560 E7B70068 */  swc1       $fs1f, 0x68($sp)
    /* 5C564 8015C564 E7B6006C */  swc1       $fs1, 0x6C($sp)
