nonmatching func_8017A3DC, 0x138

glabel func_8017A3DC
    ...
    /* 7A414 8017A414 C4238754 */  lwc1       $f3, %lo(D_80108750 + 0x4)($at)
    /* 7A418 8017A418 C4228758 */  lwc1       $f2, %lo(D_80108758)($at)
    /* 7A41C 8017A41C 44830000 */  mtc1       $v1, $f0
    /* 7A420 8017A420 46800020 */  cvt.s.w    $f0, $f0
    /* 7A424 8017A424 46000021 */  cvt.d.s    $f0, $f0
    /* 7A428 8017A428 46220003 */  div.d      $f0, $f0, $f2
    /* 7A42C 8017A42C 00408021 */  addu       $s0, $v0, $zero
    /* 7A430 8017A430 46200020 */  cvt.s.d    $f0, $f0
    /* 7A434 8017A434 44050000 */  mfc1       $a1, $f0
  ...
  .L8017A4B0:
    ...
    /* 7A4B8 8017A4B8 C423875C */  lwc1       $f3, %lo(D_80108758 + 0x4)($at)
    /* 7A4BC 8017A4BC C4228760 */  lwc1       $f2, %lo(D_80108760)($at)
    /* 7A4C0 8017A4C0 44820000 */  mtc1       $v0, $f0
    /* 7A4C4 8017A4C4 46800020 */  cvt.s.w    $f0, $f0
    /* 7A4C8 8017A4C8 46000021 */  cvt.d.s    $f0, $f0
    /* 7A4CC 8017A4CC 46220002 */  mul.d      $f0, $f0, $f2
  ...
  .L8017A4DC:
    ...
    /* 7A4E8 8017A4E8 44821000 */  mtc1       $v0, $f2
    /* 7A4EC 8017A4EC 468010A0 */  cvt.s.w    $f2, $f2
    /* 7A4F0 8017A4F0 46200020 */  cvt.s.d    $f0, $f0
    /* 7A4F4 8017A4F4 46001080 */  add.s      $f2, $f2, $f0
    /* 7A4F8 8017A4F8 4600100D */  trunc.w.s  $f0, $f2
    /* 7A4FC 8017A4FC 44020000 */  mfc1       $v0, $f0
