...
glabel func_801A446C
    ...
    /* A4470 801A4470 E424A8B0 */  swc1       $ft0, %lo(D_801FA8B0)($at)
    /* A4474 801A4474 3C018020 */  lui        $at, %hi(D_801FA878)
    /* A4478 801A4478 E422A878 */  swc1       $fv1, %lo(D_801FA878)($at)
  ...
  .L801A44B0:
    ...
    /* A44C0 801A44C0 44820000 */  mtc1       $v0, $fv0
    /* A44C4 801A44C4 46800020 */  cvt.s.w    $fv0, $fv0
    /* A44C8 801A44C8 0C051C00 */  jal        func_80147000
    /* A44CC 801A44CC E7A00028 */   swc1      $fv0, 0x28($sp)
    /* A44D0 801A44D0 24040019 */  addiu      $a0, $zero, 0x19
    /* A44D4 801A44D4 2442FFF4 */  addiu      $v0, $v0, -0xC
    /* A44D8 801A44D8 44820000 */  mtc1       $v0, $fv0
    /* A44DC 801A44DC 46800020 */  cvt.s.w    $fv0, $fv0
    /* A44E0 801A44E0 0C051C00 */  jal        func_80147000
    /* A44E4 801A44E4 E7A0002C */   swc1      $fv0, 0x2C($sp)
    /* A44E8 801A44E8 C7A00028 */  lwc1       $fv0, 0x28($sp)
    /* A44EC 801A44EC 2442FFF4 */  addiu      $v0, $v0, -0xC
    /* A44F0 801A44F0 44822000 */  mtc1       $v0, $ft0
    /* A44F4 801A44F4 46802120 */  cvt.s.w    $ft0, $ft0
