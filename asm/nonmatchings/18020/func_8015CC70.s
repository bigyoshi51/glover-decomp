...
glabel func_8015CC70
    /* 5CC70 8015CC70 4604003C */  c.lt.s     $f0, $f4
    /* 5CC74 8015CC74 00000000 */  nop
    /* 5CC78 8015CC78 45020007 */  bc1fl      .L8015CC98
    /* 5CC7C 8015CC7C 46002007 */   neg.s     $f0, $f4
    /* 5CC80 8015CC80 46041032 */  c.eq.s     $f2, $f4
  ...
  .L8015CC98:
    /* 5CC98 8015CC98 46001032 */  c.eq.s     $f2, $f0
  ...
  .L8015CCB4:
    ...
    /* 5CCCC 8015CCCC C440001C */  lwc1       $f0, 0x1C($v0)
    /* 5CCD0 8015CCD0 C4420010 */  lwc1       $f2, 0x10($v0)
    /* 5CCD4 8015CCD4 92220075 */  lbu        $v0, 0x75($s1)
    /* 5CCD8 8015CCD8 46020001 */  sub.s      $f0, $f0, $f2
    /* 5CCDC 8015CCDC 00021080 */  sll        $v0, $v0, 2
    /* 5CCE0 8015CCE0 00511021 */  addu       $v0, $v0, $s1
    /* 5CCE4 8015CCE4 E6200064 */  swc1       $f0, 0x64($s1)
    /* 5CCE8 8015CCE8 C4400028 */  lwc1       $f0, 0x28($v0)
    /* 5CCEC 8015CCEC C4420010 */  lwc1       $f2, 0x10($v0)
    /* 5CCF0 8015CCF0 92220076 */  lbu        $v0, 0x76($s1)
    /* 5CCF4 8015CCF4 46020001 */  sub.s      $f0, $f0, $f2
    /* 5CCF8 8015CCF8 00021080 */  sll        $v0, $v0, 2
    /* 5CCFC 8015CCFC 00511021 */  addu       $v0, $v0, $s1
    /* 5CD00 8015CD00 E6200068 */  swc1       $f0, 0x68($s1)
    /* 5CD04 8015CD04 C440001C */  lwc1       $f0, 0x1C($v0)
    /* 5CD08 8015CD08 C4420010 */  lwc1       $f2, 0x10($v0)
    /* 5CD0C 8015CD0C 92220076 */  lbu        $v0, 0x76($s1)
    /* 5CD10 8015CD10 46020001 */  sub.s      $f0, $f0, $f2
    /* 5CD14 8015CD14 00021080 */  sll        $v0, $v0, 2
    /* 5CD18 8015CD18 00511021 */  addu       $v0, $v0, $s1
    /* 5CD1C 8015CD1C E620006C */  swc1       $f0, 0x6C($s1)
    /* 5CD20 8015CD20 C4420028 */  lwc1       $f2, 0x28($v0)
    /* 5CD24 8015CD24 C4400010 */  lwc1       $f0, 0x10($v0)
    /* 5CD28 8015CD28 46001081 */  sub.s      $f2, $f2, $f0
    ...
    /* 5CD38 8015CD38 E6220070 */  swc1       $f2, 0x70($s1)
