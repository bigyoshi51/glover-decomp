...
glabel func_801A02A0
    ...
    /* A02A8 801A02A8 C42CAB24 */  lwc1       $f12, %lo(D_8010AB24)($at)
    ...
    /* A02C0 801A02C0 C42CAB28 */  lwc1       $f12, %lo(D_8010AB28)($at)
  ...
  .L801A02E4:
    ...
    /* A0308 801A0308 C4209764 */  lwc1       $f0, %lo(D_80299764)($at)
    /* A030C 801A030C 8E4200DC */  lw         $v0, 0xDC($s2)
    /* A0310 801A0310 E640007C */  swc1       $f0, 0x7C($s2)
    /* A0314 801A0314 E6400088 */  swc1       $f0, 0x88($s2)
    ...
    /* A0328 801A0328 C440004C */  lwc1       $f0, 0x4C($v0)
    /* A032C 801A032C 08067E74 */  j          .L8019F9D0
    /* A0330 801A0330 E460004C */   swc1      $f0, 0x4C($v1)
  .L801A0334:
    ...
    /* A034C 801A034C C42CAB2C */  lwc1       $f12, %lo(D_8010AB2C)($at)
    ...
    /* A0364 801A0364 C42CAB30 */  lwc1       $f12, %lo(D_8010AB30)($at)
    ...
    /* A037C 801A037C C42CAB34 */  lwc1       $f12, %lo(D_8010AB34)($at)
    ...
    /* A0394 801A0394 C42CAB38 */  lwc1       $f12, %lo(D_8010AB38)($at)
  ...
  .L801A03B8:
    ...
    /* A03D0 801A03D0 C434AB3C */  lwc1       $f20, %lo(D_8010AB3C)($at)
    /* A03D4 801A03D4 C4400028 */  lwc1       $f0, 0x28($v0)
    /* A03D8 801A03D8 46140002 */  mul.s      $f0, $f0, $f20
    /* A03DC 801A03DC 24050002 */  addiu      $a1, $zero, 0x2
    /* A03E0 801A03E0 0C05808A */  jal        func_80160228
    /* A03E4 801A03E4 E4400028 */   swc1      $f0, 0x28($v0)
    /* A03E8 801A03E8 8E4200D0 */  lw         $v0, 0xD0($s2)
  .L801A03EC:
    /* A03EC 801A03EC C4400028 */  lwc1       $f0, 0x28($v0)
    /* A03F0 801A03F0 46140003 */  div.s      $f0, $f0, $f20
    /* A03F4 801A03F4 E4400028 */  swc1       $f0, 0x28($v0)
    ...
    /* A042C 801A042C C420AB40 */  lwc1       $f0, %lo(D_8010AB40)($at)
    /* A0430 801A0430 8E4200D8 */  lw         $v0, 0xD8($s2)
    /* A0434 801A0434 3C018011 */  lui        $at, %hi(D_8010AB44)
    /* A0438 801A0438 C422AB44 */  lwc1       $f2, %lo(D_8010AB44)($at)
    /* A043C 801A043C E640005C */  swc1       $f0, 0x5C($s2)
    /* A0440 801A0440 C4400074 */  lwc1       $f0, 0x74($v0)
