nonmatching func_801AA5BC, 0x318
...
glabel func_801AA5BC
  ...
  .L801AA660:
    ...
    /* AA68C 801AA68C C7B70060 */  lwc1       $fs1f, 0x60($sp)
    /* AA690 801AA690 C7B60064 */  lwc1       $fs1, 0x64($sp)
    /* AA694 801AA694 C7B50058 */  lwc1       $fs0f, 0x58($sp)
    /* AA698 801AA698 C7B4005C */  lwc1       $fs0, 0x5C($sp)
    ...
    /* AA6D0 801AA6D0 E7B70078 */  swc1       $fs1f, 0x78($sp)
    /* AA6D4 801AA6D4 E7B6007C */  swc1       $fs1, 0x7C($sp)
    /* AA6D8 801AA6D8 E7B50070 */  swc1       $fs0f, 0x70($sp)
    /* AA6DC 801AA6DC E7B40074 */  swc1       $fs0, 0x74($sp)
    ...
    /* AA774 801AA774 C64600C4 */  lwc1       $ft1, 0xC4($s2)
    /* AA778 801AA778 3C018011 */  lui        $at, %hi(D_8010B284)
    /* AA77C 801AA77C C420B284 */  lwc1       $fv0, %lo(D_8010B284)($at)
    /* AA780 801AA780 46003182 */  mul.s      $ft1, $ft1, $fv0
    /* AA784 801AA784 C64400C8 */  lwc1       $ft0, 0xC8($s2)
    /* AA788 801AA788 46002102 */  mul.s      $ft0, $ft0, $fv0
    /* AA78C 801AA78C C64200CC */  lwc1       $fv1, 0xCC($s2)
    /* AA790 801AA790 46001082 */  mul.s      $fv1, $fv1, $fv0
    ...
    /* AA7A4 801AA7A4 E64600C4 */  swc1       $ft1, 0xC4($s2)
    /* AA7A8 801AA7A8 E64400C8 */  swc1       $ft0, 0xC8($s2)
    /* AA7AC 801AA7AC 0C05250A */  jal        func_80149428
    /* AA7B0 801AA7B0 E64200CC */   swc1      $fv1, 0xCC($s2)
    ...
    /* AA7E4 801AA7E4 C420B288 */  lwc1       $fv0, %lo(D_8010B288)($at)
    /* AA7E8 801AA7E8 E6400064 */  swc1       $fv0, 0x64($s2)
    /* AA7EC 801AA7EC C7A20018 */  lwc1       $fv1, 0x18($sp)
    /* AA7F0 801AA7F0 44800000 */  mtc1       $zero, $fv0
    /* AA7F4 801AA7F4 4602003C */  c.lt.s     $fv0, $fv1
    ...
    /* AA808 801AA808 C420B28C */  lwc1       $fv0, %lo(D_8010B28C)($at)
    /* AA80C 801AA80C 0806A608 */  j          .L801A9820
    /* AA810 801AA810 46001000 */   add.s     $fv0, $fv1, $fv0
  .L801AA814:
    /* AA814 801AA814 3C018011 */  lui        $at, %hi(D_8010B290)
    /* AA818 801AA818 C420B290 */  lwc1       $fv0, %lo(D_8010B290)($at)
    /* AA81C 801AA81C 46001001 */  sub.s      $fv0, $fv1, $fv0
    /* AA820 801AA820 E7A00018 */  swc1       $fv0, 0x18($sp)
  ...
  .L801AA82C:
    ...
    /* AA834 801AA834 C7AC0018 */  lwc1       $fa0, 0x18($sp)
    /* AA838 801AA838 C7AE0020 */  lwc1       $fa1, 0x20($sp)
    ...
    /* AA848 801AA848 46000306 */   mov.s     $fa0, $fv0
    ...
    /* AA860 801AA860 E6000000 */   swc1      $fv0, 0x0($s0)
    /* AA864 801AA864 C60C0000 */  lwc1       $fa0, 0x0($s0)
    /* AA868 801AA868 3C018011 */  lui        $at, %hi(D_8010B290 + 0x4)
    /* AA86C 801AA86C C421B294 */  lwc1       $fv0f, %lo(D_8010B290 + 0x4)($at)
    /* AA870 801AA870 C420B298 */  lwc1       $fv0, %lo(D_8010B298)($at)
    /* AA874 801AA874 46006321 */  cvt.d.s    $fa0, $fa0
    /* AA878 801AA878 46206300 */  add.d      $fa0, $fa0, $fv0
    /* AA87C 801AA87C 0C0525B2 */  jal        func_801496C8
    /* AA880 801AA880 46206320 */   cvt.s.d   $fa0, $fa0
    /* AA884 801AA884 26440060 */  addiu      $a0, $s2, 0x60
    /* AA888 801AA888 44060000 */  mfc1       $a2, $fv0
    ...
    /* AA89C 801AA89C C4201760 */  lwc1       $fv0, %lo(D_801F1760)($at)
    /* AA8A0 801AA8A0 8E4200D8 */  lw         $v0, 0xD8($s2)
    /* AA8A4 801AA8A4 3C018011 */  lui        $at, %hi(D_8010B29C)
    /* AA8A8 801AA8A8 C422B29C */  lwc1       $fv1, %lo(D_8010B29C)($at)
    /* AA8AC 801AA8AC E6400038 */  swc1       $fv0, 0x38($s2)
    /* AA8B0 801AA8B0 C7A00018 */  lwc1       $fv0, 0x18($sp)
    /* AA8B4 801AA8B4 AE4000B8 */  sw         $zero, 0xB8($s2)
    /* AA8B8 801AA8B8 E64000B4 */  swc1       $fv0, 0xB4($s2)
    /* AA8BC 801AA8BC C7A40020 */  lwc1       $ft0, 0x20($sp)
    /* AA8C0 801AA8C0 3C018011 */  lui        $at, %hi(D_8010B2A0)
    /* AA8C4 801AA8C4 C420B2A0 */  lwc1       $fv0, %lo(D_8010B2A0)($at)
    /* AA8C8 801AA8C8 E64000C0 */  swc1       $fv0, 0xC0($s2)
    /* AA8CC 801AA8CC E64400BC */  swc1       $ft0, 0xBC($s2)
    /* AA8D0 801AA8D0 E442001C */  swc1       $fv1, 0x1C($v0)
