nonmatching func_8011CB3C, 0x1B4

glabel func_8011CB3C
    ...
    /* 1CB8C 8011CB8C C42CF914 */  lwc1       $f12, %lo(D_8028F914)($at)
    /* 1CB90 8011CB90 3C018029 */  lui        $at, %hi(D_8028F918)
    /* 1CB94 8011CB94 C42EF918 */  lwc1       $f14, %lo(D_8028F918)($at)
  ...
  .L8011CBBC:
    ...
    /* 1CC14 8011CC14 C42CF914 */  lwc1       $f12, %lo(D_8028F914)($at)
    /* 1CC18 8011CC18 3C018029 */  lui        $at, %hi(D_8028F918)
    /* 1CC1C 8011CC1C C42EF918 */  lwc1       $f14, %lo(D_8028F918)($at)
  ...
  .L8011CC3C:
    ...
    /* 1CC54 8011CC54 C4400000 */  lwc1       $f0, 0x0($v0)
    /* 1CC58 8011CC58 3C018010 */  lui        $at, %hi(D_80100D30)
    /* 1CC5C 8011CC5C C4230D30 */  lwc1       $f3, %lo(D_80100D30)($at)
    /* 1CC60 8011CC60 C4220D34 */  lwc1       $f2, %lo(D_80100D30 + 0x4)($at)
    /* 1CC64 8011CC64 46000021 */  cvt.d.s    $f0, $f0
    /* 1CC68 8011CC68 46220000 */  add.d      $f0, $f0, $f2
    /* 1CC6C 8011CC6C 46200020 */  cvt.s.d    $f0, $f0
    /* 1CC70 8011CC70 E4400000 */  swc1       $f0, 0x0($v0)
  .L8011CC74:
    /* 1CC74 8011CC74 0C046F2E */  jal        func_8011BCB8
    /* 1CC78 8011CC78 00000000 */   nop
    /* 1CC7C 8011CC7C 3C01802A */  lui        $at, %hi(D_8029F9B4)
    /* 1CC80 8011CC80 C422F9B4 */  lwc1       $f2, %lo(D_8029F9B4)($at)
    /* 1CC84 8011CC84 3C018010 */  lui        $at, %hi(D_80100D38)
    /* 1CC88 8011CC88 C4200D38 */  lwc1       $f0, %lo(D_80100D38)($at)
    /* 1CC8C 8011CC8C 4602003C */  c.lt.s     $f0, $f2
  ...
  .L8011CCA8:
    ...
    /* 1CCC4 8011CCC4 44800000 */  mtc1       $zero, $f0
    ...
    /* 1CCDC 8011CCDC E420039C */  swc1       $f0, %lo(D_8029039C)($at)
    /* 1CCE0 8011CCE0 3C018029 */  lui        $at, %hi(D_80290398)
    /* 1CCE4 8011CCE4 E4200398 */  swc1       $f0, %lo(D_80290398)($at)
    /* 1CCE8 8011CCE8 3C018029 */  lui        $at, %hi(D_80290394)
    /* 1CCEC 8011CCEC E4200394 */  swc1       $f0, %lo(D_80290394)($at)
endlabel func_8011CB3C
