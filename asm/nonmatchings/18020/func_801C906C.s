...
glabel func_801C906C
  ...
  .L801C90BC:
    ...
    /* C90D0 801C90D0 D434C460 */  ldc1       $f20, %lo(D_8010C460)($at)
  ...
  .L801C9120:
    ...
    /* C918C 801C918C 44811000 */  mtc1       $at, $f2
    /* C9190 801C9190 00521021 */  addu       $v0, $v0, $s2
    /* C9194 801C9194 C4400000 */  lwc1       $f0, 0x0($v0)
    /* C9198 801C9198 46800020 */  cvt.s.w    $f0, $f0
    /* C919C 801C919C 46020003 */  div.s      $f0, $f0, $f2
    /* C91A0 801C91A0 46000021 */  cvt.d.s    $f0, $f0
    /* C91A4 801C91A4 46200000 */  add.d      $f0, $f0, $f0
    /* C91A8 801C91A8 C6C20018 */  lwc1       $f2, 0x18($s6)
    /* C91AC 801C91AC 468010A1 */  cvt.d.w    $f2, $f2
    /* C91B0 801C91B0 46220003 */  div.d      $f0, $f0, $f2
    ...
    /* C91D8 801C91D8 D422C468 */  ldc1       $f2, %lo(D_8010C468)($at)
    /* C91DC 801C91DC 44842000 */  mtc1       $a0, $f4
    /* C91E0 801C91E0 00000000 */  nop
    /* C91E4 801C91E4 46802121 */  cvt.d.w    $f4, $f4
    /* C91E8 801C91E8 46200020 */  cvt.s.d    $f0, $f0
    /* C91EC 801C91EC E6000010 */  swc1       $f0, 0x10($s0)
  alabel D_801C91F0
    /* C91F0 801C91F0 C4400000 */  lwc1       $f0, 0x0($v0)
    /* C91F4 801C91F4 46800020 */  cvt.s.w    $f0, $f0
    /* C91F8 801C91F8 46000021 */  cvt.d.s    $f0, $f0
    /* C91FC 801C91FC 04810004 */  bgez       $a0, .L801C9210
    /* C9200 801C9200 46220083 */   div.d     $f2, $f0, $f2
    /* C9204 801C9204 3C018011 */  lui        $at, %hi(D_8010C470)
    /* C9208 801C9208 D420C470 */  ldc1       $f0, %lo(D_8010C470)($at)
    /* C920C 801C920C 46202100 */  add.d      $f4, $f4, $f0
  .L801C9210:
    /* C9210 801C9210 00002021 */  addu       $a0, $zero, $zero
    /* C9214 801C9214 46241002 */  mul.d      $f0, $f2, $f4
    /* C9218 801C9218 00002821 */  addu       $a1, $zero, $zero
    /* C921C 801C921C 3C013F80 */  lui        $at, (0x3F800000 >> 16)
    /* C9220 801C9220 44811000 */  mtc1       $at, $f2
    ...
    /* C9234 801C9234 E6020014 */  swc1       $f2, 0x14($s0)
    /* C9238 801C9238 46200020 */  cvt.s.d    $f0, $f0
    /* C923C 801C923C E600001C */  swc1       $f0, 0x1C($s0)
