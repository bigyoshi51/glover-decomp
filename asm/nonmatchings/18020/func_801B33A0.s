...
glabel func_801B33A0
    ...
    /* B33A8 801B33A8 4600203C */  c.lt.s     $f4, $f0
  ...
  .L801B33C0:
    /* B33C0 801B33C0 4600103C */  c.lt.s     $f2, $f0
    ...
    /* B33D4 801B33D4 C420F434 */  lwc1       $f0, %lo(D_8029F434)($at)
    /* B33D8 801B33D8 3C01802A */  lui        $at, %hi(D_8029F430)
    /* B33DC 801B33DC C424F430 */  lwc1       $f4, %lo(D_8029F430)($at)
    /* B33E0 801B33E0 46040001 */  sub.s      $f0, $f0, $f4
    /* B33E4 801B33E4 3C018011 */  lui        $at, %hi(D_8010B9B0)
    /* B33E8 801B33E8 C422B9B0 */  lwc1       $f2, %lo(D_8010B9B0)($at)
    /* B33EC 801B33EC 46020183 */  div.s      $f6, $f0, $f2
    /* B33F0 801B33F0 3C01801F */  lui        $at, %hi(D_801F1AF4)
    /* B33F4 801B33F4 C4221AF4 */  lwc1       $f2, %lo(D_801F1AF4)($at)
    /* B33F8 801B33F8 46001007 */  neg.s      $f0, $f2
    /* B33FC 801B33FC 4600303C */  c.lt.s     $f6, $f0
