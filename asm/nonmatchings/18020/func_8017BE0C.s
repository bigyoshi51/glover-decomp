nonmatching func_8017BE0C, 0x36C

glabel func_8017BE0C
  ...
  .L8017BE64:
    /* 7BE64 8017BE64 C48200B4 */  lwc1       $f2, 0xB4($a0)
    /* 7BE68 8017BE68 C48000C0 */  lwc1       $f0, 0xC0($a0)
    /* 7BE6C 8017BE6C 46001081 */  sub.s      $f2, $f2, $f0
    /* 7BE70 8017BE70 C46000B4 */  lwc1       $f0, 0xB4($v1)
    /* 7BE74 8017BE74 46020000 */  add.s      $f0, $f0, $f2
    /* 7BE78 8017BE78 24840004 */  addiu      $a0, $a0, 0x4
    /* 7BE7C 8017BE7C 26100001 */  addiu      $s0, $s0, 0x1
    /* 7BE80 8017BE80 2A020003 */  slti       $v0, $s0, 0x3
    /* 7BE84 8017BE84 E46000B4 */  swc1       $f0, 0xB4($v1)
  ...
  .L8017BF20:
    ...
    /* 7BF34 8017BF34 C442003C */  lwc1       $f2, 0x3C($v0)
    /* 7BF38 8017BF38 C4400048 */  lwc1       $f0, 0x48($v0)
    /* 7BF3C 8017BF3C 46001081 */  sub.s      $f2, $f2, $f0
    /* 7BF40 8017BF40 44802000 */  mtc1       $zero, $f4
    /* 7BF44 8017BF44 46041032 */  c.eq.s     $f2, $f4
    /* 7BF48 8017BF48 00000000 */  nop
    /* 7BF4C 8017BF4C 45010006 */  bc1t       .L8017BF68
    /* 7BF50 8017BF50 264400D8 */   addiu     $a0, $s2, 0xD8
    /* 7BF54 8017BF54 44061000 */  mfc1       $a2, $f2
  ...
  .L8017BF68:
    /* 7BF68 8017BF68 C4420038 */  lwc1       $f2, 0x38($v0)
    /* 7BF6C 8017BF6C C4400044 */  lwc1       $f0, 0x44($v0)
    /* 7BF70 8017BF70 46001081 */  sub.s      $f2, $f2, $f0
    /* 7BF74 8017BF74 46041032 */  c.eq.s     $f2, $f4
    /* 7BF78 8017BF78 00000000 */  nop
    /* 7BF7C 8017BF7C 45010004 */  bc1t       .L8017BF90
    /* 7BF80 8017BF80 00802821 */   addu      $a1, $a0, $zero
    /* 7BF84 8017BF84 44061000 */  mfc1       $a2, $f2
    /* 7BF88 8017BF88 0805EBEE */  j          .L8017AFB8
    /* 7BF8C 8017BF8C 00003821 */   addu      $a3, $zero, $zero
  .L8017BF90:
    /* 7BF90 8017BF90 C4420040 */  lwc1       $f2, 0x40($v0)
    /* 7BF94 8017BF94 C440004C */  lwc1       $f0, 0x4C($v0)
    /* 7BF98 8017BF98 46001081 */  sub.s      $f2, $f2, $f0
    /* 7BF9C 8017BF9C 46041032 */  c.eq.s     $f2, $f4
    ...
    /* 7BFB0 8017BFB0 44061000 */  mfc1       $a2, $f2
  ...
  .L8017BFC8:
    ...
    /* 7BFE8 8017BFE8 C4400038 */  lwc1       $f0, 0x38($v0)
    /* 7BFEC 8017BFEC C4420044 */  lwc1       $f2, 0x44($v0)
    /* 7BFF0 8017BFF0 46020032 */  c.eq.s     $f0, $f2
    ...
    /* 7C008 8017C008 C44C0038 */  lwc1       $f12, 0x38($v0)
    /* 7C00C 8017C00C 46006300 */  add.s      $f12, $f12, $f0
    /* 7C010 8017C010 0C0525B2 */  jal        func_801496C8
    /* 7C014 8017C014 46026301 */   sub.s     $f12, $f12, $f2
    /* 7C018 8017C018 8E42002C */  lw         $v0, 0x2C($s2)
    /* 7C01C 8017C01C 02221021 */  addu       $v0, $s1, $v0
    /* 7C020 8017C020 E4400038 */  swc1       $f0, 0x38($v0)
    ...
    /* 7C034 8017C034 C4420038 */  lwc1       $f2, 0x38($v0)
    /* 7C038 8017C038 C4600038 */  lwc1       $f0, 0x38($v1)
    /* 7C03C 8017C03C 46001080 */  add.s      $f2, $f2, $f0
    /* 7C040 8017C040 C46C0044 */  lwc1       $f12, 0x44($v1)
    /* 7C044 8017C044 0C0525B2 */  jal        func_801496C8
    /* 7C048 8017C048 460C1301 */   sub.s     $f12, $f2, $f12
    /* 7C04C 8017C04C 8E42002C */  lw         $v0, 0x2C($s2)
    /* 7C050 8017C050 02221021 */  addu       $v0, $s1, $v0
    /* 7C054 8017C054 E440005C */  swc1       $f0, 0x5C($v0)
  .L8017C058:
  ...
  .L8017C06C:
    ...
    /* 7C084 8017C084 C64000B4 */  lwc1       $f0, 0xB4($s2)
    /* 7C088 8017C088 C66200B4 */  lwc1       $f2, 0xB4($s3)
    /* 7C08C 8017C08C 46020001 */  sub.s      $f0, $f0, $f2
    /* 7C090 8017C090 E7A00010 */  swc1       $f0, 0x10($sp)
    /* 7C094 8017C094 C64000B8 */  lwc1       $f0, 0xB8($s2)
    /* 7C098 8017C098 C66200B8 */  lwc1       $f2, 0xB8($s3)
    /* 7C09C 8017C09C 46020001 */  sub.s      $f0, $f0, $f2
    /* 7C0A0 8017C0A0 E7A00014 */  swc1       $f0, 0x14($sp)
    /* 7C0A4 8017C0A4 C64000BC */  lwc1       $f0, 0xBC($s2)
    /* 7C0A8 8017C0A8 C66200BC */  lwc1       $f2, 0xBC($s3)
    /* 7C0AC 8017C0AC 46020001 */  sub.s      $f0, $f0, $f2
    /* 7C0B0 8017C0B0 E7A00018 */  swc1       $f0, 0x18($sp)
    /* 7C0B4 8017C0B4 8E62002C */  lw         $v0, 0x2C($s3)
    /* 7C0B8 8017C0B8 02221021 */  addu       $v0, $s1, $v0
    /* 7C0BC 8017C0BC C4420038 */  lwc1       $f2, 0x38($v0)
    /* 7C0C0 8017C0C0 C4400044 */  lwc1       $f0, 0x44($v0)
    /* 7C0C4 8017C0C4 27A40010 */  addiu      $a0, $sp, 0x10
    /* 7C0C8 8017C0C8 46001081 */  sub.s      $f2, $f2, $f0
    /* 7C0CC 8017C0CC 00802821 */  addu       $a1, $a0, $zero
    /* 7C0D0 8017C0D0 00141600 */  sll        $v0, $s4, 24
    /* 7C0D4 8017C0D4 00028603 */  sra        $s0, $v0, 24
    /* 7C0D8 8017C0D8 44061000 */  mfc1       $a2, $f2
    /* 7C0DC 8017C0DC 0C052457 */  jal        func_8014915C
    /* 7C0E0 8017C0E0 02003821 */   addu      $a3, $s0, $zero
    /* 7C0E4 8017C0E4 C66000B4 */  lwc1       $f0, 0xB4($s3)
    /* 7C0E8 8017C0E8 C7A20010 */  lwc1       $f2, 0x10($sp)
    /* 7C0EC 8017C0EC 46020000 */  add.s      $f0, $f0, $f2
    /* 7C0F0 8017C0F0 E64000B4 */  swc1       $f0, 0xB4($s2)
    /* 7C0F4 8017C0F4 C66000B8 */  lwc1       $f0, 0xB8($s3)
    /* 7C0F8 8017C0F8 C7A20014 */  lwc1       $f2, 0x14($sp)
    /* 7C0FC 8017C0FC 46020000 */  add.s      $f0, $f0, $f2
    /* 7C100 8017C100 E64000B8 */  swc1       $f0, 0xB8($s2)
    /* 7C104 8017C104 C66000BC */  lwc1       $f0, 0xBC($s3)
  .L8017C108:
    /* 7C108 8017C108 C7A20018 */  lwc1       $f2, 0x18($sp)
    /* 7C10C 8017C10C 46020000 */  add.s      $f0, $f0, $f2
    /* 7C110 8017C110 8E440038 */  lw         $a0, 0x38($s2)
    /* 7C114 8017C114 1080000E */  beqz       $a0, .L8017C150
    /* 7C118 8017C118 E64000BC */   swc1      $f0, 0xBC($s2)
