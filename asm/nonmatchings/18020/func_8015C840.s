...
glabel func_8015C840
    ...
    /* 5C85C 8015C85C C7B70068 */  lwc1       $f23, 0x68($sp)
    /* 5C860 8015C860 C7B6006C */  lwc1       $f22, 0x6C($sp)
    /* 5C864 8015C864 C7B50060 */  lwc1       $f21, 0x60($sp)
    /* 5C868 8015C868 C7B40064 */  lwc1       $f20, 0x64($sp)
    /* 5C86C 8015C86C 27BD0070 */  addiu      $sp, $sp, 0x70
    /* 5C870 8015C870 03E00008 */  jr         $ra
    /* 5C874 8015C874 00000000 */   nop
    /* 5C878 8015C878 C4A80004 */  lwc1       $f8, 0x4($a1)
    /* 5C87C 8015C87C 44807000 */  mtc1       $zero, $f14
    /* 5C880 8015C880 460E403E */  c.le.s     $f8, $f14
    /* 5C884 8015C884 44876000 */  mtc1       $a3, $f12
    /* 5C888 8015C888 45010074 */  bc1t       .L8015CA5C
    /* 5C88C 8015C88C 00000000 */   nop
    /* 5C890 8015C890 C4800000 */  lwc1       $f0, 0x0($a0)
    /* 5C894 8015C894 C4A20000 */  lwc1       $f2, 0x0($a1)
    /* 5C898 8015C898 46020002 */  mul.s      $f0, $f0, $f2
    /* 5C89C 8015C89C C48A0004 */  lwc1       $f10, 0x4($a0)
    /* 5C8A0 8015C8A0 46085182 */  mul.s      $f6, $f10, $f8
    /* 5C8A4 8015C8A4 C4A40008 */  lwc1       $f4, 0x8($a1)
    /* 5C8A8 8015C8A8 C4820008 */  lwc1       $f2, 0x8($a0)
    /* 5C8AC 8015C8AC 46041082 */  mul.s      $f2, $f2, $f4
    /* 5C8B0 8015C8B0 46060000 */  add.s      $f0, $f0, $f6
    /* 5C8B4 8015C8B4 46020000 */  add.s      $f0, $f0, $f2
    /* 5C8B8 8015C8B8 C4A2000C */  lwc1       $f2, 0xC($a1)
    /* 5C8BC 8015C8BC 46020400 */  add.s      $f16, $f0, $f2
    /* 5C8C0 8015C8C0 46088403 */  div.s      $f16, $f16, $f8
    /* 5C8C4 8015C8C4 4610703C */  c.lt.s     $f14, $f16
  ...
  .L8015C8D8:
    /* 5C8D8 8015C8D8 460C803C */  c.lt.s     $f16, $f12
  ...
  .L8015C8EC:
    ...
    /* 5C8F8 8015C8F8 46105001 */  sub.s      $f0, $f10, $f16
    /* 5C8FC 8015C8FC E4C00004 */  swc1       $f0, 0x4($a2)
    /* 5C900 8015C900 90A20075 */  lbu        $v0, 0x75($a1)
    /* 5C904 8015C904 C4AC0064 */  lwc1       $f12, 0x64($a1)
    ...
    /* 5C918 8015C918 C4840000 */  lwc1       $f4, 0x0($a0)
    /* 5C91C 8015C91C C4400010 */  lwc1       $f0, 0x10($v0)
