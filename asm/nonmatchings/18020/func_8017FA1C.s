...
glabel func_8017FA1C
    ...
    /* 7FA40 8017FA40 C426F9C8 */  lwc1       $f6, %lo(D_8028F9C8)($at)
    /* 7FA44 8017FA44 3C018011 */  lui        $at, %hi(D_801088C0)
    /* 7FA48 8017FA48 C42288C0 */  lwc1       $f2, %lo(D_801088C0)($at)
    /* 7FA4C 8017FA4C 46023183 */  div.s      $f6, $f6, $f2
    /* 7FA50 8017FA50 3C018029 */  lui        $at, %hi(D_8028FA04)
  .L8017FA54:
    /* 7FA54 8017FA54 C428FA04 */  lwc1       $f8, %lo(D_8028FA04)($at)
    /* 7FA58 8017FA58 3C018011 */  lui        $at, %hi(D_801088C0 + 0x4)
    /* 7FA5C 8017FA5C C42588C4 */  lwc1       $f5, %lo(D_801088C0 + 0x4)($at)
    /* 7FA60 8017FA60 C42488C8 */  lwc1       $f4, %lo(D_801088C8)($at)
    /* 7FA64 8017FA64 44801000 */  mtc1       $zero, $f2
    /* 7FA68 8017FA68 3C018029 */  lui        $at, %hi(D_8028F940)
    /* 7FA6C 8017FA6C E422F940 */  swc1       $f2, %lo(D_8028F940)($at)
    /* 7FA70 8017FA70 3C018029 */  lui        $at, %hi(D_8028F93C)
    /* 7FA74 8017FA74 E422F93C */  swc1       $f2, %lo(D_8028F93C)($at)
    /* 7FA78 8017FA78 46240002 */  mul.d      $f0, $f0, $f4
    /* 7FA7C 8017FA7C 46064200 */  add.s      $f8, $f8, $f6
    /* 7FA80 8017FA80 3C018029 */  lui        $at, %hi(D_8028F938)
    /* 7FA84 8017FA84 E422F938 */  swc1       $f2, %lo(D_8028F938)($at)
    /* 7FA88 8017FA88 3C018029 */  lui        $at, %hi(D_8028FB4C)
    /* 7FA8C 8017FA8C E422FB4C */  swc1       $f2, %lo(D_8028FB4C)($at)
    /* 7FA90 8017FA90 3C018029 */  lui        $at, %hi(D_8028FB44)
    /* 7FA94 8017FA94 E422FB44 */  swc1       $f2, %lo(D_8028FB44)($at)
    /* 7FA98 8017FA98 3C018029 */  lui        $at, %hi(D_8028FA04)
    /* 7FA9C 8017FA9C E428FA04 */  swc1       $f8, %lo(D_8028FA04)($at)
    /* 7FAA0 8017FAA0 C662001C */  lwc1       $f2, 0x1C($s3)
    /* 7FAA4 8017FAA4 00008821 */  addu       $s1, $zero, $zero
    /* 7FAA8 8017FAA8 46200020 */  cvt.s.d    $f0, $f0
  .L8017FAAC:
    /* 7FAAC 8017FAAC E6600018 */  swc1       $f0, 0x18($s3)
    /* 7FAB0 8017FAB0 3C018029 */  lui        $at, %hi(D_80290360)
    /* 7FAB4 8017FAB4 E4220360 */  swc1       $f2, %lo(D_80290360)($at)
    /* 7FAB8 8017FAB8 3C018029 */  lui        $at, %hi(D_80290354)
    /* 7FABC 8017FABC E4220354 */  swc1       $f2, %lo(D_80290354)($at)
  .L8017FAC0:
