...
glabel func_8019D294
    ...
    /* 9D2A4 8019D2A4 44807000 */  mtc1       $zero, $f14
    /* 9D2A8 8019D2A8 44826000 */  mtc1       $v0, $f12
    /* 9D2AC 8019D2AC 46806320 */  cvt.s.w    $f12, $f12
    /* 9D2B0 8019D2B0 0C0525C9 */  jal        func_80149724
    /* 9D2B4 8019D2B4 00000000 */   nop
    /* 9D2B8 8019D2B8 C6220284 */  lwc1       $f2, 0x284($s1)
    /* 9D2BC 8019D2BC 46020002 */  mul.s      $f0, $f0, $f2
    /* 9D2C0 8019D2C0 3C018011 */  lui        $at, %hi(D_8010A938 + 0x4)
    /* 9D2C4 8019D2C4 C423A93C */  lwc1       $f3, %lo(D_8010A938 + 0x4)($at)
    /* 9D2C8 8019D2C8 C422A940 */  lwc1       $f2, %lo(D_8010A940)($at)
    /* 9D2CC 8019D2CC 46000021 */  cvt.d.s    $f0, $f0
    /* 9D2D0 8019D2D0 46220002 */  mul.d      $f0, $f0, $f2
    /* 9D2D4 8019D2D4 C622005C */  lwc1       $f2, 0x5C($s1)
    /* 9D2D8 8019D2D8 460010A1 */  cvt.d.s    $f2, $f2
    /* 9D2DC 8019D2DC 46201081 */  sub.d      $f2, $f2, $f0
    /* 9D2E0 8019D2E0 462010A0 */  cvt.s.d    $f2, $f2
    /* 9D2E4 8019D2E4 E622005C */  swc1       $f2, 0x5C($s1)
  .L8019D2E8:
    /* 9D2E8 8019D2E8 3C018029 */  lui        $at, %hi(D_80290310)
    /* 9D2EC 8019D2EC C4200310 */  lwc1       $f0, %lo(D_80290310)($at)
    /* 9D2F0 8019D2F0 3C018011 */  lui        $at, %hi(D_8010A944)
    /* 9D2F4 8019D2F4 C422A944 */  lwc1       $f2, %lo(D_8010A944)($at)
    /* 9D2F8 8019D2F8 46020000 */  add.s      $f0, $f0, $f2
    /* 9D2FC 8019D2FC E7A0001C */  swc1       $f0, 0x1C($sp)
    ...
    /* 9D314 8019D314 C6000000 */  lwc1       $f0, 0x0($s0)
    /* 9D318 8019D318 E7A00018 */  swc1       $f0, 0x18($sp)
    /* 9D31C 8019D31C C6200268 */  lwc1       $f0, 0x268($s1)
    /* 9D320 8019D320 080670CF */  j          .L8019C33C
    /* 9D324 8019D324 E7A00020 */   swc1      $f0, 0x20($sp)
  .L8019D328:
    /* 9D328 8019D328 3C018029 */  lui        $at, %hi(D_80290314)
    /* 9D32C 8019D32C C4200314 */  lwc1       $f0, %lo(D_80290314)($at)
    /* 9D330 8019D330 E7A00020 */  swc1       $f0, 0x20($sp)
    /* 9D334 8019D334 C6200260 */  lwc1       $f0, 0x260($s1)
    /* 9D338 8019D338 E7A00018 */  swc1       $f0, 0x18($sp)
    ...
    /* 9D354 8019D354 C42C030C */  lwc1       $f12, %lo(D_8029030C)($at)
    /* 9D358 8019D358 C6200034 */  lwc1       $f0, 0x34($s1)
    /* 9D35C 8019D35C 46006301 */  sub.s      $f12, $f12, $f0
    /* 9D360 8019D360 3C018029 */  lui        $at, %hi(D_80290310)
    /* 9D364 8019D364 C4200310 */  lwc1       $f0, %lo(D_80290310)($at)
    /* 9D368 8019D368 E7AC0018 */  swc1       $f12, 0x18($sp)
    /* 9D36C 8019D36C C6220038 */  lwc1       $f2, 0x38($s1)
    /* 9D370 8019D370 46020001 */  sub.s      $f0, $f0, $f2
    /* 9D374 8019D374 3C018029 */  lui        $at, %hi(D_80290314)
    /* 9D378 8019D378 C42E0314 */  lwc1       $f14, %lo(D_80290314)($at)
    /* 9D37C 8019D37C E7A0001C */  swc1       $f0, 0x1C($sp)
    /* 9D380 8019D380 C620003C */  lwc1       $f0, 0x3C($s1)
    /* 9D384 8019D384 46007381 */  sub.s      $f14, $f14, $f0
    /* 9D388 8019D388 0C051D18 */  jal        func_80147460
    /* 9D38C 8019D38C E7AE0020 */   swc1      $f14, 0x20($sp)
    /* 9D390 8019D390 0C0525B2 */  jal        func_801496C8
    /* 9D394 8019D394 46000306 */   mov.s     $f12, $f0
    /* 9D398 8019D398 3C018011 */  lui        $at, %hi(D_8010A948)
    /* 9D39C 8019D39C C422A948 */  lwc1       $f2, %lo(D_8010A948)($at)
    /* 9D3A0 8019D3A0 4602B03C */  c.lt.s     $f22, $f2
    /* 9D3A4 8019D3A4 00000000 */  nop
    /* 9D3A8 8019D3A8 45000014 */  bc1f       .L8019D3FC
    /* 9D3AC 8019D3AC E6200088 */   swc1      $f0, 0x88($s1)
  ...
  .L8019D4A8:
    /* 9D4A8 8019D4A8 C62002B0 */  lwc1       $f0, 0x2B0($s1)
    /* 9D4AC 8019D4AC 8E2200DC */  lw         $v0, 0xDC($s1)
    /* 9D4B0 8019D4B0 E6200088 */  swc1       $f0, 0x88($s1)
  ...
  .L8019D500:
    ...
    /* 9D510 8019D510 C7B70050 */  lwc1       $f23, 0x50($sp)
    /* 9D514 8019D514 C7B60054 */  lwc1       $f22, 0x54($sp)
    /* 9D518 8019D518 C7B50048 */  lwc1       $f21, 0x48($sp)
    /* 9D51C 8019D51C C7B4004C */  lwc1       $f20, 0x4C($sp)
    ...
    /* 9D560 8019D560 E7BF0080 */  swc1       $f31, 0x80($sp)
    /* 9D564 8019D564 E7BE0084 */  swc1       $f30, 0x84($sp)
    /* 9D568 8019D568 E7BD0078 */  swc1       $f29, 0x78($sp)
    /* 9D56C 8019D56C E7BC007C */  swc1       $f28, 0x7C($sp)
    /* 9D570 8019D570 E7BB0070 */  swc1       $f27, 0x70($sp)
    /* 9D574 8019D574 E7BA0074 */  swc1       $f26, 0x74($sp)
    /* 9D578 8019D578 E7B90068 */  swc1       $f25, 0x68($sp)
    /* 9D57C 8019D57C E7B8006C */  swc1       $f24, 0x6C($sp)
    /* 9D580 8019D580 E7B70060 */  swc1       $f23, 0x60($sp)
    /* 9D584 8019D584 E7B60064 */  swc1       $f22, 0x64($sp)
    /* 9D588 8019D588 E7B50058 */  swc1       $f21, 0x58($sp)
