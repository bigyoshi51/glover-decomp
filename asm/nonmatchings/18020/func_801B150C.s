...
glabel func_801B150C
    ...
    /* B1510 801B1510 E426F4BC */  swc1       $f6, %lo(D_8029F4BC)($at)
    /* B1514 801B1514 3C01802A */  lui        $at, %hi(D_8029F4C0)
    /* B1518 801B1518 E424F4C0 */  swc1       $f4, %lo(D_8029F4C0)($at)
    /* B151C 801B151C 3C01802A */  lui        $at, %hi(D_8029F4C4)
    /* B1520 801B1520 E422F4C4 */  swc1       $f2, %lo(D_8029F4C4)($at)
    /* B1524 801B1524 3C10802A */  lui        $s0, %hi(D_8029F504)
    /* B1528 801B1528 2610F504 */  addiu      $s0, $s0, %lo(D_8029F504)
    /* B152C 801B152C C60C0000 */  lwc1       $f12, 0x0($s0)
    /* B1530 801B1530 3C018011 */  lui        $at, %hi(D_8010B7D0)
    /* B1534 801B1534 C421B7D0 */  lwc1       $f1, %lo(D_8010B7D0)($at)
    /* B1538 801B1538 C420B7D4 */  lwc1       $f0, %lo(D_8010B7D0 + 0x4)($at)
    /* B153C 801B153C 46006321 */  cvt.d.s    $f12, $f12
    /* B1540 801B1540 46206300 */  add.d      $f12, $f12, $f0
    /* B1544 801B1544 0C0525B2 */  jal        func_801496C8
    /* B1548 801B1548 46206320 */   cvt.s.d   $f12, $f12
    /* B154C 801B154C 26040020 */  addiu      $a0, $s0, 0x20
    /* B1550 801B1550 2605FFFC */  addiu      $a1, $s0, -0x4
    /* B1554 801B1554 0C0570D4 */  jal        func_8015C350
    /* B1558 801B1558 E6000000 */   swc1      $f0, 0x0($s0)
