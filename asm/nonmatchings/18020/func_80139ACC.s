...
glabel func_80139ACC
    ...
    /* 39AE0 80139AE0 44831000 */  mtc1       $v1, $f2
    /* 39AE4 80139AE4 468010A0 */  cvt.s.w    $f2, $f2
    /* 39AE8 80139AE8 46020002 */  mul.s      $f0, $f0, $f2
    /* 39AEC 80139AEC 3C018010 */  lui        $at, %hi(D_80105AB4)
    /* 39AF0 80139AF0 C4225AB4 */  lwc1       $f2, %lo(D_80105AB4)($at)
    /* 39AF4 80139AF4 46020683 */  div.s      $f26, $f0, $f2
    /* 39AF8 80139AF8 3C018029 */  lui        $at, %hi(D_8028F95C)
    /* 39AFC 80139AFC C422F95C */  lwc1       $f2, %lo(D_8028F95C)($at)
    /* 39B00 80139B00 46001021 */  cvt.d.s    $f0, $f2
    /* 39B04 80139B04 3C018010 */  lui        $at, %hi(D_80105AB8)
    /* 39B08 80139B08 C4235AB8 */  lwc1       $f3, %lo(D_80105AB8)($at)
    /* 39B0C 80139B0C C4225ABC */  lwc1       $f2, %lo(D_80105AB8 + 0x4)($at)
    /* 39B10 80139B10 46220000 */  add.d      $f0, $f0, $f2
    /* 39B14 80139B14 462000A0 */  cvt.s.d    $f2, $f0
    /* 39B18 80139B18 46001306 */  mov.s      $f12, $f2
    ...
    /* 39B50 80139B50 44831000 */  mtc1       $v1, $f2
    /* 39B54 80139B54 468010A0 */  cvt.s.w    $f2, $f2
    /* 39B58 80139B58 46020002 */  mul.s      $f0, $f0, $f2
    /* 39B5C 80139B5C 3C018010 */  lui        $at, %hi(D_80105AC0)
    /* 39B60 80139B60 C4225AC0 */  lwc1       $f2, %lo(D_80105AC0)($at)
    /* 39B64 80139B64 46020003 */  div.s      $f0, $f0, $f2
    /* 39B68 80139B68 4600D081 */  sub.s      $f2, $f26, $f0
    /* 39B6C 80139B6C 46001021 */  cvt.d.s    $f0, $f2
    /* 39B70 80139B70 4620C082 */  mul.d      $f2, $f24, $f0
    /* 39B74 80139B74 46201020 */  cvt.s.d    $f0, $f2
    /* 39B78 80139B78 E7C00028 */  swc1       $f0, 0x28($fp)
    /* 39B7C 80139B7C 3C028029 */  lui        $v0, %hi(D_802903A8)
    /* 39B80 80139B80 8C4203A8 */  lw         $v0, %lo(D_802903A8)($v0)
    /* 39B84 80139B84 C4420004 */  lwc1       $f2, 0x4($v0)
    /* 39B88 80139B88 46001021 */  cvt.d.s    $f0, $f2
    /* 39B8C 80139B8C 3C018010 */  lui        $at, %hi(D_80105AC0 + 0x4)
    /* 39B90 80139B90 C4235AC4 */  lwc1       $f3, %lo(D_80105AC0 + 0x4)($at)
    /* 39B94 80139B94 C4225AC8 */  lwc1       $f2, %lo(D_80105AC8)($at)
    /* 39B98 80139B98 46220003 */  div.d      $f0, $f0, $f2
    /* 39B9C 80139B9C 3C02802A */  lui        $v0, %hi(D_8029FA48)
    /* 39BA0 80139BA0 8C42FA48 */  lw         $v0, %lo(D_8029FA48)($v0)
    /* 39BA4 80139BA4 C4440004 */  lwc1       $f4, 0x4($v0)
    /* 39BA8 80139BA8 460020A1 */  cvt.d.s    $f2, $f4
    /* 39BAC 80139BAC 46220002 */  mul.d      $f0, $f0, $f2
    /* 39BB0 80139BB0 3C018010 */  lui        $at, %hi(D_80105AC8 + 0x4)
    /* 39BB4 80139BB4 C4235ACC */  lwc1       $f3, %lo(D_80105AC8 + 0x4)($at)
    /* 39BB8 80139BB8 C4225AD0 */  lwc1       $f2, %lo(D_80105AD0)($at)
    /* 39BBC 80139BBC 46220002 */  mul.d      $f0, $f0, $f2
    /* 39BC0 80139BC0 3C02802A */  lui        $v0, %hi(D_8029FA48)
    /* 39BC4 80139BC4 8C42FA48 */  lw         $v0, %lo(D_8029FA48)($v0)
    /* 39BC8 80139BC8 C4440000 */  lwc1       $f4, 0x0($v0)
    /* 39BCC 80139BCC 460020A1 */  cvt.d.s    $f2, $f4
    /* 39BD0 80139BD0 46220603 */  div.d      $f24, $f0, $f2
    /* 39BD4 80139BD4 3C018029 */  lui        $at, %hi(D_8028F95C)
    /* 39BD8 80139BD8 C42CF95C */  lwc1       $f12, %lo(D_8028F95C)($at)
    ...
    /* 39C10 80139C10 44831000 */  mtc1       $v1, $f2
    /* 39C14 80139C14 468010A0 */  cvt.s.w    $f2, $f2
    /* 39C18 80139C18 46020002 */  mul.s      $f0, $f0, $f2
  .L80139C1C:
    /* 39C1C 80139C1C 3C018010 */  lui        $at, %hi(D_80105AD4)
    /* 39C20 80139C20 C4225AD4 */  lwc1       $f2, %lo(D_80105AD4)($at)
    /* 39C24 80139C24 46020683 */  div.s      $f26, $f0, $f2
    /* 39C28 80139C28 3C018029 */  lui        $at, %hi(D_8028F95C)
    /* 39C2C 80139C2C C422F95C */  lwc1       $f2, %lo(D_8028F95C)($at)
    /* 39C30 80139C30 46001021 */  cvt.d.s    $f0, $f2
    /* 39C34 80139C34 3C018010 */  lui        $at, %hi(D_80105AD8)
    /* 39C38 80139C38 C4235AD8 */  lwc1       $f3, %lo(D_80105AD8)($at)
    /* 39C3C 80139C3C C4225ADC */  lwc1       $f2, %lo(D_80105AD8 + 0x4)($at)
