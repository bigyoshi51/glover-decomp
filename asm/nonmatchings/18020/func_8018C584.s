...
glabel func_8018C584
    ...
    /* 8C594 8018C594 E6380010 */  swc1       $fs2, 0x10($s1)
    /* 8C598 8018C598 E6380014 */  swc1       $fs2, 0x14($s1)
    ...
    /* 8C5B8 8018C5B8 4616A032 */  c.eq.s     $fs0, $fs1
    /* 8C5BC 8018C5BC 00000000 */  nop
    /* 8C5C0 8018C5C0 45020001 */  bc1fl      .L8018C5C8
    /* 8C5C4 8018C5C4 E6340028 */   swc1      $fs0, 0x28($s1)
  .L8018C5C8:
    ...
    /* 8C5E8 8018C5E8 E6200050 */  swc1       $fv0, 0x50($s1)
  .L8018C5EC:
  ...
  .L8018C5F8:
    ...
    /* 8C62C 8018C62C C7B90048 */  lwc1       $fs2f, 0x48($sp)
    /* 8C630 8018C630 C7B8004C */  lwc1       $fs2, 0x4C($sp)
    /* 8C634 8018C634 C7B70040 */  lwc1       $fs1f, 0x40($sp)
    /* 8C638 8018C638 C7B60044 */  lwc1       $fs1, 0x44($sp)
    /* 8C63C 8018C63C C7B50038 */  lwc1       $fs0f, 0x38($sp)
    /* 8C640 8018C640 C7B4003C */  lwc1       $fs0, 0x3C($sp)
    ...
    /* 8C684 8018C684 E7BF0098 */  swc1       $fs5f, 0x98($sp)
    /* 8C688 8018C688 E7BE009C */  swc1       $fs5, 0x9C($sp)
    /* 8C68C 8018C68C E7BD0090 */  swc1       $fs4f, 0x90($sp)
    /* 8C690 8018C690 E7BC0094 */  swc1       $fs4, 0x94($sp)
    /* 8C694 8018C694 E7BB0088 */  swc1       $fs3f, 0x88($sp)
    /* 8C698 8018C698 E7BA008C */  swc1       $fs3, 0x8C($sp)
    /* 8C69C 8018C69C E7B90080 */  swc1       $fs2f, 0x80($sp)
    /* 8C6A0 8018C6A0 E7B80084 */  swc1       $fs2, 0x84($sp)
    /* 8C6A4 8018C6A4 E7B70078 */  swc1       $fs1f, 0x78($sp)
    /* 8C6A8 8018C6A8 E7B6007C */  swc1       $fs1, 0x7C($sp)
    /* 8C6AC 8018C6AC E7B50070 */  swc1       $fs0f, 0x70($sp)
    /* 8C6B0 8018C6B0 E7B40074 */  swc1       $fs0, 0x74($sp)
  ...
  .L8018C6DC:
    ...
    /* 8C6F8 8018C6F8 C43E9628 */  lwc1       $fs5, %lo(D_80109628)($at)
