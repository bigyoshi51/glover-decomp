...
glabel func_801C249C
  ...
  .L801C2510:
    /* C2510 801C2510 C6140030 */  lwc1       $fs0, 0x30($s0)
    ...
    /* C2524 801C2524 4600A500 */  add.s      $fs0, $fs0, $fv0
  ...
  .L801C252C:
    ...
    /* C253C 801C253C 4600A500 */  add.s      $fs0, $fs0, $fv0
  ...
  .L801C2544:
    ...
    /* C2550 801C2550 4406A000 */  mfc1       $a2, $fs0
  ...
  .L801C2594:
    ...
    /* C25A0 801C25A0 D7B40018 */  ldc1       $fs0, 0x18($sp)
  ...
  .L801C2624:
    ...
    /* C262C 801C262C C6240050 */  lwc1       $ft0, 0x50($s1)
    /* C2630 801C2630 26080001 */  addiu      $t0, $s0, 0x1
    /* C2634 801C2634 250B0001 */  addiu      $t3, $t0, 0x1
    /* C2638 801C2638 E624004C */  swc1       $ft0, 0x4C($s1)
