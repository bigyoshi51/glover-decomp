...
glabel func_8011C36C
    ...
    /* 1C370 8011C370 E42A7D48 */  swc1       $f10, %lo(D_801F7D48)($at)
    /* 1C374 8011C374 E4E80000 */  swc1       $f8, 0x0($a3)
    /* 1C378 8011C378 3C01801F */  lui        $at, %hi(D_801F7D5C)
    /* 1C37C 8011C37C E4227D5C */  swc1       $f2, %lo(D_801F7D5C)($at)
    /* 1C380 8011C380 3C01801F */  lui        $at, %hi(D_801F7D60)
    /* 1C384 8011C384 E4247D60 */  swc1       $f4, %lo(D_801F7D60)($at)
    /* 1C388 8011C388 0C0524E6 */  jal        func_80149398
    /* 1C38C 8011C38C E7A00010 */   swc1      $f0, 0x10($sp)
    /* 1C390 8011C390 C60C0000 */  lwc1       $f12, 0x0($s0)
    /* 1C394 8011C394 3C018029 */  lui        $at, %hi(D_8028F918)
    /* 1C398 8011C398 C42EF918 */  lwc1       $f14, %lo(D_8028F918)($at)
  ...
  .L8011C408:
    /* 1C408 8011C408 C68600B4 */  lwc1       $f6, 0xB4($s4)
    /* 1C40C 8011C40C 3C01801E */  lui        $at, %hi(D_801E673C)
    /* 1C410 8011C410 C422673C */  lwc1       $f2, %lo(D_801E673C)($at)
    /* 1C414 8011C414 46023182 */  mul.s      $f6, $f6, $f2
    /* 1C418 8011C418 C68400B8 */  lwc1       $f4, 0xB8($s4)
    /* 1C41C 8011C41C 46022102 */  mul.s      $f4, $f4, $f2
    /* 1C420 8011C420 C68000BC */  lwc1       $f0, 0xBC($s4)
    /* 1C424 8011C424 46020002 */  mul.s      $f0, $f0, $f2
    /* 1C428 8011C428 E68600B4 */  swc1       $f6, 0xB4($s4)
    /* 1C42C 8011C42C E68400B8 */  swc1       $f4, 0xB8($s4)
    /* 1C430 8011C430 E68000BC */  swc1       $f0, 0xBC($s4)
    ...
    /* 1C48C 8011C48C C4206738 */  lwc1       $f0, %lo(D_801E6738)($at)
    /* 1C490 8011C490 02602821 */  addu       $a1, $s3, $zero
    /* 1C494 8011C494 02A03021 */  addu       $a2, $s5, $zero
    /* 1C498 8011C498 E6740004 */  swc1       $f20, 0x4($s3)
    /* 1C49C 8011C49C E6740000 */  swc1       $f20, 0x0($s3)
    /* 1C4A0 8011C4A0 0C052668 */  jal        func_801499A0
    /* 1C4A4 8011C4A4 E6600008 */   swc1      $f0, 0x8($s3)
    /* 1C4A8 8011C4A8 C68000B4 */  lwc1       $f0, 0xB4($s4)
    /* 1C4AC 8011C4AC C6620000 */  lwc1       $f2, 0x0($s3)
    /* 1C4B0 8011C4B0 46020000 */  add.s      $f0, $f0, $f2
    /* 1C4B4 8011C4B4 C68200B8 */  lwc1       $f2, 0xB8($s4)
    /* 1C4B8 8011C4B8 E68000B4 */  swc1       $f0, 0xB4($s4)
    /* 1C4BC 8011C4BC 3C01801F */  lui        $at, %hi(D_801F7D68)
    /* 1C4C0 8011C4C0 C4207D68 */  lwc1       $f0, %lo(D_801F7D68)($at)
    /* 1C4C4 8011C4C4 26A4FF64 */  addiu      $a0, $s5, -0x9C
    /* 1C4C8 8011C4C8 46001080 */  add.s      $f2, $f2, $f0
    /* 1C4CC 8011C4CC C68000BC */  lwc1       $f0, 0xBC($s4)
    /* 1C4D0 8011C4D0 24050016 */  addiu      $a1, $zero, 0x16
    /* 1C4D4 8011C4D4 00003021 */  addu       $a2, $zero, $zero
    /* 1C4D8 8011C4D8 E68200B8 */  swc1       $f2, 0xB8($s4)
    /* 1C4DC 8011C4DC 3C01801F */  lui        $at, %hi(D_801F7D6C)
    /* 1C4E0 8011C4E0 C4227D6C */  lwc1       $f2, %lo(D_801F7D6C)($at)
    ...
    /* 1C4F4 8011C4F4 46020000 */  add.s      $f0, $f0, $f2
    ...
    /* 1C510 8011C510 E68000BC */   swc1      $f0, 0xBC($s4)
  ...
  .L8011C560:
    ...
    /* 1C590 8011C590 C420E1F8 */  lwc1       $f0, %lo(D_801EE1F8)($at)
    /* 1C594 8011C594 3C018010 */  lui        $at, %hi(D_80100CAC)
    /* 1C598 8011C598 C4220CAC */  lwc1       $f2, %lo(D_80100CAC)($at)
    /* 1C59C 8011C59C 24040018 */  addiu      $a0, $zero, 0x18
    /* 1C5A0 8011C5A0 E6400038 */  swc1       $f0, 0x38($s2)
    /* 1C5A4 8011C5A4 E4400070 */  swc1       $f0, 0x70($v0)
    /* 1C5A8 8011C5A8 0C051C00 */  jal        func_80147000
    /* 1C5AC 8011C5AC E64200C0 */   swc1      $f2, 0xC0($s2)
  ...
  .L8011C5B8:
    ...
    /* 1C5E8 8011C5E8 C420E248 */  lwc1       $f0, %lo(D_801EE248)($at)
    /* 1C5EC 8011C5EC 24040018 */  addiu      $a0, $zero, 0x18
    /* 1C5F0 8011C5F0 E6400038 */  swc1       $f0, 0x38($s2)
    /* 1C5F4 8011C5F4 0C051C00 */  jal        func_80147000
    /* 1C5F8 8011C5F8 E4400070 */   swc1      $f0, 0x70($v0)
  ...
  .L8011C604:
    ...
    /* 1C634 8011C634 C420E298 */  lwc1       $f0, %lo(D_801EE298)($at)
    /* 1C638 8011C638 24040018 */  addiu      $a0, $zero, 0x18
    /* 1C63C 8011C63C E6400038 */  swc1       $f0, 0x38($s2)
    /* 1C640 8011C640 0C051C00 */  jal        func_80147000
    /* 1C644 8011C644 E4400070 */   swc1      $f0, 0x70($v0)
    ...
    /* 1C6CC 8011C6CC C43A0CB0 */  lwc1       $f26, %lo(D_80100CB0)($at)
    /* 1C6D0 8011C6D0 3C018010 */  lui        $at, %hi(D_80100CB4)
    /* 1C6D4 8011C6D4 C4380CB4 */  lwc1       $f24, %lo(D_80100CB4)($at)
    ...
    /* 1C6E4 8011C6E4 4480B000 */  mtc1       $zero, $f22
    /* 1C6E8 8011C6E8 00004810 */  mfhi       $t1
    /* 1C6EC 8011C6EC 00091883 */  sra        $v1, $t1, 2
    /* 1C6F0 8011C6F0 00621823 */  subu       $v1, $v1, $v0
    /* 1C6F4 8011C6F4 4483A000 */  mtc1       $v1, $f20
    /* 1C6F8 8011C6F8 4680A520 */  cvt.s.w    $f20, $f20
  .L8011C6FC:
    /* 1C6FC 8011C6FC 4600A521 */  cvt.d.s    $f20, $f20
  .L8011C700:
    /* 1C700 8011C700 3C018010 */  lui        $at, %hi(D_80100CB8)
    /* 1C704 8011C704 C4210CB8 */  lwc1       $f1, %lo(D_80100CB8)($at)
    /* 1C708 8011C708 C4200CBC */  lwc1       $f0, %lo(D_80100CB8 + 0x4)($at)
    /* 1C70C 8011C70C 00101040 */  sll        $v0, $s0, 1
    /* 1C710 8011C710 44821000 */  mtc1       $v0, $f2
    /* 1C714 8011C714 468010A1 */  cvt.d.w    $f2, $f2
    /* 1C718 8011C718 46201082 */  mul.d      $f2, $f2, $f0
    /* 1C71C 8011C71C 3C018010 */  lui        $at, %hi(D_80100CC0)
  alabel D_8011C720
    /* 1C720 8011C720 C4210CC0 */  lwc1       $f1, %lo(D_80100CC0)($at)
    /* 1C724 8011C724 C4200CC4 */  lwc1       $f0, %lo(D_80100CC0 + 0x4)($at)
    /* 1C728 8011C728 46201083 */  div.d      $f2, $f2, $f0
    /* 1C72C 8011C72C 4622A080 */  add.d      $f2, $f20, $f2
    /* 1C730 8011C730 02202021 */  addu       $a0, $s1, $zero
    /* 1C734 8011C734 02202821 */  addu       $a1, $s1, $zero
    /* 1C738 8011C738 462010A0 */  cvt.s.d    $f2, $f2
    /* 1C73C 8011C73C 44061000 */  mfc1       $a2, $f2
    /* 1C740 8011C740 24070002 */  addiu      $a3, $zero, 0x2
    /* 1C744 8011C744 E6360008 */  swc1       $f22, 0x8($s1)
    /* 1C748 8011C748 E6360000 */  swc1       $f22, 0x0($s1)
    /* 1C74C 8011C74C 0C052457 */  jal        func_8014915C
    /* 1C750 8011C750 E63A0004 */   swc1      $f26, 0x4($s1)
    ...
    /* 1C768 8011C768 C6200000 */  lwc1       $f0, 0x0($s1)
    /* 1C76C 8011C76C C642003C */  lwc1       $f2, 0x3C($s2)
    /* 1C770 8011C770 46020000 */  add.s      $f0, $f0, $f2
    /* 1C774 8011C774 E6600000 */  swc1       $f0, 0x0($s3)
    /* 1C778 8011C778 3C01801F */  lui        $at, %hi(D_801F7D68)
    /* 1C77C 8011C77C C4207D68 */  lwc1       $f0, %lo(D_801F7D68)($at)
    /* 1C780 8011C780 C6420040 */  lwc1       $f2, 0x40($s2)
    /* 1C784 8011C784 46020000 */  add.s      $f0, $f0, $f2
    /* 1C788 8011C788 E6600004 */  swc1       $f0, 0x4($s3)
    /* 1C78C 8011C78C 3C01801F */  lui        $at, %hi(D_801F7D6C)
    /* 1C790 8011C790 C4207D6C */  lwc1       $f0, %lo(D_801F7D6C)($at)
    /* 1C794 8011C794 C6420044 */  lwc1       $f2, 0x44($s2)
    /* 1C798 8011C798 24040010 */  addiu      $a0, $zero, 0x10
    /* 1C79C 8011C79C 02602821 */  addu       $a1, $s3, $zero
    /* 1C7A0 8011C7A0 46020000 */  add.s      $f0, $f0, $f2
    ...
    /* 1C7B4 8011C7B4 E6600008 */   swc1      $f0, 0x8($s3)
    ...
    /* 1C7D0 8011C7D0 E4780018 */  swc1       $f24, 0x18($v1)
    /* 1C7D4 8011C7D4 E4B80070 */  swc1       $f24, 0x70($a1)
  .L8011C7D8:
    ...
    /* 1C7EC 8011C7EC C4340CC8 */  lwc1       $f20, %lo(D_80100CC8)($at)
  .L8011C7F0:
