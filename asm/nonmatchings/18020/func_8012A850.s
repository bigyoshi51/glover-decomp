...
glabel func_8012A850
    /* 2A850 8012A850 E7A00018 */  swc1       $f0, 0x18($sp)
    /* 2A854 8012A854 0C051C00 */  jal        func_80147000
    /* 2A858 8012A858 E7A2001C */   swc1      $f2, 0x1C($sp)
    /* 2A85C 8012A85C 3C018010 */  lui        $at, %hi(D_801017F4)
    /* 2A860 8012A860 C42217F4 */  lwc1       $f2, %lo(D_801017F4)($at)
    /* 2A864 8012A864 2442FFFC */  addiu      $v0, $v0, -0x4
    /* 2A868 8012A868 44820000 */  mtc1       $v0, $f0
    /* 2A86C 8012A86C 46800020 */  cvt.s.w    $f0, $f0
    /* 2A870 8012A870 46020003 */  div.s      $f0, $f0, $f2
    /* 2A874 8012A874 E7A00020 */  swc1       $f0, 0x20($sp)
    ...
    /* 2A8A4 8012A8A4 C4A40038 */  lwc1       $f4, 0x38($a1)
    /* 2A8A8 8012A8A8 94A20114 */  lhu        $v0, 0x114($a1)
    /* 2A8AC 8012A8AC 3C01801E */  lui        $at, %hi(D_801E7688)
    /* 2A8B0 8012A8B0 C4267688 */  lwc1       $f6, %lo(D_801E7688)($at)
    /* 2A8B4 8012A8B4 3C018010 */  lui        $at, %hi(D_801017F8)
    /* 2A8B8 8012A8B8 C42317F8 */  lwc1       $f3, %lo(D_801017F8)($at)
    /* 2A8BC 8012A8BC C42217FC */  lwc1       $f2, %lo(D_801017F8 + 0x4)($at)
    /* 2A8C0 8012A8C0 44820000 */  mtc1       $v0, $f0
    /* 2A8C4 8012A8C4 46800020 */  cvt.s.w    $f0, $f0
    /* 2A8C8 8012A8C8 46000021 */  cvt.d.s    $f0, $f0
    /* 2A8CC 8012A8CC 46220082 */  mul.d      $f2, $f0, $f2
    /* 2A8D0 8012A8D0 46062100 */  add.s      $f4, $f4, $f6
    /* 2A8D4 8012A8D4 C4A000F8 */  lwc1       $f0, 0xF8($a1)
    /* 2A8D8 8012A8D8 46060000 */  add.s      $f0, $f0, $f6
    /* 2A8DC 8012A8DC 3C018010 */  lui        $at, %hi(D_80101800)
    /* 2A8E0 8012A8E0 C4271800 */  lwc1       $f7, %lo(D_80101800)($at)
    /* 2A8E4 8012A8E4 C4261804 */  lwc1       $f6, %lo(D_80101800 + 0x4)($at)
    /* 2A8E8 8012A8E8 4622303E */  c.le.d     $f6, $f2
    /* 2A8EC 8012A8EC E4A40038 */  swc1       $f4, 0x38($a1)
    /* 2A8F0 8012A8F0 45010005 */  bc1t       .L8012A908
    /* 2A8F4 8012A8F4 E4A000F8 */   swc1      $f0, 0xF8($a1)
    /* 2A8F8 8012A8F8 4620100D */  trunc.w.d  $f0, $f2
    /* 2A8FC 8012A8FC 44030000 */  mfc1       $v1, $f0
    /* 2A900 8012A900 0804A647 */  j          .L8012991C
    /* 2A904 8012A904 00000000 */   nop
  .L8012A908:
    /* 2A908 8012A908 46261001 */  sub.d      $f0, $f2, $f6
    /* 2A90C 8012A90C 4620008D */  trunc.w.d  $f2, $f0
    /* 2A910 8012A910 44031000 */  mfc1       $v1, $f2
    ...
    /* 2A924 8012A924 C4231808 */  lwc1       $f3, %lo(D_80101808)($at)
    /* 2A928 8012A928 C422180C */  lwc1       $f2, %lo(D_80101808 + 0x4)($at)
    /* 2A92C 8012A92C 44820000 */  mtc1       $v0, $f0
    /* 2A930 8012A930 46800020 */  cvt.s.w    $f0, $f0
    /* 2A934 8012A934 46000021 */  cvt.d.s    $f0, $f0
    /* 2A938 8012A938 46220082 */  mul.d      $f2, $f0, $f2
    /* 2A93C 8012A93C 3C018010 */  lui        $at, %hi(D_80101810)
    /* 2A940 8012A940 C4211810 */  lwc1       $f1, %lo(D_80101810)($at)
    /* 2A944 8012A944 C4201814 */  lwc1       $f0, %lo(D_80101810 + 0x4)($at)
    /* 2A948 8012A948 4622003E */  c.le.d     $f0, $f2
    /* 2A94C 8012A94C 00000000 */  nop
    /* 2A950 8012A950 45010005 */  bc1t       .L8012A968
    /* 2A954 8012A954 A4A30114 */   sh        $v1, 0x114($a1)
    /* 2A958 8012A958 4620100D */  trunc.w.d  $f0, $f2
    /* 2A95C 8012A95C 44040000 */  mfc1       $a0, $f0
    /* 2A960 8012A960 0804A65F */  j          .L8012997C
    /* 2A964 8012A964 00000000 */   nop
  .L8012A968:
    /* 2A968 8012A968 46201001 */  sub.d      $f0, $f2, $f0
    /* 2A96C 8012A96C 4620008D */  trunc.w.d  $f2, $f0
    /* 2A970 8012A970 44041000 */  mfc1       $a0, $f2
    ...
    /* 2A984 8012A984 C4251818 */  lwc1       $f5, %lo(D_80101818)($at)
    /* 2A988 8012A988 C424181C */  lwc1       $f4, %lo(D_80101818 + 0x4)($at)
    /* 2A98C 8012A98C 44821000 */  mtc1       $v0, $f2
    /* 2A990 8012A990 468010A0 */  cvt.s.w    $f2, $f2
    /* 2A994 8012A994 460010A1 */  cvt.d.s    $f2, $f2
    /* 2A998 8012A998 46241082 */  mul.d      $f2, $f2, $f4
    /* 2A99C 8012A99C 84A30102 */  lh         $v1, 0x102($a1)
    /* 2A9A0 8012A9A0 A4A40116 */  sh         $a0, 0x116($a1)
    /* 2A9A4 8012A9A4 240200FF */  addiu      $v0, $zero, 0xFF
    /* 2A9A8 8012A9A8 44830000 */  mtc1       $v1, $f0
    /* 2A9AC 8012A9AC 46800020 */  cvt.s.w    $f0, $f0
    /* 2A9B0 8012A9B0 46000021 */  cvt.d.s    $f0, $f0
    /* 2A9B4 8012A9B4 46240002 */  mul.d      $f0, $f0, $f4
    ...
    /* 2A9D4 8012A9D4 4620110D */  trunc.w.d  $f4, $f2
    /* 2A9D8 8012A9D8 44022000 */  mfc1       $v0, $f4
    /* 2A9DC 8012A9DC 4620008D */  trunc.w.d  $f2, $f0
    /* 2A9E0 8012A9E0 44031000 */  mfc1       $v1, $f2
    /* 2A9E4 8012A9E4 A4A20100 */  sh         $v0, 0x100($a1)
    /* 2A9E8 8012A9E8 A4A30102 */  sh         $v1, 0x102($a1)
  .L8012A9EC:
    /* 2A9EC 8012A9EC 3C018010 */  lui        $at, %hi(D_80101820)
    /* 2A9F0 8012A9F0 C4201820 */  lwc1       $f0, %lo(D_80101820)($at)
    /* 2A9F4 8012A9F4 4600B03C */  c.lt.s     $f22, $f0
    ...
    /* 2AA08 8012AA08 C4341824 */  lwc1       $f20, %lo(D_80101824)($at)
  ...
  .L8012AA10:
    ...
    /* 2AA38 8012AA38 C4620000 */  lwc1       $f2, 0x0($v1)
    /* 2AA3C 8012AA3C 44820000 */  mtc1       $v0, $f0
    /* 2AA40 8012AA40 46800020 */  cvt.s.w    $f0, $f0
    /* 2AA44 8012AA44 46001080 */  add.s      $f2, $f2, $f0
    /* 2AA48 8012AA48 46141081 */  sub.s      $f2, $f2, $f20
    /* 2AA4C 8012AA4C 24040013 */  addiu      $a0, $zero, 0x13
    /* 2AA50 8012AA50 0C051C00 */  jal        func_80147000
    /* 2AA54 8012AA54 E7A20018 */   swc1      $f2, 0x18($sp)
    ...
    /* 2AA64 8012AA64 C4620004 */  lwc1       $f2, 0x4($v1)
    /* 2AA68 8012AA68 44820000 */  mtc1       $v0, $f0
    /* 2AA6C 8012AA6C 46800020 */  cvt.s.w    $f0, $f0
    /* 2AA70 8012AA70 46001080 */  add.s      $f2, $f2, $f0
    /* 2AA74 8012AA74 46141081 */  sub.s      $f2, $f2, $f20
    /* 2AA78 8012AA78 24040013 */  addiu      $a0, $zero, 0x13
    /* 2AA7C 8012AA7C 0C051C00 */  jal        func_80147000
    /* 2AA80 8012AA80 E7A2001C */   swc1      $f2, 0x1C($sp)
    ...
    /* 2AA90 8012AA90 C4620008 */  lwc1       $f2, 0x8($v1)
    /* 2AA94 8012AA94 44820000 */  mtc1       $v0, $f0
    /* 2AA98 8012AA98 46800020 */  cvt.s.w    $f0, $f0
    /* 2AA9C 8012AA9C 46001080 */  add.s      $f2, $f2, $f0
    /* 2AAA0 8012AAA0 2404000A */  addiu      $a0, $zero, 0xA
    /* 2AAA4 8012AAA4 46141081 */  sub.s      $f2, $f2, $f20
    ...
    /* 2AAB8 8012AAB8 E7A20020 */  swc1       $f2, 0x20($sp)
  ...
  .L8012AAD4:
    ...
    /* 2AAE0 8012AAE0 C7B70058 */  lwc1       $f23, 0x58($sp)
    /* 2AAE4 8012AAE4 C7B6005C */  lwc1       $f22, 0x5C($sp)
    /* 2AAE8 8012AAE8 C7B50050 */  lwc1       $f21, 0x50($sp)
    /* 2AAEC 8012AAEC C7B40054 */  lwc1       $f20, 0x54($sp)
    ...
    /* 2AB2C 8012AB2C E7B50078 */  swc1       $f21, 0x78($sp)
    /* 2AB30 8012AB30 E7B4007C */  swc1       $f20, 0x7C($sp)
  ...
  .L8012ABCC:
    ...
    /* 2ABE8 8012ABE8 C4341834 */  lwc1       $f20, %lo(D_80101834)($at)
