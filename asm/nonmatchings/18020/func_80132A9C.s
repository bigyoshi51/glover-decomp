...
glabel func_80132A9C
  ...
  .L80132AA4:
    ...
    /* 32AA8 80132AA8 C4221F00 */  lwc1       $fv1, %lo(D_80101F00)($at)
  .L80132AAC:
  ...
  .L80132AB4:
    ...
    /* 32AC0 80132AC0 E4420000 */   swc1      $fv1, 0x0($v0)
  .L80132AC4:
    ...
    /* 32AD8 80132AD8 C4221F04 */  lwc1       $fv1, %lo(D_80101F04)($at)
    /* 32ADC 80132ADC 3C118029 */  lui        $s1, %hi(D_80290374)
    /* 32AE0 80132AE0 26310374 */  addiu      $s1, $s1, %lo(D_80290374)
    /* 32AE4 80132AE4 44800000 */  mtc1       $zero, $fv0
    /* 32AE8 80132AE8 3C018020 */  lui        $at, %hi(D_801FA6C4)
    /* 32AEC 80132AEC E420A6C4 */  swc1       $fv0, %lo(D_801FA6C4)($at)
    /* 32AF0 80132AF0 E6400000 */  swc1       $fv0, 0x0($s2)
  .L80132AF4:
    /* 32AF4 80132AF4 3C018020 */  lui        $at, %hi(D_801FA6C8)
    /* 32AF8 80132AF8 E422A6C8 */  swc1       $fv1, %lo(D_801FA6C8)($at)
