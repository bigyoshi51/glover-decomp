...
glabel func_8019DCE4
    /* 9DCE4 8019DCE4 C6200060 */  lwc1       $f0, 0x60($s1)
    /* 9DCE8 8019DCE8 46000021 */  cvt.d.s    $f0, $f0
    /* 9DCEC 8019DCEC 46260002 */  mul.d      $f0, $f0, $f6
    /* 9DCF0 8019DCF0 46202120 */  cvt.s.d    $f4, $f4
    /* 9DCF4 8019DCF4 462010A0 */  cvt.s.d    $f2, $f2
    /* 9DCF8 8019DCF8 46200020 */  cvt.s.d    $f0, $f0
    /* 9DCFC 8019DCFC E6240058 */  swc1       $f4, 0x58($s1)
    /* 9DD00 8019DD00 E622005C */  swc1       $f2, 0x5C($s1)
    /* 9DD04 8019DD04 E6200060 */  swc1       $f0, 0x60($s1)
    ...
    /* 9DD40 8019DD40 C420A998 */  lwc1       $f0, %lo(D_8010A998)($at)
    /* 9DD44 8019DD44 C442004C */  lwc1       $f2, 0x4C($v0)
    /* 9DD48 8019DD48 4602003E */  c.le.s     $f0, $f2
    ...
    /* 9DD5C 8019DD5C C420A99C */  lwc1       $f0, %lo(D_8010A99C)($at)
    /* 9DD60 8019DD60 4600103E */  c.le.s     $f2, $f0
    ...
    /* 9DD74 8019DD74 C420A9A0 */  lwc1       $f0, %lo(D_8010A9A0)($at)
    /* 9DD78 8019DD78 3C018011 */  lui        $at, %hi(D_8010A9A4)
  .L8019DD7C:
    /* 9DD7C 8019DD7C C422A9A4 */  lwc1       $f2, %lo(D_8010A9A4)($at)
    /* 9DD80 8019DD80 AFA00018 */  sw         $zero, 0x18($sp)
    /* 9DD84 8019DD84 E7A0001C */  swc1       $f0, 0x1C($sp)
    /* 9DD88 8019DD88 E7A20020 */  swc1       $f2, 0x20($sp)
    /* 9DD8C 8019DD8C 8E26007C */  lw         $a2, 0x7C($s1)
    /* 9DD90 8019DD90 0C05242B */  jal        func_801490AC
    /* 9DD94 8019DD94 00802821 */   addu      $a1, $a0, $zero
    /* 9DD98 8019DD98 C6200034 */  lwc1       $f0, 0x34($s1)
    /* 9DD9C 8019DD9C C7A20018 */  lwc1       $f2, 0x18($sp)
    /* 9DDA0 8019DDA0 46020001 */  sub.s      $f0, $f0, $f2
    /* 9DDA4 8019DDA4 C7A2001C */  lwc1       $f2, 0x1C($sp)
    /* 9DDA8 8019DDA8 E7A00028 */  swc1       $f0, 0x28($sp)
    /* 9DDAC 8019DDAC C6200038 */  lwc1       $f0, 0x38($s1)
    /* 9DDB0 8019DDB0 46020001 */  sub.s      $f0, $f0, $f2
    /* 9DDB4 8019DDB4 E7A0002C */  swc1       $f0, 0x2C($sp)
    /* 9DDB8 8019DDB8 C622003C */  lwc1       $f2, 0x3C($s1)
    /* 9DDBC 8019DDBC C7A00020 */  lwc1       $f0, 0x20($sp)
    /* 9DDC0 8019DDC0 46001081 */  sub.s      $f2, $f2, $f0
    ...
    /* 9DDD4 8019DDD4 E7A20030 */   swc1      $f2, 0x30($sp)
    /* 9DDD8 8019DDD8 3C01802A */  lui        $at, %hi(D_8029F9A8)
    /* 9DDDC 8019DDDC C422F9A8 */  lwc1       $f2, %lo(D_8029F9A8)($at)
    /* 9DDE0 8019DDE0 46021080 */  add.s      $f2, $f2, $f2
    /* 9DDE4 8019DDE4 4602003E */  c.le.s     $f0, $f2
  ...
  .L8019DDF8:
    ...
    /* 9DE28 8019DE28 C7A20018 */  lwc1       $f2, 0x18($sp)
    /* 9DE2C 8019DE2C 00621821 */  addu       $v1, $v1, $v0
    /* 9DE30 8019DE30 44830000 */  mtc1       $v1, $f0
    /* 9DE34 8019DE34 46800020 */  cvt.s.w    $f0, $f0
    /* 9DE38 8019DE38 46001080 */  add.s      $f2, $f2, $f0
    /* 9DE3C 8019DE3C 2404000B */  addiu      $a0, $zero, 0xB
    /* 9DE40 8019DE40 0C051C00 */  jal        func_80147000
    /* 9DE44 8019DE44 E7A20018 */   swc1      $f2, 0x18($sp)
    /* 9DE48 8019DE48 2442FFFB */  addiu      $v0, $v0, -0x5
    /* 9DE4C 8019DE4C 00021840 */  sll        $v1, $v0, 1
    /* 9DE50 8019DE50 C7A2001C */  lwc1       $f2, 0x1C($sp)
    /* 9DE54 8019DE54 00621821 */  addu       $v1, $v1, $v0
    /* 9DE58 8019DE58 44830000 */  mtc1       $v1, $f0
    /* 9DE5C 8019DE5C 46800020 */  cvt.s.w    $f0, $f0
    /* 9DE60 8019DE60 46001080 */  add.s      $f2, $f2, $f0
    /* 9DE64 8019DE64 2404000B */  addiu      $a0, $zero, 0xB
    /* 9DE68 8019DE68 0C051C00 */  jal        func_80147000
    /* 9DE6C 8019DE6C E7A2001C */   swc1      $f2, 0x1C($sp)
    /* 9DE70 8019DE70 2404000B */  addiu      $a0, $zero, 0xB
    /* 9DE74 8019DE74 2442FFFB */  addiu      $v0, $v0, -0x5
    /* 9DE78 8019DE78 00021840 */  sll        $v1, $v0, 1
    /* 9DE7C 8019DE7C C7A20020 */  lwc1       $f2, 0x20($sp)
    /* 9DE80 8019DE80 00621821 */  addu       $v1, $v1, $v0
    /* 9DE84 8019DE84 44830000 */  mtc1       $v1, $f0
    /* 9DE88 8019DE88 46800020 */  cvt.s.w    $f0, $f0
    /* 9DE8C 8019DE8C 46001080 */  add.s      $f2, $f2, $f0
    ...
    /* 9DEA0 8019DEA0 E7A20020 */  swc1       $f2, 0x20($sp)
