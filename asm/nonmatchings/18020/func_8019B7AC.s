...
glabel func_8019B7AC
  ...
  .L8019B7CC:
    ...
    /* 9B7E8 8019B7E8 C420A804 */  lwc1       $f0, %lo(D_8010A804)($at)
    /* 9B7EC 8019B7EC E4400008 */  swc1       $f0, 0x8($v0)
    /* 9B7F0 8019B7F0 8E0200D0 */  lw         $v0, 0xD0($s0)
    /* 9B7F4 8019B7F4 3C018011 */  lui        $at, %hi(D_8010A808)
    /* 9B7F8 8019B7F8 C420A808 */  lwc1       $f0, %lo(D_8010A808)($at)
    /* 9B7FC 8019B7FC 08066A09 */  j          .L8019A824
    /* 9B800 8019B800 E440000C */   swc1      $f0, 0xC($v0)
  .L8019B804:
    /* 9B804 8019B804 8E0200D0 */  lw         $v0, 0xD0($s0)
    /* 9B808 8019B808 3C018011 */  lui        $at, %hi(D_8010A80C)
    /* 9B80C 8019B80C C420A80C */  lwc1       $f0, %lo(D_8010A80C)($at)
    /* 9B810 8019B810 E440000C */  swc1       $f0, 0xC($v0)
    /* 9B814 8019B814 8E0200D0 */  lw         $v0, 0xD0($s0)
    /* 9B818 8019B818 3C018011 */  lui        $at, %hi(D_8010A810)
    /* 9B81C 8019B81C C420A810 */  lwc1       $f0, %lo(D_8010A810)($at)
    /* 9B820 8019B820 E4400008 */  swc1       $f0, 0x8($v0)
    ...
    /* 9B838 8019B838 C482004C */  lwc1       $f2, 0x4C($a0)
    /* 9B83C 8019B83C 3C018011 */  lui        $at, %hi(D_8010A814)
    /* 9B840 8019B840 C420A814 */  lwc1       $f0, %lo(D_8010A814)($at)
    /* 9B844 8019B844 4602003C */  c.lt.s     $f0, $f2
    ...
    /* 9B85C 8019B85C C6000034 */  lwc1       $f0, 0x34($s0)
    /* 9B860 8019B860 44821000 */  mtc1       $v0, $f2
    /* 9B864 8019B864 468010A0 */  cvt.s.w    $f2, $f2
    /* 9B868 8019B868 46020000 */  add.s      $f0, $f0, $f2
    /* 9B86C 8019B86C 3C018011 */  lui        $at, %hi(D_8010A818)
    /* 9B870 8019B870 C434A818 */  lwc1       $f20, %lo(D_8010A818)($at)
    /* 9B874 8019B874 46140001 */  sub.s      $f0, $f0, $f20
    /* 9B878 8019B878 E7A00018 */  swc1       $f0, 0x18($sp)
    /* 9B87C 8019B87C C6000038 */  lwc1       $f0, 0x38($s0)
    /* 9B880 8019B880 C6020030 */  lwc1       $f2, 0x30($s0)
    /* 9B884 8019B884 46020001 */  sub.s      $f0, $f0, $f2
    /* 9B888 8019B888 3C018011 */  lui        $at, %hi(D_8010A81C)
    /* 9B88C 8019B88C C422A81C */  lwc1       $f2, %lo(D_8010A81C)($at)
    /* 9B890 8019B890 46020000 */  add.s      $f0, $f0, $f2
    /* 9B894 8019B894 24040005 */  addiu      $a0, $zero, 0x5
    /* 9B898 8019B898 0C051C00 */  jal        func_80147000
    /* 9B89C 8019B89C E7A0001C */   swc1      $f0, 0x1C($sp)
    /* 9B8A0 8019B8A0 C602003C */  lwc1       $f2, 0x3C($s0)
    /* 9B8A4 8019B8A4 44820000 */  mtc1       $v0, $f0
    /* 9B8A8 8019B8A8 46800020 */  cvt.s.w    $f0, $f0
    /* 9B8AC 8019B8AC 46001080 */  add.s      $f2, $f2, $f0
    /* 9B8B0 8019B8B0 00002021 */  addu       $a0, $zero, $zero
    /* 9B8B4 8019B8B4 46141081 */  sub.s      $f2, $f2, $f20
    ...
    /* 9B8C8 8019B8C8 E7A20020 */  swc1       $f2, 0x20($sp)
  ...
  .L8019B8D4:
    ...
    /* 9B8D8 8019B8D8 C420A820 */  lwc1       $f0, %lo(D_8010A820)($at)
    /* 9B8DC 8019B8DC 08066A3C */  j          .L8019A8F0
    /* 9B8E0 8019B8E0 E6000070 */   swc1      $f0, 0x70($s0)
  .L8019B8E4:
    /* 9B8E4 8019B8E4 8E0200D0 */  lw         $v0, 0xD0($s0)
    /* 9B8E8 8019B8E8 C4400018 */  lwc1       $f0, 0x18($v0)
    /* 9B8EC 8019B8EC E6000070 */  swc1       $f0, 0x70($s0)
    ...
    /* 9B904 8019B904 C482004C */  lwc1       $f2, 0x4C($a0)
    /* 9B908 8019B908 3C018011 */  lui        $at, %hi(D_8010A824)
    /* 9B90C 8019B90C C420A824 */  lwc1       $f0, %lo(D_8010A824)($at)
    /* 9B910 8019B910 4602003C */  c.lt.s     $f0, $f2
    ...
    /* 9B924 8019B924 C420A828 */  lwc1       $f0, %lo(D_8010A828)($at)
    /* 9B928 8019B928 4600103C */  c.lt.s     $f2, $f0
