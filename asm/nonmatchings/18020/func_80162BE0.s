...
glabel func_80162BE0
  ...
  .L80162C78:
    ...
    /* 62C94 80162C94 C4200310 */  lwc1       $f0, %lo(D_80290310)($at)
    /* 62C98 80162C98 3C01802A */  lui        $at, %hi(D_8029F9B0)
    /* 62C9C 80162C9C C422F9B0 */  lwc1       $f2, %lo(D_8029F9B0)($at)
    /* 62CA0 80162CA0 46020001 */  sub.s      $f0, $f0, $f2
    /* 62CA4 80162CA4 3C018010 */  lui        $at, %hi(D_801073C4)
    /* 62CA8 80162CA8 C42473C4 */  lwc1       $f4, %lo(D_801073C4)($at)
    /* 62CAC 80162CAC 46040003 */  div.s      $f0, $f0, $f4
    /* 62CB0 80162CB0 46001080 */  add.s      $f2, $f2, $f0
    /* 62CB4 80162CB4 3C018029 */  lui        $at, %hi(D_8028FAB4)
    /* 62CB8 80162CB8 E422FAB4 */  swc1       $f2, %lo(D_8028FAB4)($at)
  ...
  .L80162CC4:
    ...
    /* 62CD0 80162CD0 C422FAB0 */  lwc1       $f2, %lo(D_8028FAB0)($at)
    /* 62CD4 80162CD4 C4400004 */  lwc1       $f0, 0x4($v0)
    /* 62CD8 80162CD8 46020000 */  add.s      $f0, $f0, $f2
    /* 62CDC 80162CDC 3C018029 */  lui        $at, %hi(D_8028FAB4)
    /* 62CE0 80162CE0 E420FAB4 */  swc1       $f0, %lo(D_8028FAB4)($at)
    /* 62CE4 80162CE4 3C018029 */  lui        $at, %hi(D_8028F9C8)
    /* 62CE8 80162CE8 C420F9C8 */  lwc1       $f0, %lo(D_8028F9C8)($at)
    /* 62CEC 80162CEC 3C018010 */  lui        $at, %hi(D_801073C8)
    /* 62CF0 80162CF0 C42273C8 */  lwc1       $f2, %lo(D_801073C8)($at)
    /* 62CF4 80162CF4 46020003 */  div.s      $f0, $f0, $f2
    /* 62CF8 80162CF8 3C028029 */  lui        $v0, %hi(D_8028FAB0)
    /* 62CFC 80162CFC 2442FAB0 */  addiu      $v0, $v0, %lo(D_8028FAB0)
    /* 62D00 80162D00 C444FF54 */  lwc1       $f4, -0xAC($v0)
    /* 62D04 80162D04 3C018029 */  lui        $at, %hi(D_8028FAB4)
    /* 62D08 80162D08 C428FAB4 */  lwc1       $f8, %lo(D_8028FAB4)($at)
    /* 62D0C 80162D0C 4608203C */  c.lt.s     $f4, $f8
    /* 62D10 80162D10 E4400000 */  swc1       $f0, 0x0($v0)
