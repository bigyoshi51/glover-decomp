...
glabel func_801B8824
    ...
    /* B8860 801B8860 C420BD88 */  lwc1       $f0, %lo(D_8010BD88)($at)
    /* B8864 801B8864 44821000 */  mtc1       $v0, $f2
    /* B8868 801B8868 468010A0 */  cvt.s.w    $f2, $f2
    /* B886C 801B886C 46001083 */  div.s      $f2, $f2, $f0
    /* B8870 801B8870 3C018011 */  lui        $at, %hi(D_8010BD8C)
    /* B8874 801B8874 C420BD8C */  lwc1       $f0, %lo(D_8010BD8C)($at)
    /* B8878 801B8878 46001080 */  add.s      $f2, $f2, $f0
    /* B887C 801B887C 3C018011 */  lui        $at, %hi(D_8010BD90)
    /* B8880 801B8880 C420BD90 */  lwc1       $f0, %lo(D_8010BD90)($at)
    /* B8884 801B8884 46001082 */  mul.s      $f2, $f2, $f0
    ...
    /* B8898 801B8898 4618A500 */  add.s      $f20, $f20, $f24
