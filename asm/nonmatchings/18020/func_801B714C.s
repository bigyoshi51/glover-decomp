nonmatching func_801B714C, 0x1F8

glabel func_801B714C
    ...
    /* B7160 801B7160 E7B700C8 */  swc1       $f23, 0xC8($sp)
    /* B7164 801B7164 E7B600CC */  swc1       $f22, 0xCC($sp)
    /* B7168 801B7168 C7B600E8 */  lwc1       $f22, 0xE8($sp)
    ...
    /* B717C 801B717C E7B900D0 */  swc1       $f25, 0xD0($sp)
    /* B7180 801B7180 E7B800D4 */  swc1       $f24, 0xD4($sp)
    /* B7184 801B7184 00820018 */  mult       $a0, $v0
    /* B7188 801B7188 4487C000 */  mtc1       $a3, $f24
    ...
    /* B719C 801B719C E7B500C0 */  swc1       $f21, 0xC0($sp)
    /* B71A0 801B71A0 E7B400C4 */  swc1       $f20, 0xC4($sp)
    ...
    /* B71D4 801B71D4 C422C7A0 */  lwc1       $f2, %lo(D_801EC7A0)($at)
    /* B71D8 801B71D8 46021080 */  add.s      $f2, $f2, $f2
    /* B71DC 801B71DC 4600103C */  c.lt.s     $f2, $f0
    ...
    /* B71F0 801B71F0 C421BC94 */  lwc1       $f1, %lo(D_8010BC90 + 0x4)($at)
    /* B71F4 801B71F4 C420BC98 */  lwc1       $f0, %lo(D_8010BC98)($at)
    /* B71F8 801B71F8 4600B521 */  cvt.d.s    $f20, $f22
    /* B71FC 801B71FC 4620A03C */  c.lt.d     $f20, $f0
  ...
  .L801B720C:
    ...
    /* B723C 801B723C C423BC9C */  lwc1       $f3, %lo(D_8010BC98 + 0x4)($at)
    /* B7240 801B7240 C422BCA0 */  lwc1       $f2, %lo(D_8010BCA0)($at)
    /* B7244 801B7244 4634103C */  c.lt.d     $f2, $f20
    /* B7248 801B7248 E7B80024 */  swc1       $f24, 0x24($sp)
    ...
    /* B7270 801B7270 C421BCA4 */  lwc1       $f1, %lo(D_8010BCA0 + 0x4)($at)
    /* B7274 801B7274 C420BCA8 */  lwc1       $f0, %lo(D_8010BCA8)($at)
    /* B7278 801B7278 4620A03C */  c.lt.d     $f20, $f0
    /* B727C 801B727C 00000000 */  nop
    /* B7280 801B7280 45000008 */  bc1f       .L801B72A4
    /* B7284 801B7284 00000000 */   nop
    /* B7288 801B7288 4634103C */  c.lt.d     $f2, $f20
  .L801B728C:
    /* B728C 801B728C 3C018011 */  lui        $at, %hi(D_8010BCAC)
    /* B7290 801B7290 C422BCAC */  lwc1       $f2, %lo(D_8010BCAC)($at)
    /* B7294 801B7294 45030005 */  bc1tl      .L801B72AC
  .L801B7298:
    /* B7298 801B7298 4600B086 */   mov.s     $f2, $f22
    /* B729C 801B729C 0806D8AC */  j          .L801B62B0
    /* B72A0 801B72A0 02002021 */   addu      $a0, $s0, $zero
  .L801B72A4:
    /* B72A4 801B72A4 3C018011 */  lui        $at, %hi(D_8010BCB0)
    /* B72A8 801B72A8 C422BCB0 */  lwc1       $f2, %lo(D_8010BCB0)($at)
  .L801B72AC:
    ...
    /* B72B8 801B72B8 C420BCB4 */  lwc1       $f0, %lo(D_8010BCB4)($at)
    ...
    /* B72C8 801B72C8 44071000 */  mfc1       $a3, $f2
  ...
  .L801B72DC:
    /* B72DC 801B72DC E7A00010 */  swc1       $f0, 0x10($sp)
    ...
    /* B72EC 801B72EC C420BCB8 */  lwc1       $f0, %lo(D_8010BCB8)($at)
    /* B72F0 801B72F0 02401021 */  addu       $v0, $s2, $zero
    /* B72F4 801B72F4 10400003 */  beqz       $v0, .L801B7304
    /* B72F8 801B72F8 E6000038 */   swc1      $f0, 0x38($s0)
  ...
  .L801B732C:
    ...
    /* B7340 801B7340 C7B900D0 */  lwc1       $f25, 0xD0($sp)
endlabel func_801B714C
