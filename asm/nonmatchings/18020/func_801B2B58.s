...
glabel func_801B2B58
    ...
    /* B2B68 801B2B68 E7B90050 */  swc1       $fs2f, 0x50($sp)
    /* B2B6C 801B2B6C E7B80054 */  swc1       $fs2, 0x54($sp)
    /* B2B70 801B2B70 E7B70048 */  swc1       $fs1f, 0x48($sp)
    /* B2B74 801B2B74 E7B6004C */  swc1       $fs1, 0x4C($sp)
    /* B2B78 801B2B78 E7B50040 */  swc1       $fs0f, 0x40($sp)
    /* B2B7C 801B2B7C E7B40044 */  swc1       $fs0, 0x44($sp)
    /* B2B80 801B2B80 AFA00010 */  sw         $zero, 0x10($sp)
    /* B2B84 801B2B84 AFA00014 */  sw         $zero, 0x14($sp)
    /* B2B88 801B2B88 C4400070 */  lwc1       $fv0, 0x70($v0)
    /* B2B8C 801B2B8C 3C018011 */  lui        $at, %hi(D_8010B8F0 + 0x4)
    /* B2B90 801B2B90 C423B8F4 */  lwc1       $fv1f, %lo(D_8010B8F0 + 0x4)($at)
    /* B2B94 801B2B94 C422B8F8 */  lwc1       $fv1, %lo(D_8010B8F8)($at)
    /* B2B98 801B2B98 46000021 */  cvt.d.s    $fv0, $fv0
    /* B2B9C 801B2B9C 46220101 */  sub.d      $ft0, $fv0, $fv1
    /* B2BA0 801B2BA0 3C018011 */  lui        $at, %hi(D_8010B8F8 + 0x4)
    /* B2BA4 801B2BA4 C421B8FC */  lwc1       $fv0f, %lo(D_8010B8F8 + 0x4)($at)
    /* B2BA8 801B2BA8 C420B900 */  lwc1       $fv0, %lo(D_8010B900)($at)
    /* B2BAC 801B2BAC 00808821 */  addu       $s1, $a0, $zero
    /* B2BB0 801B2BB0 3C01801F */  lui        $at, %hi(D_801EEC40)
    /* B2BB4 801B2BB4 C422EC40 */  lwc1       $fv1, %lo(D_801EEC40)($at)
    /* B2BB8 801B2BB8 4620203C */  c.lt.d     $ft0, $fv0
    /* B2BBC 801B2BBC 00A09021 */  addu       $s2, $a1, $zero
    /* B2BC0 801B2BC0 45000007 */  bc1f       .L801B2BE0
    /* B2BC4 801B2BC4 460010A1 */   cvt.d.s   $fv1, $fv1
    /* B2BC8 801B2BC8 3C018011 */  lui        $at, %hi(D_8010B900 + 0x4)
    /* B2BCC 801B2BCC C421B904 */  lwc1       $fv0f, %lo(D_8010B900 + 0x4)($at)
    /* B2BD0 801B2BD0 C420B908 */  lwc1       $fv0, %lo(D_8010B908)($at)
    /* B2BD4 801B2BD4 46220082 */  mul.d      $fv1, $fv0, $fv1
    /* B2BD8 801B2BD8 0806C6FD */  j          .L801B1BF4
    /* B2BDC 801B2BDC 00000000 */   nop
  .L801B2BE0:
    /* B2BE0 801B2BE0 3C018011 */  lui        $at, %hi(D_8010B908 + 0x4)
    /* B2BE4 801B2BE4 C421B90C */  lwc1       $fv0f, %lo(D_8010B908 + 0x4)($at)
    /* B2BE8 801B2BE8 C420B910 */  lwc1       $fv0, %lo(D_8010B910)($at)
    /* B2BEC 801B2BEC 46202003 */  div.d      $fv0, $ft0, $fv0
    /* B2BF0 801B2BF0 46220082 */  mul.d      $fv1, $fv0, $fv1
    /* B2BF4 801B2BF4 3C018029 */  lui        $at, %hi(D_80290394)
    /* B2BF8 801B2BF8 C4200394 */  lwc1       $fv0, %lo(D_80290394)($at)
    /* B2BFC 801B2BFC 3C018011 */  lui        $at, %hi(D_8010B910 + 0x4)
    /* B2C00 801B2C00 C425B914 */  lwc1       $ft0f, %lo(D_8010B910 + 0x4)($at)
    /* B2C04 801B2C04 C424B918 */  lwc1       $ft0, %lo(D_8010B918)($at)
    /* B2C08 801B2C08 46000021 */  cvt.d.s    $fv0, $fv0
    /* B2C0C 801B2C0C 4620203C */  c.lt.d     $ft0, $fv0
    /* B2C10 801B2C10 00000000 */  nop
    /* B2C14 801B2C14 46201002 */  mul.d      $fv0, $fv1, $fv0
    /* B2C18 801B2C18 45020003 */  bc1fl      .L801B2C28
    /* B2C1C 801B2C1C 00000000 */   nop
    /* B2C20 801B2C20 00000000 */  nop
    /* B2C24 801B2C24 46241002 */  mul.d      $fv0, $fv1, $ft0
  .L801B2C28:
    /* B2C28 801B2C28 3C028029 */  lui        $v0, %hi(D_802901AC)
    /* B2C2C 801B2C2C 8C4201AC */  lw         $v0, %lo(D_802901AC)($v0)
    /* B2C30 801B2C30 462000A0 */  cvt.s.d    $fv1, $fv0
    /* B2C34 801B2C34 10400013 */  beqz       $v0, .L801B2C84
    /* B2C38 801B2C38 E7A20018 */   swc1      $fv1, 0x18($sp)
    /* B2C3C 801B2C3C 3C02802A */  lui        $v0, %hi(D_8029FA50)
    /* B2C40 801B2C40 8C42FA50 */  lw         $v0, %lo(D_8029FA50)($v0)
    /* B2C44 801B2C44 C4400070 */  lwc1       $fv0, 0x70($v0)
    /* B2C48 801B2C48 3C018011 */  lui        $at, %hi(D_8010B918 + 0x4)
    /* B2C4C 801B2C4C C427B91C */  lwc1       $ft1f, %lo(D_8010B918 + 0x4)($at)
    /* B2C50 801B2C50 C426B920 */  lwc1       $ft1, %lo(D_8010B920)($at)
    /* B2C54 801B2C54 46000121 */  cvt.d.s    $ft0, $fv0
    /* B2C58 801B2C58 4626203C */  c.lt.d     $ft0, $ft1
    /* B2C5C 801B2C5C 00000000 */  nop
  .L801B2C60:
    /* B2C60 801B2C60 45000004 */  bc1f       .L801B2C74
    /* B2C64 801B2C64 00000000 */   nop
    /* B2C68 801B2C68 46243001 */  sub.d      $fv0, $ft1, $ft0
    /* B2C6C 801B2C6C 46200020 */  cvt.s.d    $fv0, $fv0
    /* B2C70 801B2C70 E7A00014 */  swc1       $fv0, 0x14($sp)
  .L801B2C74:
    /* B2C74 801B2C74 3C018011 */  lui        $at, %hi(D_8010B924)
    /* B2C78 801B2C78 C420B924 */  lwc1       $fv0, %lo(D_8010B924)($at)
    /* B2C7C 801B2C7C 46001001 */  sub.s      $fv0, $fv1, $fv0
    /* B2C80 801B2C80 E7A00018 */  swc1       $fv0, 0x18($sp)
  .L801B2C84:
    /* B2C84 801B2C84 3C018029 */  lui        $at, %hi(D_80290350)
    /* B2C88 801B2C88 C4200350 */  lwc1       $fv0, %lo(D_80290350)($at)
    /* B2C8C 801B2C8C 27A40010 */  addiu      $a0, $sp, 0x10
    /* B2C90 801B2C90 46000007 */  neg.s      $fv0, $fv0
    /* B2C94 801B2C94 00802821 */  addu       $a1, $a0, $zero
    /* B2C98 801B2C98 44060000 */  mfc1       $a2, $fv0
    ...
    /* B2CA8 801B2CA8 C42C0354 */  lwc1       $fa0, %lo(D_80290354)($at)
    /* B2CAC 801B2CAC 3C018011 */  lui        $at, %hi(D_8010B928)
    /* B2CB0 801B2CB0 C421B928 */  lwc1       $fv0f, %lo(D_8010B928)($at)
    /* B2CB4 801B2CB4 C420B92C */  lwc1       $fv0, %lo(D_8010B928 + 0x4)($at)
    /* B2CB8 801B2CB8 46006321 */  cvt.d.s    $fa0, $fa0
    /* B2CBC 801B2CBC 46206300 */  add.d      $fa0, $fa0, $fv0
    ...
    /* B2CDC 801B2CDC 46206320 */   cvt.s.d   $fa0, $fa0
    /* B2CE0 801B2CE0 27A40010 */  addiu      $a0, $sp, 0x10
    /* B2CE4 801B2CE4 44060000 */  mfc1       $a2, $fv0
    ...
    /* B2CF8 801B2CF8 C6000000 */  lwc1       $fv0, 0x0($s0)
    /* B2CFC 801B2CFC C7A20010 */  lwc1       $fv1, 0x10($sp)
    /* B2D00 801B2D00 46020000 */  add.s      $fv0, $fv0, $fv1
    /* B2D04 801B2D04 E6200000 */  swc1       $fv0, 0x0($s1)
    /* B2D08 801B2D08 3C01802A */  lui        $at, %hi(D_8029F9B0)
    /* B2D0C 801B2D0C C420F9B0 */  lwc1       $fv0, %lo(D_8029F9B0)($at)
    /* B2D10 801B2D10 C7A20014 */  lwc1       $fv1, 0x14($sp)
    /* B2D14 801B2D14 46020000 */  add.s      $fv0, $fv0, $fv1
    /* B2D18 801B2D18 E6200004 */  swc1       $fv0, 0x4($s1)
  .L801B2D1C:
    /* B2D1C 801B2D1C 3C01802A */  lui        $at, %hi(D_8029F9B4)
    /* B2D20 801B2D20 C420F9B4 */  lwc1       $fv0, %lo(D_8029F9B4)($at)
    /* B2D24 801B2D24 C7A20018 */  lwc1       $fv1, 0x18($sp)
    /* B2D28 801B2D28 46020000 */  add.s      $fv0, $fv0, $fv1
  .L801B2D2C:
    /* B2D2C 801B2D2C E6200008 */  swc1       $fv0, 0x8($s1)
    /* B2D30 801B2D30 C6140000 */  lwc1       $fs0, 0x0($s0)
    /* B2D34 801B2D34 3C01802A */  lui        $at, %hi(D_8029F9B8)
    /* B2D38 801B2D38 C420F9B8 */  lwc1       $fv0, %lo(D_8029F9B8)($at)
    /* B2D3C 801B2D3C 3C01802A */  lui        $at, %hi(D_8029F9B4)
    /* B2D40 801B2D40 C422F9B4 */  lwc1       $fv1, %lo(D_8029F9B4)($at)
    /* B2D44 801B2D44 4600A501 */  sub.s      $fs0, $fs0, $fv0
    /* B2D48 801B2D48 3C01802A */  lui        $at, %hi(D_8029F9C0)
    /* B2D4C 801B2D4C C420F9C0 */  lwc1       $fv0, %lo(D_8029F9C0)($at)
    /* B2D50 801B2D50 46001601 */  sub.s      $fs2, $fv1, $fv0
    /* B2D54 801B2D54 4600A306 */  mov.s      $fa0, $fs0
    /* B2D58 801B2D58 0C051D18 */  jal        func_80147460
    /* B2D5C 801B2D5C 4600C386 */   mov.s     $fa1, $fs2
    /* B2D60 801B2D60 0C0525B2 */  jal        func_801496C8
    /* B2D64 801B2D64 46000306 */   mov.s     $fa0, $fv0
    /* B2D68 801B2D68 27A40020 */  addiu      $a0, $sp, 0x20
    /* B2D6C 801B2D6C 46000586 */  mov.s      $fs1, $fv0
    /* B2D70 801B2D70 4406B000 */  mfc1       $a2, $fs1
    /* B2D74 801B2D74 0C05242B */  jal        func_801490AC
    /* B2D78 801B2D78 00802821 */   addu      $a1, $a0, $zero
    /* B2D7C 801B2D7C C6000000 */  lwc1       $fv0, 0x0($s0)
    /* B2D80 801B2D80 C7A20020 */  lwc1       $fv1, 0x20($sp)
    /* B2D84 801B2D84 46020000 */  add.s      $fv0, $fv0, $fv1
    /* B2D88 801B2D88 E6400000 */  swc1       $fv0, 0x0($s2)
    /* B2D8C 801B2D8C 3C01802A */  lui        $at, %hi(D_8029F9B0)
    /* B2D90 801B2D90 C420F9B0 */  lwc1       $fv0, %lo(D_8029F9B0)($at)
    /* B2D94 801B2D94 C7A20024 */  lwc1       $fv1, 0x24($sp)
    /* B2D98 801B2D98 46020000 */  add.s      $fv0, $fv0, $fv1
    /* B2D9C 801B2D9C E6400004 */  swc1       $fv0, 0x4($s2)
    /* B2DA0 801B2DA0 3C01802A */  lui        $at, %hi(D_8029F9B4)
    /* B2DA4 801B2DA4 C422F9B4 */  lwc1       $fv1, %lo(D_8029F9B4)($at)
    /* B2DA8 801B2DA8 C7A00028 */  lwc1       $fv0, 0x28($sp)
    /* B2DAC 801B2DAC 46001080 */  add.s      $fv1, $fv1, $fv0
    /* B2DB0 801B2DB0 44800000 */  mtc1       $zero, $fv0
    /* B2DB4 801B2DB4 4600A032 */  c.eq.s     $fs0, $fv0
    /* B2DB8 801B2DB8 24020001 */  addiu      $v0, $zero, 0x1
    /* B2DBC 801B2DBC 45010002 */  bc1t       .L801B2DC8
    /* B2DC0 801B2DC0 E6420008 */   swc1      $fv1, 0x8($s2)
    /* B2DC4 801B2DC4 00001021 */  addu       $v0, $zero, $zero
  .L801B2DC8:
    /* B2DC8 801B2DC8 4600C032 */  c.eq.s     $fs2, $fv0
  ...
  .L801B2DDC:
    ...
    /* B2DEC 801B2DEC C42E0354 */  lwc1       $fa1, %lo(D_80290354)($at)
    /* B2DF0 801B2DF0 0C052513 */  jal        func_8014944C
    /* B2DF4 801B2DF4 4600B306 */   mov.s     $fa0, $fs1
    /* B2DF8 801B2DF8 3C018011 */  lui        $at, %hi(D_8010B930)
    /* B2DFC 801B2DFC C422B930 */  lwc1       $fv1, %lo(D_8010B930)($at)
    /* B2E00 801B2E00 4602003C */  c.lt.s     $fv0, $fv1
  ...
  .L801B2E14:
    ...
    /* B2E24 801B2E24 C7B90050 */  lwc1       $fs2f, 0x50($sp)
    /* B2E28 801B2E28 C7B80054 */  lwc1       $fs2, 0x54($sp)
    /* B2E2C 801B2E2C C7B70048 */  lwc1       $fs1f, 0x48($sp)
    /* B2E30 801B2E30 C7B6004C */  lwc1       $fs1, 0x4C($sp)
    /* B2E34 801B2E34 C7B50040 */  lwc1       $fs0f, 0x40($sp)
    /* B2E38 801B2E38 C7B40044 */  lwc1       $fs0, 0x44($sp)
    ...
    /* B2E8C 801B2E8C E7B70038 */  swc1       $fs1f, 0x38($sp)
    /* B2E90 801B2E90 E7B6003C */  swc1       $fs1, 0x3C($sp)
    /* B2E94 801B2E94 E7B50030 */  swc1       $fs0f, 0x30($sp)
    /* B2E98 801B2E98 E7B40034 */  swc1       $fs0, 0x34($sp)
  ...
  .L801B2F34:
    ...
    /* B2F3C 801B2F3C C4400000 */  lwc1       $fv0, 0x0($v0)
    /* B2F40 801B2F40 3C018011 */  lui        $at, %hi(D_8010B938 + 0x4)
    /* B2F44 801B2F44 C423B93C */  lwc1       $fv1f, %lo(D_8010B938 + 0x4)($at)
    /* B2F48 801B2F48 C422B940 */  lwc1       $fv1, %lo(D_8010B940)($at)
    /* B2F4C 801B2F4C 46000021 */  cvt.d.s    $fv0, $fv0
    /* B2F50 801B2F50 46220002 */  mul.d      $fv0, $fv0, $fv1
    /* B2F54 801B2F54 46200020 */  cvt.s.d    $fv0, $fv0
    /* B2F58 801B2F58 E4400000 */  swc1       $fv0, 0x0($v0)
    /* B2F5C 801B2F5C C480000C */  lwc1       $fv0, 0xC($a0)
    /* B2F60 801B2F60 4480A000 */  mtc1       $zero, $fs0
    /* B2F64 801B2F64 4600A03C */  c.lt.s     $fs0, $fv0
    ...
    /* B2F78 801B2F78 C42CB944 */  lwc1       $fa0, %lo(D_8010B944)($at)
    ...
    /* B2F98 801B2F98 C420EC40 */  lwc1       $fv0, %lo(D_801EEC40)($at)
    /* B2F9C 801B2F9C 3C018011 */  lui        $at, %hi(D_8010B948)
    /* B2FA0 801B2FA0 C423B948 */  lwc1       $fv1f, %lo(D_8010B948)($at)
    /* B2FA4 801B2FA4 C422B94C */  lwc1       $fv1, %lo(D_8010B948 + 0x4)($at)
    /* B2FA8 801B2FA8 46000021 */  cvt.d.s    $fv0, $fv0
    /* B2FAC 801B2FAC 46220002 */  mul.d      $fv0, $fv0, $fv1
    /* B2FB0 801B2FB0 3C018011 */  lui        $at, %hi(D_8010B950)
    /* B2FB4 801B2FB4 C423B950 */  lwc1       $fv1f, %lo(D_8010B950)($at)
    /* B2FB8 801B2FB8 C422B954 */  lwc1       $fv1, %lo(D_8010B950 + 0x4)($at)
    /* B2FBC 801B2FBC 46220003 */  div.d      $fv0, $fv0, $fv1
    /* B2FC0 801B2FC0 3C02802A */  lui        $v0, %hi(D_8029FA50)
    /* B2FC4 801B2FC4 8C42FA50 */  lw         $v0, %lo(D_8029FA50)($v0)
    /* B2FC8 801B2FC8 C4420070 */  lwc1       $fv1, 0x70($v0)
    /* B2FCC 801B2FCC 460010A1 */  cvt.d.s    $fv1, $fv1
    /* B2FD0 801B2FD0 46201081 */  sub.d      $fv1, $fv1, $fv0
    /* B2FD4 801B2FD4 3C018011 */  lui        $at, %hi(D_8010B958)
    /* B2FD8 801B2FD8 C425B958 */  lwc1       $ft0f, %lo(D_8010B958)($at)
    /* B2FDC 801B2FDC C424B95C */  lwc1       $ft0, %lo(D_8010B958 + 0x4)($at)
    /* B2FE0 801B2FE0 3C018011 */  lui        $at, %hi(D_8010B960)
    /* B2FE4 801B2FE4 C426B960 */  lwc1       $ft1, %lo(D_8010B960)($at)
    /* B2FE8 801B2FE8 3C01801F */  lui        $at, %hi(D_801F1AF0)
    /* B2FEC 801B2FEC C4201AF0 */  lwc1       $fv0, %lo(D_801F1AF0)($at)
    /* B2FF0 801B2FF0 46241082 */  mul.d      $fv1, $fv1, $ft0
    /* B2FF4 801B2FF4 46060001 */  sub.s      $fv0, $fv0, $ft1
    /* B2FF8 801B2FF8 46000021 */  cvt.d.s    $fv0, $fv0
    /* B2FFC 801B2FFC 46220000 */  add.d      $fv0, $fv0, $fv1
    /* B3000 801B3000 46200020 */  cvt.s.d    $fv0, $fv0
    /* B3004 801B3004 44050000 */  mfc1       $a1, $fv0
    ...
    /* B3014 801B3014 E434F430 */  swc1       $fs0, %lo(D_8029F430)($at)
  ...
  .L801B3020:
    ...
    /* B3028 801B3028 C440000C */  lwc1       $fv0, 0xC($v0)
    /* B302C 801B302C 44803000 */  mtc1       $zero, $ft1
    /* B3030 801B3030 4606003C */  c.lt.s     $fv0, $ft1
    /* B3034 801B3034 00000000 */  nop
    /* B3038 801B3038 4500001E */  bc1f       .L801B30B4
    /* B303C 801B303C 00000000 */   nop
    /* B3040 801B3040 C442004C */  lwc1       $fv1, 0x4C($v0)
    /* B3044 801B3044 3C018011 */  lui        $at, %hi(D_8010B964)
    /* B3048 801B3048 C424B964 */  lwc1       $ft0, %lo(D_8010B964)($at)
    /* B304C 801B304C 4604103E */  c.le.s     $fv1, $ft0
    /* B3050 801B3050 00000000 */  nop
    /* B3054 801B3054 45000017 */  bc1f       .L801B30B4
    /* B3058 801B3058 00000000 */   nop
    /* B305C 801B305C 46040000 */  add.s      $fv0, $fv0, $ft0
    /* B3060 801B3060 4602003C */  c.lt.s     $fv0, $fv1
    ...
    /* B3078 801B3078 C4400074 */  lwc1       $fv0, 0x74($v0)
    /* B307C 801B307C 3C018011 */  lui        $at, %hi(D_8010B968)
    /* B3080 801B3080 C423B968 */  lwc1       $fv1f, %lo(D_8010B968)($at)
    /* B3084 801B3084 C422B96C */  lwc1       $fv1, %lo(D_8010B968 + 0x4)($at)
    /* B3088 801B3088 3C048029 */  lui        $a0, %hi(D_802903B0)
    /* B308C 801B308C 8C8403B0 */  lw         $a0, %lo(D_802903B0)($a0)
    /* B3090 801B3090 46000021 */  cvt.d.s    $fv0, $fv0
    /* B3094 801B3094 46220000 */  add.d      $fv0, $fv0, $fv1
    /* B3098 801B3098 3C01802A */  lui        $at, %hi(D_8029F434)
    /* B309C 801B309C E426F434 */  swc1       $ft1, %lo(D_8029F434)($at)
    /* B30A0 801B30A0 46200020 */  cvt.s.d    $fv0, $fv0
    /* B30A4 801B30A4 44050000 */  mfc1       $a1, $fv0
  ...
  .L801B30B4:
    ...
    /* B30B8 801B30B8 C420F9A8 */  lwc1       $fv0, %lo(D_8029F9A8)($at)
    /* B30BC 801B30BC 3C018011 */  lui        $at, %hi(D_8010B970)
    /* B30C0 801B30C0 C423B970 */  lwc1       $fv1f, %lo(D_8010B970)($at)
    /* B30C4 801B30C4 C422B974 */  lwc1       $fv1, %lo(D_8010B970 + 0x4)($at)
    /* B30C8 801B30C8 46000021 */  cvt.d.s    $fv0, $fv0
    /* B30CC 801B30CC 46220101 */  sub.d      $ft0, $fv0, $fv1
    /* B30D0 801B30D0 44800000 */  mtc1       $zero, $fv0
    /* B30D4 801B30D4 44800800 */  mtc1       $zero, $fv0f
    /* B30D8 801B30D8 4624003C */  c.lt.d     $fv0, $ft0
    /* B30DC 801B30DC 00000000 */  nop
    /* B30E0 801B30E0 4502000A */  bc1fl      .L801B310C
    /* B30E4 801B30E4 46202007 */   neg.d     $fv0, $ft0
    /* B30E8 801B30E8 3C018011 */  lui        $at, %hi(D_8010B978)
    /* B30EC 801B30EC C421B978 */  lwc1       $fv0f, %lo(D_8010B978)($at)
    /* B30F0 801B30F0 C420B97C */  lwc1       $fv0, %lo(D_8010B978 + 0x4)($at)
    /* B30F4 801B30F4 4624003C */  c.lt.d     $fv0, $ft0
  ...
  .L801B310C:
    ...
    /* B3110 801B3110 C423B980 */  lwc1       $fv1f, %lo(D_8010B980)($at)
    /* B3114 801B3114 C422B984 */  lwc1       $fv1, %lo(D_8010B980 + 0x4)($at)
    /* B3118 801B3118 4620103C */  c.lt.d     $fv1, $fv0
    ...
    /* B3130 801B3130 C6140000 */  lwc1       $fs0, 0x0($s0)
    /* B3134 801B3134 3C018029 */  lui        $at, %hi(D_80290334)
    /* B3138 801B3138 C4360334 */  lwc1       $fs1, %lo(D_80290334)($at)
    /* B313C 801B313C 0C06C60B */  jal        func_801B182C
    /* B3140 801B3140 24110001 */   addiu     $s1, $zero, 0x1
    /* B3144 801B3144 E6140000 */  swc1       $fs0, 0x0($s0)
    /* B3148 801B3148 3C018029 */  lui        $at, %hi(D_80290334)
    /* B314C 801B314C E4360334 */  swc1       $fs1, %lo(D_80290334)($at)
  .L801B3150:
    /* B3150 801B3150 3C01802A */  lui        $at, %hi(D_8029F434)
    /* B3154 801B3154 C420F434 */  lwc1       $fv0, %lo(D_8029F434)($at)
    /* B3158 801B3158 3C01802A */  lui        $at, %hi(D_8029F430)
    /* B315C 801B315C C422F430 */  lwc1       $fv1, %lo(D_8029F430)($at)
    /* B3160 801B3160 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* B3164 801B3164 3C018011 */  lui        $at, %hi(D_8010B988)
  .L801B3168:
    /* B3168 801B3168 C422B988 */  lwc1       $fv1, %lo(D_8010B988)($at)
    /* B316C 801B316C 46020003 */  div.s      $fv0, $fv0, $fv1
    /* B3170 801B3170 3C01801F */  lui        $at, %hi(D_801F1AF4)
    /* B3174 801B3174 C4221AF4 */  lwc1       $fv1, %lo(D_801F1AF4)($at)
    /* B3178 801B3178 46001107 */  neg.s      $ft0, $fv1
    /* B317C 801B317C 4604003C */  c.lt.s     $fv0, $ft0
    /* B3180 801B3180 00000000 */  nop
    /* B3184 801B3184 45000007 */  bc1f       .L801B31A4
    /* B3188 801B3188 00000000 */   nop
    /* B318C 801B318C 4602203C */  c.lt.s     $ft0, $fv1
  ...
  .L801B31A4:
    /* B31A4 801B31A4 4602003C */  c.lt.s     $fv0, $fv1
