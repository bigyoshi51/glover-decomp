...
glabel func_8015EE6C
    ...
    /* 5EEB8 8015EEB8 C420030C */  lwc1       $fv0, %lo(D_8029030C)($at)
    /* 5EEBC 8015EEBC C44200B4 */  lwc1       $fv1, 0xB4($v0)
    /* 5EEC0 8015EEC0 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* 5EEC4 8015EEC4 3C018029 */  lui        $at, %hi(D_80290098)
    /* 5EEC8 8015EEC8 E4200098 */  swc1       $fv0, %lo(D_80290098)($at)
    /* 5EECC 8015EECC 8C620178 */  lw         $v0, 0x178($v1)
    /* 5EED0 8015EED0 3C018029 */  lui        $at, %hi(D_80290310)
    /* 5EED4 8015EED4 C4200310 */  lwc1       $fv0, %lo(D_80290310)($at)
    /* 5EED8 8015EED8 C44200B8 */  lwc1       $fv1, 0xB8($v0)
    /* 5EEDC 8015EEDC 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* 5EEE0 8015EEE0 3C018029 */  lui        $at, %hi(D_8029009C)
    /* 5EEE4 8015EEE4 E420009C */  swc1       $fv0, %lo(D_8029009C)($at)
    /* 5EEE8 8015EEE8 8C620178 */  lw         $v0, 0x178($v1)
    /* 5EEEC 8015EEEC 3C018029 */  lui        $at, %hi(D_80290314)
    /* 5EEF0 8015EEF0 C4200314 */  lwc1       $fv0, %lo(D_80290314)($at)
    /* 5EEF4 8015EEF4 C44200BC */  lwc1       $fv1, 0xBC($v0)
    /* 5EEF8 8015EEF8 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* 5EEFC 8015EEFC 3C018029 */  lui        $at, %hi(D_802900A0)
    /* 5EF00 8015EF00 E42000A0 */  swc1       $fv0, %lo(D_802900A0)($at)
  ...
  .L8015EF34:
    ...
    /* 5EF44 8015EF44 44800000 */  mtc1       $zero, $fv0
    /* 5EF48 8015EF48 E6200060 */  swc1       $fv0, 0x60($s1)
    /* 5EF4C 8015EF4C E620005C */  swc1       $fv0, 0x5C($s1)
    /* 5EF50 8015EF50 E6200058 */  swc1       $fv0, 0x58($s1)
    /* 5EF54 8015EF54 E6200074 */  swc1       $fv0, 0x74($s1)
  .L8015EF58:
    ...
    /* 5EFA0 8015EFA0 C4367278 */  lwc1       $fs1, %lo(D_80107278)($at)
    ...
    /* 5EFB0 8015EFB0 4480A000 */  mtc1       $zero, $fs0
  .L8015EFB4:
    /* 5EFB4 8015EFB4 82030000 */  lb         $v1, 0x0($s0)
    /* 5EFB8 8015EFB8 00031080 */  sll        $v0, $v1, 2
  .L8015EFBC:
    /* 5EFBC 8015EFBC 00521021 */  addu       $v0, $v0, $s2
    /* 5EFC0 8015EFC0 C4400000 */  lwc1       $fv0, 0x0($v0)
    /* 5EFC4 8015EFC4 46140032 */  c.eq.s     $fv0, $fs0
    ...
    /* 5EFE8 8015EFE8 E7B60028 */   swc1      $fs1, 0x28($sp)
    /* 5EFEC 8015EFEC 0805780A */  j          .L8015E028
    /* 5EFF0 8015EFF0 00000000 */   nop
  .L8015EFF4:
    /* 5EFF4 8015EFF4 5074000A */  beql       $v1, $s4, .L8015F020
    /* 5EFF8 8015EFF8 E7B40028 */   swc1      $fs0, 0x28($sp)
    /* 5EFFC 8015EFFC 0805780A */  j          .L8015E028
    /* 5F000 8015F000 00000000 */   nop
  .L8015F004:
    /* 5F004 8015F004 E7B4002C */  swc1       $fs0, 0x2C($sp)
    /* 5F008 8015F008 0805780A */  j          .L8015E028
    /* 5F00C 8015F00C E7B40030 */   swc1      $fs0, 0x30($sp)
  .L8015F010:
    /* 5F010 8015F010 E7B40028 */  swc1       $fs0, 0x28($sp)
    /* 5F014 8015F014 E7B6002C */  swc1       $fs1, 0x2C($sp)
    /* 5F018 8015F018 0805780A */  j          .L8015E028
    /* 5F01C 8015F01C E7B40030 */   swc1      $fs0, 0x30($sp)
  .L8015F020:
    /* 5F020 8015F020 E7B4002C */  swc1       $fs0, 0x2C($sp)
    /* 5F024 8015F024 E7B60030 */  swc1       $fs1, 0x30($sp)
    /* 5F028 8015F028 82020000 */  lb         $v0, 0x0($s0)
    /* 5F02C 8015F02C 00021080 */  sll        $v0, $v0, 2
    /* 5F030 8015F030 00521021 */  addu       $v0, $v0, $s2
    /* 5F034 8015F034 C4400000 */  lwc1       $fv0, 0x0($v0)
    ...
    /* 5F044 8015F044 E7A00034 */   swc1      $fv0, 0x34($sp)
  ...
  .L8015F07C:
    ...
    /* 5F084 8015F084 C7B70080 */  lwc1       $fs1f, 0x80($sp)
    /* 5F088 8015F088 C7B60084 */  lwc1       $fs1, 0x84($sp)
    /* 5F08C 8015F08C C7B50078 */  lwc1       $fs0f, 0x78($sp)
    /* 5F090 8015F090 C7B4007C */  lwc1       $fs0, 0x7C($sp)
