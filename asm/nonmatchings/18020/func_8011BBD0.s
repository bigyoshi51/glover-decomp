...
glabel func_8011BBD0
    ...
    /* 1BBF0 8011BBF0 E4400038 */  swc1       $fv0, 0x38($v0)
    ...
    /* 1BC0C 8011BC0C C4200C58 */  lwc1       $fv0, %lo(D_80100C58)($at)
    /* 1BC10 8011BC10 3C018010 */  lui        $at, %hi(D_80100C5C)
    /* 1BC14 8011BC14 C4220C5C */  lwc1       $fv1, %lo(D_80100C5C)($at)
    ...
    /* 1BC2C 8011BC2C E4207D50 */  swc1       $fv0, %lo(D_801F7D50)($at)
    /* 1BC30 8011BC30 3C01801F */  lui        $at, %hi(D_801F7D54)
    /* 1BC34 8011BC34 E4227D54 */  swc1       $fv1, %lo(D_801F7D54)($at)
  .L8011BC38:
    /* 1BC38 8011BC38 24100046 */  addiu      $s0, $zero, 0x46
    /* 1BC3C 8011BC3C 44800000 */  mtc1       $zero, $fv0
    /* 1BC40 8011BC40 24120001 */  addiu      $s2, $zero, 0x1
    /* 1BC44 8011BC44 46000506 */  mov.s      $fs0, $fv0
    /* 1BC48 8011BC48 3C018029 */  lui        $at, %hi(D_80290338)
    /* 1BC4C 8011BC4C E4340338 */  swc1       $fs0, %lo(D_80290338)($at)
    /* 1BC50 8011BC50 3C018029 */  lui        $at, %hi(D_80290334)
    /* 1BC54 8011BC54 E4340334 */  swc1       $fs0, %lo(D_80290334)($at)
    /* 1BC58 8011BC58 3C018029 */  lui        $at, %hi(D_80290330)
    /* 1BC5C 8011BC5C E4340330 */  swc1       $fs0, %lo(D_80290330)($at)
  .L8011BC60:
    ...
    /* 1BC88 8011BC88 C48000F4 */  lwc1       $fv0, 0xF4($a0)
    /* 1BC8C 8011BC8C 46140032 */  c.eq.s     $fv0, $fs0
