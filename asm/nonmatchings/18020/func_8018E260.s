...
glabel func_8018E260
  ...
  .L8018E2E4:
    ...
    /* 8E308 8018E308 C42CFE4C */  lwc1       $f12, %lo(D_8028FE4C)($at)
    /* 8E30C 8018E30C 3C018011 */  lui        $at, %hi(D_80109740)
    /* 8E310 8018E310 C4219740 */  lwc1       $f1, %lo(D_80109740)($at)
    /* 8E314 8018E314 C4209744 */  lwc1       $f0, %lo(D_80109740 + 0x4)($at)
    /* 8E318 8018E318 46006321 */  cvt.d.s    $f12, $f12
    /* 8E31C 8018E31C 46206300 */  add.d      $f12, $f12, $f0
    /* 8E320 8018E320 0C0525B2 */  jal        func_801496C8
    /* 8E324 8018E324 46206320 */   cvt.s.d   $f12, $f12
    /* 8E328 8018E328 3C018029 */  lui        $at, %hi(D_8028FE4C)
    /* 8E32C 8018E32C E420FE4C */  swc1       $f0, %lo(D_8028FE4C)($at)
  .L8018E330:
  ...
  .L8018E348:
    ...
    /* 8E350 8018E350 C4400030 */  lwc1       $f0, 0x30($v0)
    /* 8E354 8018E354 44801000 */  mtc1       $zero, $f2
    /* 8E358 8018E358 46020032 */  c.eq.s     $f0, $f2
    ...
    /* 8E370 8018E370 E4420018 */  swc1       $f2, 0x18($v0)
  .L8018E374:
