...
glabel func_8012A77C
    /* 2A77C 8012A77C 46020000 */  add.s      $f0, $f0, $f2
    /* 2A780 8012A780 E4400044 */  swc1       $f0, 0x44($v0)
  .L8012A784:
    /* 2A784 8012A784 3C018010 */  lui        $at, %hi(D_801017D8)
    /* 2A788 8012A788 C42017D8 */  lwc1       $f0, %lo(D_801017D8)($at)
    /* 2A78C 8012A78C 4616003C */  c.lt.s     $f0, $f22
  ...
  .L8012A7A0:
    ...
    /* 2A7A4 8012A7A4 C42017DC */  lwc1       $f0, %lo(D_801017DC)($at)
    /* 2A7A8 8012A7A8 4600B03C */  c.lt.s     $f22, $f0
  ...
  .L8012A7C0:
    ...
    /* 2A7E0 8012A7E0 C42017E0 */  lwc1       $f0, %lo(D_801017E0)($at)
    /* 2A7E4 8012A7E4 4600B03C */  c.lt.s     $f22, $f0
    ...
    /* 2A800 8012A800 C43417E4 */  lwc1       $f20, %lo(D_801017E4)($at)
    /* 2A804 8012A804 2442FFFC */  addiu      $v0, $v0, -0x4
    /* 2A808 8012A808 44820000 */  mtc1       $v0, $f0
    /* 2A80C 8012A80C 46800020 */  cvt.s.w    $f0, $f0
    /* 2A810 8012A810 46140003 */  div.s      $f0, $f0, $f20
    /* 2A814 8012A814 3C018010 */  lui        $at, %hi(D_801017E8)
    /* 2A818 8012A818 C42217E8 */  lwc1       $f2, %lo(D_801017E8)($at)
    /* 2A81C 8012A81C 24040009 */  addiu      $a0, $zero, 0x9
    /* 2A820 8012A820 E7A2001C */  swc1       $f2, 0x1C($sp)
    /* 2A824 8012A824 0C051C00 */  jal        func_80147000
    /* 2A828 8012A828 E7A00018 */   swc1      $f0, 0x18($sp)
    /* 2A82C 8012A82C 2442FFFC */  addiu      $v0, $v0, -0x4
    /* 2A830 8012A830 44820000 */  mtc1       $v0, $f0
    /* 2A834 8012A834 46800020 */  cvt.s.w    $f0, $f0
    /* 2A838 8012A838 0804A61D */  j          .L80129874
    /* 2A83C 8012A83C 46140003 */   div.s     $f0, $f0, $f20
  .L8012A840:
    /* 2A840 8012A840 3C018010 */  lui        $at, %hi(D_801017EC)
    /* 2A844 8012A844 C42017EC */  lwc1       $f0, %lo(D_801017EC)($at)
    /* 2A848 8012A848 3C018010 */  lui        $at, %hi(D_801017F0)
    /* 2A84C 8012A84C C42217F0 */  lwc1       $f2, %lo(D_801017F0)($at)
