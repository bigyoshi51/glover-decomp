...
glabel func_801BB128
  ...
  .L801BB150:
    ...
    /* BB16C 801BB16C C6040034 */  lwc1       $f4, 0x34($s0)
    /* BB170 801BB170 C6600000 */  lwc1       $f0, 0x0($s3)
    /* BB174 801BB174 46002101 */  sub.s      $f4, $f4, $f0
    /* BB178 801BB178 E7A40010 */  swc1       $f4, 0x10($sp)
    /* BB17C 801BB17C C6020038 */  lwc1       $f2, 0x38($s0)
    /* BB180 801BB180 C6600004 */  lwc1       $f0, 0x4($s3)
    /* BB184 801BB184 46042102 */  mul.s      $f4, $f4, $f4
    /* BB188 801BB188 46001081 */  sub.s      $f2, $f2, $f0
    /* BB18C 801BB18C E7A20014 */  swc1       $f2, 0x14($sp)
    /* BB190 801BB190 C600003C */  lwc1       $f0, 0x3C($s0)
    /* BB194 801BB194 C6660008 */  lwc1       $f6, 0x8($s3)
    /* BB198 801BB198 46021082 */  mul.s      $f2, $f2, $f2
    /* BB19C 801BB19C 46060001 */  sub.s      $f0, $f0, $f6
    /* BB1A0 801BB1A0 46000182 */  mul.s      $f6, $f0, $f0
    /* BB1A4 801BB1A4 46022100 */  add.s      $f4, $f4, $f2
    /* BB1A8 801BB1A8 46062300 */  add.s      $f12, $f4, $f6
    /* BB1AC 801BB1AC 46006084 */  sqrt.s     $f2, $f12
    /* BB1B0 801BB1B0 46021032 */  c.eq.s     $f2, $f2
    /* BB1B4 801BB1B4 00000000 */  nop
    /* BB1B8 801BB1B8 45010004 */  bc1t       .L801BB1CC
    /* BB1BC 801BB1BC E7A00018 */   swc1      $f0, 0x18($sp)
    /* BB1C0 801BB1C0 0C07100C */  jal        func_801C4030
    /* BB1C4 801BB1C4 00000000 */   nop
    /* BB1C8 801BB1C8 46000086 */  mov.s      $f2, $f0
  .L801BB1CC:
    /* BB1CC 801BB1CC 4614103E */  c.le.s     $f2, $f20
    /* BB1D0 801BB1D0 E7A20020 */  swc1       $f2, 0x20($sp)
