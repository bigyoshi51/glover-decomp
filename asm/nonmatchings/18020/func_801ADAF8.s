nonmatching func_801ADAF8, 0x2CC

glabel func_801ADAF8
    /* ADAF8 801ADAF8 46000021 */  cvt.d.s    $fv0, $fv0
    /* ADAFC 801ADAFC 46260002 */  mul.d      $fv0, $fv0, $ft1
    /* ADB00 801ADB00 C6260024 */  lwc1       $ft1, 0x24($s1)
    /* ADB04 801ADB04 46202120 */  cvt.s.d    $ft0, $ft0
    /* ADB08 801ADB08 462010A0 */  cvt.s.d    $fv1, $fv1
    /* ADB0C 801ADB0C E7A40018 */  swc1       $ft0, 0x18($sp)
    /* ADB10 801ADB10 46062100 */  add.s      $ft0, $ft0, $ft1
    /* ADB14 801ADB14 46200020 */  cvt.s.d    $fv0, $fv0
    /* ADB18 801ADB18 E7A2001C */  swc1       $fv1, 0x1C($sp)
    /* ADB1C 801ADB1C E7A00020 */  swc1       $fv0, 0x20($sp)
    /* ADB20 801ADB20 E6040060 */  swc1       $ft0, 0x60($s0)
    /* ADB24 801ADB24 C7A0001C */  lwc1       $fv0, 0x1C($sp)
    /* ADB28 801ADB28 3C018029 */  lui        $at, %hi(D_80290334)
    /* ADB2C 801ADB2C C4220334 */  lwc1       $fv1, %lo(D_80290334)($at)
    /* ADB30 801ADB30 46020000 */  add.s      $fv0, $fv0, $fv1
    /* ADB34 801ADB34 E6000064 */  swc1       $fv0, 0x64($s0)
    /* ADB38 801ADB38 C7A00020 */  lwc1       $fv0, 0x20($sp)
    /* ADB3C 801ADB3C 3C018029 */  lui        $at, %hi(D_80290338)
    /* ADB40 801ADB40 C4220338 */  lwc1       $fv1, %lo(D_80290338)($at)
    /* ADB44 801ADB44 46020000 */  add.s      $fv0, $fv0, $fv1
    /* ADB48 801ADB48 27A40018 */  addiu      $a0, $sp, 0x18
    /* ADB4C 801ADB4C 0C0524B5 */  jal        func_801492D4
    /* ADB50 801ADB50 E6000068 */   swc1      $fv0, 0x68($s0)
  ...
  .L801ADBA4:
    ...
    /* ADBBC 801ADBBC C7B50040 */  lwc1       $fs0f, 0x40($sp)
    /* ADBC0 801ADBC0 C7B40044 */  lwc1       $fs0, 0x44($sp)
    ...
    /* ADC18 801ADC18 44800000 */  mtc1       $zero, $fv0
    /* ADC1C 801ADC1C 3C050100 */  lui        $a1, (0x1000000 >> 16)
    /* ADC20 801ADC20 E6200068 */  swc1       $fv0, 0x68($s1)
    /* ADC24 801ADC24 E6200064 */  swc1       $fv0, 0x64($s1)
    /* ADC28 801ADC28 00451024 */  and        $v0, $v0, $a1
    /* ADC2C 801ADC2C 14400022 */  bnez       $v0, .L801ADCB8
    /* ADC30 801ADC30 E6200060 */   swc1      $fv0, 0x60($s1)
    /* ADC34 801ADC34 8E2200D8 */  lw         $v0, 0xD8($s1)
    /* ADC38 801ADC38 3C018011 */  lui        $at, %hi(D_8010B4F8)
    /* ADC3C 801ADC3C C420B4F8 */  lwc1       $fv0, %lo(D_8010B4F8)($at)
    /* ADC40 801ADC40 E440001C */  swc1       $fv0, 0x1C($v0)
    ...
    /* ADC68 801ADC68 44820000 */  mtc1       $v0, $fv0
    /* ADC6C 801ADC6C 46800020 */  cvt.s.w    $fv0, $fv0
    /* ADC70 801ADC70 0C051C00 */  jal        func_80147000
    /* ADC74 801ADC74 E62000B4 */   swc1      $fv0, 0xB4($s1)
    /* ADC78 801ADC78 24040015 */  addiu      $a0, $zero, 0x15
    /* ADC7C 801ADC7C 2442FFF6 */  addiu      $v0, $v0, -0xA
    /* ADC80 801ADC80 44820000 */  mtc1       $v0, $fv0
    /* ADC84 801ADC84 46800020 */  cvt.s.w    $fv0, $fv0
    /* ADC88 801ADC88 0C051C00 */  jal        func_80147000
    /* ADC8C 801ADC8C E62000B8 */   swc1      $fv0, 0xB8($s1)
    /* ADC90 801ADC90 262400B4 */  addiu      $a0, $s1, 0xB4
    /* ADC94 801ADC94 2442FFF6 */  addiu      $v0, $v0, -0xA
    /* ADC98 801ADC98 44820000 */  mtc1       $v0, $fv0
    /* ADC9C 801ADC9C 46800020 */  cvt.s.w    $fv0, $fv0
    /* ADCA0 801ADCA0 0C05255A */  jal        func_80149568
    /* ADCA4 801ADCA4 E62000BC */   swc1      $fv0, 0xBC($s1)
    /* ADCA8 801ADCA8 3C018011 */  lui        $at, %hi(D_8010B4FC)
    /* ADCAC 801ADCAC C420B4FC */  lwc1       $fv0, %lo(D_8010B4FC)($at)
    /* ADCB0 801ADCB0 0806B331 */  j          .L801ACCC4
    /* ADCB4 801ADCB4 E62000C0 */   swc1      $fv0, 0xC0($s1)
  .L801ADCB8:
    /* ADCB8 801ADCB8 C62000C0 */  lwc1       $fv0, 0xC0($s1)
    /* ADCBC 801ADCBC 46000007 */  neg.s      $fv0, $fv0
    /* ADCC0 801ADCC0 E62000C0 */  swc1       $fv0, 0xC0($s1)
    ...
    /* ADCD4 801ADCD4 44820000 */  mtc1       $v0, $fv0
    /* ADCD8 801ADCD8 46800020 */  cvt.s.w    $fv0, $fv0
    /* ADCDC 801ADCDC 0C051C00 */  jal        func_80147000
    /* ADCE0 801ADCE0 E7A00018 */   swc1      $fv0, 0x18($sp)
  .L801ADCE4:
    ...
    /* ADCF8 801ADCF8 C422B500 */  lwc1       $fv1, %lo(D_8010B500)($at)
    /* ADCFC 801ADCFC 3C018011 */  lui        $at, %hi(D_8010B504)
    /* ADD00 801ADD00 C424B504 */  lwc1       $ft0, %lo(D_8010B504)($at)
    /* ADD04 801ADD04 2442FFFE */  addiu      $v0, $v0, -0x2
    /* ADD08 801ADD08 44820000 */  mtc1       $v0, $fv0
    /* ADD0C 801ADD0C 46800020 */  cvt.s.w    $fv0, $fv0
    /* ADD10 801ADD10 E7A00020 */  swc1       $fv0, 0x20($sp)
    /* ADD14 801ADD14 AFA00028 */  sw         $zero, 0x28($sp)
    /* ADD18 801ADD18 AFA0002C */  sw         $zero, 0x2C($sp)
    /* ADD1C 801ADD1C E7A2001C */  swc1       $fv1, 0x1C($sp)
    /* ADD20 801ADD20 0C052668 */  jal        func_801499A0
    /* ADD24 801ADD24 E7A40030 */   swc1      $ft0, 0x30($sp)
    /* ADD28 801ADD28 C7A00028 */  lwc1       $fv0, 0x28($sp)
    /* ADD2C 801ADD2C C622003C */  lwc1       $fv1, 0x3C($s1)
    /* ADD30 801ADD30 46020000 */  add.s      $fv0, $fv0, $fv1
    /* ADD34 801ADD34 E7A00028 */  swc1       $fv0, 0x28($sp)
    /* ADD38 801ADD38 C7A0002C */  lwc1       $fv0, 0x2C($sp)
    /* ADD3C 801ADD3C C6220040 */  lwc1       $fv1, 0x40($s1)
    /* ADD40 801ADD40 46020000 */  add.s      $fv0, $fv0, $fv1
    /* ADD44 801ADD44 E7A0002C */  swc1       $fv0, 0x2C($sp)
    /* ADD48 801ADD48 C7A00030 */  lwc1       $fv0, 0x30($sp)
    /* ADD4C 801ADD4C C6220044 */  lwc1       $fv1, 0x44($s1)
    /* ADD50 801ADD50 24040001 */  addiu      $a0, $zero, 0x1
    /* ADD54 801ADD54 46020000 */  add.s      $fv0, $fv0, $fv1
    ...
    /* ADD68 801ADD68 E7A00030 */   swc1      $fv0, 0x30($sp)
  .L801ADD6C:
    ...
    /* ADD84 801ADD84 C7A40018 */  lwc1       $ft0, 0x18($sp)
    /* ADD88 801ADD88 3C018011 */  lui        $at, %hi(D_8010B508)
    /* ADD8C 801ADD8C C427B508 */  lwc1       $ft1f, %lo(D_8010B508)($at)
    /* ADD90 801ADD90 C426B50C */  lwc1       $ft1, %lo(D_8010B508 + 0x4)($at)
  .L801ADD94:
    /* ADD94 801ADD94 46002121 */  cvt.d.s    $ft0, $ft0
    /* ADD98 801ADD98 46262102 */  mul.d      $ft0, $ft0, $ft1
    /* ADD9C 801ADD9C C7A2001C */  lwc1       $fv1, 0x1C($sp)
    /* ADDA0 801ADDA0 460010A1 */  cvt.d.s    $fv1, $fv1
    /* ADDA4 801ADDA4 46261082 */  mul.d      $fv1, $fv1, $ft1
    /* ADDA8 801ADDA8 C7A00020 */  lwc1       $fv0, 0x20($sp)
    /* ADDAC 801ADDAC 46000021 */  cvt.d.s    $fv0, $fv0
    /* ADDB0 801ADDB0 46260002 */  mul.d      $fv0, $fv0, $ft1
    ...
    /* ADDC0 801ADDC0 46202120 */  cvt.s.d    $ft0, $ft0
