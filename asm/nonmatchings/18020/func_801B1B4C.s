...
glabel func_801B1B4C
    ...
    /* B1B60 801B1B60 44820000 */  mtc1       $v0, $fv0
    /* B1B64 801B1B64 46800020 */  cvt.s.w    $fv0, $fv0
    /* B1B68 801B1B68 0C051C00 */  jal        func_80147000
    /* B1B6C 801B1B6C E7A00018 */   swc1      $fv0, 0x18($sp)
    /* B1B70 801B1B70 2404000A */  addiu      $a0, $zero, 0xA
    /* B1B74 801B1B74 2442FFFB */  addiu      $v0, $v0, -0x5
    /* B1B78 801B1B78 44820000 */  mtc1       $v0, $fv0
    /* B1B7C 801B1B7C 46800020 */  cvt.s.w    $fv0, $fv0
    /* B1B80 801B1B80 0C051C00 */  jal        func_80147000
    /* B1B84 801B1B84 E7A0001C */   swc1      $fv0, 0x1C($sp)
    /* B1B88 801B1B88 27A40018 */  addiu      $a0, $sp, 0x18
    /* B1B8C 801B1B8C 2442FFFB */  addiu      $v0, $v0, -0x5
    /* B1B90 801B1B90 44820000 */  mtc1       $v0, $fv0
    /* B1B94 801B1B94 46800020 */  cvt.s.w    $fv0, $fv0
    /* B1B98 801B1B98 0C05255A */  jal        func_80149568
    /* B1B9C 801B1B9C E7A00020 */   swc1      $fv0, 0x20($sp)
    ...
    /* B1BB0 801B1BB0 C423B824 */  lwc1       $fv1f, %lo(D_8010B820 + 0x4)($at)
    /* B1BB4 801B1BB4 C422B828 */  lwc1       $fv1, %lo(D_8010B828)($at)
    /* B1BB8 801B1BB8 44820000 */  mtc1       $v0, $fv0
    /* B1BBC 801B1BBC 46800020 */  cvt.s.w    $fv0, $fv0
    /* B1BC0 801B1BC0 46000021 */  cvt.d.s    $fv0, $fv0
    /* B1BC4 801B1BC4 46220003 */  div.d      $fv0, $fv0, $fv1
    /* B1BC8 801B1BC8 2624FFD8 */  addiu      $a0, $s1, -0x28
    /* B1BCC 801B1BCC 3C074120 */  lui        $a3, (0x41200000 >> 16)
    /* B1BD0 801B1BD0 46200020 */  cvt.s.d    $fv0, $fv0
    /* B1BD4 801B1BD4 44060000 */  mfc1       $a2, $fv0
    ...
    /* B1BEC 801B1BEC C420B82C */  lwc1       $fv0, %lo(D_8010B82C)($at)
  ...
  .L801B1BF4:
    ...
    /* B1C00 801B1C00 4483A000 */  mtc1       $v1, $fs0
    /* B1C04 801B1C04 4680A520 */  cvt.s.w    $fs0, $fs0
    /* B1C08 801B1C08 4614003E */  c.le.s     $fv0, $fs0
    /* B1C0C 801B1C0C 00000000 */  nop
    /* B1C10 801B1C10 45030005 */  bc1tl      .L801B1C28
    /* B1C14 801B1C14 4600A001 */   sub.s     $fv0, $fs0, $fv0
    /* B1C18 801B1C18 4600A00D */  trunc.w.s  $fv0, $fs0
    /* B1C1C 801B1C1C 44040000 */  mfc1       $a0, $fv0
    /* B1C20 801B1C20 0806C30E */  j          .L801B0C38
    /* B1C24 801B1C24 00000000 */   nop
  .L801B1C28:
    /* B1C28 801B1C28 4600008D */  trunc.w.s  $fv1, $fv0
    /* B1C2C 801B1C2C 44041000 */  mfc1       $a0, $fv1
    ...
    /* B1C44 801B1C44 C420B830 */  lwc1       $fv0, %lo(D_8010B830)($at)
    /* B1C48 801B1C48 4600A003 */  div.s      $fv0, $fs0, $fv0
    /* B1C4C 801B1C4C 44821000 */  mtc1       $v0, $fv1
    /* B1C50 801B1C50 468010A0 */  cvt.s.w    $fv1, $fv1
    /* B1C54 801B1C54 46001081 */  sub.s      $fv1, $fv1, $fv0
    /* B1C58 801B1C58 3C018011 */  lui        $at, %hi(D_8010B834)
    /* B1C5C 801B1C5C C420B834 */  lwc1       $fv0, %lo(D_8010B834)($at)
    /* B1C60 801B1C60 46001083 */  div.s      $fv1, $fv1, $fv0
    /* B1C64 801B1C64 3C018011 */  lui        $at, %hi(D_8010B838)
    /* B1C68 801B1C68 C420B838 */  lwc1       $fv0, %lo(D_8010B838)($at)
    /* B1C6C 801B1C6C 4614003E */  c.le.s     $fv0, $fs0
    /* B1C70 801B1C70 00000000 */  nop
    /* B1C74 801B1C74 45010005 */  bc1t       .L801B1C8C
    /* B1C78 801B1C78 E7A20018 */   swc1      $fv1, 0x18($sp)
    /* B1C7C 801B1C7C 4600A00D */  trunc.w.s  $fv0, $fs0
    /* B1C80 801B1C80 44040000 */  mfc1       $a0, $fv0
    /* B1C84 801B1C84 0806C328 */  j          .L801B0CA0
    /* B1C88 801B1C88 00000000 */   nop
  .L801B1C8C:
    /* B1C8C 801B1C8C 4600A001 */  sub.s      $fv0, $fs0, $fv0
    /* B1C90 801B1C90 4600008D */  trunc.w.s  $fv1, $fv0
    /* B1C94 801B1C94 44041000 */  mfc1       $a0, $fv1
    ...
    /* B1CAC 801B1CAC C420B83C */  lwc1       $fv0, %lo(D_8010B83C)($at)
    /* B1CB0 801B1CB0 4600A003 */  div.s      $fv0, $fs0, $fv0
    /* B1CB4 801B1CB4 44821000 */  mtc1       $v0, $fv1
    /* B1CB8 801B1CB8 468010A0 */  cvt.s.w    $fv1, $fv1
    /* B1CBC 801B1CBC 46001081 */  sub.s      $fv1, $fv1, $fv0
    /* B1CC0 801B1CC0 3C018011 */  lui        $at, %hi(D_8010B840)
    /* B1CC4 801B1CC4 C420B840 */  lwc1       $fv0, %lo(D_8010B840)($at)
    /* B1CC8 801B1CC8 46001083 */  div.s      $fv1, $fv1, $fv0
    /* B1CCC 801B1CCC 3C018011 */  lui        $at, %hi(D_8010B844)
    /* B1CD0 801B1CD0 C420B844 */  lwc1       $fv0, %lo(D_8010B844)($at)
    /* B1CD4 801B1CD4 4614003E */  c.le.s     $fv0, $fs0
    /* B1CD8 801B1CD8 00000000 */  nop
    /* B1CDC 801B1CDC 45010005 */  bc1t       .L801B1CF4
    /* B1CE0 801B1CE0 E7A20020 */   swc1      $fv1, 0x20($sp)
    /* B1CE4 801B1CE4 4600A00D */  trunc.w.s  $fv0, $fs0
    /* B1CE8 801B1CE8 44040000 */  mfc1       $a0, $fv0
    /* B1CEC 801B1CEC 0806C342 */  j          .L801B0D08
    /* B1CF0 801B1CF0 00000000 */   nop
  .L801B1CF4:
    /* B1CF4 801B1CF4 4600A001 */  sub.s      $fv0, $fs0, $fv0
    /* B1CF8 801B1CF8 4600008D */  trunc.w.s  $fv1, $fv0
    /* B1CFC 801B1CFC 44041000 */  mfc1       $a0, $fv1
    ...
    /* B1D14 801B1D14 C422B848 */  lwc1       $fv1, %lo(D_8010B848)($at)
    /* B1D18 801B1D18 44820000 */  mtc1       $v0, $fv0
    /* B1D1C 801B1D1C 46800020 */  cvt.s.w    $fv0, $fv0
    /* B1D20 801B1D20 46020003 */  div.s      $fv0, $fv0, $fv1
    /* B1D24 801B1D24 E7A0001C */  swc1       $fv0, 0x1C($sp)
  ...
  .L801B1D9C:
    ...
    /* B1DC0 801B1DC0 C7B700A8 */  lwc1       $fs1f, 0xA8($sp)
    /* B1DC4 801B1DC4 C7B600AC */  lwc1       $fs1, 0xAC($sp)
    /* B1DC8 801B1DC8 C7B500A0 */  lwc1       $fs0f, 0xA0($sp)
    /* B1DCC 801B1DCC C7B400A4 */  lwc1       $fs0, 0xA4($sp)
    ...
    /* B1DF8 801B1DF8 C422F5C4 */  lwc1       $fv1, %lo(D_8029F5C4)($at)
    /* B1DFC 801B1DFC 44800000 */  mtc1       $zero, $fv0
    /* B1E00 801B1E00 46001032 */  c.eq.s     $fv1, $fv0
    ...
    /* B1E34 801B1E34 C420D938 */  lwc1       $fv0, %lo(D_801ED938)($at)
    /* B1E38 801B1E38 3C018011 */  lui        $at, %hi(D_8010B848 + 0x4)
    /* B1E3C 801B1E3C C425B84C */  lwc1       $ft0f, %lo(D_8010B848 + 0x4)($at)
    /* B1E40 801B1E40 C424B850 */  lwc1       $ft0, %lo(D_8010B850)($at)
    /* B1E44 801B1E44 C4820070 */  lwc1       $fv1, 0x70($a0)
