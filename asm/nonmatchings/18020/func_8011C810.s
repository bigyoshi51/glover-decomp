...
glabel func_8011C810
    /* 1C810 8011C810 C6220000 */  lwc1       $f2, 0x0($s1)
    /* 1C814 8011C814 2442FFF9 */  addiu      $v0, $v0, -0x7
    /* 1C818 8011C818 44820000 */  mtc1       $v0, $f0
    /* 1C81C 8011C81C 46800020 */  cvt.s.w    $f0, $f0
    /* 1C820 8011C820 46001080 */  add.s      $f2, $f2, $f0
    /* 1C824 8011C824 2404000F */  addiu      $a0, $zero, 0xF
    /* 1C828 8011C828 0C051C00 */  jal        func_80147000
    /* 1C82C 8011C82C E6220000 */   swc1      $f2, 0x0($s1)
    /* 1C830 8011C830 C6220004 */  lwc1       $f2, 0x4($s1)
    /* 1C834 8011C834 2442FFF9 */  addiu      $v0, $v0, -0x7
    /* 1C838 8011C838 44820000 */  mtc1       $v0, $f0
    /* 1C83C 8011C83C 46800020 */  cvt.s.w    $f0, $f0
    /* 1C840 8011C840 46001080 */  add.s      $f2, $f2, $f0
    /* 1C844 8011C844 2404000F */  addiu      $a0, $zero, 0xF
    /* 1C848 8011C848 0C051C00 */  jal        func_80147000
    /* 1C84C 8011C84C E6220004 */   swc1      $f2, 0x4($s1)
    /* 1C850 8011C850 C6220008 */  lwc1       $f2, 0x8($s1)
    /* 1C854 8011C854 2442FFF9 */  addiu      $v0, $v0, -0x7
    /* 1C858 8011C858 44820000 */  mtc1       $v0, $f0
    /* 1C85C 8011C85C 46800020 */  cvt.s.w    $f0, $f0
    /* 1C860 8011C860 46001080 */  add.s      $f2, $f2, $f0
    /* 1C864 8011C864 2A020005 */  slti       $v0, $s0, 0x5
    /* 1C868 8011C868 1040000F */  beqz       $v0, .L8011C8A8
    /* 1C86C 8011C86C E6220008 */   swc1      $f2, 0x8($s1)
    ...
    /* 1C8A4 8011C8A4 E4740018 */   swc1      $f20, 0x18($v1)
  .L8011C8A8:
    ...
    /* 1C8E4 8011C8E4 E4940018 */  swc1       $f20, 0x18($a0)
    /* 1C8E8 8011C8E8 E4B40070 */  swc1       $f20, 0x70($a1)
