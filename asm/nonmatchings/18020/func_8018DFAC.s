...
glabel func_8018DFAC
    ...
    /* 8E008 8018E008 E434F544 */  swc1       $f20, %lo(D_8029F544)($at)
    /* 8E00C 8018E00C 3C01802A */  lui        $at, %hi(D_8029F548)
    /* 8E010 8018E010 E434F548 */  swc1       $f20, %lo(D_8029F548)($at)
    /* 8E014 8018E014 3C01802A */  lui        $at, %hi(D_8029F54C)
    /* 8E018 8018E018 E434F54C */  swc1       $f20, %lo(D_8029F54C)($at)
    ...
    /* 8E038 8018E038 C42CF504 */  lwc1       $f12, %lo(D_8029F504)($at)
  ...
  .L8018E0A0:
    ...
    /* 8E0AC 8018E0AC C4349730 */  lwc1       $f20, %lo(D_80109730)($at)
    ...
    /* 8E14C 8018E14C E434F544 */  swc1       $f20, %lo(D_8029F544)($at)
    /* 8E150 8018E150 3C01802A */  lui        $at, %hi(D_8029F548)
    /* 8E154 8018E154 E434F548 */  swc1       $f20, %lo(D_8029F548)($at)
    /* 8E158 8018E158 3C01802A */  lui        $at, %hi(D_8029F54C)
    /* 8E15C 8018E15C E434F54C */  swc1       $f20, %lo(D_8029F54C)($at)
    ...
    /* 8E17C 8018E17C C42CF504 */  lwc1       $f12, %lo(D_8029F504)($at)
  ...
  .L8018E188:
    ...
    /* 8E19C 8018E19C C42CFE4C */  lwc1       $f12, %lo(D_8028FE4C)($at)
    /* 8E1A0 8018E1A0 3C018011 */  lui        $at, %hi(D_80109730 + 0x4)
    /* 8E1A4 8018E1A4 C4219734 */  lwc1       $f1, %lo(D_80109730 + 0x4)($at)
    /* 8E1A8 8018E1A8 C4209738 */  lwc1       $f0, %lo(D_80109738)($at)
    /* 8E1AC 8018E1AC 46006321 */  cvt.d.s    $f12, $f12
    /* 8E1B0 8018E1B0 46206300 */  add.d      $f12, $f12, $f0
    /* 8E1B4 8018E1B4 0C0525B2 */  jal        func_801496C8
    /* 8E1B8 8018E1B8 46206320 */   cvt.s.d   $f12, $f12
    /* 8E1BC 8018E1BC 3C01802A */  lui        $at, %hi(D_8029F504)
    /* 8E1C0 8018E1C0 E420F504 */  swc1       $f0, %lo(D_8029F504)($at)
  .L8018E1C4:
  ...
  .L8018E1F4:
    ...
    /* 8E21C 8018E21C C434973C */  lwc1       $f20, %lo(D_8010973C)($at)
