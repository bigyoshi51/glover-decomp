...
glabel func_801CAF2C
    ...
    /* CAF30 801CAF30 46201082 */   mul.d     $fv1, $fv1, $fv0
  .L801CAF34:
    /* CAF34 801CAF34 00042043 */  sra        $a0, $a0, 1
    /* CAF38 801CAF38 1480FFFB */  bnez       $a0, .L801CAF28
    /* CAF3C 801CAF3C 46200002 */   mul.d     $fv0, $fv0, $fv0
  .L801CAF40:
    /* CAF40 801CAF40 00000000 */  nop
    /* CAF44 801CAF44 46221082 */  mul.d      $fv1, $fv1, $fv1
    /* CAF48 801CAF48 00000000 */  nop
    /* CAF4C 801CAF4C 46221082 */  mul.d      $fv1, $fv1, $fv1
    /* CAF50 801CAF50 00000000 */  nop
    /* CAF54 801CAF54 46221082 */  mul.d      $fv1, $fv1, $fv1
    /* CAF58 801CAF58 4620100D */  trunc.w.d  $fv0, $fv1
    /* CAF5C 801CAF5C 44020000 */  mfc1       $v0, $fv0
    /* CAF60 801CAF60 00000000 */  nop
    /* CAF64 801CAF64 00021400 */  sll        $v0, $v0, 16
    /* CAF68 801CAF68 00021403 */  sra        $v0, $v0, 16
    /* CAF6C 801CAF6C 44820000 */  mtc1       $v0, $fv0
    /* CAF70 801CAF70 00000000 */  nop
    /* CAF74 801CAF74 46800020 */  cvt.s.w    $fv0, $fv0
    /* CAF78 801CAF78 46000021 */  cvt.d.s    $fv0, $fv0
    /* CAF7C 801CAF7C 46201001 */  sub.d      $fv0, $fv1, $fv0
    /* CAF80 801CAF80 3C018011 */  lui        $at, %hi(D_8010C578)
    /* CAF84 801CAF84 D422C578 */  ldc1       $fv1, %lo(D_8010C578)($at)
    /* CAF88 801CAF88 46220002 */  mul.d      $fv0, $fv0, $fv1
    /* CAF8C 801CAF8C 4620008D */  trunc.w.d  $fv1, $fv0
    /* CAF90 801CAF90 44031000 */  mfc1       $v1, $fv1
    ...
    /* CAFB4 801CAFB4 46006006 */   mov.s     $fv0, $fa0
  .L801CAFB8:
    /* CAFB8 801CAFB8 44821000 */  mtc1       $v0, $fv1
    /* CAFBC 801CAFBC 00000000 */  nop
    /* CAFC0 801CAFC0 468010A0 */  cvt.s.w    $fv1, $fv1
