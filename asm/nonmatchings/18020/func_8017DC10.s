...
glabel func_8017DC10
  ...
  .L8017DC38:
    ...
    /* 7DC44 8017DC44 C4420050 */  lwc1       $fv1, 0x50($v0)
    /* 7DC48 8017DC48 C4600018 */  lwc1       $fv0, 0x18($v1)
    /* 7DC4C 8017DC4C 46001082 */  mul.s      $fv1, $fv1, $fv0
    /* 7DC50 8017DC50 8CE2002C */  lw         $v0, 0x2C($a3)
    /* 7DC54 8017DC54 E4420000 */  swc1       $fv1, 0x0($v0)
  ...
  .L8017DC78:
    ...
    /* 7DCA8 8017DCA8 C620001C */  lwc1       $fv0, 0x1C($s1)
    /* 7DCAC 8017DCAC 4480B000 */  mtc1       $zero, $fs1
    /* 7DCB0 8017DCB0 46160032 */  c.eq.s     $fv0, $fs1
    ...
    /* 7DCC8 8017DCC8 C62C00B4 */  lwc1       $fa0, 0xB4($s1)
    /* 7DCCC 8017DCCC C4400000 */  lwc1       $fv0, 0x0($v0)
    /* 7DCD0 8017DCD0 46006301 */  sub.s      $fa0, $fa0, $fv0
    /* 7DCD4 8017DCD4 E7AC0018 */  swc1       $fa0, 0x18($sp)
    /* 7DCD8 8017DCD8 8E220038 */  lw         $v0, 0x38($s1)
    /* 7DCDC 8017DCDC 00621021 */  addu       $v0, $v1, $v0
    /* 7DCE0 8017DCE0 8C420000 */  lw         $v0, 0x0($v0)
    /* 7DCE4 8017DCE4 C62000B8 */  lwc1       $fv0, 0xB8($s1)
    /* 7DCE8 8017DCE8 C4420004 */  lwc1       $fv1, 0x4($v0)
    /* 7DCEC 8017DCEC 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* 7DCF0 8017DCF0 E7A0001C */  swc1       $fv0, 0x1C($sp)
    /* 7DCF4 8017DCF4 8E220038 */  lw         $v0, 0x38($s1)
    /* 7DCF8 8017DCF8 00621821 */  addu       $v1, $v1, $v0
    /* 7DCFC 8017DCFC 8C620000 */  lw         $v0, 0x0($v1)
    /* 7DD00 8017DD00 C62E00BC */  lwc1       $fa1, 0xBC($s1)
    /* 7DD04 8017DD04 C4400008 */  lwc1       $fv0, 0x8($v0)
    /* 7DD08 8017DD08 46007381 */  sub.s      $fa1, $fa1, $fv0
    /* 7DD0C 8017DD0C 0C051D18 */  jal        func_80147460
    /* 7DD10 8017DD10 E7AE0020 */   swc1      $fa1, 0x20($sp)
    /* 7DD14 8017DD14 0C0525B2 */  jal        func_801496C8
    /* 7DD18 8017DD18 46000306 */   mov.s     $fa0, $fv0
    /* 7DD1C 8017DD1C 8E22002C */  lw         $v0, 0x2C($s1)
    /* 7DD20 8017DD20 E4400060 */  swc1       $fv0, 0x60($v0)
    /* 7DD24 8017DD24 C7A20018 */  lwc1       $fv1, 0x18($sp)
    /* 7DD28 8017DD28 46021082 */  mul.s      $fv1, $fv1, $fv1
    /* 7DD2C 8017DD2C C7A00020 */  lwc1       $fv0, 0x20($sp)
    /* 7DD30 8017DD30 46000002 */  mul.s      $fv0, $fv0, $fv0
    /* 7DD34 8017DD34 46001300 */  add.s      $fa0, $fv1, $fv0
    /* 7DD38 8017DD38 46006004 */  sqrt.s     $fv0, $fa0
    /* 7DD3C 8017DD3C 46000032 */  c.eq.s     $fv0, $fv0
  ...
  .L8017DD54:
    /* 7DD54 8017DD54 C7AC001C */  lwc1       $fa0, 0x1C($sp)
    /* 7DD58 8017DD58 46006307 */  neg.s      $fa0, $fa0
    /* 7DD5C 8017DD5C 0C051D18 */  jal        func_80147460
    /* 7DD60 8017DD60 46000386 */   mov.s     $fa1, $fv0
    /* 7DD64 8017DD64 0C0525B2 */  jal        func_801496C8
    /* 7DD68 8017DD68 46000306 */   mov.s     $fa0, $fv0
    /* 7DD6C 8017DD6C 8E22002C */  lw         $v0, 0x2C($s1)
    /* 7DD70 8017DD70 E440005C */  swc1       $fv0, 0x5C($v0)
    /* 7DD74 8017DD74 8E22002C */  lw         $v0, 0x2C($s1)
    /* 7DD78 8017DD78 C44C003C */  lwc1       $fa0, 0x3C($v0)
    /* 7DD7C 8017DD7C C44E0048 */  lwc1       $fa1, 0x48($v0)
    /* 7DD80 8017DD80 0C052533 */  jal        func_801494CC
    /* 7DD84 8017DD84 00000000 */   nop
    /* 7DD88 8017DD88 46000506 */  mov.s      $fs0, $fv0
    /* 7DD8C 8017DD8C 4614B03C */  c.lt.s     $fs1, $fs0
    /* 7DD90 8017DD90 00000000 */  nop
    /* 7DD94 8017DD94 45020001 */  bc1fl      .L8017DD9C
    /* 7DD98 8017DD98 4600A007 */   neg.s     $fv0, $fs0
  .L8017DD9C:
    /* 7DD9C 8017DD9C 3C018011 */  lui        $at, %hi(D_80108878 + 0x4)
    /* 7DDA0 8017DDA0 C423887C */  lwc1       $fv1f, %lo(D_80108878 + 0x4)($at)
    /* 7DDA4 8017DDA4 C4228880 */  lwc1       $fv1, %lo(D_80108880)($at)
    /* 7DDA8 8017DDA8 46000021 */  cvt.d.s    $fv0, $fv0
    /* 7DDAC 8017DDAC 4620103E */  c.le.d     $fv1, $fv0
    ...
    /* 7DDC0 8017DDC0 C44C0034 */  lwc1       $fa0, 0x34($v0)
    /* 7DDC4 8017DDC4 460CA302 */  mul.s      $fa0, $fs0, $fa0
    ...
    /* 7DDD8 8017DDD8 E4400064 */   swc1      $fv0, 0x64($v0)
  .L8017DDDC:
    /* 7DDDC 8017DDDC 8E22002C */  lw         $v0, 0x2C($s1)
    /* 7DDE0 8017DDE0 0805F37F */  j          .L8017CDFC
    /* 7DDE4 8017DDE4 E4560064 */   swc1      $fs1, 0x64($v0)
  .L8017DDE8:
    /* 7DDE8 8017DDE8 8E22002C */  lw         $v0, 0x2C($s1)
    /* 7DDEC 8017DDEC C440003C */  lwc1       $fv0, 0x3C($v0)
    /* 7DDF0 8017DDF0 E4400060 */  swc1       $fv0, 0x60($v0)
    /* 7DDF4 8017DDF4 8E22002C */  lw         $v0, 0x2C($s1)
    /* 7DDF8 8017DDF8 AC400064 */  sw         $zero, 0x64($v0)
  .L8017DDFC:
    /* 7DDFC 8017DDFC 44800000 */  mtc1       $zero, $fv0
    /* 7DE00 8017DE00 4600D032 */  c.eq.s     $fs3, $fv0
  ...
  .L8017DEB8:
    ...
    /* 7DED4 8017DED4 C7BB0080 */  lwc1       $fs3f, 0x80($sp)
    /* 7DED8 8017DED8 C7BA0084 */  lwc1       $fs3, 0x84($sp)
    /* 7DEDC 8017DEDC C7B90078 */  lwc1       $fs2f, 0x78($sp)
    /* 7DEE0 8017DEE0 C7B8007C */  lwc1       $fs2, 0x7C($sp)
    /* 7DEE4 8017DEE4 C7B70070 */  lwc1       $fs1f, 0x70($sp)
    /* 7DEE8 8017DEE8 C7B60074 */  lwc1       $fs1, 0x74($sp)
    /* 7DEEC 8017DEEC C7B50068 */  lwc1       $fs0f, 0x68($sp)
    /* 7DEF0 8017DEF0 C7B4006C */  lwc1       $fs0, 0x6C($sp)
    ...
    /* 7DF1C 8017DF1C C60400B4 */  lwc1       $ft0, 0xB4($s0)
    /* 7DF20 8017DF20 C60000C0 */  lwc1       $fv0, 0xC0($s0)
    /* 7DF24 8017DF24 46002101 */  sub.s      $ft0, $ft0, $fv0
    /* 7DF28 8017DF28 E7A40028 */  swc1       $ft0, 0x28($sp)
    /* 7DF2C 8017DF2C C60000B8 */  lwc1       $fv0, 0xB8($s0)
    /* 7DF30 8017DF30 C60200C4 */  lwc1       $fv1, 0xC4($s0)
    /* 7DF34 8017DF34 46042102 */  mul.s      $ft0, $ft0, $ft0
    /* 7DF38 8017DF38 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* 7DF3C 8017DF3C E7A0002C */  swc1       $fv0, 0x2C($sp)
    /* 7DF40 8017DF40 C60200BC */  lwc1       $fv1, 0xBC($s0)
    /* 7DF44 8017DF44 C60600C8 */  lwc1       $ft1, 0xC8($s0)
    /* 7DF48 8017DF48 46000002 */  mul.s      $fv0, $fv0, $fv0
    /* 7DF4C 8017DF4C 46061081 */  sub.s      $fv1, $fv1, $ft1
    /* 7DF50 8017DF50 46021182 */  mul.s      $ft1, $fv1, $fv1
    /* 7DF54 8017DF54 46002100 */  add.s      $ft0, $ft0, $fv0
    /* 7DF58 8017DF58 E7A20030 */  swc1       $fv1, 0x30($sp)
    /* 7DF5C 8017DF5C 8E02003C */  lw         $v0, 0x3C($s0)
    /* 7DF60 8017DF60 10400006 */  beqz       $v0, .L8017DF7C
    /* 7DF64 8017DF64 46062100 */   add.s     $ft0, $ft0, $ft1
  ...
  .L8017DF7C:
    ...
    /* 7DF80 8017DF80 C4238884 */  lwc1       $fv1f, %lo(D_80108880 + 0x4)($at)
    /* 7DF84 8017DF84 C4228888 */  lwc1       $fv1, %lo(D_80108888)($at)
    /* 7DF88 8017DF88 46002021 */  cvt.d.s    $fv0, $ft0
    /* 7DF8C 8017DF8C 4620103C */  c.lt.d     $fv1, $fv0
    /* 7DF90 8017DF90 00000000 */  nop
    /* 7DF94 8017DF94 45010009 */  bc1t       .L8017DFBC
    /* 7DF98 8017DF98 00000000 */   nop
    /* 7DF9C 8017DF9C 44800000 */  mtc1       $zero, $fv0
    /* 7DFA0 8017DFA0 4604003C */  c.lt.s     $fv0, $ft0
  ...
  .L8017E12C:
    ...
    /* 7E13C 8017E13C C60200DC */  lwc1       $fv1, 0xDC($s0)
    /* 7E140 8017E140 3C01801F */  lui        $at, %hi(D_801ED680)
    /* 7E144 8017E144 C420D680 */  lwc1       $fv0, %lo(D_801ED680)($at)
    /* 7E148 8017E148 46001081 */  sub.s      $fv1, $fv1, $fv0
    ...
    /* 7E158 8017E158 E60200DC */   swc1      $fv1, 0xDC($s0)
    /* 7E15C 8017E15C C60400D8 */  lwc1       $ft0, 0xD8($s0)
    /* 7E160 8017E160 46042102 */  mul.s      $ft0, $ft0, $ft0
    /* 7E164 8017E164 C60200DC */  lwc1       $fv1, 0xDC($s0)
    /* 7E168 8017E168 46021082 */  mul.s      $fv1, $fv1, $fv1
    /* 7E16C 8017E16C C60000E0 */  lwc1       $fv0, 0xE0($s0)
    /* 7E170 8017E170 46000002 */  mul.s      $fv0, $fv0, $fv0
    /* 7E174 8017E174 46022100 */  add.s      $ft0, $ft0, $fv1
    /* 7E178 8017E178 46002300 */  add.s      $fa0, $ft0, $fv0
    /* 7E17C 8017E17C 46006004 */  sqrt.s     $fv0, $fa0
    /* 7E180 8017E180 46000032 */  c.eq.s     $fv0, $fv0
  ...
  .L8017E198:
    /* 7E198 8017E198 C604001C */  lwc1       $ft0, 0x1C($s0)
    /* 7E19C 8017E19C 4600203C */  c.lt.s     $ft0, $fv0
    /* 7E1A0 8017E1A0 00000000 */  nop
    /* 7E1A4 8017E1A4 45000013 */  bc1f       .L8017E1F4
    /* 7E1A8 8017E1A8 E60000F4 */   swc1      $fv0, 0xF4($s0)
    /* 7E1AC 8017E1AC 46002103 */  div.s      $ft0, $ft0, $fv0
    /* 7E1B0 8017E1B0 C602001C */  lwc1       $fv1, 0x1C($s0)
    /* 7E1B4 8017E1B4 C60000F4 */  lwc1       $fv0, 0xF4($s0)
    /* 7E1B8 8017E1B8 46001083 */  div.s      $fv1, $fv1, $fv0
    /* 7E1BC 8017E1BC C606001C */  lwc1       $ft1, 0x1C($s0)
    /* 7E1C0 8017E1C0 C60000F4 */  lwc1       $fv0, 0xF4($s0)
    /* 7E1C4 8017E1C4 46003183 */  div.s      $ft1, $ft1, $fv0
    /* 7E1C8 8017E1C8 C60800D8 */  lwc1       $ft2, 0xD8($s0)
    /* 7E1CC 8017E1CC 46044202 */  mul.s      $ft2, $ft2, $ft0
    /* 7E1D0 8017E1D0 C60400DC */  lwc1       $ft0, 0xDC($s0)
    /* 7E1D4 8017E1D4 46022102 */  mul.s      $ft0, $ft0, $fv1
    /* 7E1D8 8017E1D8 C60200E0 */  lwc1       $fv1, 0xE0($s0)
    /* 7E1DC 8017E1DC 46061082 */  mul.s      $fv1, $fv1, $ft1
    /* 7E1E0 8017E1E0 C600001C */  lwc1       $fv0, 0x1C($s0)
    /* 7E1E4 8017E1E4 E60000F4 */  swc1       $fv0, 0xF4($s0)
    /* 7E1E8 8017E1E8 E60800D8 */  swc1       $ft2, 0xD8($s0)
    /* 7E1EC 8017E1EC E60400DC */  swc1       $ft0, 0xDC($s0)
    /* 7E1F0 8017E1F0 E60200E0 */  swc1       $fv1, 0xE0($s0)
  .L8017E1F4:
  ...
  .L8017E200:
    ...
    /* 7E248 8017E248 E7B500D0 */  swc1       $fs0f, 0xD0($sp)
    /* 7E24C 8017E24C E7B400D4 */  swc1       $fs0, 0xD4($sp)
    /* 7E250 8017E250 8E220014 */  lw         $v0, 0x14($s1)
    /* 7E254 8017E254 44850000 */  mtc1       $a1, $fv0
  ...
  .L8017E29C:
    ...
    /* 7E2AC 8017E2AC 4480A000 */  mtc1       $zero, $fs0
  ...
  .L8017E2C0:
    ...
    /* 7E2E4 8017E2E4 C4400000 */  lwc1       $fv0, 0x0($v0)
    /* 7E2E8 8017E2E8 E6000010 */  swc1       $fv0, 0x10($s0)
    ...
    /* 7E310 8017E310 C4400004 */  lwc1       $fv0, 0x4($v0)
    /* 7E314 8017E314 E6000014 */  swc1       $fv0, 0x14($s0)
