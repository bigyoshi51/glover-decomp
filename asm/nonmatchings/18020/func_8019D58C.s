...
glabel func_8019D58C
    /* 9D58C 8019D58C E7B4005C */  swc1       $f20, 0x5C($sp)
    ...
    /* 9D59C 8019D59C C422A950 */  lwc1       $f2, %lo(D_8010A950)($at)
    /* 9D5A0 8019D5A0 46020002 */  mul.s      $f0, $f0, $f2
    /* 9D5A4 8019D5A4 3C018011 */  lui        $at, %hi(D_8010A954)
    /* 9D5A8 8019D5A8 C422A954 */  lwc1       $f2, %lo(D_8010A954)($at)
    /* 9D5AC 8019D5AC 46020000 */  add.s      $f0, $f0, $f2
    ...
    /* 9D5BC 8019D5BC 4600008D */  trunc.w.s  $f2, $f0
    /* 9D5C0 8019D5C0 44021000 */  mfc1       $v0, $f2
  ...
  .L8019D674:
    ...
    /* 9D6A0 8019D6A0 C42CA958 */  lwc1       $f12, %lo(D_8010A958)($at)
    ...
    /* 9D6C0 8019D6C0 44807000 */  mtc1       $zero, $f14
    ...
    /* 9D6D4 8019D6D4 44821000 */  mtc1       $v0, $f2
    /* 9D6D8 8019D6D8 468010A0 */  cvt.s.w    $f2, $f2
    /* 9D6DC 8019D6DC 46020002 */  mul.s      $f0, $f0, $f2
    /* 9D6E0 8019D6E0 3C02801F */  lui        $v0, %hi(D_801F01BC)
    /* 9D6E4 8019D6E4 844201BC */  lh         $v0, %lo(D_801F01BC)($v0)
    /* 9D6E8 8019D6E8 44821000 */  mtc1       $v0, $f2
    /* 9D6EC 8019D6EC 468010A0 */  cvt.s.w    $f2, $f2
    /* 9D6F0 8019D6F0 46001080 */  add.s      $f2, $f2, $f0
    /* 9D6F4 8019D6F4 3C018011 */  lui        $at, %hi(D_8010A95C)
    /* 9D6F8 8019D6F8 C420A95C */  lwc1       $f0, %lo(D_8010A95C)($at)
    /* 9D6FC 8019D6FC 4602003E */  c.le.s     $f0, $f2
    /* 9D700 8019D700 00000000 */  nop
    /* 9D704 8019D704 45030023 */  bc1tl      .L8019D794
    /* 9D708 8019D708 46001001 */   sub.s     $f0, $f2, $f0
    /* 9D70C 8019D70C 4600100D */  trunc.w.s  $f0, $f2
    /* 9D710 8019D710 44040000 */  mfc1       $a0, $f0
    /* 9D714 8019D714 080671E9 */  j          .L8019C7A4
    /* 9D718 8019D718 00000000 */   nop
  .L8019D71C:
    /* 9D71C 8019D71C C60C003C */  lwc1       $f12, 0x3C($s0)
    /* 9D720 8019D720 C6200034 */  lwc1       $f0, 0x34($s1)
    /* 9D724 8019D724 46006301 */  sub.s      $f12, $f12, $f0
    /* 9D728 8019D728 E7AC0018 */  swc1       $f12, 0x18($sp)
    /* 9D72C 8019D72C C6000040 */  lwc1       $f0, 0x40($s0)
    /* 9D730 8019D730 C6220038 */  lwc1       $f2, 0x38($s1)
    /* 9D734 8019D734 46020001 */  sub.s      $f0, $f0, $f2
    /* 9D738 8019D738 E7A0001C */  swc1       $f0, 0x1C($sp)
    /* 9D73C 8019D73C C60E0044 */  lwc1       $f14, 0x44($s0)
    /* 9D740 8019D740 C620003C */  lwc1       $f0, 0x3C($s1)
    /* 9D744 8019D744 46007381 */  sub.s      $f14, $f14, $f0
    /* 9D748 8019D748 0C051D18 */  jal        func_80147460
    /* 9D74C 8019D74C E7AE0020 */   swc1      $f14, 0x20($sp)
    /* 9D750 8019D750 0C0525B2 */  jal        func_801496C8
    /* 9D754 8019D754 46000306 */   mov.s     $f12, $f0
    /* 9D758 8019D758 8E2200D0 */  lw         $v0, 0xD0($s1)
    /* 9D75C 8019D75C 3C018011 */  lui        $at, %hi(D_8010A960)
    /* 9D760 8019D760 C434A960 */  lwc1       $f20, %lo(D_8010A960)($at)
    /* 9D764 8019D764 E6200088 */  swc1       $f0, 0x88($s1)
    /* 9D768 8019D768 C4400028 */  lwc1       $f0, 0x28($v0)
    /* 9D76C 8019D76C 46140002 */  mul.s      $f0, $f0, $f20
    ...
    /* 9D77C 8019D77C E4400028 */   swc1      $f0, 0x28($v0)
    /* 9D780 8019D780 8E2200D0 */  lw         $v0, 0xD0($s1)
    /* 9D784 8019D784 C4400028 */  lwc1       $f0, 0x28($v0)
    /* 9D788 8019D788 46140003 */  div.s      $f0, $f0, $f20
    /* 9D78C 8019D78C 080672FA */  j          .L8019CBE8
    /* 9D790 8019D790 E4400028 */   swc1      $f0, 0x28($v0)
  .L8019D794:
    /* 9D794 8019D794 4600008D */  trunc.w.s  $f2, $f0
    /* 9D798 8019D798 44041000 */  mfc1       $a0, $f2
  ...
  .L8019D84C:
    ...
    /* 9D868 8019D868 C43AA964 */  lwc1       $f26, %lo(D_8010A964)($at)
    /* 9D86C 8019D86C 3C018011 */  lui        $at, %hi(D_8010A968)
    /* 9D870 8019D870 C43EA968 */  lwc1       $f30, %lo(D_8010A968)($at)
    /* 9D874 8019D874 3C018011 */  lui        $at, %hi(D_8010A96C)
    /* 9D878 8019D878 C43CA96C */  lwc1       $f28, %lo(D_8010A96C)($at)
    /* 9D87C 8019D87C 24140001 */  addiu      $s4, $zero, 0x1
    /* 9D880 8019D880 4480B000 */  mtc1       $zero, $f22
  .L8019D884:
    ...
    /* 9D89C 8019D89C C422A970 */  lwc1       $f2, %lo(D_8010A970)($at)
    /* 9D8A0 8019D8A0 46000506 */  mov.s      $f20, $f0
    /* 9D8A4 8019D8A4 4602A03E */  c.le.s     $f20, $f2
    /* 9D8A8 8019D8A8 00000000 */  nop
    /* 9D8AC 8019D8AC 450000C9 */  bc1f       .L8019DBD4
    /* 9D8B0 8019D8B0 24120002 */   addiu     $s2, $zero, 0x2
    /* 9D8B4 8019D8B4 C604003C */  lwc1       $f4, 0x3C($s0)
    /* 9D8B8 8019D8B8 C6200034 */  lwc1       $f0, 0x34($s1)
    /* 9D8BC 8019D8BC 46002101 */  sub.s      $f4, $f4, $f0
    /* 9D8C0 8019D8C0 E7A40018 */  swc1       $f4, 0x18($sp)
    /* 9D8C4 8019D8C4 C6020040 */  lwc1       $f2, 0x40($s0)
    /* 9D8C8 8019D8C8 C6200038 */  lwc1       $f0, 0x38($s1)
    /* 9D8CC 8019D8CC 46001081 */  sub.s      $f2, $f2, $f0
    /* 9D8D0 8019D8D0 E7A2001C */  swc1       $f2, 0x1C($sp)
    /* 9D8D4 8019D8D4 C6060044 */  lwc1       $f6, 0x44($s0)
    /* 9D8D8 8019D8D8 C620003C */  lwc1       $f0, 0x3C($s1)
    /* 9D8DC 8019D8DC 46003181 */  sub.s      $f6, $f6, $f0
    /* 9D8E0 8019D8E0 E7A60020 */  swc1       $f6, 0x20($sp)
    /* 9D8E4 8019D8E4 C6000060 */  lwc1       $f0, 0x60($s0)
    /* 9D8E8 8019D8E8 46002102 */  mul.s      $f4, $f4, $f0
    /* 9D8EC 8019D8EC C6000064 */  lwc1       $f0, 0x64($s0)
    /* 9D8F0 8019D8F0 46001082 */  mul.s      $f2, $f2, $f0
    /* 9D8F4 8019D8F4 C6000068 */  lwc1       $f0, 0x68($s0)
    /* 9D8F8 8019D8F8 46003182 */  mul.s      $f6, $f6, $f0
    /* 9D8FC 8019D8FC 46022100 */  add.s      $f4, $f4, $f2
    /* 9D900 8019D900 3C018011 */  lui        $at, %hi(D_8010A974)
    /* 9D904 8019D904 C420A974 */  lwc1       $f0, %lo(D_8010A974)($at)
    /* 9D908 8019D908 24150001 */  addiu      $s5, $zero, 0x1
    /* 9D90C 8019D90C 4600A03C */  c.lt.s     $f20, $f0
    /* 9D910 8019D910 24020001 */  addiu      $v0, $zero, 0x1
    /* 9D914 8019D914 45010002 */  bc1t       .L8019D920
    /* 9D918 8019D918 46062600 */   add.s     $f24, $f4, $f6
    /* 9D91C 8019D91C 00001021 */  addu       $v0, $zero, $zero
  .L8019D920:
    /* 9D920 8019D920 4616C03C */  c.lt.s     $f24, $f22
  ...
  .L8019D934:
    ...
    /* 9D960 8019D960 E7B60010 */   swc1      $f22, 0x10($sp)
    ...
    /* 9D978 8019D978 E7B60010 */   swc1      $f22, 0x10($sp)
  .L8019D97C:
  ...
  .L8019D98C:
    ...
    /* 9D994 8019D994 C420A978 */  lwc1       $f0, %lo(D_8010A978)($at)
    /* 9D998 8019D998 C442004C */  lwc1       $f2, 0x4C($v0)
    /* 9D99C 8019D99C 4602003E */  c.le.s     $f0, $f2
    /* 9D9A0 8019D9A0 00000000 */  nop
    /* 9D9A4 8019D9A4 45020040 */  bc1fl      .L8019DAA8
    /* 9D9A8 8019D9A8 24020002 */   addiu     $v0, $zero, 0x2
    /* 9D9AC 8019D9AC 4618B03C */  c.lt.s     $f22, $f24
  ...
  .L8019D9BC:
    ...
    /* 9D9C0 8019D9C0 C420A97C */  lwc1       $f0, %lo(D_8010A97C)($at)
    /* 9D9C4 8019D9C4 4600103C */  c.lt.s     $f2, $f0
  ...
  .L8019D9D0:
    ...
    /* 9D9D8 8019D9D8 C420A980 */  lwc1       $f0, %lo(D_8010A980)($at)
    /* 9D9DC 8019D9DC 4600A03E */  c.le.s     $f20, $f0
    /* 9D9E0 8019D9E0 00000000 */  nop
    /* 9D9E4 8019D9E4 4502002F */  bc1fl      .L8019DAA4
    /* 9D9E8 8019D9E8 E456000C */   swc1      $f22, 0xC($v0)
    /* 9D9EC 8019D9EC 00009021 */  addu       $s2, $zero, $zero
    /* 9D9F0 8019D9F0 2402FFFE */  addiu      $v0, $zero, -0x2
    /* 9D9F4 8019D9F4 E6160068 */  swc1       $f22, 0x68($s0)
    /* 9D9F8 8019D9F8 E6160064 */  swc1       $f22, 0x64($s0)
    /* 9D9FC 8019D9FC E6160060 */  swc1       $f22, 0x60($s0)
    /* 9DA00 8019DA00 080672A9 */  j          .L8019CAA4
    /* 9DA04 8019DA04 A602015C */   sh        $v0, 0x15C($s0)
  .L8019DA08:
    /* 9DA08 8019DA08 3C018011 */  lui        $at, %hi(D_8010A984)
    /* 9DA0C 8019DA0C C420A984 */  lwc1       $f0, %lo(D_8010A984)($at)
    /* 9DA10 8019DA10 4600103C */  c.lt.s     $f2, $f0
  ...
  .L8019DAA8:
    ...
    /* 9DAB4 8019DAB4 C42C030C */  lwc1       $f12, %lo(D_8029030C)($at)
    /* 9DAB8 8019DAB8 C6200034 */  lwc1       $f0, 0x34($s1)
    /* 9DABC 8019DABC 46006301 */  sub.s      $f12, $f12, $f0
    /* 9DAC0 8019DAC0 3C018029 */  lui        $at, %hi(D_80290310)
    /* 9DAC4 8019DAC4 C4200310 */  lwc1       $f0, %lo(D_80290310)($at)
    /* 9DAC8 8019DAC8 E7AC0018 */  swc1       $f12, 0x18($sp)
    /* 9DACC 8019DACC C6220038 */  lwc1       $f2, 0x38($s1)
    /* 9DAD0 8019DAD0 46020001 */  sub.s      $f0, $f0, $f2
    /* 9DAD4 8019DAD4 3C018029 */  lui        $at, %hi(D_80290314)
    /* 9DAD8 8019DAD8 C42E0314 */  lwc1       $f14, %lo(D_80290314)($at)
    /* 9DADC 8019DADC E7A0001C */  swc1       $f0, 0x1C($sp)
    /* 9DAE0 8019DAE0 C620003C */  lwc1       $f0, 0x3C($s1)
    /* 9DAE4 8019DAE4 46007381 */  sub.s      $f14, $f14, $f0
    /* 9DAE8 8019DAE8 0C051D18 */  jal        func_80147460
    /* 9DAEC 8019DAEC E7AE0020 */   swc1      $f14, 0x20($sp)
    /* 9DAF0 8019DAF0 0C0525B2 */  jal        func_801496C8
    /* 9DAF4 8019DAF4 46000306 */   mov.s     $f12, $f0
    /* 9DAF8 8019DAF8 8E2200D0 */  lw         $v0, 0xD0($s1)
    /* 9DAFC 8019DAFC E6200088 */  swc1       $f0, 0x88($s1)
    /* 9DB00 8019DB00 C4400028 */  lwc1       $f0, 0x28($v0)
    /* 9DB04 8019DB04 461A0002 */  mul.s      $f0, $f0, $f26
    ...
    /* 9DB14 8019DB14 E4400028 */   swc1      $f0, 0x28($v0)
    /* 9DB18 8019DB18 8E2200D0 */  lw         $v0, 0xD0($s1)
    /* 9DB1C 8019DB1C C4400028 */  lwc1       $f0, 0x28($v0)
    /* 9DB20 8019DB20 461A0003 */  div.s      $f0, $f0, $f26
    /* 9DB24 8019DB24 16400030 */  bnez       $s2, .L8019DBE8
    /* 9DB28 8019DB28 E4400028 */   swc1      $f0, 0x28($v0)
    /* 9DB2C 8019DB2C 2604003C */  addiu      $a0, $s0, 0x3C
    /* 9DB30 8019DB30 00802821 */  addu       $a1, $a0, $zero
    /* 9DB34 8019DB34 4406F000 */  mfc1       $a2, $f30
    /* 9DB38 8019DB38 26270034 */  addiu      $a3, $s1, 0x34
    /* 9DB3C 8019DB3C 0C0524FB */  jal        func_801493EC
    /* 9DB40 8019DB40 AFA60010 */   sw        $a2, 0x10($sp)
    /* 9DB44 8019DB44 C6220038 */  lwc1       $f2, 0x38($s1)
    /* 9DB48 8019DB48 3C018011 */  lui        $at, %hi(D_8010A988)
    /* 9DB4C 8019DB4C C420A988 */  lwc1       $f0, %lo(D_8010A988)($at)
    /* 9DB50 8019DB50 46001080 */  add.s      $f2, $f2, $f0
    /* 9DB54 8019DB54 C6040040 */  lwc1       $f4, 0x40($s0)
  .L8019DB58:
    /* 9DB58 8019DB58 46041081 */  sub.s      $f2, $f2, $f4
    /* 9DB5C 8019DB5C 3C018011 */  lui        $at, %hi(D_8010A98C)
    /* 9DB60 8019DB60 C420A98C */  lwc1       $f0, %lo(D_8010A98C)($at)
    /* 9DB64 8019DB64 46001083 */  div.s      $f2, $f2, $f0
    /* 9DB68 8019DB68 461C103C */  c.lt.s     $f2, $f28
    /* 9DB6C 8019DB6C 00000000 */  nop
    /* 9DB70 8019DB70 45010006 */  bc1t       .L8019DB8C
    /* 9DB74 8019DB74 00000000 */   nop
    /* 9DB78 8019DB78 461A103C */  c.lt.s     $f2, $f26
