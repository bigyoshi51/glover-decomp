nonmatching func_801C1300, 0x2B8

glabel func_801C1300
  ...
  .L801C14E8:
    ...
    /* C159C 801C159C 3C0E801C */  lui        $t6, %hi(func_801C1300 + 0x38)
    /* C15A0 801C15A0 26D6B2C8 */  addiu      $s6, $s6, %lo(D_802AB2C8)
    /* C15A4 801C15A4 25CE1338 */  addiu      $t6, $t6, %lo(func_801C1300 + 0x38)
