nonmatching func_801B5F74, 0x1D8
...
glabel func_801B5F74
  ...
  .L801B5F78:
    ...
    /* B5F90 801B5F90 C434BBB4 */  lwc1       $f20, %lo(D_8010BBB4)($at)
    /* B5F94 801B5F94 3C018011 */  lui        $at, %hi(D_8010BBB8)
    /* B5F98 801B5F98 C438BBB8 */  lwc1       $f24, %lo(D_8010BBB8)($at)
    /* B5F9C 801B5F9C 3C018011 */  lui        $at, %hi(D_8010BBBC)
    /* B5FA0 801B5FA0 C436BBBC */  lwc1       $f22, %lo(D_8010BBBC)($at)
  ...
  .L801B5FB8:
    /* B5FB8 801B5FB8 C6420030 */  lwc1       $f2, 0x30($s2)
    /* B5FBC 801B5FBC C6400034 */  lwc1       $f0, 0x34($s2)
    /* B5FC0 801B5FC0 46001032 */  c.eq.s     $f2, $f0
    /* B5FC4 801B5FC4 00000000 */  nop
    /* B5FC8 801B5FC8 45010026 */  bc1t       .L801B6064
    /* B5FCC 801B5FCC 00000000 */   nop
    /* B5FD0 801B5FD0 46001081 */  sub.s      $f2, $f2, $f0
    /* B5FD4 801B5FD4 3C018011 */  lui        $at, %hi(D_8010BBC0)
    /* B5FD8 801B5FD8 C420BBC0 */  lwc1       $f0, %lo(D_8010BBC0)($at)
    /* B5FDC 801B5FDC 46001103 */  div.s      $f4, $f2, $f0
    /* B5FE0 801B5FE0 4604A03C */  c.lt.s     $f20, $f4
    /* B5FE4 801B5FE4 00000000 */  nop
    /* B5FE8 801B5FE8 4502000A */  bc1fl      .L801B6014
    /* B5FEC 801B5FEC 4600A006 */   mov.s     $f0, $f20
    /* B5FF0 801B5FF0 4618203C */  c.lt.s     $f4, $f24
    /* B5FF4 801B5FF4 00000000 */  nop
    /* B5FF8 801B5FF8 45020006 */  bc1fl      .L801B6014
    /* B5FFC 801B5FFC 4600C006 */   mov.s     $f0, $f24
    /* B6000 801B6000 4604A03C */  c.lt.s     $f20, $f4
    /* B6004 801B6004 00000000 */  nop
    /* B6008 801B6008 45000002 */  bc1f       .L801B6014
    /* B600C 801B600C 4600A006 */   mov.s     $f0, $f20
    /* B6010 801B6010 46002006 */  mov.s      $f0, $f4
  .L801B6014:
    /* B6014 801B6014 C6420030 */  lwc1       $f2, 0x30($s2)
    /* B6018 801B6018 46000106 */  mov.s      $f4, $f0
    /* B601C 801B601C 46041081 */  sub.s      $f2, $f2, $f4
    /* B6020 801B6020 46161181 */  sub.s      $f6, $f2, $f22
    /* B6024 801B6024 C6400010 */  lwc1       $f0, 0x10($s2)
    /* B6028 801B6028 4600303C */  c.lt.s     $f6, $f0
    /* B602C 801B602C 00000000 */  nop
    /* B6030 801B6030 45000002 */  bc1f       .L801B603C
    /* B6034 801B6034 E6420030 */   swc1      $f2, 0x30($s2)
    /* B6038 801B6038 E6460010 */  swc1       $f6, 0x10($s2)
  .L801B603C:
    /* B603C 801B603C C6420030 */  lwc1       $f2, 0x30($s2)
    /* B6040 801B6040 46161080 */  add.s      $f2, $f2, $f22
    /* B6044 801B6044 C6400010 */  lwc1       $f0, 0x10($s2)
    /* B6048 801B6048 46001081 */  sub.s      $f2, $f2, $f0
    /* B604C 801B604C 8E420008 */  lw         $v0, 0x8($s2)
    /* B6050 801B6050 10400004 */  beqz       $v0, .L801B6064
    /* B6054 801B6054 E642001C */   swc1      $f2, 0x1C($s2)
    /* B6058 801B6058 C4400038 */  lwc1       $f0, 0x38($v0)
    /* B605C 801B605C 46040001 */  sub.s      $f0, $f0, $f4
    /* B6060 801B6060 E4400038 */  swc1       $f0, 0x38($v0)
  .L801B6064:
  ...
  .L801B60B0:
    ...
    /* B611C 801B611C C6000038 */  lwc1       $f0, 0x38($s0)
    /* B6120 801B6120 C6040030 */  lwc1       $f4, 0x30($s0)
    /* B6124 801B6124 46040000 */  add.s      $f0, $f0, $f4
    /* B6128 801B6128 C6420030 */  lwc1       $f2, 0x30($s2)
    /* B612C 801B612C 4600103E */  c.le.s     $f2, $f0
    /* B6130 801B6130 00000000 */  nop
    /* B6134 801B6134 4502000A */  bc1fl      .L801B6160
    /* B6138 801B6138 02002821 */   addu      $a1, $s0, $zero
    /* B613C 801B613C C6000044 */  lwc1       $f0, 0x44($s0)
    /* B6140 801B6140 46040000 */  add.s      $f0, $f0, $f4
    /* B6144 801B6144 4602003C */  c.lt.s     $f0, $f2
