...
glabel func_801B6A78
    ...
    /* B6A84 801B6A84 C422BC40 */  lwc1       $f2, %lo(D_8010BC40)($at)
    /* B6A88 801B6A88 46020003 */  div.s      $f0, $f0, $f2
    ...
    /* B6A9C 801B6A9C 44060000 */  mfc1       $a2, $f0
    ...
    /* B6AC0 801B6AC0 C437BC44 */  lwc1       $f23, %lo(D_8010BC40 + 0x4)($at)
    /* B6AC4 801B6AC4 C436BC48 */  lwc1       $f22, %lo(D_8010BC48)($at)
    /* B6AC8 801B6AC8 3C018011 */  lui        $at, %hi(D_8010BC48 + 0x4)
    /* B6ACC 801B6ACC C435BC4C */  lwc1       $f21, %lo(D_8010BC48 + 0x4)($at)
    /* B6AD0 801B6AD0 C434BC50 */  lwc1       $f20, %lo(D_8010BC50)($at)
    /* B6AD4 801B6AD4 C60C0048 */  lwc1       $f12, 0x48($s0)
    /* B6AD8 801B6AD8 46006321 */  cvt.d.s    $f12, $f12
    /* B6ADC 801B6ADC 46366300 */  add.d      $f12, $f12, $f22
    /* B6AE0 801B6AE0 0C0525B2 */  jal        func_801496C8
    /* B6AE4 801B6AE4 46206320 */   cvt.s.d   $f12, $f12
    /* B6AE8 801B6AE8 C60C0048 */  lwc1       $f12, 0x48($s0)
    /* B6AEC 801B6AEC 46006321 */  cvt.d.s    $f12, $f12
    /* B6AF0 801B6AF0 46346300 */  add.d      $f12, $f12, $f20
    /* B6AF4 801B6AF4 E6000044 */  swc1       $f0, 0x44($s0)
    /* B6AF8 801B6AF8 0C0525B2 */  jal        func_801496C8
    /* B6AFC 801B6AFC 46206320 */   cvt.s.d   $f12, $f12
    /* B6B00 801B6B00 E6000048 */  swc1       $f0, 0x48($s0)
