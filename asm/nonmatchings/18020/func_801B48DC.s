...
glabel func_801B48DC
    ...
    /* B48F0 801B48F0 C7BF0088 */  lwc1       $f31, 0x88($sp)
    /* B48F4 801B48F4 C7BE008C */  lwc1       $f30, 0x8C($sp)
    /* B48F8 801B48F8 C7BD0080 */  lwc1       $f29, 0x80($sp)
    /* B48FC 801B48FC C7BC0084 */  lwc1       $f28, 0x84($sp)
    /* B4900 801B4900 C7BB0078 */  lwc1       $f27, 0x78($sp)
    /* B4904 801B4904 C7BA007C */  lwc1       $f26, 0x7C($sp)
    /* B4908 801B4908 C7B90070 */  lwc1       $f25, 0x70($sp)
    /* B490C 801B490C C7B80074 */  lwc1       $f24, 0x74($sp)
    /* B4910 801B4910 C7B70068 */  lwc1       $f23, 0x68($sp)
    /* B4914 801B4914 C7B6006C */  lwc1       $f22, 0x6C($sp)
    /* B4918 801B4918 C7B50060 */  lwc1       $f21, 0x60($sp)
    /* B491C 801B491C C7B40064 */  lwc1       $f20, 0x64($sp)
  ...
  .L801B49A4:
    ...
    /* B49E0 801B49E0 C433BA98 */  lwc1       $f19, %lo(D_8010BA98)($at)
    /* B49E4 801B49E4 C432BA9C */  lwc1       $f18, %lo(D_8010BA98 + 0x4)($at)
    /* B49E8 801B49E8 27BDFFF0 */  addiu      $sp, $sp, -0x10
    /* B49EC 801B49EC 00004821 */  addu       $t1, $zero, $zero
    /* B49F0 801B49F0 E7B70008 */  swc1       $f23, 0x8($sp)
    /* B49F4 801B49F4 E7B6000C */  swc1       $f22, 0xC($sp)
    /* B49F8 801B49F8 3C018011 */  lui        $at, %hi(D_8010BAA0)
    /* B49FC 801B49FC C436BAA0 */  lwc1       $f22, %lo(D_8010BAA0)($at)
    ...
    /* B4A14 801B4A14 E7B50000 */  swc1       $f21, 0x0($sp)
    /* B4A18 801B4A18 E7B40004 */  swc1       $f20, 0x4($sp)
    /* B4A1C 801B4A1C 3C018011 */  lui        $at, %hi(D_8010BAA4)
    /* B4A20 801B4A20 C434BAA4 */  lwc1       $f20, %lo(D_8010BAA4)($at)
    /* B4A24 801B4A24 00A26821 */  addu       $t5, $a1, $v0
    /* B4A28 801B4A28 44867000 */  mtc1       $a2, $f14
    /* B4A2C 801B4A2C 00005021 */  addu       $t2, $zero, $zero
    /* B4A30 801B4A30 46007421 */  cvt.d.s    $f16, $f14
  .L801B4A34:
    /* B4A34 801B4A34 4630903E */  c.le.d     $f18, $f16
    /* B4A38 801B4A38 00000000 */  nop
    /* B4A3C 801B4A3C 45000015 */  bc1f       .L801B4A94
    /* B4A40 801B4A40 24070001 */   addiu     $a3, $zero, 0x1
    /* B4A44 801B4A44 4616703E */  c.le.s     $f14, $f22
  ...
  .L801B4A94:
    ...
    /* B4A9C 801B4A9C 460EA301 */  sub.s      $f12, $f20, $f14
  .L801B4AA0:
    ...
    /* B4AC0 801B4AC0 44824000 */  mtc1       $v0, $f8
    /* B4AC4 801B4AC4 46804220 */  cvt.s.w    $f8, $f8
    /* B4AC8 801B4AC8 460E4202 */  mul.s      $f8, $f8, $f14
    /* B4ACC 801B4ACC 00641821 */  addu       $v1, $v1, $a0
    /* B4AD0 801B4AD0 9463FFFE */  lhu        $v1, -0x2($v1)
    /* B4AD4 801B4AD4 000312C2 */  srl        $v0, $v1, 11
    /* B4AD8 801B4AD8 44825000 */  mtc1       $v0, $f10
    /* B4ADC 801B4ADC 468052A0 */  cvt.s.w    $f10, $f10
    /* B4AE0 801B4AE0 460C5282 */  mul.s      $f10, $f10, $f12
    /* B4AE4 801B4AE4 30C207C0 */  andi       $v0, $a2, 0x7C0
    /* B4AE8 801B4AE8 00021182 */  srl        $v0, $v0, 6
    /* B4AEC 801B4AEC 44822000 */  mtc1       $v0, $f4
    /* B4AF0 801B4AF0 46802120 */  cvt.s.w    $f4, $f4
    /* B4AF4 801B4AF4 460E2102 */  mul.s      $f4, $f4, $f14
    /* B4AF8 801B4AF8 306207C0 */  andi       $v0, $v1, 0x7C0
    /* B4AFC 801B4AFC 00021182 */  srl        $v0, $v0, 6
    /* B4B00 801B4B00 44823000 */  mtc1       $v0, $f6
    /* B4B04 801B4B04 468031A0 */  cvt.s.w    $f6, $f6
    /* B4B08 801B4B08 460C3182 */  mul.s      $f6, $f6, $f12
    /* B4B0C 801B4B0C 30C2003E */  andi       $v0, $a2, 0x3E
    /* B4B10 801B4B10 00021042 */  srl        $v0, $v0, 1
    /* B4B14 801B4B14 44820000 */  mtc1       $v0, $f0
    /* B4B18 801B4B18 46800020 */  cvt.s.w    $f0, $f0
    /* B4B1C 801B4B1C 460E0002 */  mul.s      $f0, $f0, $f14
    /* B4B20 801B4B20 3063003E */  andi       $v1, $v1, 0x3E
    /* B4B24 801B4B24 00031842 */  srl        $v1, $v1, 1
    /* B4B28 801B4B28 44831000 */  mtc1       $v1, $f2
    /* B4B2C 801B4B2C 468010A0 */  cvt.s.w    $f2, $f2
    /* B4B30 801B4B30 460A4200 */  add.s      $f8, $f8, $f10
    /* B4B34 801B4B34 460C1082 */  mul.s      $f2, $f2, $f12
    /* B4B38 801B4B38 24E70001 */  addiu      $a3, $a3, 0x1
    /* B4B3C 801B4B3C 46062100 */  add.s      $f4, $f4, $f6
  .L801B4B40:
    /* B4B40 801B4B40 00082040 */  sll        $a0, $t0, 1
    /* B4B44 801B4B44 25080010 */  addiu      $t0, $t0, 0x10
    /* B4B48 801B4B48 00852021 */  addu       $a0, $a0, $a1
    /* B4B4C 801B4B4C 46020000 */  add.s      $f0, $f0, $f2
    /* B4B50 801B4B50 4600418D */  trunc.w.s  $f6, $f8
    /* B4B54 801B4B54 44033000 */  mfc1       $v1, $f6
    /* B4B58 801B4B58 00031AC0 */  sll        $v1, $v1, 11
    /* B4B5C 801B4B5C 4600208D */  trunc.w.s  $f2, $f4
    /* B4B60 801B4B60 44021000 */  mfc1       $v0, $f2
    /* B4B64 801B4B64 00021180 */  sll        $v0, $v0, 6
    /* B4B68 801B4B68 00621821 */  addu       $v1, $v1, $v0
    /* B4B6C 801B4B6C 4600008D */  trunc.w.s  $f2, $f0
    /* B4B70 801B4B70 44021000 */  mfc1       $v0, $f2
  ...
  .L801B4B90:
    ...
    /* B4B9C 801B4B9C C7B70008 */  lwc1       $f23, 0x8($sp)
    /* B4BA0 801B4BA0 C7B6000C */  lwc1       $f22, 0xC($sp)
    /* B4BA4 801B4BA4 C7B50000 */  lwc1       $f21, 0x0($sp)
    /* B4BA8 801B4BA8 C7B40004 */  lwc1       $f20, 0x4($sp)
