...
glabel func_801A0444
    /* A0444 801A0444 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A0448 801A0448 E4400074 */  swc1       $fv0, 0x74($v0)
  .L801A044C:
  ...
  .L801A0464:
    ...
    /* A0498 801A0498 C422F9EC */  lwc1       $fv1, %lo(D_8029F9EC)($at)
    /* A049C 801A049C 3C018011 */  lui        $at, %hi(D_8010AB48)
    /* A04A0 801A04A0 C420AB48 */  lwc1       $fv0, %lo(D_8010AB48)($at)
    /* A04A4 801A04A4 4602003C */  c.lt.s     $fv0, $fv1
  ...
  .L801A0500:
    ...
    /* A0538 801A0538 C422F9EC */  lwc1       $fv1, %lo(D_8029F9EC)($at)
    /* A053C 801A053C 3C018011 */  lui        $at, %hi(D_8010AB4C)
    /* A0540 801A0540 C420AB4C */  lwc1       $fv0, %lo(D_8010AB4C)($at)
    /* A0544 801A0544 4602003C */  c.lt.s     $fv0, $fv1
  ...
  .L801A058C:
    ...
    /* A059C 801A059C C420AB50 */  lwc1       $fv0, %lo(D_8010AB50)($at)
    /* A05A0 801A05A0 3C018011 */  lui        $at, %hi(D_8010AB54)
    /* A05A4 801A05A4 C422AB54 */  lwc1       $fv1, %lo(D_8010AB54)($at)
    /* A05A8 801A05A8 3C018011 */  lui        $at, %hi(D_8010AB58)
    /* A05AC 801A05AC C424AB58 */  lwc1       $ft0, %lo(D_8010AB58)($at)
    /* A05B0 801A05B0 8E4200D8 */  lw         $v0, 0xD8($s2)
    /* A05B4 801A05B4 E640008C */  swc1       $fv0, 0x8C($s2)
    /* A05B8 801A05B8 E6420084 */  swc1       $fv1, 0x84($s2)
    /* A05BC 801A05BC E644005C */  swc1       $ft0, 0x5C($s2)
    /* A05C0 801A05C0 C4400074 */  lwc1       $fv0, 0x74($v0)
    /* A05C4 801A05C4 3C018011 */  lui        $at, %hi(D_8010AB5C)
    /* A05C8 801A05C8 C422AB5C */  lwc1       $fv1, %lo(D_8010AB5C)($at)
    /* A05CC 801A05CC 46020000 */  add.s      $fv0, $fv0, $fv1
    /* A05D0 801A05D0 3C018029 */  lui        $at, %hi(D_8028FBCC)
    /* A05D4 801A05D4 C424FBCC */  lwc1       $ft0, %lo(D_8028FBCC)($at)
    /* A05D8 801A05D8 3C048029 */  lui        $a0, %hi(D_80290330)
    /* A05DC 801A05DC 24840330 */  addiu      $a0, $a0, %lo(D_80290330)
    /* A05E0 801A05E0 E4400074 */  swc1       $fv0, 0x74($v0)
    /* A05E4 801A05E4 C4800000 */  lwc1       $fv0, 0x0($a0)
    /* A05E8 801A05E8 3C018029 */  lui        $at, %hi(D_80290338)
    /* A05EC 801A05EC C4220338 */  lwc1       $fv1, %lo(D_80290338)($at)
    /* A05F0 801A05F0 3C028029 */  lui        $v0, %hi(D_80290300)
    /* A05F4 801A05F4 8C420300 */  lw         $v0, %lo(D_80290300)($v0)
    /* A05F8 801A05F8 46000000 */  add.s      $fv0, $fv0, $fv0
    ...
    /* A0608 801A0608 E4240348 */  swc1       $ft0, %lo(D_80290348)($at)
    /* A060C 801A060C 46021080 */  add.s      $fv1, $fv1, $fv1
    ...
    /* A061C 801A061C E4800000 */  swc1       $fv0, 0x0($a0)
    /* A0620 801A0620 3C018029 */  lui        $at, %hi(D_80290338)
    /* A0624 801A0624 E4220338 */  swc1       $fv1, %lo(D_80290338)($at)
  ...
  .L801A0630:
    ...
    /* A0684 801A0684 C422AB60 */  lwc1       $fv1, %lo(D_8010AB60)($at)
    /* A0688 801A0688 4602003C */  c.lt.s     $fv0, $fv1
    ...
    /* A06AC 801A06AC C60C0000 */  lwc1       $fa0, 0x0($s0)
    /* A06B0 801A06B0 C6400034 */  lwc1       $fv0, 0x34($s2)
    /* A06B4 801A06B4 46006301 */  sub.s      $fa0, $fa0, $fv0
    /* A06B8 801A06B8 3C018029 */  lui        $at, %hi(D_80290310)
    /* A06BC 801A06BC C4200310 */  lwc1       $fv0, %lo(D_80290310)($at)
    /* A06C0 801A06C0 E7AC0010 */  swc1       $fa0, 0x10($sp)
    /* A06C4 801A06C4 C6420038 */  lwc1       $fv1, 0x38($s2)
    /* A06C8 801A06C8 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A06CC 801A06CC 3C018029 */  lui        $at, %hi(D_80290314)
    /* A06D0 801A06D0 C42E0314 */  lwc1       $fa1, %lo(D_80290314)($at)
    /* A06D4 801A06D4 E7A00014 */  swc1       $fv0, 0x14($sp)
    /* A06D8 801A06D8 C640003C */  lwc1       $fv0, 0x3C($s2)
    /* A06DC 801A06DC 46007381 */  sub.s      $fa1, $fa1, $fv0
    /* A06E0 801A06E0 08067DF1 */  j          .L8019F7C4
    /* A06E4 801A06E4 E7AE0018 */   swc1      $fa1, 0x18($sp)
  .L801A06E8:
    /* A06E8 801A06E8 3C04802A */  lui        $a0, %hi(D_8029F9AC)
    /* A06EC 801A06EC 2484F9AC */  addiu      $a0, $a0, %lo(D_8029F9AC)
    /* A06F0 801A06F0 C4800000 */  lwc1       $fv0, 0x0($a0)
    /* A06F4 801A06F4 C6420034 */  lwc1       $fv1, 0x34($s2)
    /* A06F8 801A06F8 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A06FC 801A06FC E7A00010 */  swc1       $fv0, 0x10($sp)
    /* A0700 801A0700 3C01802A */  lui        $at, %hi(D_8029F9B0)
    /* A0704 801A0704 C420F9B0 */  lwc1       $fv0, %lo(D_8029F9B0)($at)
    /* A0708 801A0708 C6420038 */  lwc1       $fv1, 0x38($s2)
    /* A070C 801A070C 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A0710 801A0710 3C01802A */  lui        $at, %hi(D_8029F9B4)
    /* A0714 801A0714 C422F9B4 */  lwc1       $fv1, %lo(D_8029F9B4)($at)
    /* A0718 801A0718 E7A00014 */  swc1       $fv0, 0x14($sp)
    /* A071C 801A071C C640003C */  lwc1       $fv0, 0x3C($s2)
    /* A0720 801A0720 46001081 */  sub.s      $fv1, $fv1, $fv0
    /* A0724 801A0724 26450034 */  addiu      $a1, $s2, 0x34
    /* A0728 801A0728 0C05236C */  jal        func_80148DB0
    /* A072C 801A072C E7A20018 */   swc1      $fv1, 0x18($sp)
    /* A0730 801A0730 3C018011 */  lui        $at, %hi(D_8010AB64)
    /* A0734 801A0734 C422AB64 */  lwc1       $fv1, %lo(D_8010AB64)($at)
    /* A0738 801A0738 46000106 */  mov.s      $ft0, $fv0
    /* A073C 801A073C 4604103C */  c.lt.s     $fv1, $ft0
    /* A0740 801A0740 00000000 */  nop
    /* A0744 801A0744 4500000C */  bc1f       .L801A0778
    /* A0748 801A0748 00000000 */   nop
    /* A074C 801A074C C7AC0010 */  lwc1       $fa0, 0x10($sp)
    /* A0750 801A0750 C7AE0018 */  lwc1       $fa1, 0x18($sp)
    /* A0754 801A0754 0C051D18 */  jal        func_80147460
    /* A0758 801A0758 00000000 */   nop
    /* A075C 801A075C 3C018011 */  lui        $at, %hi(D_8010AB68)
    /* A0760 801A0760 C423AB68 */  lwc1       $fv1f, %lo(D_8010AB68)($at)
    /* A0764 801A0764 C422AB6C */  lwc1       $fv1, %lo(D_8010AB68 + 0x4)($at)
    /* A0768 801A0768 46000021 */  cvt.d.s    $fv0, $fv0
    /* A076C 801A076C 46220000 */  add.d      $fv0, $fv0, $fv1
    /* A0770 801A0770 08067DF4 */  j          .L8019F7D0
    /* A0774 801A0774 46200320 */   cvt.s.d   $fa0, $fv0
  .L801A0778:
    /* A0778 801A0778 3C018011 */  lui        $at, %hi(D_8010AB70)
    /* A077C 801A077C C420AB70 */  lwc1       $fv0, %lo(D_8010AB70)($at)
    /* A0780 801A0780 4600203C */  c.lt.s     $ft0, $fv0
    /* A0784 801A0784 00000000 */  nop
    /* A0788 801A0788 4500000C */  bc1f       .L801A07BC
    /* A078C 801A078C 00000000 */   nop
    /* A0790 801A0790 C7AC0010 */  lwc1       $fa0, 0x10($sp)
    /* A0794 801A0794 C7AE0018 */  lwc1       $fa1, 0x18($sp)
    /* A0798 801A0798 0C051D18 */  jal        func_80147460
    /* A079C 801A079C 00000000 */   nop
    /* A07A0 801A07A0 3C018011 */  lui        $at, %hi(D_8010AB70 + 0x4)
    /* A07A4 801A07A4 C423AB74 */  lwc1       $fv1f, %lo(D_8010AB70 + 0x4)($at)
    /* A07A8 801A07A8 C422AB78 */  lwc1       $fv1, %lo(D_8010AB78)($at)
    /* A07AC 801A07AC 46000021 */  cvt.d.s    $fv0, $fv0
    /* A07B0 801A07B0 46220000 */  add.d      $fv0, $fv0, $fv1
    /* A07B4 801A07B4 08067DF4 */  j          .L8019F7D0
    /* A07B8 801A07B8 46200320 */   cvt.s.d   $fa0, $fv0
  .L801A07BC:
    /* A07BC 801A07BC C7AC0010 */  lwc1       $fa0, 0x10($sp)
    /* A07C0 801A07C0 C7AE0018 */  lwc1       $fa1, 0x18($sp)
    /* A07C4 801A07C4 0C051D18 */  jal        func_80147460
    /* A07C8 801A07C8 00000000 */   nop
    /* A07CC 801A07CC 46000306 */  mov.s      $fa0, $fv0
    /* A07D0 801A07D0 0C0525B2 */  jal        func_801496C8
    /* A07D4 801A07D4 00000000 */   nop
    /* A07D8 801A07D8 E6400088 */  swc1       $fv0, 0x88($s2)
    /* A07DC 801A07DC 8E4200D0 */  lw         $v0, 0xD0($s2)
    /* A07E0 801A07E0 C4400004 */  lwc1       $fv0, 0x4($v0)
    /* A07E4 801A07E4 AFA00010 */  sw         $zero, 0x10($sp)
    /* A07E8 801A07E8 E7A00018 */  swc1       $fv0, 0x18($sp)
    /* A07EC 801A07EC C640007C */  lwc1       $fv0, 0x7C($s2)
    /* A07F0 801A07F0 3C018011 */  lui        $at, %hi(D_8010AB78 + 0x4)
    /* A07F4 801A07F4 C423AB7C */  lwc1       $fv1f, %lo(D_8010AB78 + 0x4)($at)
    /* A07F8 801A07F8 C422AB80 */  lwc1       $fv1, %lo(D_8010AB80)($at)
    /* A07FC 801A07FC 46000021 */  cvt.d.s    $fv0, $fv0
    /* A0800 801A0800 46220000 */  add.d      $fv0, $fv0, $fv1
    /* A0804 801A0804 27A40010 */  addiu      $a0, $sp, 0x10
    /* A0808 801A0808 46200020 */  cvt.s.d    $fv0, $fv0
    /* A080C 801A080C 44060000 */  mfc1       $a2, $fv0
  ...
  .L801A082C:
    /* A082C 801A082C C6400058 */  lwc1       $fv0, 0x58($s2)
    /* A0830 801A0830 3C018011 */  lui        $at, %hi(D_8010AB80 + 0x4)
    /* A0834 801A0834 C425AB84 */  lwc1       $ft0f, %lo(D_8010AB80 + 0x4)($at)
    /* A0838 801A0838 C424AB88 */  lwc1       $ft0, %lo(D_8010AB88)($at)
    /* A083C 801A083C 46000021 */  cvt.d.s    $fv0, $fv0
    /* A0840 801A0840 46240002 */  mul.d      $fv0, $fv0, $ft0
    /* A0844 801A0844 C6420060 */  lwc1       $fv1, 0x60($s2)
    /* A0848 801A0848 460010A1 */  cvt.d.s    $fv1, $fv1
    /* A084C 801A084C 46241082 */  mul.d      $fv1, $fv1, $ft0
    /* A0850 801A0850 46200020 */  cvt.s.d    $fv0, $fv0
    /* A0854 801A0854 462010A0 */  cvt.s.d    $fv1, $fv1
    /* A0858 801A0858 E6400058 */  swc1       $fv0, 0x58($s2)
    /* A085C 801A085C E6420060 */  swc1       $fv1, 0x60($s2)
  .L801A0860:
    ...
    /* A0874 801A0874 C480000C */  lwc1       $fv0, 0xC($a0)
    /* A0878 801A0878 3C018011 */  lui        $at, %hi(D_8010AB8C)
    /* A087C 801A087C C422AB8C */  lwc1       $fv1, %lo(D_8010AB8C)($at)
    /* A0880 801A0880 46020000 */  add.s      $fv0, $fv0, $fv1
    /* A0884 801A0884 C482004C */  lwc1       $fv1, 0x4C($a0)
    /* A0888 801A0888 4600103C */  c.lt.s     $fv1, $fv0
    /* A088C 801A088C 00000000 */  nop
    /* A0890 801A0890 45000027 */  bc1f       .L801A0930
    /* A0894 801A0894 00000000 */   nop
    /* A0898 801A0898 C6440034 */  lwc1       $ft0, 0x34($s2)
    /* A089C 801A089C 3C01802A */  lui        $at, %hi(D_8029F9AC)
    /* A08A0 801A08A0 C420F9AC */  lwc1       $fv0, %lo(D_8029F9AC)($at)
    /* A08A4 801A08A4 46002101 */  sub.s      $ft0, $ft0, $fv0
    /* A08A8 801A08A8 3C01802A */  lui        $at, %hi(D_8029F9B0)
    /* A08AC 801A08AC C422F9B0 */  lwc1       $fv1, %lo(D_8029F9B0)($at)
    /* A08B0 801A08B0 E7A40010 */  swc1       $ft0, 0x10($sp)
    /* A08B4 801A08B4 C6400038 */  lwc1       $fv0, 0x38($s2)
    /* A08B8 801A08B8 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A08BC 801A08BC 46042102 */  mul.s      $ft0, $ft0, $ft0
    /* A08C0 801A08C0 E7A00014 */  swc1       $fv0, 0x14($sp)
    /* A08C4 801A08C4 C642003C */  lwc1       $fv1, 0x3C($s2)
    /* A08C8 801A08C8 3C01802A */  lui        $at, %hi(D_8029F9B4)
    /* A08CC 801A08CC C420F9B4 */  lwc1       $fv0, %lo(D_8029F9B4)($at)
    /* A08D0 801A08D0 46001081 */  sub.s      $fv1, $fv1, $fv0
    /* A08D4 801A08D4 46021002 */  mul.s      $fv0, $fv1, $fv1
    /* A08D8 801A08D8 46002300 */  add.s      $fa0, $ft0, $fv0
    /* A08DC 801A08DC 46006004 */  sqrt.s     $fv0, $fa0
    /* A08E0 801A08E0 46000032 */  c.eq.s     $fv0, $fv0
    /* A08E4 801A08E4 00000000 */  nop
    /* A08E8 801A08E8 45010003 */  bc1t       .L801A08F8
    /* A08EC 801A08EC E7A20018 */   swc1      $fv1, 0x18($sp)
    /* A08F0 801A08F0 0C07100C */  jal        func_801C4030
    /* A08F4 801A08F4 00000000 */   nop
  .L801A08F8:
    /* A08F8 801A08F8 C7AC0014 */  lwc1       $fa0, 0x14($sp)
    /* A08FC 801A08FC 0C051D18 */  jal        func_80147460
    /* A0900 801A0900 46000386 */   mov.s     $fa1, $fv0
    /* A0904 801A0904 3C018011 */  lui        $at, %hi(D_8010AB90)
    /* A0908 801A0908 C423AB90 */  lwc1       $fv1f, %lo(D_8010AB90)($at)
    /* A090C 801A090C C422AB94 */  lwc1       $fv1, %lo(D_8010AB90 + 0x4)($at)
    /* A0910 801A0910 46000021 */  cvt.d.s    $fv0, $fv0
    /* A0914 801A0914 46220001 */  sub.d      $fv0, $fv0, $fv1
    /* A0918 801A0918 0C0525B2 */  jal        func_801496C8
    /* A091C 801A091C 46200320 */   cvt.s.d   $fa0, $fv0
    ...
    /* A092C 801A092C E6400078 */   swc1      $fv0, 0x78($s2)
  .L801A0930:
    /* A0930 801A0930 8E4200DC */  lw         $v0, 0xDC($s2)
    /* A0934 801A0934 3C018011 */  lui        $at, %hi(D_8010AB98)
    /* A0938 801A0938 C420AB98 */  lwc1       $fv0, %lo(D_8010AB98)($at)
    /* A093C 801A093C C442004C */  lwc1       $fv1, 0x4C($v0)
    /* A0940 801A0940 4602003E */  c.le.s     $fv0, $fv1
    ...
    /* A0954 801A0954 C420AB9C */  lwc1       $fv0, %lo(D_8010AB9C)($at)
    /* A0958 801A0958 4600103E */  c.le.s     $fv1, $fv0
  ...
  .L801A0968:
    ...
    /* A097C 801A097C C424ABA0 */  lwc1       $ft0, %lo(D_8010ABA0)($at)
    /* A0980 801A0980 C442004C */  lwc1       $fv1, 0x4C($v0)
    /* A0984 801A0984 4602203E */  c.le.s     $ft0, $fv1
    /* A0988 801A0988 00000000 */  nop
    /* A098C 801A098C 4500000C */  bc1f       .L801A09C0
    /* A0990 801A0990 00000000 */   nop
    /* A0994 801A0994 C440000C */  lwc1       $fv0, 0xC($v0)
    /* A0998 801A0998 46040000 */  add.s      $fv0, $fv0, $ft0
    /* A099C 801A099C 4600103C */  c.lt.s     $fv1, $fv0
  ...
  .L801A09D0:
    ...
    /* A09E0 801A09E0 C7B50040 */  lwc1       $fs0f, 0x40($sp)
    /* A09E4 801A09E4 C7B40044 */  lwc1       $fs0, 0x44($sp)
    ...
    /* A0A0C 801A0A0C E7B50038 */  swc1       $fs0f, 0x38($sp)
    /* A0A10 801A0A10 E7B4003C */  swc1       $fs0, 0x3C($sp)
    ...
    /* A0A2C 801A0A2C C422ABA4 */  lwc1       $fv1, %lo(D_8010ABA4)($at)
    ...
    /* A0A48 801A0A48 C6200038 */  lwc1       $fv0, 0x38($s1)
    /* A0A4C 801A0A4C 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A0A50 801A0A50 E6200038 */  swc1       $fv0, 0x38($s1)
    /* A0A54 801A0A54 3C01802A */  lui        $at, %hi(D_80299764)
    /* A0A58 801A0A58 C4209764 */  lwc1       $fv0, %lo(D_80299764)($at)
    /* A0A5C 801A0A5C E620007C */  swc1       $fv0, 0x7C($s1)
    /* A0A60 801A0A60 E6200088 */  swc1       $fv0, 0x88($s1)
    ...
    /* A0A70 801A0A70 C440000C */  lwc1       $fv0, 0xC($v0)
    /* A0A74 801A0A74 E460000C */  swc1       $fv0, 0xC($v1)
    ...
    /* A0A84 801A0A84 C440004C */  lwc1       $fv0, 0x4C($v0)
    /* A0A88 801A0A88 E460004C */  swc1       $fv0, 0x4C($v1)
    /* A0A8C 801A0A8C 8E2200DC */  lw         $v0, 0xDC($s1)
    /* A0A90 801A0A90 3C018011 */  lui        $at, %hi(D_8010ABA8)
    /* A0A94 801A0A94 C424ABA8 */  lwc1       $ft0, %lo(D_8010ABA8)($at)
    /* A0A98 801A0A98 C442004C */  lwc1       $fv1, 0x4C($v0)
    /* A0A9C 801A0A9C 4602203E */  c.le.s     $ft0, $fv1
  .L801A0AA0:
    ...
    /* A0AB4 801A0AB4 C440000C */  lwc1       $fv0, 0xC($v0)
    /* A0AB8 801A0AB8 46040000 */  add.s      $fv0, $fv0, $ft0
    /* A0ABC 801A0ABC 4600103C */  c.lt.s     $fv1, $fv0
  ...
  .L801A0AE0:
    /* A0AE0 801A0AE0 C6220034 */  lwc1       $fv1, 0x34($s1)
    /* A0AE4 801A0AE4 46021082 */  mul.s      $fv1, $fv1, $fv1
    /* A0AE8 801A0AE8 C620003C */  lwc1       $fv0, 0x3C($s1)
    /* A0AEC 801A0AEC 46000002 */  mul.s      $fv0, $fv0, $fv0
    /* A0AF0 801A0AF0 46001300 */  add.s      $fa0, $fv1, $fv0
    /* A0AF4 801A0AF4 46006004 */  sqrt.s     $fv0, $fa0
    /* A0AF8 801A0AF8 46000032 */  c.eq.s     $fv0, $fv0
  ...
  .L801A0B10:
    ...
    /* A0B14 801A0B14 C434ABAC */  lwc1       $fs0, %lo(D_8010ABAC)($at)
    /* A0B18 801A0B18 4600A03C */  c.lt.s     $fs0, $fv0
    ...
    /* A0B30 801A0B30 C6220034 */  lwc1       $fv1, 0x34($s1)
    /* A0B34 801A0B34 46141082 */  mul.s      $fv1, $fv1, $fs0
    /* A0B38 801A0B38 C620003C */  lwc1       $fv0, 0x3C($s1)
    /* A0B3C 801A0B3C 46140002 */  mul.s      $fv0, $fv0, $fs0
    /* A0B40 801A0B40 E6220034 */  swc1       $fv1, 0x34($s1)
    /* A0B44 801A0B44 E620003C */  swc1       $fv0, 0x3C($s1)
  .L801A0B48:
    ...
    /* A0B60 801A0B60 C42CABB0 */  lwc1       $fa0, %lo(D_8010ABB0)($at)
  ...
  .L801A0C08:
    ...
    /* A0C20 801A0C20 C420ABB4 */  lwc1       $fv0, %lo(D_8010ABB4)($at)
    /* A0C24 801A0C24 E4400004 */  swc1       $fv0, 0x4($v0)
    /* A0C28 801A0C28 8E2200D0 */  lw         $v0, 0xD0($s1)
    /* A0C2C 801A0C2C E4400028 */  swc1       $fv0, 0x28($v0)
  ...
  .L801A0CC0:
    ...
    /* A0CC8 801A0CC8 C420ABB8 */  lwc1       $fv0, %lo(D_8010ABB8)($at)
    /* A0CCC 801A0CCC E4400004 */  swc1       $fv0, 0x4($v0)
    /* A0CD0 801A0CD0 8E2200D0 */  lw         $v0, 0xD0($s1)
    /* A0CD4 801A0CD4 3C018011 */  lui        $at, %hi(D_8010ABBC)
  .L801A0CD8:
    /* A0CD8 801A0CD8 C420ABBC */  lwc1       $fv0, %lo(D_8010ABBC)($at)
    /* A0CDC 801A0CDC E4400028 */  swc1       $fv0, 0x28($v0)
    ...
    /* A0D38 801A0D38 C6200030 */  lwc1       $fv0, 0x30($s1)
    /* A0D3C 801A0D3C 3C018011 */  lui        $at, %hi(D_8010ABC0)
    /* A0D40 801A0D40 C423ABC0 */  lwc1       $fv1f, %lo(D_8010ABC0)($at)
    /* A0D44 801A0D44 C422ABC4 */  lwc1       $fv1, %lo(D_8010ABC0 + 0x4)($at)
    /* A0D48 801A0D48 46000007 */  neg.s      $fv0, $fv0
    /* A0D4C 801A0D4C 46000021 */  cvt.d.s    $fv0, $fv0
    /* A0D50 801A0D50 46220003 */  div.d      $fv0, $fv0, $fv1
    ...
    /* A0D60 801A0D60 46200020 */  cvt.s.d    $fv0, $fv0
    /* A0D64 801A0D64 44060000 */  mfc1       $a2, $fv0
  ...
  .L801A0DC8:
    ...
    /* A0E00 801A0E00 C620005C */  lwc1       $fv0, 0x5C($s1)
    /* A0E04 801A0E04 3C018011 */  lui        $at, %hi(D_8010ABC8)
    /* A0E08 801A0E08 C422ABC8 */  lwc1       $fv1, %lo(D_8010ABC8)($at)
    /* A0E0C 801A0E0C 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* A0E10 801A0E10 E620005C */  swc1       $fv0, 0x5C($s1)
  .L801A0E14:
    /* A0E14 801A0E14 C6200058 */  lwc1       $fv0, 0x58($s1)
    /* A0E18 801A0E18 3C018011 */  lui        $at, %hi(D_8010ABC8 + 0x4)
    /* A0E1C 801A0E1C C425ABCC */  lwc1       $ft0f, %lo(D_8010ABC8 + 0x4)($at)
    /* A0E20 801A0E20 C424ABD0 */  lwc1       $ft0, %lo(D_8010ABD0)($at)
    /* A0E24 801A0E24 46000021 */  cvt.d.s    $fv0, $fv0
    /* A0E28 801A0E28 46240002 */  mul.d      $fv0, $fv0, $ft0
    /* A0E2C 801A0E2C C6220060 */  lwc1       $fv1, 0x60($s1)
    /* A0E30 801A0E30 460010A1 */  cvt.d.s    $fv1, $fv1
    /* A0E34 801A0E34 46241082 */  mul.d      $fv1, $fv1, $ft0
    /* A0E38 801A0E38 46200020 */  cvt.s.d    $fv0, $fv0
    /* A0E3C 801A0E3C 462010A0 */  cvt.s.d    $fv1, $fv1
    /* A0E40 801A0E40 E6200058 */  swc1       $fv0, 0x58($s1)
    /* A0E44 801A0E44 08068010 */  j          .L801A0040
    /* A0E48 801A0E48 E6220060 */   swc1      $fv1, 0x60($s1)
  .L801A0E4C:
    /* A0E4C 801A0E4C C6240058 */  lwc1       $ft0, 0x58($s1)
    /* A0E50 801A0E50 3C018011 */  lui        $at, %hi(D_8010ABD0 + 0x4)
    /* A0E54 801A0E54 C427ABD4 */  lwc1       $ft1f, %lo(D_8010ABD0 + 0x4)($at)
    /* A0E58 801A0E58 C426ABD8 */  lwc1       $ft1, %lo(D_8010ABD8)($at)
    /* A0E5C 801A0E5C 46002121 */  cvt.d.s    $ft0, $ft0
    /* A0E60 801A0E60 46262102 */  mul.d      $ft0, $ft0, $ft1
    /* A0E64 801A0E64 C622005C */  lwc1       $fv1, 0x5C($s1)
    /* A0E68 801A0E68 460010A1 */  cvt.d.s    $fv1, $fv1
    /* A0E6C 801A0E6C 46261082 */  mul.d      $fv1, $fv1, $ft1
    /* A0E70 801A0E70 C6200060 */  lwc1       $fv0, 0x60($s1)
    /* A0E74 801A0E74 46000021 */  cvt.d.s    $fv0, $fv0
    /* A0E78 801A0E78 46260002 */  mul.d      $fv0, $fv0, $ft1
    /* A0E7C 801A0E7C AE20008C */  sw         $zero, 0x8C($s1)
    /* A0E80 801A0E80 46202120 */  cvt.s.d    $ft0, $ft0
    /* A0E84 801A0E84 462010A0 */  cvt.s.d    $fv1, $fv1
    /* A0E88 801A0E88 46200020 */  cvt.s.d    $fv0, $fv0
    /* A0E8C 801A0E8C E6240058 */  swc1       $ft0, 0x58($s1)
    /* A0E90 801A0E90 E622005C */  swc1       $fv1, 0x5C($s1)
    /* A0E94 801A0E94 08068010 */  j          .L801A0040
    /* A0E98 801A0E98 E6200060 */   swc1      $fv0, 0x60($s1)
  .L801A0E9C:
    /* A0E9C 801A0E9C 3C018011 */  lui        $at, %hi(D_8010ABDC)
    /* A0EA0 801A0EA0 C420ABDC */  lwc1       $fv0, %lo(D_8010ABDC)($at)
    /* A0EA4 801A0EA4 3C018011 */  lui        $at, %hi(D_8010ABE0)
    /* A0EA8 801A0EA8 C422ABE0 */  lwc1       $fv1, %lo(D_8010ABE0)($at)
    /* A0EAC 801A0EAC E7A00020 */  swc1       $fv0, 0x20($sp)
    /* A0EB0 801A0EB0 C6200258 */  lwc1       $fv0, 0x258($s1)
    /* A0EB4 801A0EB4 46800020 */  cvt.s.w    $fv0, $fv0
    /* A0EB8 801A0EB8 46020003 */  div.s      $fv0, $fv0, $fv1
    /* A0EBC 801A0EBC 27A40018 */  addiu      $a0, $sp, 0x18
    /* A0EC0 801A0EC0 44060000 */  mfc1       $a2, $fv0
    ...
    /* A0EF0 801A0EF0 C620005C */  lwc1       $fv0, 0x5C($s1)
    /* A0EF4 801A0EF4 3C018011 */  lui        $at, %hi(D_8010ABE0 + 0x4)
    /* A0EF8 801A0EF8 C423ABE4 */  lwc1       $fv1f, %lo(D_8010ABE0 + 0x4)($at)
    /* A0EFC 801A0EFC C422ABE8 */  lwc1       $fv1, %lo(D_8010ABE8)($at)
    /* A0F00 801A0F00 46000021 */  cvt.d.s    $fv0, $fv0
    /* A0F04 801A0F04 46220000 */  add.d      $fv0, $fv0, $fv1
    /* A0F08 801A0F08 3C018011 */  lui        $at, %hi(D_8010ABEC)
    /* A0F0C 801A0F0C C422ABEC */  lwc1       $fv1, %lo(D_8010ABEC)($at)
    /* A0F10 801A0F10 46200020 */  cvt.s.d    $fv0, $fv0
    /* A0F14 801A0F14 E620005C */  swc1       $fv0, 0x5C($s1)
    /* A0F18 801A0F18 3C018029 */  lui        $at, %hi(D_80290310)
    /* A0F1C 801A0F1C C4200310 */  lwc1       $fv0, %lo(D_80290310)($at)
    /* A0F20 801A0F20 46020000 */  add.s      $fv0, $fv0, $fv1
    /* A0F24 801A0F24 C6220038 */  lwc1       $fv1, 0x38($s1)
    /* A0F28 801A0F28 4602003E */  c.le.s     $fv0, $fv1
    ...
    /* A0F40 801A0F40 C420ABF0 */  lwc1       $fv0, %lo(D_8010ABF0)($at)
    /* A0F44 801A0F44 C4420000 */  lwc1       $fv1, 0x0($v0)
    /* A0F48 801A0F48 4602003C */  c.lt.s     $fv0, $fv1
  ...
  .L801A0F70:
    ...
    /* A0F84 801A0F84 44800000 */  mtc1       $zero, $fv0
    /* A0F88 801A0F88 E6200060 */  swc1       $fv0, 0x60($s1)
    /* A0F8C 801A0F8C E620005C */  swc1       $fv0, 0x5C($s1)
    /* A0F90 801A0F90 08067FF0 */  j          .L8019FFC0
    /* A0F94 801A0F94 E6200058 */   swc1      $fv0, 0x58($s1)
  .L801A0F98:
    /* A0F98 801A0F98 14620009 */  bne        $v1, $v0, .L801A0FC0
    /* A0F9C 801A0F9C 00000000 */   nop
    /* A0FA0 801A0FA0 C620005C */  lwc1       $fv0, 0x5C($s1)
    /* A0FA4 801A0FA4 3C018011 */  lui        $at, %hi(D_8010ABF0 + 0x4)
    /* A0FA8 801A0FA8 C423ABF4 */  lwc1       $fv1f, %lo(D_8010ABF0 + 0x4)($at)
    /* A0FAC 801A0FAC C422ABF8 */  lwc1       $fv1, %lo(D_8010ABF8)($at)
    /* A0FB0 801A0FB0 46000021 */  cvt.d.s    $fv0, $fv0
    /* A0FB4 801A0FB4 46220002 */  mul.d      $fv0, $fv0, $fv1
    /* A0FB8 801A0FB8 46200020 */  cvt.s.d    $fv0, $fv0
    /* A0FBC 801A0FBC E620005C */  swc1       $fv0, 0x5C($s1)
  .L801A0FC0:
    ...
    /* A1004 801A1004 C420ABFC */  lwc1       $fv0, %lo(D_8010ABFC)($at)
    /* A1008 801A1008 E620005C */  swc1       $fv0, 0x5C($s1)
  .L801A100C:
  ...
  .L801A104C:
    ...
    /* A1050 801A1050 C7B50038 */  lwc1       $fs0f, 0x38($sp)
    /* A1054 801A1054 C7B4003C */  lwc1       $fs0, 0x3C($sp)
    ...
    /* A1078 801A1078 E7B70038 */  swc1       $fs1f, 0x38($sp)
    /* A107C 801A107C E7B6003C */  swc1       $fs1, 0x3C($sp)
    /* A1080 801A1080 E7B50030 */  swc1       $fs0f, 0x30($sp)
    /* A1084 801A1084 E7B40034 */  swc1       $fs0, 0x34($sp)
    ...
    /* A10F4 801A10F4 C7A20010 */  lwc1       $fv1, 0x10($sp)
    /* A10F8 801A10F8 46021082 */  mul.s      $fv1, $fv1, $fv1
    /* A10FC 801A10FC C7A00018 */  lwc1       $fv0, 0x18($sp)
    /* A1100 801A1100 46000002 */  mul.s      $fv0, $fv0, $fv0
    /* A1104 801A1104 46001300 */  add.s      $fa0, $fv1, $fv0
    /* A1108 801A1108 46006104 */  sqrt.s     $ft0, $fa0
    /* A110C 801A110C 46042032 */  c.eq.s     $ft0, $ft0
    ...
    /* A1124 801A1124 46000106 */  mov.s      $ft0, $fv0
  .L801A1128:
    /* A1128 801A1128 C6020038 */  lwc1       $fv1, 0x38($s0)
    /* A112C 801A112C 3C018011 */  lui        $at, %hi(D_8010AC00)
    /* A1130 801A1130 C420AC00 */  lwc1       $fv0, %lo(D_8010AC00)($at)
    /* A1134 801A1134 46001002 */  mul.s      $fv0, $fv1, $fv0
    /* A1138 801A1138 46002586 */  mov.s      $fs1, $ft0
    /* A113C 801A113C 4600B03C */  c.lt.s     $fs1, $fv0
    ...
    /* A1150 801A1150 C421AC04 */  lwc1       $fv0f, %lo(D_8010AC00 + 0x4)($at)
    /* A1154 801A1154 C420AC08 */  lwc1       $fv0, %lo(D_8010AC08)($at)
    /* A1158 801A1158 460010A1 */  cvt.d.s    $fv1, $fv1
    /* A115C 801A115C 46201082 */  mul.d      $fv1, $fv1, $fv0
    /* A1160 801A1160 4600B021 */  cvt.d.s    $fv0, $fs1
    /* A1164 801A1164 4620103C */  c.lt.d     $fv1, $fv0
    ...
    /* A1180 801A1180 C420AC0C */  lwc1       $fv0, %lo(D_8010AC0C)($at)
    /* A1184 801A1184 46160003 */  div.s      $fv0, $fv0, $fs1
    /* A1188 801A1188 26240024 */  addiu      $a0, $s1, 0x24
    /* A118C 801A118C 44060000 */  mfc1       $a2, $fv0
    ...
    /* A11A4 801A11A4 C420AC10 */  lwc1       $fv0, %lo(D_8010AC10)($at)
    ...
    /* A11B8 801A11B8 E4200334 */  swc1       $fv0, %lo(D_80290334)($at)
  .L801A11BC:
    ...
    /* A11E4 801A11E4 C7A20010 */  lwc1       $fv1, 0x10($sp)
    /* A11E8 801A11E8 46021082 */  mul.s      $fv1, $fv1, $fv1
    /* A11EC 801A11EC C7A00018 */  lwc1       $fv0, 0x18($sp)
    /* A11F0 801A11F0 46000002 */  mul.s      $fv0, $fv0, $fv0
    /* A11F4 801A11F4 46001300 */  add.s      $fa0, $fv1, $fv0
    /* A11F8 801A11F8 46006104 */  sqrt.s     $ft0, $fa0
    /* A11FC 801A11FC 46042032 */  c.eq.s     $ft0, $ft0
    ...
    /* A1214 801A1214 46000106 */  mov.s      $ft0, $fv0
  .L801A1218:
    /* A1218 801A1218 C6020038 */  lwc1       $fv1, 0x38($s0)
    /* A121C 801A121C 3C018011 */  lui        $at, %hi(D_8010AC14)
    /* A1220 801A1220 C420AC14 */  lwc1       $fv0, %lo(D_8010AC14)($at)
    /* A1224 801A1224 46001002 */  mul.s      $fv0, $fv1, $fv0
    /* A1228 801A1228 46002586 */  mov.s      $fs1, $ft0
    /* A122C 801A122C 4600B03C */  c.lt.s     $fs1, $fv0
    ...
    /* A1240 801A1240 C420AC18 */  lwc1       $fv0, %lo(D_8010AC18)($at)
    /* A1244 801A1244 46001002 */  mul.s      $fv0, $fv1, $fv0
    /* A1248 801A1248 4616003C */  c.lt.s     $fv0, $fs1
    ...
    /* A125C 801A125C C434AC1C */  lwc1       $fs0, %lo(D_8010AC1C)($at)
    /* A1260 801A1260 4616A583 */  div.s      $fs1, $fs0, $fs1
    /* A1264 801A1264 4406B000 */  mfc1       $a2, $fs1
    ...
    /* A1274 801A1274 E434F9D4 */  swc1       $fs0, %lo(D_8029F9D4)($at)
  .L801A1278:
    /* A1278 801A1278 8FBF0028 */  lw         $ra, 0x28($sp)
    /* A127C 801A127C 8FB10024 */  lw         $s1, 0x24($sp)
    /* A1280 801A1280 8FB00020 */  lw         $s0, 0x20($sp)
    /* A1284 801A1284 C7B70038 */  lwc1       $fs1f, 0x38($sp)
    /* A1288 801A1288 C7B6003C */  lwc1       $fs1, 0x3C($sp)
    /* A128C 801A128C C7B50030 */  lwc1       $fs0f, 0x30($sp)
    /* A1290 801A1290 C7B40034 */  lwc1       $fs0, 0x34($sp)
    ...
    /* A12B8 801A12B8 E7B50030 */  swc1       $fs0f, 0x30($sp)
    /* A12BC 801A12BC E7B40034 */  swc1       $fs0, 0x34($sp)
    /* A12C0 801A12C0 4486A000 */  mtc1       $a2, $fs0
    /* A12C4 801A12C4 24050001 */  addiu      $a1, $zero, 0x1
    /* A12C8 801A12C8 E7B70038 */  swc1       $fs1f, 0x38($sp)
    /* A12CC 801A12CC E7B6003C */  swc1       $fs1, 0x3C($sp)
    /* A12D0 801A12D0 4487B000 */  mtc1       $a3, $fs1
    ...
    /* A1320 801A1320 44822000 */  mtc1       $v0, $ft0
    /* A1324 801A1324 46802120 */  cvt.s.w    $ft0, $ft0
    /* A1328 801A1328 44072000 */  mfc1       $a3, $ft0
    /* A132C 801A132C 44920000 */  mtc1       $s2, $fv0
    /* A1330 801A1330 46800020 */  cvt.s.w    $fv0, $fv0
    /* A1334 801A1334 E7A00010 */  swc1       $fv0, 0x10($sp)
    ...
    /* A1348 801A1348 C6200018 */  lwc1       $fv0, 0x18($s1)
    /* A134C 801A134C 46140000 */  add.s      $fv0, $fv0, $fs0
    /* A1350 801A1350 E6200018 */  swc1       $fv0, 0x18($s1)
    ...
    /* A1368 801A1368 C423AC2C */  lwc1       $fv1f, %lo(D_8010AC28 + 0x4)($at)
    /* A136C 801A136C C422AC30 */  lwc1       $fv1, %lo(D_8010AC30)($at)
    /* A1370 801A1370 46000021 */  cvt.d.s    $fv0, $fv0
    /* A1374 801A1374 4622003C */  c.lt.d     $fv0, $fv1
    ...
    /* A1388 801A1388 C420AC34 */  lwc1       $fv0, %lo(D_8010AC34)($at)
    /* A138C 801A138C E6200018 */  swc1       $fv0, 0x18($s1)
  .L801A1390:
    /* A1390 801A1390 A222002F */  sb         $v0, 0x2F($s1)
  .L801A1394:
    /* A1394 801A1394 9222002F */  lbu        $v0, 0x2F($s1)
    /* A1398 801A1398 44920000 */  mtc1       $s2, $fv0
    /* A139C 801A139C 46800020 */  cvt.s.w    $fv0, $fv0
    /* A13A0 801A13A0 44821000 */  mtc1       $v0, $fv1
    /* A13A4 801A13A4 468010A0 */  cvt.s.w    $fv1, $fv1
    /* A13A8 801A13A8 46001083 */  div.s      $fv1, $fv1, $fv0
    /* A13AC 801A13AC 3C018011 */  lui        $at, %hi(D_8010AC38)
    /* A13B0 801A13B0 C420AC38 */  lwc1       $fv0, %lo(D_8010AC38)($at)
    /* A13B4 801A13B4 4602003E */  c.le.s     $fv0, $fv1
    /* A13B8 801A13B8 AE200038 */  sw         $zero, 0x38($s1)
    /* A13BC 801A13BC 45010005 */  bc1t       .L801A13D4
    /* A13C0 801A13C0 A2200030 */   sb        $zero, 0x30($s1)
    /* A13C4 801A13C4 4600100D */  trunc.w.s  $fv0, $fv1
    /* A13C8 801A13C8 44030000 */  mfc1       $v1, $fv0
    /* A13CC 801A13CC 080680FB */  j          .L801A03EC
    /* A13D0 801A13D0 A223008A */   sb        $v1, 0x8A($s1)
  .L801A13D4:
    /* A13D4 801A13D4 46001001 */  sub.s      $fv0, $fv1, $fv0
    /* A13D8 801A13D8 4600008D */  trunc.w.s  $fv1, $fv0
    /* A13DC 801A13DC 44031000 */  mfc1       $v1, $fv1
    ...
    /* A1414 801A1414 E4960034 */   swc1      $fs1, 0x34($a0)
  .L801A1418:
    ...
    /* A1428 801A1428 C7B70038 */  lwc1       $fs1f, 0x38($sp)
    /* A142C 801A142C C7B6003C */  lwc1       $fs1, 0x3C($sp)
    /* A1430 801A1430 C7B50030 */  lwc1       $fs0f, 0x30($sp)
    /* A1434 801A1434 C7B40034 */  lwc1       $fs0, 0x34($sp)
    ...
    /* A1470 801A1470 E7B70050 */  swc1       $fs1f, 0x50($sp)
    /* A1474 801A1474 E7B60054 */  swc1       $fs1, 0x54($sp)
    /* A1478 801A1478 E7B50048 */  swc1       $fs0f, 0x48($sp)
    /* A147C 801A147C E7B4004C */  swc1       $fs0, 0x4C($sp)
  ...
  .L801A1490:
    ...
    /* A14CC 801A14CC C440000C */  lwc1       $fv0, 0xC($v0)
    /* A14D0 801A14D0 3C018011 */  lui        $at, %hi(D_8010AC3C)
    /* A14D4 801A14D4 C422AC3C */  lwc1       $fv1, %lo(D_8010AC3C)($at)
    /* A14D8 801A14D8 46020000 */  add.s      $fv0, $fv0, $fv1
    /* A14DC 801A14DC C60200B8 */  lwc1       $fv1, 0xB8($s0)
    /* A14E0 801A14E0 4600103C */  c.lt.s     $fv1, $fv0
  ...
  .L801A14F0:
    ...
    /* A1504 801A1504 C66200B4 */  lwc1       $fv1, 0xB4($s3)
    /* A1508 801A1508 C6800000 */  lwc1       $fv0, 0x0($s4)
    /* A150C 801A150C 46001081 */  sub.s      $fv1, $fv1, $fv0
    /* A1510 801A1510 3C01802A */  lui        $at, %hi(D_8029F9B0)
    /* A1514 801A1514 C424F9B0 */  lwc1       $ft0, %lo(D_8029F9B0)($at)
    /* A1518 801A1518 E7A20018 */  swc1       $fv1, 0x18($sp)
    /* A151C 801A151C C66000B8 */  lwc1       $fv0, 0xB8($s3)
  .L801A1520:
    /* A1520 801A1520 46021082 */  mul.s      $fv1, $fv1, $fv1
    /* A1524 801A1524 46040001 */  sub.s      $fv0, $fv0, $ft0
    /* A1528 801A1528 3C01802A */  lui        $at, %hi(D_8029F9B4)
    /* A152C 801A152C C426F9B4 */  lwc1       $ft1, %lo(D_8029F9B4)($at)
    /* A1530 801A1530 E7A0001C */  swc1       $fv0, 0x1C($sp)
    /* A1534 801A1534 C66400BC */  lwc1       $ft0, 0xBC($s3)
    /* A1538 801A1538 46000002 */  mul.s      $fv0, $fv0, $fv0
    /* A153C 801A153C 46062101 */  sub.s      $ft0, $ft0, $ft1
    /* A1540 801A1540 46042182 */  mul.s      $ft1, $ft0, $ft0
    /* A1544 801A1544 46001080 */  add.s      $fv1, $fv1, $fv0
    /* A1548 801A1548 46061300 */  add.s      $fa0, $fv1, $ft1
    /* A154C 801A154C 46006584 */  sqrt.s     $fs1, $fa0
    /* A1550 801A1550 4616B032 */  c.eq.s     $fs1, $fs1
