...
glabel func_801B1580
    ...
    /* B1588 801B1588 C424F544 */  lwc1       $f4, %lo(D_8029F544)($at)
    /* B158C 801B158C 3C018011 */  lui        $at, %hi(D_8010B7D8)
    /* B1590 801B1590 C427B7D8 */  lwc1       $f7, %lo(D_8010B7D8)($at)
    /* B1594 801B1594 C426B7DC */  lwc1       $f6, %lo(D_8010B7D8 + 0x4)($at)
    /* B1598 801B1598 3C01802A */  lui        $at, %hi(D_8029F548)
    /* B159C 801B159C C422F548 */  lwc1       $f2, %lo(D_8029F548)($at)
    /* B15A0 801B15A0 46002121 */  cvt.d.s    $f4, $f4
    /* B15A4 801B15A4 46262101 */  sub.d      $f4, $f4, $f6
    /* B15A8 801B15A8 3C01802A */  lui        $at, %hi(D_8029F54C)
    /* B15AC 801B15AC C420F54C */  lwc1       $f0, %lo(D_8029F54C)($at)
    /* B15B0 801B15B0 460010A1 */  cvt.d.s    $f2, $f2
    /* B15B4 801B15B4 46261081 */  sub.d      $f2, $f2, $f6
    /* B15B8 801B15B8 46000021 */  cvt.d.s    $f0, $f0
    /* B15BC 801B15BC 46260001 */  sub.d      $f0, $f0, $f6
    /* B15C0 801B15C0 46202120 */  cvt.s.d    $f4, $f4
    /* B15C4 801B15C4 462010A0 */  cvt.s.d    $f2, $f2
    /* B15C8 801B15C8 46200020 */  cvt.s.d    $f0, $f0
    /* B15CC 801B15CC 3C01802A */  lui        $at, %hi(D_8029F544)
    /* B15D0 801B15D0 E424F544 */  swc1       $f4, %lo(D_8029F544)($at)
    /* B15D4 801B15D4 3C01802A */  lui        $at, %hi(D_8029F548)
    /* B15D8 801B15D8 E422F548 */  swc1       $f2, %lo(D_8029F548)($at)
    /* B15DC 801B15DC 3C01802A */  lui        $at, %hi(D_8029F54C)
    /* B15E0 801B15E0 E420F54C */  swc1       $f0, %lo(D_8029F54C)($at)
  .L801B15E4:
    ...
    /* B1610 801B1610 C422B7E0 */  lwc1       $f2, %lo(D_8010B7E0)($at)
    /* B1614 801B1614 27A60018 */  addiu      $a2, $sp, 0x18
    /* B1618 801B1618 44800000 */  mtc1       $zero, $f0
    /* B161C 801B161C 24E7FC18 */  addiu      $a3, $a3, -0x3E8
    /* B1620 801B1620 E7A00020 */  swc1       $f0, 0x20($sp)
    /* B1624 801B1624 E7A00018 */  swc1       $f0, 0x18($sp)
    /* B1628 801B1628 0C06B8BA */  jal        func_801AE2E8
    /* B162C 801B162C E7A2001C */   swc1      $f2, 0x1C($sp)
  .L801B1630:
    ...
    /* B1674 801B1674 C4800070 */  lwc1       $f0, 0x70($a0)
    /* B1678 801B1678 3C01801F */  lui        $at, %hi(D_801EFDE8)
    /* B167C 801B167C 00220821 */  addu       $at, $at, $v0
    /* B1680 801B1680 C422FDE8 */  lwc1       $f2, %lo(D_801EFDE8)($at)
    /* B1684 801B1684 46020002 */  mul.s      $f0, $f0, $f2
    ...
    /* B169C 801B169C C422D938 */  lwc1       $f2, %lo(D_801ED938)($at)
    /* B16A0 801B16A0 46020003 */  div.s      $f0, $f0, $f2
    ...
    /* B16B0 801B16B0 E420FA3C */  swc1       $f0, %lo(D_8029FA3C)($at)
    /* B16B4 801B16B4 3C01802A */  lui        $at, %hi(D_8029FA38)
    /* B16B8 801B16B8 E420FA38 */  swc1       $f0, %lo(D_8029FA38)($at)
    /* B16BC 801B16BC 3C01802A */  lui        $at, %hi(D_8029FA34)
    /* B16C0 801B16C0 E420FA34 */  swc1       $f0, %lo(D_8029FA34)($at)
    ...
    /* B16DC 801B16DC C420D938 */  lwc1       $f0, %lo(D_801ED938)($at)
    /* B16E0 801B16E0 0806C1DE */  j          .L801B0778
    /* B16E4 801B16E4 E4800074 */   swc1      $f0, 0x74($a0)
  .L801B16E8:
    ...
    /* B1724 801B1724 C420B7E4 */  lwc1       $f0, %lo(D_8010B7E4)($at)
    /* B1728 801B1728 E4400074 */  swc1       $f0, 0x74($v0)
  .L801B172C:
    /* B172C 801B172C 3C02802A */  lui        $v0, %hi(D_8029FA50)
    /* B1730 801B1730 8C42FA50 */  lw         $v0, %lo(D_8029FA50)($v0)
    /* B1734 801B1734 C4400070 */  lwc1       $f0, 0x70($v0)
    /* B1738 801B1738 3C018011 */  lui        $at, %hi(D_8010B7E8)
    /* B173C 801B173C C423B7E8 */  lwc1       $f3, %lo(D_8010B7E8)($at)
    /* B1740 801B1740 C422B7EC */  lwc1       $f2, %lo(D_8010B7E8 + 0x4)($at)
    /* B1744 801B1744 46000021 */  cvt.d.s    $f0, $f0
    /* B1748 801B1748 46220002 */  mul.d      $f0, $f0, $f2
    /* B174C 801B174C 3C018011 */  lui        $at, %hi(D_8010B7F0)
    /* B1750 801B1750 C423B7F0 */  lwc1       $f3, %lo(D_8010B7F0)($at)
    /* B1754 801B1754 C422B7F4 */  lwc1       $f2, %lo(D_8010B7F0 + 0x4)($at)
    /* B1758 801B1758 46220003 */  div.d      $f0, $f0, $f2
    /* B175C 801B175C 46200020 */  cvt.s.d    $f0, $f0
    /* B1760 801B1760 3C01802A */  lui        $at, %hi(D_8029FA3C)
    /* B1764 801B1764 E420FA3C */  swc1       $f0, %lo(D_8029FA3C)($at)
    /* B1768 801B1768 3C01802A */  lui        $at, %hi(D_8029FA38)
    /* B176C 801B176C E420FA38 */  swc1       $f0, %lo(D_8029FA38)($at)
    /* B1770 801B1770 3C01802A */  lui        $at, %hi(D_8029FA34)
    /* B1774 801B1774 E420FA34 */  swc1       $f0, %lo(D_8029FA34)($at)
  .L801B1778:
    /* B1778 801B1778 3C02802A */  lui        $v0, %hi(D_8029FA50)
    /* B177C 801B177C 8C42FA50 */  lw         $v0, %lo(D_8029FA50)($v0)
    /* B1780 801B1780 C4400070 */  lwc1       $f0, 0x70($v0)
    /* B1784 801B1784 3C018011 */  lui        $at, %hi(D_8010B7F8)
    /* B1788 801B1788 C423B7F8 */  lwc1       $f3, %lo(D_8010B7F8)($at)
    /* B178C 801B178C C422B7FC */  lwc1       $f2, %lo(D_8010B7F8 + 0x4)($at)
    /* B1790 801B1790 46000021 */  cvt.d.s    $f0, $f0
    /* B1794 801B1794 46220002 */  mul.d      $f0, $f0, $f2
    ...
    /* B17A8 801B17A8 46200020 */  cvt.s.d    $f0, $f0
    /* B17AC 801B17AC E4400008 */  swc1       $f0, 0x8($v0)
    ...
    /* B17D8 801B17D8 C426030C */  lwc1       $f6, %lo(D_8029030C)($at)
    /* B17DC 801B17DC 3C01802A */  lui        $at, %hi(D_8029F9AC)
    /* B17E0 801B17E0 C420F9AC */  lwc1       $f0, %lo(D_8029F9AC)($at)
    ...
    /* B17F0 801B17F0 C4220310 */  lwc1       $f2, %lo(D_80290310)($at)
    /* B17F4 801B17F4 46003181 */  sub.s      $f6, $f6, $f0
    /* B17F8 801B17F8 3C01802A */  lui        $at, %hi(D_8029F9B0)
    /* B17FC 801B17FC C424F9B0 */  lwc1       $f4, %lo(D_8029F9B0)($at)
    /* B1800 801B1800 8E030000 */  lw         $v1, 0x0($s0)
    /* B1804 801B1804 3C018029 */  lui        $at, %hi(D_80290314)
    /* B1808 801B1808 C4200314 */  lwc1       $f0, %lo(D_80290314)($at)
    /* B180C 801B180C 46041081 */  sub.s      $f2, $f2, $f4
    /* B1810 801B1810 3C01802A */  lui        $at, %hi(D_8029F9B4)
    /* B1814 801B1814 C424F9B4 */  lwc1       $f4, %lo(D_8029F9B4)($at)
    /* B1818 801B1818 2402FFFE */  addiu      $v0, $zero, -0x2
  .L801B181C:
    /* B181C 801B181C 00621824 */  and        $v1, $v1, $v0
    /* B1820 801B1820 46040001 */  sub.s      $f0, $f0, $f4
    /* B1824 801B1824 AE030000 */  sw         $v1, 0x0($s0)
    /* B1828 801B1828 E7A60018 */  swc1       $f6, 0x18($sp)
