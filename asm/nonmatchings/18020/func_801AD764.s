...
glabel func_801AD764
    ...
    /* AD78C 801AD78C C6480000 */  lwc1       $f8, 0x0($s2)
    /* AD790 801AD790 3C018011 */  lui        $at, %hi(D_8010B4A8)
    /* AD794 801AD794 C422B4A8 */  lwc1       $f2, %lo(D_8010B4A8)($at)
    /* AD798 801AD798 46024083 */  div.s      $f2, $f8, $f2
    /* AD79C 801AD79C C6060038 */  lwc1       $f6, 0x38($s0)
    /* AD7A0 801AD7A0 46023081 */  sub.s      $f2, $f6, $f2
    /* AD7A4 801AD7A4 46000106 */  mov.s      $f4, $f0
    /* AD7A8 801AD7A8 4602203C */  c.lt.s     $f4, $f2
    /* AD7AC 801AD7AC 00000000 */  nop
    /* AD7B0 801AD7B0 4502009C */  bc1fl      .L801ADA24
    /* AD7B4 801AD7B4 46083000 */   add.s     $f0, $f6, $f8
    ...
    /* AD7CC 801AD7CC C6000040 */  lwc1       $f0, 0x40($s0)
    /* AD7D0 801AD7D0 C602004C */  lwc1       $f2, 0x4C($s0)
    /* AD7D4 801AD7D4 46020001 */  sub.s      $f0, $f0, $f2
    /* AD7D8 801AD7D8 E6000064 */  swc1       $f0, 0x64($s0)
  .L801AD7DC:
  ...
  .L801AD80C:
    ...
    /* AD864 801AD864 C6420028 */  lwc1       $f2, 0x28($s2)
    /* AD868 801AD868 3C018011 */  lui        $at, %hi(D_8010B4B0)
    /* AD86C 801AD86C C425B4B0 */  lwc1       $f5, %lo(D_8010B4B0)($at)
    /* AD870 801AD870 C424B4B4 */  lwc1       $f4, %lo(D_8010B4B0 + 0x4)($at)
    /* AD874 801AD874 460010A1 */  cvt.d.s    $f2, $f2
    /* AD878 801AD878 46241082 */  mul.d      $f2, $f2, $f4
    /* AD87C 801AD87C 3C018029 */  lui        $at, %hi(D_80290338)
    /* AD880 801AD880 C4200338 */  lwc1       $f0, %lo(D_80290338)($at)
    /* AD884 801AD884 46000021 */  cvt.d.s    $f0, $f0
    /* AD888 801AD888 46240002 */  mul.d      $f0, $f0, $f4
    /* AD88C 801AD88C 462010A0 */  cvt.s.d    $f2, $f2
    /* AD890 801AD890 46200020 */  cvt.s.d    $f0, $f0
    /* AD894 801AD894 E6420028 */  swc1       $f2, 0x28($s2)
    /* AD898 801AD898 3C018029 */  lui        $at, %hi(D_80290338)
    /* AD89C 801AD89C E4200338 */  swc1       $f0, %lo(D_80290338)($at)
    /* AD8A0 801AD8A0 C6000064 */  lwc1       $f0, 0x64($s0)
    /* AD8A4 801AD8A4 3C018029 */  lui        $at, %hi(D_80290334)
    /* AD8A8 801AD8A8 E4200334 */  swc1       $f0, %lo(D_80290334)($at)
  .L801AD8AC:
  ...
  .L801AD8C4:
    ...
    /* AD8F4 801AD8F4 C440003C */  lwc1       $f0, 0x3C($v0)
    /* AD8F8 801AD8F8 3C018011 */  lui        $at, %hi(D_8010B4B8)
    /* AD8FC 801AD8FC C423B4B8 */  lwc1       $f3, %lo(D_8010B4B8)($at)
    /* AD900 801AD900 C422B4BC */  lwc1       $f2, %lo(D_8010B4B8 + 0x4)($at)
    /* AD904 801AD904 46000021 */  cvt.d.s    $f0, $f0
    /* AD908 801AD908 46220002 */  mul.d      $f0, $f0, $f2
    /* AD90C 801AD90C 3C018011 */  lui        $at, %hi(D_8010B4C0)
    /* AD910 801AD910 C423B4C0 */  lwc1       $f3, %lo(D_8010B4C0)($at)
    /* AD914 801AD914 C422B4C4 */  lwc1       $f2, %lo(D_8010B4C0 + 0x4)($at)
    /* AD918 801AD918 46220003 */  div.d      $f0, $f0, $f2
    /* AD91C 801AD91C 8E0300DC */  lw         $v1, 0xDC($s0)
    /* AD920 801AD920 4620008D */  trunc.w.d  $f2, $f0
    /* AD924 801AD924 44021000 */  mfc1       $v0, $f2
    /* AD928 801AD928 A462001C */  sh         $v0, 0x1C($v1)
    /* AD92C 801AD92C C6000064 */  lwc1       $f0, 0x64($s0)
    /* AD930 801AD930 3C018011 */  lui        $at, %hi(D_8010B4C8)
    /* AD934 801AD934 C422B4C8 */  lwc1       $f2, %lo(D_8010B4C8)($at)
  ...
  .L801AD980:
    ...
    /* AD994 801AD994 C6000064 */  lwc1       $f0, 0x64($s0)
    /* AD998 801AD998 3C018011 */  lui        $at, %hi(D_8010B4C8 + 0x4)
    /* AD99C 801AD99C C423B4CC */  lwc1       $f3, %lo(D_8010B4C8 + 0x4)($at)
  .L801AD9A0:
    /* AD9A0 801AD9A0 C422B4D0 */  lwc1       $f2, %lo(D_8010B4D0)($at)
    /* AD9A4 801AD9A4 46000021 */  cvt.d.s    $f0, $f0
    /* AD9A8 801AD9A8 4620103E */  c.le.d     $f2, $f0
  ...
  .L801AD9B8:
    ...
    /* AD9BC 801AD9BC C42CB4D4 */  lwc1       $f12, %lo(D_8010B4D4)($at)
    ...
    /* AD9CC 801AD9CC 4480A000 */  mtc1       $zero, $f20
    /* AD9D0 801AD9D0 00621024 */  and        $v0, $v1, $v0
    /* AD9D4 801AD9D4 AE020030 */  sw         $v0, 0x30($s0)
    /* AD9D8 801AD9D8 0C0525C9 */  jal        func_80149724
    /* AD9DC 801AD9DC 4600A386 */   mov.s     $f14, $f20
    /* AD9E0 801AD9E0 3C018011 */  lui        $at, %hi(D_8010B4D8)
    /* AD9E4 801AD9E4 C422B4D8 */  lwc1       $f2, %lo(D_8010B4D8)($at)
    /* AD9E8 801AD9E8 46020103 */  div.s      $f4, $f0, $f2
    /* AD9EC 801AD9EC 4604A03C */  c.lt.s     $f20, $f4
    ...
    /* ADA00 801ADA00 C423B4DC */  lwc1       $f3, %lo(D_8010B4D8 + 0x4)($at)
    /* ADA04 801ADA04 C422B4E0 */  lwc1       $f2, %lo(D_8010B4E0)($at)
    /* ADA08 801ADA08 46002021 */  cvt.d.s    $f0, $f4
    /* ADA0C 801ADA0C 46220002 */  mul.d      $f0, $f0, $f2
    /* ADA10 801ADA10 46200120 */  cvt.s.d    $f4, $f0
  .L801ADA14:
    /* ADA14 801ADA14 C6000064 */  lwc1       $f0, 0x64($s0)
    /* ADA18 801ADA18 46040000 */  add.s      $f0, $f0, $f4
    /* ADA1C 801ADA1C 0806B2E8 */  j          .L801ACBA0
    /* ADA20 801ADA20 E6000064 */   swc1      $f0, 0x64($s0)
  .L801ADA24:
    /* ADA24 801ADA24 4600203C */  c.lt.s     $f4, $f0
  ...
  .L801ADA88:
    ...
    /* ADA90 801ADA90 C6200000 */  lwc1       $f0, 0x0($s1)
    /* ADA94 801ADA94 C602003C */  lwc1       $f2, 0x3C($s0)
  .L801ADA98:
    /* ADA98 801ADA98 46020001 */  sub.s      $f0, $f0, $f2
    /* ADA9C 801ADA9C E7A00018 */  swc1       $f0, 0x18($sp)
    /* ADAA0 801ADAA0 3C018029 */  lui        $at, %hi(D_80290310)
    /* ADAA4 801ADAA4 C4200310 */  lwc1       $f0, %lo(D_80290310)($at)
    /* ADAA8 801ADAA8 C6020040 */  lwc1       $f2, 0x40($s0)
    /* ADAAC 801ADAAC 46020001 */  sub.s      $f0, $f0, $f2
    /* ADAB0 801ADAB0 E7A0001C */  swc1       $f0, 0x1C($sp)
    /* ADAB4 801ADAB4 3C018029 */  lui        $at, %hi(D_80290314)
    /* ADAB8 801ADAB8 C4200314 */  lwc1       $f0, %lo(D_80290314)($at)
    /* ADABC 801ADABC C6020044 */  lwc1       $f2, 0x44($s0)
    /* ADAC0 801ADAC0 46020001 */  sub.s      $f0, $f0, $f2
    /* ADAC4 801ADAC4 27A40018 */  addiu      $a0, $sp, 0x18
  .L801ADAC8:
    /* ADAC8 801ADAC8 0C05255A */  jal        func_80149568
    /* ADACC 801ADACC E7A00020 */   swc1      $f0, 0x20($sp)
    /* ADAD0 801ADAD0 C7A40018 */  lwc1       $f4, 0x18($sp)
    /* ADAD4 801ADAD4 3C018011 */  lui        $at, %hi(D_8010B4E0 + 0x4)
    /* ADAD8 801ADAD8 C427B4E4 */  lwc1       $f7, %lo(D_8010B4E0 + 0x4)($at)
    /* ADADC 801ADADC C426B4E8 */  lwc1       $f6, %lo(D_8010B4E8)($at)
  .L801ADAE0:
    /* ADAE0 801ADAE0 46002121 */  cvt.d.s    $f4, $f4
    /* ADAE4 801ADAE4 46262102 */  mul.d      $f4, $f4, $f6
    /* ADAE8 801ADAE8 C7A2001C */  lwc1       $f2, 0x1C($sp)
    /* ADAEC 801ADAEC 460010A1 */  cvt.d.s    $f2, $f2
    /* ADAF0 801ADAF0 46261082 */  mul.d      $f2, $f2, $f6
    /* ADAF4 801ADAF4 C7A00020 */  lwc1       $f0, 0x20($sp)
