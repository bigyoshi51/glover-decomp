...
glabel func_801A0064
  ...
  .L801A007C:
    ...
    /* A0094 801A0094 C7B90068 */  lwc1       $fs2f, 0x68($sp)
    /* A0098 801A0098 C7B8006C */  lwc1       $fs2, 0x6C($sp)
    /* A009C 801A009C C7B70060 */  lwc1       $fs1f, 0x60($sp)
    /* A00A0 801A00A0 C7B60064 */  lwc1       $fs1, 0x64($sp)
    /* A00A4 801A00A4 C7B50058 */  lwc1       $fs0f, 0x58($sp)
    /* A00A8 801A00A8 C7B4005C */  lwc1       $fs0, 0x5C($sp)
    ...
    /* A00D0 801A00D0 E7B50040 */  swc1       $fs0f, 0x40($sp)
    /* A00D4 801A00D4 E7B40044 */  swc1       $fs0, 0x44($sp)
    /* A00D8 801A00D8 C6400034 */  lwc1       $fv0, 0x34($s2)
    /* A00DC 801A00DC 3C108029 */  lui        $s0, %hi(D_80290310)
    /* A00E0 801A00E0 26100310 */  addiu      $s0, $s0, %lo(D_80290310)
    /* A00E4 801A00E4 C604FFFC */  lwc1       $ft0, -0x4($s0)
    /* A00E8 801A00E8 46002101 */  sub.s      $ft0, $ft0, $fv0
    /* A00EC 801A00EC E7A00010 */  swc1       $fv0, 0x10($sp)
    /* A00F0 801A00F0 C6000000 */  lwc1       $fv0, 0x0($s0)
    /* A00F4 801A00F4 3C018029 */  lui        $at, %hi(D_80290314)
    /* A00F8 801A00F8 C4220314 */  lwc1       $fv1, %lo(D_80290314)($at)
    /* A00FC 801A00FC 27B10020 */  addiu      $s1, $sp, 0x20
    /* A0100 801A0100 46000201 */  sub.s      $ft2, $fv0, $fv0
    /* A0104 801A0104 C646003C */  lwc1       $ft1, 0x3C($s2)
    /* A0108 801A0108 02202021 */  addu       $a0, $s1, $zero
    /* A010C 801A010C 2610FFFC */  addiu      $s0, $s0, -0x4
    /* A0110 801A0110 46061081 */  sub.s      $fv1, $fv1, $ft1
    /* A0114 801A0114 E7A00014 */  swc1       $fv0, 0x14($sp)
    /* A0118 801A0118 E7A60018 */  swc1       $ft1, 0x18($sp)
    /* A011C 801A011C E7A40020 */  swc1       $ft0, 0x20($sp)
    /* A0120 801A0120 E7A80024 */  swc1       $ft2, 0x24($sp)
    /* A0124 801A0124 0C05255A */  jal        func_80149568
    /* A0128 801A0128 E7A20028 */   swc1      $fv1, 0x28($sp)
    /* A012C 801A012C C7A20020 */  lwc1       $fv1, 0x20($sp)
    /* A0130 801A0130 3C018029 */  lui        $at, %hi(D_8028FB24)
    /* A0134 801A0134 C424FB24 */  lwc1       $ft0, %lo(D_8028FB24)($at)
    /* A0138 801A0138 46041082 */  mul.s      $fv1, $fv1, $ft0
    /* A013C 801A013C C7A00028 */  lwc1       $fv0, 0x28($sp)
    /* A0140 801A0140 46040002 */  mul.s      $fv0, $fv0, $ft0
    /* A0144 801A0144 27A40010 */  addiu      $a0, $sp, 0x10
    /* A0148 801A0148 02002821 */  addu       $a1, $s0, $zero
    /* A014C 801A014C 02203021 */  addu       $a2, $s1, $zero
    /* A0150 801A0150 E7A20020 */  swc1       $fv1, 0x20($sp)
    /* A0154 801A0154 0C0524DD */  jal        func_80149374
    /* A0158 801A0158 E7A00028 */   swc1      $fv0, 0x28($sp)
    /* A015C 801A015C C7A20010 */  lwc1       $fv1, 0x10($sp)
    /* A0160 801A0160 46021082 */  mul.s      $fv1, $fv1, $fv1
    /* A0164 801A0164 C7A00018 */  lwc1       $fv0, 0x18($sp)
    /* A0168 801A0168 46000002 */  mul.s      $fv0, $fv0, $fv0
    /* A016C 801A016C 46001300 */  add.s      $fa0, $fv1, $fv0
    /* A0170 801A0170 46006104 */  sqrt.s     $ft0, $fa0
    /* A0174 801A0174 C7A00014 */  lwc1       $fv0, 0x14($sp)
    /* A0178 801A0178 3C018011 */  lui        $at, %hi(D_8010AB00)
    /* A017C 801A017C C422AB00 */  lwc1       $fv1, %lo(D_8010AB00)($at)
    /* A0180 801A0180 46020000 */  add.s      $fv0, $fv0, $fv1
    /* A0184 801A0184 46042032 */  c.eq.s     $ft0, $ft0
    /* A0188 801A0188 00000000 */  nop
    /* A018C 801A018C 45010004 */  bc1t       .L801A01A0
    /* A0190 801A0190 E7A00014 */   swc1      $fv0, 0x14($sp)
    /* A0194 801A0194 0C07100C */  jal        func_801C4030
    /* A0198 801A0198 00000000 */   nop
    /* A019C 801A019C 46000106 */  mov.s      $ft0, $fv0
  .L801A01A0:
    /* A01A0 801A01A0 3C018011 */  lui        $at, %hi(D_8010AB04)
    /* A01A4 801A01A4 C420AB04 */  lwc1       $fv0, %lo(D_8010AB04)($at)
    /* A01A8 801A01A8 4600203C */  c.lt.s     $ft0, $fv0
  ...
  .L801A01E0:
    ...
    /* A01F8 801A01F8 C42CAB08 */  lwc1       $fa0, %lo(D_8010AB08)($at)
    /* A01FC 801A01FC 8E4300DC */  lw         $v1, 0xDC($s2)
    /* A0200 801A0200 C440000C */  lwc1       $fv0, 0xC($v0)
    /* A0204 801A0204 0C068A51 */  jal        func_801A2944
    /* A0208 801A0208 E460000C */   swc1      $fv0, 0xC($v1)
    ...
    /* A0218 801A0218 C42CAB0C */  lwc1       $fa0, %lo(D_8010AB0C)($at)
    ...
    /* A0230 801A0230 C42CAB10 */  lwc1       $fa0, %lo(D_8010AB10)($at)
    ...
    /* A0248 801A0248 C42CAB14 */  lwc1       $fa0, %lo(D_8010AB14)($at)
    ...
    /* A0260 801A0260 C42CAB18 */  lwc1       $fa0, %lo(D_8010AB18)($at)
    ...
    /* A0278 801A0278 C42CAB1C */  lwc1       $fa0, %lo(D_8010AB1C)($at)
    ...
    /* A0290 801A0290 C42CAB20 */  lwc1       $fa0, %lo(D_8010AB20)($at)
