...
glabel func_801BA644
    ...
    /* BA684 801BA684 C436BE88 */  lwc1       $f22, %lo(D_8010BE88)($at)
    /* BA688 801BA688 3C018011 */  lui        $at, %hi(D_8010BE8C)
    /* BA68C 801BA68C C434BE8C */  lwc1       $f20, %lo(D_8010BE8C)($at)
    /* BA690 801BA690 24130005 */  addiu      $s3, $zero, 0x5
    /* BA694 801BA694 3C018011 */  lui        $at, %hi(D_8010BE90)
    /* BA698 801BA698 C438BE90 */  lwc1       $f24, %lo(D_8010BE90)($at)
  .L801BA69C:
    /* BA69C 801BA69C 0C051C00 */  jal        func_80147000
    /* BA6A0 801BA6A0 24040007 */   addiu     $a0, $zero, 0x7
    /* BA6A4 801BA6A4 C6200060 */  lwc1       $f0, 0x60($s1)
    /* BA6A8 801BA6A8 46160003 */  div.s      $f0, $f0, $f22
    /* BA6AC 801BA6AC 44821000 */  mtc1       $v0, $f2
    /* BA6B0 801BA6B0 468010A0 */  cvt.s.w    $f2, $f2
    /* BA6B4 801BA6B4 46020000 */  add.s      $f0, $f0, $f2
    /* BA6B8 801BA6B8 46140001 */  sub.s      $f0, $f0, $f20
    /* BA6BC 801BA6BC 24040007 */  addiu      $a0, $zero, 0x7
    /* BA6C0 801BA6C0 0C051C00 */  jal        func_80147000
    /* BA6C4 801BA6C4 E7A00018 */   swc1      $f0, 0x18($sp)
    /* BA6C8 801BA6C8 C6200064 */  lwc1       $f0, 0x64($s1)
    /* BA6CC 801BA6CC 46160003 */  div.s      $f0, $f0, $f22
    /* BA6D0 801BA6D0 44821000 */  mtc1       $v0, $f2
    /* BA6D4 801BA6D4 468010A0 */  cvt.s.w    $f2, $f2
    /* BA6D8 801BA6D8 46020000 */  add.s      $f0, $f0, $f2
    /* BA6DC 801BA6DC 46140001 */  sub.s      $f0, $f0, $f20
    /* BA6E0 801BA6E0 24040007 */  addiu      $a0, $zero, 0x7
    /* BA6E4 801BA6E4 0C051C00 */  jal        func_80147000
    /* BA6E8 801BA6E8 E7A0001C */   swc1      $f0, 0x1C($sp)
    /* BA6EC 801BA6EC C6220068 */  lwc1       $f2, 0x68($s1)
    /* BA6F0 801BA6F0 46161083 */  div.s      $f2, $f2, $f22
    /* BA6F4 801BA6F4 44820000 */  mtc1       $v0, $f0
    /* BA6F8 801BA6F8 46800020 */  cvt.s.w    $f0, $f0
    /* BA6FC 801BA6FC 46001080 */  add.s      $f2, $f2, $f0
