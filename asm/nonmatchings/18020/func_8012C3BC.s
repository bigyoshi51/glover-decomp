...
glabel func_8012C3BC
    ...
    /* 2C468 8012C468 C4341900 */  lwc1       $f20, %lo(D_80101900)($at)
    ...
    /* 2C47C 8012C47C 44820000 */  mtc1       $v0, $f0
    /* 2C480 8012C480 46800020 */  cvt.s.w    $f0, $f0
    /* 2C484 8012C484 0C051C00 */  jal        func_80147000
    /* 2C488 8012C488 E7A00018 */   swc1      $f0, 0x18($sp)
    /* 2C48C 8012C48C 24040006 */  addiu      $a0, $zero, 0x6
    /* 2C490 8012C490 2442FFFB */  addiu      $v0, $v0, -0x5
    /* 2C494 8012C494 44820000 */  mtc1       $v0, $f0
    /* 2C498 8012C498 46800020 */  cvt.s.w    $f0, $f0
    /* 2C49C 8012C49C 0C051C00 */  jal        func_80147000
    /* 2C4A0 8012C4A0 E7A00020 */   swc1      $f0, 0x20($sp)
    ...
    /* 2C4B8 8012C4B8 44820000 */  mtc1       $v0, $f0
    /* 2C4BC 8012C4BC 46800020 */  cvt.s.w    $f0, $f0
    /* 2C4C0 8012C4C0 E7A0001C */  swc1       $f0, 0x1C($sp)
    ...
    /* 2C4E0 8012C4E0 E4540018 */  swc1       $f20, 0x18($v0)
    /* 2C4E4 8012C4E4 E4740070 */  swc1       $f20, 0x70($v1)
  .L8012C4E8:
    ...
    /* 2C518 8012C518 C620000C */  lwc1       $f0, 0xC($s1)
    /* 2C51C 8012C51C 4600008D */  trunc.w.s  $f2, $f0
    /* 2C520 8012C520 44021000 */  mfc1       $v0, $f2
    ...
    /* 2C554 8012C554 C620000C */  lwc1       $f0, 0xC($s1)
    /* 2C558 8012C558 3C048029 */  lui        $a0, %hi(D_8028FFC4)
    /* 2C55C 8012C55C 2484FFC4 */  addiu      $a0, $a0, %lo(D_8028FFC4)
    /* 2C560 8012C560 4600008D */  trunc.w.s  $f2, $f0
    /* 2C564 8012C564 44031000 */  mfc1       $v1, $f2
    ...
    /* 2C584 8012C584 C620000C */  lwc1       $f0, 0xC($s1)
    /* 2C588 8012C588 4600008D */  trunc.w.s  $f2, $f0
    /* 2C58C 8012C58C 44031000 */  mfc1       $v1, $f2
    ...
    /* 2C5B0 8012C5B0 C4201904 */  lwc1       $f0, %lo(D_80101904)($at)
    /* 2C5B4 8012C5B4 E440004C */  swc1       $f0, 0x4C($v0)
    /* 2C5B8 8012C5B8 C620000C */  lwc1       $f0, 0xC($s1)
    /* 2C5BC 8012C5BC 4600008D */  trunc.w.s  $f2, $f0
    /* 2C5C0 8012C5C0 44031000 */  mfc1       $v1, $f2
