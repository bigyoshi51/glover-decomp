...
glabel func_8014AD0C
    /* 4AD0C 8014AD0C E6000000 */  swc1       $f0, 0x0($s0)
    /* 4AD10 8014AD10 C6380004 */  lwc1       $f24, 0x4($s1)
    /* 4AD14 8014AD14 3C018010 */  lui        $at, %hi(D_801063A0 + 0x4)
    /* 4AD18 8014AD18 C42163A4 */  lwc1       $f1, %lo(D_801063A0 + 0x4)($at)
    /* 4AD1C 8014AD1C C42063A8 */  lwc1       $f0, %lo(D_801063A8)($at)
    /* 4AD20 8014AD20 4600C521 */  cvt.d.s    $f20, $f24
    /* 4AD24 8014AD24 4634003C */  c.lt.d     $f0, $f20
    /* 4AD28 8014AD28 3C11801D */  lui        $s1, %hi(func_801D41A0 + 0x30)
    /* 4AD2C 8014AD2C 263141D0 */  addiu      $s1, $s1, %lo(func_801D41A0 + 0x30)
    ...
    /* 4AD40 8014AD40 4407A000 */  mfc1       $a3, $f20
    /* 4AD44 8014AD44 4406A800 */  mfc1       $a2, $f21
  ...
  .L8014AD70:
    ...
    /* 4AD74 8014AD74 C42163AC */  lwc1       $f1, %lo(D_801063A8 + 0x4)($at)
    /* 4AD78 8014AD78 C42063B0 */  lwc1       $f0, %lo(D_801063B0)($at)
    /* 4AD7C 8014AD7C 4620A03C */  c.lt.d     $f20, $f0
    ...
    /* 4AD94 8014AD94 4407A000 */  mfc1       $a3, $f20
    /* 4AD98 8014AD98 4406A800 */  mfc1       $a2, $f21
  ...
  .L8014ADC4:
    ...
    /* 4ADC8 8014ADC8 C42163B4 */  lwc1       $f1, %lo(D_801063B0 + 0x4)($at)
    /* 4ADCC 8014ADCC C42063B8 */  lwc1       $f0, %lo(D_801063B8)($at)
    /* 4ADD0 8014ADD0 4620A032 */  c.eq.d     $f20, $f0
    /* 4ADD4 8014ADD4 00000000 */  nop
    /* 4ADD8 8014ADD8 4501000F */  bc1t       .L8014AE18
    /* 4ADDC 8014ADDC 4600B006 */   mov.s     $f0, $f22
    /* 4ADE0 8014ADE0 3C018010 */  lui        $at, %hi(D_801063BC)
    /* 4ADE4 8014ADE4 C42063BC */  lwc1       $f0, %lo(D_801063BC)($at)
    /* 4ADE8 8014ADE8 4600C002 */  mul.s      $f0, $f24, $f0
    /* 4ADEC 8014ADEC 4600008D */  trunc.w.s  $f2, $f0
    /* 4ADF0 8014ADF0 44021000 */  mfc1       $v0, $f2
    ...
    /* 4AE08 8014AE08 C42263C0 */  lwc1       $f2, %lo(D_801063C0)($at)
    /* 4AE0C 8014AE0C 44820000 */  mtc1       $v0, $f0
    /* 4AE10 8014AE10 46800020 */  cvt.s.w    $f0, $f0
    /* 4AE14 8014AE14 46020003 */  div.s      $f0, $f0, $f2
  .L8014AE18:
    /* 4AE18 8014AE18 3C018010 */  lui        $at, %hi(D_801063C4)
    /* 4AE1C 8014AE1C C42C63C4 */  lwc1       $f12, %lo(D_801063C4)($at)
    /* 4AE20 8014AE20 460C0303 */  div.s      $f12, $f0, $f12
    /* 4AE24 8014AE24 0C071800 */  jal        func_801C6000
    /* 4AE28 8014AE28 E60C000C */   swc1      $f12, 0xC($s0)
    /* 4AE2C 8014AE2C C6020000 */  lwc1       $f2, 0x0($s0)
    /* 4AE30 8014AE30 46001082 */  mul.s      $f2, $f2, $f0
    /* 4AE34 8014AE34 C60C000C */  lwc1       $f12, 0xC($s0)
    /* 4AE38 8014AE38 0C071800 */  jal        func_801C6000
    /* 4AE3C 8014AE3C E6020000 */   swc1      $f2, 0x0($s0)
    /* 4AE40 8014AE40 C6020008 */  lwc1       $f2, 0x8($s0)
    /* 4AE44 8014AE44 46001082 */  mul.s      $f2, $f2, $f0
    /* 4AE48 8014AE48 C60C000C */  lwc1       $f12, 0xC($s0)
    /* 4AE4C 8014AE4C 080527F0 */  j          .L80149FC0
    /* 4AE50 8014AE50 E6020008 */   swc1      $f2, 0x8($s0)
  .L8014AE54:
    /* 4AE54 8014AE54 C6200008 */  lwc1       $f0, 0x8($s1)
    /* 4AE58 8014AE58 46160032 */  c.eq.s     $f0, $f22
    /* 4AE5C 8014AE5C 00000000 */  nop
    /* 4AE60 8014AE60 4501005B */  bc1t       .L8014AFD0
    /* 4AE64 8014AE64 00000000 */   nop
    /* 4AE68 8014AE68 E6160008 */  swc1       $f22, 0x8($s0)
    /* 4AE6C 8014AE6C C6380004 */  lwc1       $f24, 0x4($s1)
    /* 4AE70 8014AE70 3C018010 */  lui        $at, %hi(D_801063C8)
    /* 4AE74 8014AE74 C42163C8 */  lwc1       $f1, %lo(D_801063C8)($at)
    /* 4AE78 8014AE78 C42063CC */  lwc1       $f0, %lo(D_801063C8 + 0x4)($at)
    /* 4AE7C 8014AE7C 4600C521 */  cvt.d.s    $f20, $f24
    /* 4AE80 8014AE80 4634003C */  c.lt.d     $f0, $f20
    /* 4AE84 8014AE84 3C12801D */  lui        $s2, %hi(func_801D41A0 + 0x30)
    /* 4AE88 8014AE88 265241D0 */  addiu      $s2, $s2, %lo(func_801D41A0 + 0x30)
    ...
    /* 4AE9C 8014AE9C 4407A000 */  mfc1       $a3, $f20
    /* 4AEA0 8014AEA0 4406A800 */  mfc1       $a2, $f21
  ...
  .L8014AECC:
    ...
    /* 4AED0 8014AED0 C42163D0 */  lwc1       $f1, %lo(D_801063D0)($at)
    /* 4AED4 8014AED4 C42063D4 */  lwc1       $f0, %lo(D_801063D0 + 0x4)($at)
    /* 4AED8 8014AED8 4620A03C */  c.lt.d     $f20, $f0
  .L8014AEDC:
    ...
    /* 4AEF0 8014AEF0 4407A000 */  mfc1       $a3, $f20
    /* 4AEF4 8014AEF4 4406A800 */  mfc1       $a2, $f21
  ...
  .L8014AF20:
    ...
    /* 4AF24 8014AF24 C42163D8 */  lwc1       $f1, %lo(D_801063D8)($at)
    /* 4AF28 8014AF28 C42063DC */  lwc1       $f0, %lo(D_801063D8 + 0x4)($at)
    /* 4AF2C 8014AF2C 4620A032 */  c.eq.d     $f20, $f0
    /* 4AF30 8014AF30 00000000 */  nop
    /* 4AF34 8014AF34 4501000F */  bc1t       .L8014AF74
    /* 4AF38 8014AF38 4600B306 */   mov.s     $f12, $f22
    /* 4AF3C 8014AF3C 3C018010 */  lui        $at, %hi(D_801063E0)
    /* 4AF40 8014AF40 C42063E0 */  lwc1       $f0, %lo(D_801063E0)($at)
    /* 4AF44 8014AF44 4600C002 */  mul.s      $f0, $f24, $f0
    /* 4AF48 8014AF48 4600008D */  trunc.w.s  $f2, $f0
    /* 4AF4C 8014AF4C 44021000 */  mfc1       $v0, $f2
    ...
    /* 4AF64 8014AF64 C42263E4 */  lwc1       $f2, %lo(D_801063E4)($at)
    /* 4AF68 8014AF68 44820000 */  mtc1       $v0, $f0
    /* 4AF6C 8014AF6C 46800020 */  cvt.s.w    $f0, $f0
    /* 4AF70 8014AF70 46020303 */  div.s      $f12, $f0, $f2
  .L8014AF74:
    /* 4AF74 8014AF74 3C018010 */  lui        $at, %hi(D_801063E8)
    /* 4AF78 8014AF78 C42063E8 */  lwc1       $f0, %lo(D_801063E8)($at)
    /* 4AF7C 8014AF7C 46006303 */  div.s      $f12, $f12, $f0
  .L8014AF80:
    /* 4AF80 8014AF80 E60C000C */  swc1       $f12, 0xC($s0)
    /* 4AF84 8014AF84 C6220008 */  lwc1       $f2, 0x8($s1)
    /* 4AF88 8014AF88 44800000 */  mtc1       $zero, $f0
    /* 4AF8C 8014AF8C 4602003C */  c.lt.s     $f0, $f2
    ...
    /* 4AFA8 8014AFA8 E6000000 */   swc1      $f0, 0x0($s0)
  .L8014AFAC:
    /* 4AFAC 8014AFAC 0C071800 */  jal        func_801C6000
    /* 4AFB0 8014AFB0 00000000 */   nop
    /* 4AFB4 8014AFB4 46000007 */  neg.s      $f0, $f0
    /* 4AFB8 8014AFB8 E6000000 */  swc1       $f0, 0x0($s0)
    /* 4AFBC 8014AFBC C60C000C */  lwc1       $f12, 0xC($s0)
    /* 4AFC0 8014AFC0 0C071010 */  jal        func_801C4040
    /* 4AFC4 8014AFC4 00000000 */   nop
    /* 4AFC8 8014AFC8 08052802 */  j          .L8014A008
    /* 4AFCC 8014AFCC E600000C */   swc1      $f0, 0xC($s0)
  .L8014AFD0:
    /* 4AFD0 8014AFD0 C6200004 */  lwc1       $f0, 0x4($s1)
    /* 4AFD4 8014AFD4 4600B03C */  c.lt.s     $f22, $f0
    /* 4AFD8 8014AFD8 00000000 */  nop
    /* 4AFDC 8014AFDC 45000006 */  bc1f       .L8014AFF8
    /* 4AFE0 8014AFE0 E6160000 */   swc1      $f22, 0x0($s0)
    /* 4AFE4 8014AFE4 3C018010 */  lui        $at, %hi(D_801063EC)
    /* 4AFE8 8014AFE8 C42063EC */  lwc1       $f0, %lo(D_801063EC)($at)
    /* 4AFEC 8014AFEC E6160008 */  swc1       $f22, 0x8($s0)
    /* 4AFF0 8014AFF0 08052802 */  j          .L8014A008
    /* 4AFF4 8014AFF4 E600000C */   swc1      $f0, 0xC($s0)
  .L8014AFF8:
    /* 4AFF8 8014AFF8 3C018010 */  lui        $at, %hi(D_801063F0)
    /* 4AFFC 8014AFFC C42063F0 */  lwc1       $f0, %lo(D_801063F0)($at)
    /* 4B000 8014B000 E616000C */  swc1       $f22, 0xC($s0)
    /* 4B004 8014B004 E6000008 */  swc1       $f0, 0x8($s0)
    ...
    /* 4B01C 8014B01C C7B90030 */  lwc1       $f25, 0x30($sp)
    /* 4B020 8014B020 C7B80034 */  lwc1       $f24, 0x34($sp)
  .L8014B024:
    /* 4B024 8014B024 C7B70028 */  lwc1       $f23, 0x28($sp)
    /* 4B028 8014B028 C7B6002C */  lwc1       $f22, 0x2C($sp)
    /* 4B02C 8014B02C C7B50020 */  lwc1       $f21, 0x20($sp)
    /* 4B030 8014B030 C7B40024 */  lwc1       $f20, 0x24($sp)
