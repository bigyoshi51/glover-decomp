...
glabel func_801B6B3C
  ...
  .L801B6B6C:
    ...
    /* B6B9C 801B6B9C C420BC54 */  lwc1       $fv0, %lo(D_8010BC54)($at)
    ...
    /* B6BB0 801B6BB0 E7A00010 */   swc1      $fv0, 0x10($sp)
  ...
  .L801B6BD0:
    /* B6BD0 801B6BD0 C600004C */  lwc1       $fv0, 0x4C($s0)
    /* B6BD4 801B6BD4 C6020050 */  lwc1       $fv1, 0x50($s0)
    /* B6BD8 801B6BD8 E6000044 */  swc1       $fv0, 0x44($s0)
    /* B6BDC 801B6BDC E6020048 */  swc1       $fv1, 0x48($s0)
  ...
  .L801B6BEC:
    ...
    /* B6BF4 801B6BF4 44800000 */  mtc1       $zero, $fv0
    /* B6BF8 801B6BF8 00511023 */  subu       $v0, $v0, $s1
    /* B6BFC 801B6BFC 44822000 */  mtc1       $v0, $ft0
    /* B6C00 801B6C00 46802120 */  cvt.s.w    $ft0, $ft0
    /* B6C04 801B6C04 4604003C */  c.lt.s     $fv0, $ft0
    /* B6C08 801B6C08 00000000 */  nop
    /* B6C0C 801B6C0C 45020009 */  bc1fl      .L801B6C34
    /* B6C10 801B6C10 46002007 */   neg.s     $fv0, $ft0
    /* B6C14 801B6C14 3C018011 */  lui        $at, %hi(D_8010BC58)
    /* B6C18 801B6C18 C420BC58 */  lwc1       $fv0, %lo(D_8010BC58)($at)
    /* B6C1C 801B6C1C 4604003C */  c.lt.s     $fv0, $ft0
  ...
  .L801B6C34:
    ...
    /* B6C38 801B6C38 C422BC5C */  lwc1       $fv1, %lo(D_8010BC5C)($at)
    /* B6C3C 801B6C3C 4600103C */  c.lt.s     $fv1, $fv0
    ...
    /* B6C50 801B6C50 C420BC60 */  lwc1       $fv0, %lo(D_8010BC60)($at)
    /* B6C54 801B6C54 46002103 */  div.s      $ft0, $ft0, $fv0
    ...
    /* B6C64 801B6C64 44820000 */  mtc1       $v0, $fv0
    /* B6C68 801B6C68 46800020 */  cvt.s.w    $fv0, $fv0
    /* B6C6C 801B6C6C 46040081 */  sub.s      $fv1, $fv0, $ft0
    /* B6C70 801B6C70 3C018011 */  lui        $at, %hi(D_8010BC64)
    /* B6C74 801B6C74 C420BC64 */  lwc1       $fv0, %lo(D_8010BC64)($at)
    /* B6C78 801B6C78 4602003E */  c.le.s     $fv0, $fv1
    /* B6C7C 801B6C7C 00000000 */  nop
    /* B6C80 801B6C80 45030005 */  bc1tl      .L801B6C98
    /* B6C84 801B6C84 46001001 */   sub.s     $fv0, $fv1, $fv0
    /* B6C88 801B6C88 4600100D */  trunc.w.s  $fv0, $fv1
    /* B6C8C 801B6C8C 44030000 */  mfc1       $v1, $fv0
    /* B6C90 801B6C90 0806D72A */  j          .L801B5CA8
    /* B6C94 801B6C94 00000000 */   nop
  .L801B6C98:
    /* B6C98 801B6C98 4600008D */  trunc.w.s  $fv1, $fv0
    /* B6C9C 801B6C9C 44031000 */  mfc1       $v1, $fv1
    ...
    /* B6CB4 801B6CB4 44820000 */  mtc1       $v0, $fv0
    /* B6CB8 801B6CB8 46800020 */  cvt.s.w    $fv0, $fv0
    /* B6CBC 801B6CBC 46040081 */  sub.s      $fv1, $fv0, $ft0
    /* B6CC0 801B6CC0 3C018011 */  lui        $at, %hi(D_8010BC68)
    /* B6CC4 801B6CC4 C420BC68 */  lwc1       $fv0, %lo(D_8010BC68)($at)
    /* B6CC8 801B6CC8 4602003E */  c.le.s     $fv0, $fv1
    /* B6CCC 801B6CCC 00000000 */  nop
    /* B6CD0 801B6CD0 45010005 */  bc1t       .L801B6CE8
    /* B6CD4 801B6CD4 A0A30000 */   sb        $v1, 0x0($a1)
    /* B6CD8 801B6CD8 4600100D */  trunc.w.s  $fv0, $fv1
    /* B6CDC 801B6CDC 44030000 */  mfc1       $v1, $fv0
    /* B6CE0 801B6CE0 0806D740 */  j          .L801B5D00
    /* B6CE4 801B6CE4 A0830000 */   sb        $v1, 0x0($a0)
  .L801B6CE8:
    /* B6CE8 801B6CE8 46001001 */  sub.s      $fv0, $fv1, $fv0
    /* B6CEC 801B6CEC 4600008D */  trunc.w.s  $fv1, $fv0
    /* B6CF0 801B6CF0 44031000 */  mfc1       $v1, $fv1
  ...
  .L801B6D00:
    ...
    /* B6D08 801B6D08 44800000 */  mtc1       $zero, $fv0
    /* B6D0C 801B6D0C 00531023 */  subu       $v0, $v0, $s3
    /* B6D10 801B6D10 44822000 */  mtc1       $v0, $ft0
    /* B6D14 801B6D14 46802120 */  cvt.s.w    $ft0, $ft0
    /* B6D18 801B6D18 4604003C */  c.lt.s     $fv0, $ft0
    /* B6D1C 801B6D1C 00000000 */  nop
    /* B6D20 801B6D20 45020009 */  bc1fl      .L801B6D48
    /* B6D24 801B6D24 46002007 */   neg.s     $fv0, $ft0
    /* B6D28 801B6D28 3C018011 */  lui        $at, %hi(D_8010BC6C)
    /* B6D2C 801B6D2C C420BC6C */  lwc1       $fv0, %lo(D_8010BC6C)($at)
    /* B6D30 801B6D30 4604003C */  c.lt.s     $fv0, $ft0
  ...
  .L801B6D48:
    ...
    /* B6D4C 801B6D4C C422BC70 */  lwc1       $fv1, %lo(D_8010BC70)($at)
    /* B6D50 801B6D50 4600103C */  c.lt.s     $fv1, $fv0
    ...
    /* B6D64 801B6D64 C420BC74 */  lwc1       $fv0, %lo(D_8010BC74)($at)
    /* B6D68 801B6D68 46002103 */  div.s      $ft0, $ft0, $fv0
    ...
    /* B6D78 801B6D78 44820000 */  mtc1       $v0, $fv0
    /* B6D7C 801B6D7C 46800020 */  cvt.s.w    $fv0, $fv0
    /* B6D80 801B6D80 46040081 */  sub.s      $fv1, $fv0, $ft0
    /* B6D84 801B6D84 3C018011 */  lui        $at, %hi(D_8010BC78)
    /* B6D88 801B6D88 C420BC78 */  lwc1       $fv0, %lo(D_8010BC78)($at)
    /* B6D8C 801B6D8C 4602003E */  c.le.s     $fv0, $fv1
    /* B6D90 801B6D90 00000000 */  nop
    /* B6D94 801B6D94 45030005 */  bc1tl      .L801B6DAC
    /* B6D98 801B6D98 46001001 */   sub.s     $fv0, $fv1, $fv0
    /* B6D9C 801B6D9C 4600100D */  trunc.w.s  $fv0, $fv1
    /* B6DA0 801B6DA0 44030000 */  mfc1       $v1, $fv0
    /* B6DA4 801B6DA4 0806D76F */  j          .L801B5DBC
    /* B6DA8 801B6DA8 00000000 */   nop
  .L801B6DAC:
    /* B6DAC 801B6DAC 4600008D */  trunc.w.s  $fv1, $fv0
    /* B6DB0 801B6DB0 44031000 */  mfc1       $v1, $fv1
    ...
    /* B6DC8 801B6DC8 44820000 */  mtc1       $v0, $fv0
    /* B6DCC 801B6DCC 46800020 */  cvt.s.w    $fv0, $fv0
    /* B6DD0 801B6DD0 46040081 */  sub.s      $fv1, $fv0, $ft0
    /* B6DD4 801B6DD4 3C018011 */  lui        $at, %hi(D_8010BC7C)
    /* B6DD8 801B6DD8 C420BC7C */  lwc1       $fv0, %lo(D_8010BC7C)($at)
    /* B6DDC 801B6DDC 4602003E */  c.le.s     $fv0, $fv1
    /* B6DE0 801B6DE0 00000000 */  nop
    /* B6DE4 801B6DE4 45010005 */  bc1t       .L801B6DFC
    /* B6DE8 801B6DE8 A0A30000 */   sb        $v1, 0x0($a1)
    /* B6DEC 801B6DEC 4600100D */  trunc.w.s  $fv0, $fv1
    /* B6DF0 801B6DF0 44030000 */  mfc1       $v1, $fv0
    /* B6DF4 801B6DF4 0806D785 */  j          .L801B5E14
    /* B6DF8 801B6DF8 A0830000 */   sb        $v1, 0x0($a0)
  .L801B6DFC:
    /* B6DFC 801B6DFC 46001001 */  sub.s      $fv0, $fv1, $fv0
    /* B6E00 801B6E00 4600008D */  trunc.w.s  $fv1, $fv0
    /* B6E04 801B6E04 44031000 */  mfc1       $v1, $fv1
  ...
  .L801B6E14:
    ...
    /* B6E1C 801B6E1C 44800000 */  mtc1       $zero, $fv0
    /* B6E20 801B6E20 00541023 */  subu       $v0, $v0, $s4
    /* B6E24 801B6E24 44822000 */  mtc1       $v0, $ft0
    /* B6E28 801B6E28 46802120 */  cvt.s.w    $ft0, $ft0
    /* B6E2C 801B6E2C 4604003C */  c.lt.s     $fv0, $ft0
    /* B6E30 801B6E30 00000000 */  nop
    /* B6E34 801B6E34 45020009 */  bc1fl      .L801B6E5C
    /* B6E38 801B6E38 46002007 */   neg.s     $fv0, $ft0
    /* B6E3C 801B6E3C 3C018011 */  lui        $at, %hi(D_8010BC80)
    /* B6E40 801B6E40 C420BC80 */  lwc1       $fv0, %lo(D_8010BC80)($at)
    /* B6E44 801B6E44 4604003C */  c.lt.s     $fv0, $ft0
  ...
  .L801B6E5C:
    ...
    /* B6E60 801B6E60 C422BC84 */  lwc1       $fv1, %lo(D_8010BC84)($at)
    /* B6E64 801B6E64 4600103C */  c.lt.s     $fv1, $fv0
    ...
    /* B6E78 801B6E78 C420BC88 */  lwc1       $fv0, %lo(D_8010BC88)($at)
    /* B6E7C 801B6E7C 46002103 */  div.s      $ft0, $ft0, $fv0
    ...
    /* B6E8C 801B6E8C 44820000 */  mtc1       $v0, $fv0
    /* B6E90 801B6E90 46800020 */  cvt.s.w    $fv0, $fv0
    /* B6E94 801B6E94 46040081 */  sub.s      $fv1, $fv0, $ft0
    /* B6E98 801B6E98 3C018011 */  lui        $at, %hi(D_8010BC8C)
    /* B6E9C 801B6E9C C420BC8C */  lwc1       $fv0, %lo(D_8010BC8C)($at)
    /* B6EA0 801B6EA0 4602003E */  c.le.s     $fv0, $fv1
    /* B6EA4 801B6EA4 00000000 */  nop
    /* B6EA8 801B6EA8 45030005 */  bc1tl      .L801B6EC0
    /* B6EAC 801B6EAC 46001001 */   sub.s     $fv0, $fv1, $fv0
    /* B6EB0 801B6EB0 4600100D */  trunc.w.s  $fv0, $fv1
    /* B6EB4 801B6EB4 44030000 */  mfc1       $v1, $fv0
    /* B6EB8 801B6EB8 0806D7B4 */  j          .L801B5ED0
    /* B6EBC 801B6EBC 00000000 */   nop
  .L801B6EC0:
    /* B6EC0 801B6EC0 4600008D */  trunc.w.s  $fv1, $fv0
    /* B6EC4 801B6EC4 44031000 */  mfc1       $v1, $fv1
    ...
    /* B6EDC 801B6EDC 44820000 */  mtc1       $v0, $fv0
    /* B6EE0 801B6EE0 46800020 */  cvt.s.w    $fv0, $fv0
    /* B6EE4 801B6EE4 46040081 */  sub.s      $fv1, $fv0, $ft0
    /* B6EE8 801B6EE8 3C018011 */  lui        $at, %hi(D_8010BC90)
    /* B6EEC 801B6EEC C420BC90 */  lwc1       $fv0, %lo(D_8010BC90)($at)
    /* B6EF0 801B6EF0 4602003E */  c.le.s     $fv0, $fv1
    /* B6EF4 801B6EF4 00000000 */  nop
    /* B6EF8 801B6EF8 45010005 */  bc1t       .L801B6F10
    /* B6EFC 801B6EFC A0A30000 */   sb        $v1, 0x0($a1)
    /* B6F00 801B6F00 4600100D */  trunc.w.s  $fv0, $fv1
    /* B6F04 801B6F04 44030000 */  mfc1       $v1, $fv0
    /* B6F08 801B6F08 0806D7CA */  j          .L801B5F28
    /* B6F0C 801B6F0C A0830000 */   sb        $v1, 0x0($a0)
  .L801B6F10:
    /* B6F10 801B6F10 46001001 */  sub.s      $fv0, $fv1, $fv0
    /* B6F14 801B6F14 4600008D */  trunc.w.s  $fv1, $fv0
    /* B6F18 801B6F18 44031000 */  mfc1       $v1, $fv1
  ...
  .L801B6F28:
    ...
    /* B6F58 801B6F58 C7B70050 */  lwc1       $fs1f, 0x50($sp)
    /* B6F5C 801B6F5C C7B60054 */  lwc1       $fs1, 0x54($sp)
    /* B6F60 801B6F60 C7B50048 */  lwc1       $fs0f, 0x48($sp)
    /* B6F64 801B6F64 C7B4004C */  lwc1       $fs0, 0x4C($sp)
  ...
  .L801B6FDC:
    /* B6FDC 801B6FDC C6000038 */  lwc1       $fv0, 0x38($s0)
    /* B6FE0 801B6FE0 C6020030 */  lwc1       $fv1, 0x30($s0)
    /* B6FE4 801B6FE4 46020000 */  add.s      $fv0, $fv0, $fv1
    /* B6FE8 801B6FE8 C64C0030 */  lwc1       $fa0, 0x30($s2)
    /* B6FEC 801B6FEC 4600603E */  c.le.s     $fa0, $fv0
    /* B6FF0 801B6FF0 00000000 */  nop
    /* B6FF4 801B6FF4 45000007 */  bc1f       .L801B7014
    /* B6FF8 801B6FF8 00000000 */   nop
    /* B6FFC 801B6FFC C6000044 */  lwc1       $fv0, 0x44($s0)
  .L801B7000:
    /* B7000 801B7000 46020000 */  add.s      $fv0, $fv0, $fv1
    /* B7004 801B7004 460C003C */  c.lt.s     $fv0, $fa0
    /* B7008 801B7008 00000000 */  nop
    /* B700C 801B700C 4501000F */  bc1t       .L801B704C
    /* B7010 801B7010 02002821 */   addu      $a1, $s0, $zero
  .L801B7014:
    /* B7014 801B7014 C6000038 */  lwc1       $fv0, 0x38($s0)
    /* B7018 801B7018 C6020030 */  lwc1       $fv1, 0x30($s0)
    /* B701C 801B701C 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* B7020 801B7020 C64C0030 */  lwc1       $fa0, 0x30($s2)
    /* B7024 801B7024 460C003C */  c.lt.s     $fv0, $fa0
    /* B7028 801B7028 00000000 */  nop
    /* B702C 801B702C 4500000B */  bc1f       .L801B705C
    /* B7030 801B7030 00000000 */   nop
    /* B7034 801B7034 C6000044 */  lwc1       $fv0, 0x44($s0)
    /* B7038 801B7038 46020001 */  sub.s      $fv0, $fv0, $fv1
    /* B703C 801B703C 4600603E */  c.le.s     $fa0, $fv0
  ...
  .L801B705C:
    ...
    /* B7080 801B7080 C6060038 */  lwc1       $ft1, 0x38($s0)
    /* B7084 801B7084 C6040030 */  lwc1       $ft0, 0x30($s0)
    /* B7088 801B7088 46043001 */  sub.s      $fv0, $ft1, $ft0
    /* B708C 801B708C C6420030 */  lwc1       $fv1, 0x30($s2)
    /* B7090 801B7090 4602003C */  c.lt.s     $fv0, $fv1
    /* B7094 801B7094 00000000 */  nop
  .L801B7098:
    /* B7098 801B7098 4500001D */  bc1f       .L801B7110
    /* B709C 801B709C 00000000 */   nop
    /* B70A0 801B70A0 46043000 */  add.s      $fv0, $ft1, $ft0
  .L801B70A4:
    /* B70A4 801B70A4 4600103E */  c.le.s     $fv1, $fv0
    /* B70A8 801B70A8 00000000 */  nop
    /* B70AC 801B70AC 45000018 */  bc1f       .L801B7110
    /* B70B0 801B70B0 00000000 */   nop
    /* B70B4 801B70B4 C6020058 */  lwc1       $fv1, 0x58($s0)
    /* B70B8 801B70B8 46021082 */  mul.s      $fv1, $fv1, $fv1
    /* B70BC 801B70BC C6000060 */  lwc1       $fv0, 0x60($s0)
    /* B70C0 801B70C0 46000002 */  mul.s      $fv0, $fv0, $fv0
    /* B70C4 801B70C4 46001300 */  add.s      $fa0, $fv1, $fv0
    /* B70C8 801B70C8 46006004 */  sqrt.s     $fv0, $fa0
    /* B70CC 801B70CC 46000032 */  c.eq.s     $fv0, $fv0
  ...
  .L801B70E4:
    ...
    /* B70F4 801B70F4 E7A00010 */  swc1       $fv0, 0x10($sp)
