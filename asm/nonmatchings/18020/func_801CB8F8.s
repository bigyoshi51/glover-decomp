...
glabel func_801CB8F8
    ...
    /* CB934 801CB934 44811000 */  mtc1       $at, $f2
    /* CB938 801CB938 44860000 */  mtc1       $a2, $f0
    /* CB93C 801CB93C 00000000 */  nop
    /* CB940 801CB940 46800020 */  cvt.s.w    $f0, $f0
    /* CB944 801CB944 46020003 */  div.s      $f0, $f0, $f2
    /* CB948 801CB948 3C02801F */  lui        $v0, %hi(D_801F46D0)
    /* CB94C 801CB94C 8C4246D0 */  lw         $v0, %lo(D_801F46D0)($v0)
    /* CB950 801CB950 46000021 */  cvt.d.s    $f0, $f0
    /* CB954 801CB954 46200000 */  add.d      $f0, $f0, $f0
    /* CB958 801CB958 C4420044 */  lwc1       $f2, 0x44($v0)
    /* CB95C 801CB95C 468010A1 */  cvt.d.w    $f2, $f2
    /* CB960 801CB960 46220003 */  div.d      $f0, $f0, $f2
    ...
    /* CB978 801CB978 46200020 */  cvt.s.d    $f0, $f0
    /* CB97C 801CB97C 08072A89 */  j          .L801CAA24
    /* CB980 801CB980 E4400010 */   swc1      $f0, 0x10($v0)
    ...
    /* CB998 801CB998 D422C5E0 */  ldc1       $f2, %lo(D_8010C5E0)($at)
    /* CB99C 801CB99C 44860000 */  mtc1       $a2, $f0
