...
glabel func_8010E560
    ...
    /* F5C8 8010E5C8 C4200104 */  lwc1       $fv0, %lo(D_80100104)($at)
    /* F5CC 8010E5CC 3C018010 */  lui        $at, %hi(D_80100108)
    /* F5D0 8010E5D0 C4220108 */  lwc1       $fv1, %lo(D_80100108)($at)
    ...
    /* F650 8010E650 E420644C */  swc1       $fv0, %lo(D_801F644C)($at)
    /* F654 8010E654 3C01801F */  lui        $at, %hi(D_801F64C0)
    /* F658 8010E658 E42264C0 */  swc1       $fv1, %lo(D_801F64C0)($at)
  .L8010E65C:
    /* F65C 8010E65C 3C018010 */  lui        $at, %hi(D_8010010C)
    /* F660 8010E660 C420010C */  lwc1       $fv0, %lo(D_8010010C)($at)
    /* F664 8010E664 3C018010 */  lui        $at, %hi(D_80100110)
    /* F668 8010E668 C4220110 */  lwc1       $fv1, %lo(D_80100110)($at)
    /* F66C 8010E66C 3C018010 */  lui        $at, %hi(D_80100114)
    /* F670 8010E670 C4240114 */  lwc1       $ft0, %lo(D_80100114)($at)
    ...
    /* F684 8010E684 E420644C */  swc1       $fv0, %lo(D_801F644C)($at)
    /* F688 8010E688 3C01801F */  lui        $at, %hi(D_801F64C0)
    /* F68C 8010E68C E42264C0 */  swc1       $fv1, %lo(D_801F64C0)($at)
    /* F690 8010E690 3C01801E */  lui        $at, %hi(D_801E64C4)
    /* F694 8010E694 E42464C4 */  swc1       $ft0, %lo(D_801E64C4)($at)
