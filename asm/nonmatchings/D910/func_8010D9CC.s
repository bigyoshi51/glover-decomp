...
glabel func_8010D9CC
  ...
  .L8010DA64:
    ...
    /* EB14 8010DB14 D7400218 */  ldc1       $f0, 0x218($k0)
    /* EB18 8010DB18 D7420228 */  ldc1       $f2, 0x228($k0)
    /* EB1C 8010DB1C D7440238 */  ldc1       $f4, 0x238($k0)
    /* EB20 8010DB20 D7460248 */  ldc1       $f6, 0x248($k0)
    /* EB24 8010DB24 D7480258 */  ldc1       $f8, 0x258($k0)
    /* EB28 8010DB28 D74A0268 */  ldc1       $f10, 0x268($k0)
    /* EB2C 8010DB2C D74C0278 */  ldc1       $f12, 0x278($k0)
    /* EB30 8010DB30 D74E0288 */  ldc1       $f14, 0x288($k0)
    /* EB34 8010DB34 D7500298 */  ldc1       $f16, 0x298($k0)
    /* EB38 8010DB38 D75202A8 */  ldc1       $f18, 0x2A8($k0)
    /* EB3C 8010DB3C D75402B8 */  ldc1       $f20, 0x2B8($k0)
    /* EB40 8010DB40 D75602C8 */  ldc1       $f22, 0x2C8($k0)
    /* EB44 8010DB44 D75802D8 */  ldc1       $f24, 0x2D8($k0)
    /* EB48 8010DB48 D75A02E8 */  ldc1       $f26, 0x2E8($k0)
    /* EB4C 8010DB4C D75C02F8 */  ldc1       $f28, 0x2F8($k0)
    /* EB50 8010DB50 D75E0308 */  ldc1       $f30, 0x308($k0)
    ...
    /* EB64 8010DB64 D7410220 */  ldc1       $f1, 0x220($k0)
    /* EB68 8010DB68 D7430230 */  ldc1       $f3, 0x230($k0)
    /* EB6C 8010DB6C D7450240 */  ldc1       $f5, 0x240($k0)
    /* EB70 8010DB70 D7470250 */  ldc1       $f7, 0x250($k0)
    /* EB74 8010DB74 D7490260 */  ldc1       $f9, 0x260($k0)
    /* EB78 8010DB78 D74B0270 */  ldc1       $f11, 0x270($k0)
    /* EB7C 8010DB7C D74D0280 */  ldc1       $f13, 0x280($k0)
    /* EB80 8010DB80 D74F0290 */  ldc1       $f15, 0x290($k0)
    /* EB84 8010DB84 D75102A0 */  ldc1       $f17, 0x2A0($k0)
    /* EB88 8010DB88 D75302B0 */  ldc1       $f19, 0x2B0($k0)
    /* EB8C 8010DB8C D75502C0 */  ldc1       $f21, 0x2C0($k0)
    /* EB90 8010DB90 D75702D0 */  ldc1       $f23, 0x2D0($k0)
    /* EB94 8010DB94 D75902E0 */  ldc1       $f25, 0x2E0($k0)
    /* EB98 8010DB98 D75B02F0 */  ldc1       $f27, 0x2F0($k0)
    /* EB9C 8010DB9C D75D0300 */  ldc1       $f29, 0x300($k0)
    /* EBA0 8010DBA0 D75F0310 */  ldc1       $f31, 0x310($k0)
  .L8010DBA4:
